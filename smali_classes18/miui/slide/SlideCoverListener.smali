...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v2, Lmiui/slide/SlideCoverListener$H;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v3

    invoke-direct {v2, p0, v3}, Lmiui/slide/SlideCoverListener$H;-><init>(Lmiui/slide/SlideCoverListener;Landroid/os/Looper;)V

    iput-object v2, p0, Lmiui/slide/SlideCoverListener;->mHandler:Landroid/os/Handler;

    new-instance v2, Lmiui/slide/SlideCoverEventManager;
    ...
    invoke-direct {v2, p0, p1, v3}, Lmiui/slide/SlideCoverEventManager;-><init>(Lmiui/slide/SlideCoverListener;Landroid/content/Context;Landroid/os/Looper;)V

    iput-object v2, p0, Lmiui/slide/SlideCoverListener;->mSlideCoverEventManager:Lmiui/slide/SlideCoverEventManager;

    iget-object v2, p0, Lmiui/slide/SlideCoverListener;->mSensorManager:Landroid/hardware/SensorManager;
...
.method private updateSystemStatus(I)V
    ...
    iget v2, p0, Lmiui/slide/SlideCoverListener;->mTotalHistoryCount:I
