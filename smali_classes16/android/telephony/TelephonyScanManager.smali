...
# virtual methods
.method public requestNetworkScan(ILandroid/telephony/NetworkScanRequest;Ljava/util/concurrent/Executor;Landroid/telephony/TelephonyScanManager$NetworkScanCallback;Ljava/lang/String;)Landroid/telephony/NetworkScan;
    .locals 9
    ...
    iget-object v6, p0, Landroid/telephony/TelephonyScanManager;->mMessenger:Landroid/os/Messenger;
    ...
    invoke-interface/range {v3 .. v8}, Lcom/android/internal/telephony/ITelephony;->requestNetworkScan(ILandroid/telephony/NetworkScanRequest;Landroid/os/Messenger;Landroid/os/IBinder;Ljava/lang/String;)I
    ...
    :cond_0
    invoke-direct {p0, v3, p2, p3, p4}, Landroid/telephony/TelephonyScanManager;->saveScanInfo(ILandroid/telephony/NetworkScanRequest;Ljava/util/concurrent/Executor;Landroid/telephony/TelephonyScanManager$NetworkScanCallback;)V

    new-instance v4, Landroid/telephony/NetworkScan;

    invoke-direct {v4, v3, p1}, Landroid/telephony/NetworkScan;-><init>(II)V
    :try_end_0
