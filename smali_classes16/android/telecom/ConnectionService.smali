...
.method private addParticipantWithConference(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "ConnectionService addParticipantWithConference(%s, %s)"
...
.method private conference(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v3, v0}, Landroid/telecom/Log;->d(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private createConnection(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    ...
    const-string v10, "createConnection, callManagerAccount: %s, callId: %s, request: %s, isIncoming: %b, isUnknown: %b, isLegacyHandover: %b, isHandover: %b"

    invoke-static {v0, v10, v8}, Landroid/telecom/Log;->d(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v15, "android.telecom.extra.HANDOVER_FROM_PHONE_ACCOUNT"
    ...
    invoke-virtual {v0, v14, v3}, Landroid/telecom/ConnectionService;->onCreateOutgoingHandoverConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/ConnectionRequest;)Landroid/telecom/Connection;
    ...
    :cond_3
    invoke-virtual {v0, v14, v3}, Landroid/telecom/ConnectionService;->onCreateIncomingHandoverConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/ConnectionRequest;)Landroid/telecom/Connection;
    ...
    invoke-static {v0, v15, v14}, Landroid/telecom/Log;->d(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V

    if-nez v8, :cond_7

    new-array v14, v6, [Ljava/lang/Object;

    const-string v15, "createConnection, implementation returned null connection."

    invoke-static {v0, v15, v14}, Landroid/telecom/Log;->i(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v14, Landroid/telecom/DisconnectCause;

    const-string v15, "IMPL_RETURNED_NULL_CONNECTION"

    invoke-direct {v14, v5, v15}, Landroid/telecom/DisconnectCause;-><init>(ILjava/lang/String;)V

    invoke-static {v14}, Landroid/telecom/Connection;->createFailedConnection(Landroid/telecom/DisconnectCause;)Landroid/telecom/Connection;
    ...
    invoke-virtual {v8, v5}, Landroid/telecom/Connection;->setAudioModeIsVoip(Z)V
    ...
    invoke-direct {v0, v13, v2, v8}, Landroid/telecom/ConnectionService;->addConnection(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/Connection;)V
    ...
    invoke-static {v15}, Landroid/telecom/Connection;->toLogSafePhoneNumber(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v16 .. v16}, Landroid/telecom/Connection;->stateToString(I)Ljava/lang/String;
    ...
    invoke-static/range {v16 .. v16}, Landroid/telecom/Connection;->capabilitiesToString(I)Ljava/lang/String;
    ...
    invoke-static {v0, v9, v12}, Landroid/telecom/Log;->v(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v9}, Landroid/telecom/ConnectionService;->createIdList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct/range {v16 .. v37}, Landroid/telecom/ParcelableConnection;-><init>(Landroid/telecom/PhoneAccountHandle;IIIILandroid/net/Uri;ILjava/lang/String;ILcom/android/internal/telecom/IVideoProvider;IZZJJLandroid/telecom/StatusHints;Landroid/telecom/DisconnectCause;Ljava/util/List;Landroid/os/Bundle;)V
...
.method private handleRttUpgradeResponse(Ljava/lang/String;Landroid/telecom/Connection$RttTextStream;)V
    ...
    invoke-static {p0, v2, v0}, Landroid/telecom/Log;->d(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final addConference(Landroid/telecom/Conference;)V
    ...
    const-string v3, "addConference: conference=%s"

    invoke-static {v0, v3, v2}, Landroid/telecom/Log;->d(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/telecom/Conference;->getAddress()Landroid/net/Uri;

    move-result-object v19

    invoke-virtual/range {p1 .. p1}, Landroid/telecom/Conference;->getAddressPresentation()I

    move-result v20

    invoke-virtual/range {p1 .. p1}, Landroid/telecom/Conference;->getCallerDisplayName()Ljava/lang/String;

    move-result-object v21

    invoke-virtual/range {p1 .. p1}, Landroid/telecom/Conference;->getCallerDisplayNamePresentation()I
    ...
    invoke-direct/range {v5 .. v22}, Landroid/telecom/ParcelableConference;-><init>(Landroid/telecom/PhoneAccountHandle;IIILjava/util/List;Lcom/android/internal/telecom/IVideoProvider;IJJLandroid/telecom/StatusHints;Landroid/os/Bundle;Landroid/net/Uri;ILjava/lang/String;I)V
...
.method public final addExistingConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/Connection;Landroid/telecom/Conference;)V
    ...
    :goto_0
    new-instance v28, Landroid/telecom/ParcelableConnection;
