...
.method public final getCallRadioTech()I
    .locals 4

    const/4 v0, 0x0

    invoke-virtual {p0}, Landroid/telecom/Conference;->getExtras()Landroid/os/Bundle;
    ...
    const-string v3, "android.telecom.extra.CALL_NETWORK_TYPE"
...
.method public final setCallRadioTech(I)V
    .locals 2
    ...
    const-string v1, "android.telecom.extra.CALL_NETWORK_TYPE"

    invoke-virtual {p0, v1, v0}, Landroid/telecom/Conference;->putExtra(Ljava/lang/String;I)V
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, "[State: %s,Capabilites: %s, VideoState: %s, VideoProvider: %s, ThisObject %s]"
...
.method public updateCallRadioTechAfterCreation()V
    .locals 3

    invoke-virtual {p0}, Landroid/telecom/Conference;->getPrimaryConnection()Landroid/telecom/Connection;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroid/telecom/Connection;->getCallRadioTech()I

    move-result v1

    invoke-virtual {p0, v1}, Landroid/telecom/Conference;->setCallRadioTech(I)V
    ...
    const-string v2, "No primary connection found while updateCallRadioTechAfterCreation"
