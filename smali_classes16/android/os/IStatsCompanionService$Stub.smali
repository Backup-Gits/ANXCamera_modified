...
.field static final TRANSACTION_sendActiveConfigsChangedBroadcast:I = 0xa

.field static final TRANSACTION_sendDataBroadcast:I = 0x9

.field static final TRANSACTION_sendSubscriberBroadcast:I = 0xb
...
.field static final TRANSACTION_triggerUidSnapshot:I = 0xc
...
.method public static getDefaultImpl()Landroid/os/IStatsCompanionService;
    .locals 1

    sget-object v0, Landroid/os/IStatsCompanionService$Stub$Proxy;->sDefaultImpl:Landroid/os/IStatsCompanionService;
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo v0, "triggerUidSnapshot"

    return-object v0

    :pswitch_1
    const-string/jumbo v0, "sendSubscriberBroadcast"

    return-object v0

    :pswitch_2
    const-string/jumbo v0, "sendActiveConfigsChangedBroadcast"

    return-object v0

    :pswitch_3
    const-string/jumbo v0, "sendDataBroadcast"
    ...
    :pswitch_5
    const-string v0, "cancelAlarmForSubscriberTriggering"

    return-object v0

    :pswitch_6
    const-string/jumbo v0, "setAlarmForSubscriberTriggering"

    return-object v0

    :pswitch_7
    const-string v0, "cancelPullingAlarm"

    return-object v0

    :pswitch_8
    const-string/jumbo v0, "setPullingAlarm"

    return-object v0

    :pswitch_9
    const-string v0, "cancelAnomalyAlarm"

    return-object v0

    :pswitch_a
    const-string/jumbo v0, "setAnomalyAlarm"

    return-object v0

    :pswitch_b
    const-string/jumbo v0, "statsdReady"
...
.method public static setDefaultImpl(Landroid/os/IStatsCompanionService;)Z
    .locals 1
    ...
    sput-object p0, Landroid/os/IStatsCompanionService$Stub$Proxy;->sDefaultImpl:Landroid/os/IStatsCompanionService;
...
.method public getTransactionName(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Landroid/os/IStatsCompanionService$Stub;->getDefaultTransactionName(I)Ljava/lang/String;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string v11, "android.os.IStatsCompanionService"
    ...
    invoke-virtual {v12, v1, v2}, Landroid/os/IStatsCompanionService$Stub;->sendActiveConfigsChangedBroadcast(Landroid/os/IBinder;[J)V
