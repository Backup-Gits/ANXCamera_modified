...
.field static final TRANSACTION_getUserName:I = 0x3b
...
.field static final TRANSACTION_getUserStartRealtime:I = 0x3c

.field static final TRANSACTION_getUserUnlockRealtime:I = 0x3d
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_8
    const-string/jumbo v0, "getManagedProfileBadge"
    ...
    :pswitch_a
    const-string v0, "createProfileForUserEvenWhenDisallowed"
    ...
    :pswitch_17
    const-string/jumbo v0, "getApplicationRestrictionsForUser"

    return-object v0

    :pswitch_18
    const-string/jumbo v0, "getApplicationRestrictions"
    ...
    :pswitch_38
    const-string v0, "createRestrictedProfile"

    return-object v0

    :pswitch_39
    const-string v0, "createProfileForUser"
    ...
    :pswitch_3c
    const-string/jumbo v0, "getCredentialOwnerProfile"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_0
    invoke-virtual {v6, v1, v0, v2, v3}, Landroid/os/IUserManager$Stub;->requestQuietModeEnabled(Ljava/lang/String;ZILandroid/content/IntentSender;)Z
    ...
    invoke-virtual {v6, v1, v2, v3, v4}, Landroid/os/IUserManager$Stub;->createProfileForUserEvenWhenDisallowed(Ljava/lang/String;II[Ljava/lang/String;)Landroid/content/pm/UserInfo;
    ...
    invoke-virtual {v1, v9, v11}, Landroid/os/PersistableBundle;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v6, v1, v2}, Landroid/os/IUserManager$Stub;->getApplicationRestrictionsForUser(Ljava/lang/String;I)Landroid/os/Bundle;
    ...
    invoke-virtual {v6, v1}, Landroid/os/IUserManager$Stub;->getApplicationRestrictions(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-virtual {v6, v1, v0, v2}, Landroid/os/IUserManager$Stub;->setUserRestriction(Ljava/lang/String;ZI)V
    ...
    invoke-virtual {v6, v1}, Landroid/os/IUserManager$Stub;->getUserRestrictions(I)Landroid/os/Bundle;
    ...
    invoke-virtual {v6, v1}, Landroid/os/IUserManager$Stub;->getUserInfo(I)Landroid/content/pm/UserInfo;
    ...
    invoke-virtual {v6, v1}, Landroid/os/IUserManager$Stub;->getProfileParent(I)Landroid/content/pm/UserInfo;
    ...
    :cond_f
    invoke-virtual {v6, v1, v0}, Landroid/os/IUserManager$Stub;->canAddMoreManagedProfiles(IZ)Z
    ...
    :cond_10
    invoke-virtual {v6, v1, v0}, Landroid/os/IUserManager$Stub;->getProfileIds(IZ)[I
    ...
    :cond_11
    invoke-virtual {v6, v1, v0}, Landroid/os/IUserManager$Stub;->getProfiles(IZ)Ljava/util/List;
    ...
    invoke-virtual {v6, v1}, Landroid/os/IUserManager$Stub;->getUserIcon(I)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-virtual {v6, v1, v2}, Landroid/os/IUserManager$Stub;->createRestrictedProfile(Ljava/lang/String;I)Landroid/content/pm/UserInfo;
    ...
    invoke-virtual {v6, v1, v2, v3, v4}, Landroid/os/IUserManager$Stub;->createProfileForUser(Ljava/lang/String;II[Ljava/lang/String;)Landroid/content/pm/UserInfo;
    ...
    invoke-virtual {v6, v1, v2}, Landroid/os/IUserManager$Stub;->createUser(Ljava/lang/String;I)Landroid/content/pm/UserInfo;
