...
.method private moveDelayedDoFrameAtFront(J)V
    .locals 7
    ...
    invoke-virtual {v1}, Landroid/view/Choreographer;->hasPendingDelayedVsync()Z
    ...
    invoke-static {v3}, Landroid/os/MessageMonitor;->isDoFrame(Landroid/os/Message;)Z
    ...
    const-string v6, "PrePostF"

    invoke-static {v4, v5, v6}, Landroid/os/Trace;->traceBegin(JLjava/lang/String;)V

    iget-object v6, v3, Landroid/os/Message;->next:Landroid/os/Message;

    iput-object v6, v2, Landroid/os/Message;->next:Landroid/os/Message;

    iget-object v6, p0, Landroid/os/MessageQueue;->mMessages:Landroid/os/Message;

    iput-object v6, v3, Landroid/os/Message;->next:Landroid/os/Message;
...
.method next()Landroid/os/Message;
    ...
    invoke-virtual {p0, v0}, Landroid/os/MessageQueue;->next(Z)Landroid/os/Message;
...
.method next(Z)Landroid/os/Message;
    .locals 13
    .annotation build Landroid/annotation/UnsupportedAppUsage;
    .end annotation
    ...
    invoke-direct {p0, v5, v6}, Landroid/os/MessageQueue;->moveDelayedDoFrameAtFront(J)V
