...
.method public static apply464xlatAdjustments(Landroid/net/NetworkStats;Landroid/net/NetworkStats;Ljava/util/Map;Z)V
    ...
    :goto_0
    iget v6, v1, Landroid/net/NetworkStats;->size:I

    if-ge v5, v6, :cond_4

    invoke-virtual {v1, v5, v3}, Landroid/net/NetworkStats;->getValues(ILandroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats$Entry;

    move-result-object v3

    iget-object v6, v3, Landroid/net/NetworkStats$Entry;->iface:Ljava/lang/String;
    ...
    iget-wide v12, v3, Landroid/net/NetworkStats$Entry;->rxPackets:J
    ...
    :cond_2
    invoke-virtual {v2, v4}, Landroid/net/NetworkStats;->combineValues(Landroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats;
    ...
    iget-wide v12, v3, Landroid/net/NetworkStats$Entry;->txPackets:J
    ...
    invoke-direct {v1, v5, v3}, Landroid/net/NetworkStats;->setValues(ILandroid/net/NetworkStats$Entry;)V
    ...
    invoke-virtual {v0, v5}, Landroid/net/NetworkStats;->removeUids([I)V
...
.method public filter(I[Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v3, v1}, Landroid/net/NetworkStats;->getValues(ILandroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats$Entry;
    ...
    iget v4, v1, Landroid/net/NetworkStats$Entry;->tag:I

    if-ne p3, v4, :cond_3

    :cond_2
    sget-object v4, Landroid/net/NetworkStats;->INTERFACES_ALL:[Ljava/lang/String;

    if-eq p2, v4, :cond_4

    iget-object v4, v1, Landroid/net/NetworkStats$Entry;->iface:Ljava/lang/String;

    invoke-static {p2, v4}, Lcom/android/internal/util/ArrayUtils;->contains([Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v2, v1}, Landroid/net/NetworkStats;->setValues(ILandroid/net/NetworkStats$Entry;)V
...
.method public migrateTun(ILjava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v3, "Failed to deduct underlying network traffic from VPN package. Moved="
...
.method public removeUids([I)V
    ...
    invoke-direct {p0, v0, v1}, Landroid/net/NetworkStats;->maybeCopyEntry(II)V
