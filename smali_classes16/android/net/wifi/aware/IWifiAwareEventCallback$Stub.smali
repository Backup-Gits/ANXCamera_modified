...
.method public static asInterface(Landroid/os/IBinder;)Landroid/net/wifi/aware/IWifiAwareEventCallback;
    ...
    check-cast v1, Landroid/net/wifi/aware/IWifiAwareEventCallback;
...
.method public static getDefaultImpl()Landroid/net/wifi/aware/IWifiAwareEventCallback;
    .locals 1

    sget-object v0, Landroid/net/wifi/aware/IWifiAwareEventCallback$Stub$Proxy;->sDefaultImpl:Landroid/net/wifi/aware/IWifiAwareEventCallback;
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo v0, "onIdentityChanged"

    return-object v0

    :cond_1
    const-string/jumbo v0, "onConnectFail"
...
.method public static setDefaultImpl(Landroid/net/wifi/aware/IWifiAwareEventCallback;)Z
    .locals 1
    ...
    sput-object p0, Landroid/net/wifi/aware/IWifiAwareEventCallback$Stub$Proxy;->sDefaultImpl:Landroid/net/wifi/aware/IWifiAwareEventCallback;
...
.method public getTransactionName(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Landroid/net/wifi/aware/IWifiAwareEventCallback$Stub;->getDefaultTransactionName(I)Ljava/lang/String;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, v2}, Landroid/net/wifi/aware/IWifiAwareEventCallback$Stub;->onIdentityChanged([B)V
    ...
    invoke-virtual {p0, v2}, Landroid/net/wifi/aware/IWifiAwareEventCallback$Stub;->onConnectFail(I)V
    ...
    invoke-virtual {p0, v2}, Landroid/net/wifi/aware/IWifiAwareEventCallback$Stub;->onConnectSuccess(I)V
