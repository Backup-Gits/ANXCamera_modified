...
.method public static getDefaultImpl()Landroid/net/wifi/aware/IWifiAwareManager;
    .locals 1

    sget-object v0, Landroid/net/wifi/aware/IWifiAwareManager$Stub$Proxy;->sDefaultImpl:Landroid/net/wifi/aware/IWifiAwareManager;
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo v0, "requestMacAddresses"

    return-object v0

    :pswitch_1
    const-string/jumbo v0, "terminateSession"
    ...
    :pswitch_3
    const-string/jumbo v0, "updateSubscribe"

    return-object v0

    :pswitch_4
    const-string/jumbo v0, "updatePublish"
    ...
    :pswitch_9
    const-string/jumbo v0, "getCharacteristics"

    return-object v0

    :pswitch_a
    const-string/jumbo v0, "isUsageEnabled"
...
.method public static setDefaultImpl(Landroid/net/wifi/aware/IWifiAwareManager;)Z
    .locals 1
    ...
    sput-object p0, Landroid/net/wifi/aware/IWifiAwareManager$Stub$Proxy;->sDefaultImpl:Landroid/net/wifi/aware/IWifiAwareManager;
...
.method public getTransactionName(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Landroid/net/wifi/aware/IWifiAwareManager$Stub;->getDefaultTransactionName(I)Ljava/lang/String;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    sget-object v2, Landroid/net/wifi/aware/SubscribeConfig;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v2, v9}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/net/wifi/aware/SubscribeConfig;
    ...
    :goto_0
    invoke-virtual {v7, v0, v1, v2}, Landroid/net/wifi/aware/IWifiAwareManager$Stub;->updateSubscribe(IILandroid/net/wifi/aware/SubscribeConfig;)V
    ...
    sget-object v2, Landroid/net/wifi/aware/PublishConfig;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v2, v9}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/net/wifi/aware/PublishConfig;
    ...
    :goto_1
    invoke-virtual {v7, v0, v1, v2}, Landroid/net/wifi/aware/IWifiAwareManager$Stub;->updatePublish(IILandroid/net/wifi/aware/PublishConfig;)V
    ...
    invoke-virtual {v7, v0, v1, v2, v3}, Landroid/net/wifi/aware/IWifiAwareManager$Stub;->subscribe(Ljava/lang/String;ILandroid/net/wifi/aware/SubscribeConfig;Landroid/net/wifi/aware/IWifiAwareDiscoverySessionCallback;)V
    ...
    invoke-virtual {v7, v0, v1, v2, v3}, Landroid/net/wifi/aware/IWifiAwareManager$Stub;->publish(Ljava/lang/String;ILandroid/net/wifi/aware/PublishConfig;Landroid/net/wifi/aware/IWifiAwareDiscoverySessionCallback;)V
    ...
    invoke-static {v1}, Landroid/net/wifi/aware/IWifiAwareEventCallback$Stub;->asInterface(Landroid/os/IBinder;)Landroid/net/wifi/aware/IWifiAwareEventCallback;
