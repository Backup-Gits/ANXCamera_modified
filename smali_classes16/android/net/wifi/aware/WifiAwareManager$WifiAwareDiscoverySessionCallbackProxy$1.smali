...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v0, "WifiAwareDiscoverySessionCallbackProxy: handleMessage post GC"
    ...
    const-string/jumbo v3, "message2"
    ...
    invoke-direct {v3, v4, v5, v2}, Landroid/net/wifi/aware/TlvBufferUtils$TlvIterable;-><init>(II[B)V
    ...
    iget-object v1, p0, Landroid/net/wifi/aware/WifiAwareManager$WifiAwareDiscoverySessionCallbackProxy$1;->this$0:Landroid/net/wifi/aware/WifiAwareManager$WifiAwareDiscoverySessionCallbackProxy;

    invoke-static {v1}, Landroid/net/wifi/aware/WifiAwareManager$WifiAwareDiscoverySessionCallbackProxy;->access$300(Landroid/net/wifi/aware/WifiAwareManager$WifiAwareDiscoverySessionCallbackProxy;)Landroid/net/wifi/aware/DiscoverySessionCallback;
    ...
    invoke-direct {v3, v5}, Landroid/net/wifi/aware/PeerHandle;-><init>(I)V
    ...
    invoke-virtual {v1, v3, v4, v0}, Landroid/net/wifi/aware/DiscoverySessionCallback;->onServiceDiscovered(Landroid/net/wifi/aware/PeerHandle;[BLjava/util/List;)V
    ...
    invoke-virtual {v1, v3, v4, v0, v5}, Landroid/net/wifi/aware/DiscoverySessionCallback;->onServiceDiscoveredWithinRange(Landroid/net/wifi/aware/PeerHandle;[BLjava/util/List;I)V
