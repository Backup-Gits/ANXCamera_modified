...
# static fields
.field public static sDefaultImpl:Landroid/net/wifi/aware/IWifiAwareManager;
...
.method public connect(Landroid/os/IBinder;Ljava/lang/String;Landroid/net/wifi/aware/IWifiAwareEventCallback;Landroid/net/wifi/aware/ConfigRequest;Z)V
    ...
    invoke-virtual {p4, v0, v3}, Landroid/net/wifi/aware/ConfigRequest;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {}, Landroid/net/wifi/aware/IWifiAwareManager$Stub;->getDefaultImpl()Landroid/net/wifi/aware/IWifiAwareManager;
...
.method public disconnect(ILandroid/os/IBinder;)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/net/wifi/aware/IWifiAwareManager;->disconnect(ILandroid/os/IBinder;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getCharacteristics()Landroid/net/wifi/aware/Characteristics;
    ...
    invoke-interface {v3}, Landroid/net/wifi/aware/IWifiAwareManager;->getCharacteristics()Landroid/net/wifi/aware/Characteristics;
    ...
    check-cast v3, Landroid/net/wifi/aware/Characteristics;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public isUsageEnabled()Z
    ...
    invoke-interface {v3}, Landroid/net/wifi/aware/IWifiAwareManager;->isUsageEnabled()Z
...
.method public publish(Ljava/lang/String;ILandroid/net/wifi/aware/PublishConfig;Landroid/net/wifi/aware/IWifiAwareDiscoverySessionCallback;)V
    ...
    invoke-interface {v3, p1, p2, p3, p4}, Landroid/net/wifi/aware/IWifiAwareManager;->publish(Ljava/lang/String;ILandroid/net/wifi/aware/PublishConfig;Landroid/net/wifi/aware/IWifiAwareDiscoverySessionCallback;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public requestMacAddresses(ILjava/util/List;Landroid/net/wifi/aware/IWifiAwareMacAddressProvider;)V
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/net/wifi/aware/IWifiAwareManager;->requestMacAddresses(ILjava/util/List;Landroid/net/wifi/aware/IWifiAwareMacAddressProvider;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public sendMessage(III[BII)V
    ...
    iget-object v0, v9, Landroid/net/wifi/aware/IWifiAwareManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
    ...
    invoke-interface/range {v3 .. v9}, Landroid/net/wifi/aware/IWifiAwareManager;->sendMessage(III[BII)V
    :try_end_6
...
.method public subscribe(Ljava/lang/String;ILandroid/net/wifi/aware/SubscribeConfig;Landroid/net/wifi/aware/IWifiAwareDiscoverySessionCallback;)V
    ...
    invoke-interface {v3, p1, p2, p3, p4}, Landroid/net/wifi/aware/IWifiAwareManager;->subscribe(Ljava/lang/String;ILandroid/net/wifi/aware/SubscribeConfig;Landroid/net/wifi/aware/IWifiAwareDiscoverySessionCallback;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public terminateSession(II)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/net/wifi/aware/IWifiAwareManager;->terminateSession(II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public updatePublish(IILandroid/net/wifi/aware/PublishConfig;)V
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/net/wifi/aware/IWifiAwareManager;->updatePublish(IILandroid/net/wifi/aware/PublishConfig;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public updateSubscribe(IILandroid/net/wifi/aware/SubscribeConfig;)V
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/net/wifi/aware/IWifiAwareManager;->updateSubscribe(IILandroid/net/wifi/aware/SubscribeConfig;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
