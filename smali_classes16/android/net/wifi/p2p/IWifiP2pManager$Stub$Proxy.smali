...
# static fields
.field public static sDefaultImpl:Landroid/net/wifi/p2p/IWifiP2pManager;
...
.method public checkConfigureWifiDisplayPermission()V
    ...
    invoke-static {}, Landroid/net/wifi/p2p/IWifiP2pManager$Stub;->getDefaultImpl()Landroid/net/wifi/p2p/IWifiP2pManager;
    ...
    invoke-interface {v3}, Landroid/net/wifi/p2p/IWifiP2pManager;->checkConfigureWifiDisplayPermission()V
    :try_end_0
...
.method public close(Landroid/os/IBinder;)V
    ...
    invoke-interface {v2, p1}, Landroid/net/wifi/p2p/IWifiP2pManager;->close(Landroid/os/IBinder;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getMessenger(Landroid/os/IBinder;)Landroid/os/Messenger;
    ...
    invoke-interface {v3, p1}, Landroid/net/wifi/p2p/IWifiP2pManager;->getMessenger(Landroid/os/IBinder;)Landroid/os/Messenger;
...
.method public getP2pStateMachineMessenger()Landroid/os/Messenger;
    ...
    invoke-interface {v3}, Landroid/net/wifi/p2p/IWifiP2pManager;->getP2pStateMachineMessenger()Landroid/os/Messenger;
...
.method public setMiracastMode(I)V
    ...
    invoke-interface {v3, p1}, Landroid/net/wifi/p2p/IWifiP2pManager;->setMiracastMode(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
