...
.field public static final KEY_MGMT_DPP:I = 0xd
...
.field public static final KEY_MGMT_FILS_SHA256:I = 0xe

.field public static final KEY_MGMT_FILS_SHA384:I = 0xf
...
.field public static final KEY_MGMT_WAPI_CERT:I = 0x15

.field public static final KEY_MGMT_WAPI_PSK:I = 0x14
...
.method public constructor <init>(Landroid/net/wifi/WifiSsid;Ljava/lang/String;JI[BLjava/lang/String;IIJ)V
    ...
    invoke-static/range {p8 .. p9}, Landroid/net/wifi/MiuiScanResult;->compensateSignalLevel(II)I
    ...
    iput v9, v0, Landroid/net/wifi/ScanResult;->frequency:I

    move-wide/from16 v10, p10

    iput-wide v10, v0, Landroid/net/wifi/ScanResult;->timestamp:J

    const/4 v12, -0x1

    iput v12, v0, Landroid/net/wifi/ScanResult;->distanceCm:I

    iput v12, v0, Landroid/net/wifi/ScanResult;->distanceSdCm:I

    iput v12, v0, Landroid/net/wifi/ScanResult;->channelWidth:I

    iput v12, v0, Landroid/net/wifi/ScanResult;->centerFreq0:I

    iput v12, v0, Landroid/net/wifi/ScanResult;->centerFreq1:I

    const-wide/16 v13, 0x0

    iput-wide v13, v0, Landroid/net/wifi/ScanResult;->flags:J

    iput-boolean v7, v0, Landroid/net/wifi/ScanResult;->isCarrierAp:Z

    iput v12, v0, Landroid/net/wifi/ScanResult;->carrierApEapType:I
...
.method public static is60GHz(I)Z
    .locals 1
...
.method public is60GHz()Z
    .locals 1

    iget v0, p0, Landroid/net/wifi/ScanResult;->frequency:I

    invoke-static {v0}, Landroid/net/wifi/ScanResult;->is60GHz(I)Z
...
.method public toString()Ljava/lang/String;
    ...
    const-string v5, ", distanceSd: "

    invoke-virtual {v0, v5}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget v5, p0, Landroid/net/wifi/ScanResult;->distanceSdCm:I
    ...
    iget-wide v7, p0, Landroid/net/wifi/ScanResult;->flags:J
