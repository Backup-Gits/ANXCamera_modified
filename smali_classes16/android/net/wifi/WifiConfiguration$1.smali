...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiConfiguration;->access$200(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/WifiConfiguration$NetworkSelectionStatus;
    ...
    iput-object v4, v0, Landroid/net/wifi/WifiConfiguration;->allowedGroupManagementCiphers:Ljava/util/BitSet;
    ...
    :goto_c
    iput-boolean v5, v0, Landroid/net/wifi/WifiConfiguration;->trusted:Z
    ...
    :goto_d
    iput-boolean v5, v0, Landroid/net/wifi/WifiConfiguration;->fromWifiNetworkSuggestion:Z
    ...
    :goto_e
    iput-boolean v5, v0, Landroid/net/wifi/WifiConfiguration;->fromWifiNetworkSpecifier:Z
    ...
    invoke-static {v0, v5}, Landroid/net/wifi/WifiConfiguration;->access$402(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v4}, Landroid/net/wifi/WifiConfiguration;->access$502(Landroid/net/wifi/WifiConfiguration;Landroid/net/MacAddress;)Landroid/net/MacAddress;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v4

    iput-object v4, v0, Landroid/net/wifi/WifiConfiguration;->dppConnector:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v4

    iput-object v4, v0, Landroid/net/wifi/WifiConfiguration;->dppNetAccessKey:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v4

    iput v4, v0, Landroid/net/wifi/WifiConfiguration;->dppNetAccessKeyExpiry:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v4

    iput-object v4, v0, Landroid/net/wifi/WifiConfiguration;->dppCsign:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v4

    iput v4, v0, Landroid/net/wifi/WifiConfiguration;->macRandomizationSetting:I
    ...
    :cond_14
    iput-boolean v2, v0, Landroid/net/wifi/WifiConfiguration;->osu:Z

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v2

    iput-object v2, v0, Landroid/net/wifi/WifiConfiguration;->oweTransIfaceName:Ljava/lang/String;
