...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/net/wifi/WifiInfo;
    ...
    invoke-virtual {v0, v1}, Landroid/net/wifi/WifiInfo;->setTxLinkSpeedMbps(I)V

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v1

    invoke-virtual {v0, v1}, Landroid/net/wifi/WifiInfo;->setRxLinkSpeedMbps(I)V
    ...
    :goto_3
    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$502(Landroid/net/wifi/WifiInfo;Z)Z
    ...
    iput-wide v4, v0, Landroid/net/wifi/WifiInfo;->txSuccess:J
    ...
    iput-wide v4, v0, Landroid/net/wifi/WifiInfo;->txRetries:J
    ...
    iput-wide v4, v0, Landroid/net/wifi/WifiInfo;->txBad:J
    ...
    iput-wide v4, v0, Landroid/net/wifi/WifiInfo;->rxSuccess:J
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$702(Landroid/net/wifi/WifiInfo;Landroid/net/wifi/SupplicantState;)Landroid/net/wifi/SupplicantState;
    ...
    :goto_4
    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$802(Landroid/net/wifi/WifiInfo;Z)Z

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$902(Landroid/net/wifi/WifiInfo;Ljava/lang/String;)Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$1002(Landroid/net/wifi/WifiInfo;Ljava/lang/String;)Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$1102(Landroid/net/wifi/WifiInfo;Ljava/lang/String;)Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v1

    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$1202(Landroid/net/wifi/WifiInfo;I)I
    ...
    :goto_5
    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$1302(Landroid/net/wifi/WifiInfo;Z)Z
    ...
    :goto_6
    invoke-static {v0, v2}, Landroid/net/wifi/WifiInfo;->access$1402(Landroid/net/wifi/WifiInfo;Z)Z
