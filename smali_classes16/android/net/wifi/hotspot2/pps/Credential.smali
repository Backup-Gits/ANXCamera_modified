...
.method public constructor <init>(Landroid/net/wifi/hotspot2/pps/Credential;)V
    ...
    invoke-direct {v1, v0}, Landroid/net/wifi/hotspot2/pps/Credential$UserCredential;-><init>(Landroid/net/wifi/hotspot2/pps/Credential$UserCredential;)V
    ...
    new-instance v1, Landroid/net/wifi/hotspot2/pps/Credential$CertificateCredential;

    invoke-direct {v1, v0}, Landroid/net/wifi/hotspot2/pps/Credential$CertificateCredential;-><init>(Landroid/net/wifi/hotspot2/pps/Credential$CertificateCredential;)V
    ...
    new-instance v1, Landroid/net/wifi/hotspot2/pps/Credential$SimCredential;

    invoke-direct {v1, v0}, Landroid/net/wifi/hotspot2/pps/Credential$SimCredential;-><init>(Landroid/net/wifi/hotspot2/pps/Credential$SimCredential;)V
    ...
    :cond_3
    iget-object v0, p1, Landroid/net/wifi/hotspot2/pps/Credential;->mCaCertificates:[Ljava/security/cert/X509Certificate;
...
.method private verifyCertCredential(Z)Z
    .locals 5
    ...
    const-string v0, "Missing certificate credential"
    ...
    iget-object v0, p0, Landroid/net/wifi/hotspot2/pps/Credential;->mCaCertificates:[Ljava/security/cert/X509Certificate;

    if-nez v0, :cond_3

    const-string v0, "Missing CA Certificate for certificate credential"
    ...
    const-string v0, "Missing client private key for certificate credential"
    ...
    invoke-virtual {v3}, Landroid/net/wifi/hotspot2/pps/Credential$CertificateCredential;->getCertSha256Fingerprint()[B

    move-result-object v3

    invoke-static {v0, v3}, Landroid/net/wifi/hotspot2/pps/Credential;->verifySha256Fingerprint([Ljava/security/cert/X509Certificate;[B)Z

    move-result v0

    if-nez v0, :cond_5

    const-string v0, "SHA-256 fingerprint mismatch"
    ...
    :cond_6
    :goto_0
    const-string v0, "Contained more than one type of credential"
...
.method private verifySimCredential()Z
    ...
    const-string v0, "Missing SIM credential"
...
.method private verifyUserCredential(Z)Z
    .locals 4
    ...
    const-string v0, "Missing user credential"
    ...
    const-string v0, "Missing CA Certificate for user credential"
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :goto_2
    iget-object v3, p0, Landroid/net/wifi/hotspot2/pps/Credential;->mCaCertificates:[Ljava/security/cert/X509Certificate;

    iget-object v4, v1, Landroid/net/wifi/hotspot2/pps/Credential;->mCaCertificates:[Ljava/security/cert/X509Certificate;
...
.method public validate(Z)Z
    ...
    invoke-direct {p0, p1}, Landroid/net/wifi/hotspot2/pps/Credential;->verifyUserCredential(Z)Z
    ...
    invoke-direct {p0, p1}, Landroid/net/wifi/hotspot2/pps/Credential;->verifyCertCredential(Z)Z
    ...
    :cond_5
    const-string v0, "Missing required credential"
