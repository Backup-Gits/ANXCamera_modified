...
.method public constructor <init>(Landroid/net/wifi/hotspot2/PasspointConfiguration;)V
    ...
    invoke-direct {v1, v0}, Landroid/net/wifi/hotspot2/pps/HomeSp;-><init>(Landroid/net/wifi/hotspot2/pps/HomeSp;)V

    iput-object v1, p0, Landroid/net/wifi/hotspot2/PasspointConfiguration;->mHomeSp:Landroid/net/wifi/hotspot2/pps/HomeSp;
    ...
    invoke-direct {v1, v0}, Landroid/net/wifi/hotspot2/pps/Credential;-><init>(Landroid/net/wifi/hotspot2/pps/Credential;)V

    iput-object v1, p0, Landroid/net/wifi/hotspot2/PasspointConfiguration;->mCredential:Landroid/net/wifi/hotspot2/pps/Credential;
    ...
    invoke-direct {v1, v0}, Landroid/net/wifi/hotspot2/pps/Policy;-><init>(Landroid/net/wifi/hotspot2/pps/Policy;)V

    iput-object v1, p0, Landroid/net/wifi/hotspot2/PasspointConfiguration;->mPolicy:Landroid/net/wifi/hotspot2/pps/Policy;
    ...
    new-instance v1, Landroid/net/wifi/hotspot2/pps/UpdateParameter;

    invoke-direct {v1, v0}, Landroid/net/wifi/hotspot2/pps/UpdateParameter;-><init>(Landroid/net/wifi/hotspot2/pps/UpdateParameter;)V

    iput-object v1, p0, Landroid/net/wifi/hotspot2/PasspointConfiguration;->mSubscriptionUpdate:Landroid/net/wifi/hotspot2/pps/UpdateParameter;
    ...
    iget-object v0, p1, Landroid/net/wifi/hotspot2/PasspointConfiguration;->mServiceFriendlyNames:Ljava/util/Map;
...
.method private validateForCommonR1andR2(Z)Z
    .locals 8
    ...
    invoke-virtual {v0, p1}, Landroid/net/wifi/hotspot2/pps/Credential;->validate(Z)Z
    ...
    const-string v6, "PasspointConfiguration"
    ...
    const-string v5, "URL bytes exceeded the max: "
    ...
    const-string v0, "Fingerprint not specified"
    ...
    const-string v5, "Incorrect size of trust root certificate SHA-256 fingerprint: "
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, Landroid/net/wifi/hotspot2/PasspointConfiguration;->mServiceFriendlyNames:Ljava/util/Map;

    if-nez v3, :cond_6

    iget-object v3, v1, Landroid/net/wifi/hotspot2/PasspointConfiguration;->mServiceFriendlyNames:Ljava/util/Map;
    ...
    :cond_6
    iget-object v4, v1, Landroid/net/wifi/hotspot2/PasspointConfiguration;->mServiceFriendlyNames:Ljava/util/Map;
...
.method public getServiceFriendlyName()Ljava/lang/String;
    .locals 4
    ...
    :cond_1
    iget-object v2, p0, Landroid/net/wifi/hotspot2/PasspointConfiguration;->mServiceFriendlyNames:Ljava/util/Map;
...
.method public getServiceFriendlyNames()Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public validate()Z
    ...
    invoke-direct {p0, v0}, Landroid/net/wifi/hotspot2/PasspointConfiguration;->validateForCommonR1andR2(Z)Z
...
.method public validateForR2()Z
    ...
    :cond_1
    invoke-direct {p0, v1}, Landroid/net/wifi/hotspot2/PasspointConfiguration;->validateForCommonR1andR2(Z)Z
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    const-string/jumbo v2, "serviceFriendlyNames"
