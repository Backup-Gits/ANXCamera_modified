...
.field private static final NODE_SUBSCRIPTION_PARAMETER:Ljava/lang/String; = "SubscriptionParameters"
...
.method private static buildPpsNode(Landroid/net/wifi/hotspot2/omadm/XMLNode;)Landroid/net/wifi/hotspot2/omadm/PpsMoParser$PPSNode;
    ...
    const-string v4, " missing both value and children"
    ...
    invoke-direct {v5, v4}, Landroid/net/wifi/hotspot2/omadm/PpsMoParser$ParsingException;-><init>(Ljava/lang/String;)V
    ...
    const-string v4, " contained both value and children"
...
.method private static parseEAPMethod(Landroid/net/wifi/hotspot2/omadm/PpsMoParser$PPSNode;Landroid/net/wifi/hotspot2/pps/Credential$UserCredential;)V
    ...
    const-string v3, "Ignore unsupported EAP method parameter: "
...
.method public static parseMoText(Ljava/lang/String;)Landroid/net/wifi/hotspot2/PasspointConfiguration;
    ...
    const-string v4, "PpsMoParser"

    const-string v5, "MgmtTree"

    if-eq v3, v5, :cond_1

    const-string v3, "Root is not a MgmtTree"
    ...
    check-cast v7, Landroid/net/wifi/hotspot2/omadm/XMLNode;

    invoke-virtual {v7}, Landroid/net/wifi/hotspot2/omadm/XMLNode;->getTag()Ljava/lang/String;
    ...
    const-string v6, "Unexpected multiple Node element under MgmtTree"
    ...
    :cond_6
    :try_start_1
    invoke-static {v7}, Landroid/net/wifi/hotspot2/omadm/PpsMoParser;->parsePpsNode(Landroid/net/wifi/hotspot2/omadm/XMLNode;)Landroid/net/wifi/hotspot2/PasspointConfiguration;
    ...
    invoke-virtual {v6}, Landroid/net/wifi/hotspot2/omadm/PpsMoParser$ParsingException;->getMessage()Ljava/lang/String;
    ...
    const-string v6, "Duplicate VerDTD element"
    ...
    :cond_8
    invoke-virtual {v7}, Landroid/net/wifi/hotspot2/omadm/XMLNode;->getText()Ljava/lang/String;
...
.method private static parsePpsInstance(Landroid/net/wifi/hotspot2/omadm/PpsMoParser$PPSNode;)Landroid/net/wifi/hotspot2/PasspointConfiguration;
    ...
    :sswitch_3
    const-string v5, "SubscriptionParameters"
    ...
    .sparse-switch
        ...
        0x9ad3066 -> :sswitch_5
        0x12bd88f6 -> :sswitch_4
        0x4255a307 -> :sswitch_3
...
.method private static parsePreferredRoamingPartner(Landroid/net/wifi/hotspot2/omadm/PpsMoParser$PPSNode;)Landroid/net/wifi/hotspot2/pps/Policy$RoamingPartner;
    ...
    const-string/jumbo v8, "includeSubdomains"
    ...
    invoke-virtual {v0, v7}, Landroid/net/wifi/hotspot2/pps/Policy$RoamingPartner;->setFqdnExactMatch(Z)V
...
.method private static parseSubscriptionParameter(Landroid/net/wifi/hotspot2/omadm/PpsMoParser$PPSNode;Landroid/net/wifi/hotspot2/PasspointConfiguration;)V
    ...
    :sswitch_data_0
    .sparse-switch
        -0x730b3f07 -> :sswitch_3
        -0x639674e3 -> :sswitch_2
        -0x62ae6572 -> :sswitch_1
        0x684c9f4d -> :sswitch_0
    .end sparse-switch
.end method
...
.method private static parseUpdateParameter(Landroid/net/wifi/hotspot2/omadm/PpsMoParser$PPSNode;)Landroid/net/wifi/hotspot2/pps/UpdateParameter;
    ...
    const-string v4, "Ignore unsupported paramter: "
...
.method private static parseUsageLimits(Landroid/net/wifi/hotspot2/omadm/PpsMoParser$PPSNode;Landroid/net/wifi/hotspot2/PasspointConfiguration;)V
    ...
    .sparse-switch
        -0x77fb8f0 -> :sswitch_3
        0x22fde34f -> :sswitch_2
        0x60b8c611 -> :sswitch_1
        0x7890e0ce -> :sswitch_0
    .end sparse-switch
.end method
