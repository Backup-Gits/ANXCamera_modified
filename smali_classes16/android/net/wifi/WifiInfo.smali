...
.field public static final LINK_SPEED_UNKNOWN:I = -0x1
...
.field private mNetworkSuggestionOrSpecifierPackageName:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/net/wifi/WifiInfo;->mWifiGeneration:I
...
.method public constructor <init>(Landroid/net/wifi/WifiInfo;)V
    ...
    iget v0, p1, Landroid/net/wifi/WifiInfo;->mTxLinkSpeed:I

    iput v0, p0, Landroid/net/wifi/WifiInfo;->mTxLinkSpeed:I

    iget v0, p1, Landroid/net/wifi/WifiInfo;->mRxLinkSpeed:I

    iput v0, p0, Landroid/net/wifi/WifiInfo;->mRxLinkSpeed:I
    ...
    iget-object v0, p1, Landroid/net/wifi/WifiInfo;->mNetworkSuggestionOrSpecifierPackageName:Ljava/lang/String;

    iput-object v0, p0, Landroid/net/wifi/WifiInfo;->mNetworkSuggestionOrSpecifierPackageName:Ljava/lang/String;
    ...
    iget v0, p1, Landroid/net/wifi/WifiInfo;->mWifiGeneration:I
    ...
    iget-boolean v0, p1, Landroid/net/wifi/WifiInfo;->mTwtSupport:Z

    iput-boolean v0, p0, Landroid/net/wifi/WifiInfo;->mTwtSupport:Z
...
.method static synthetic access$1002(Landroid/net/wifi/WifiInfo;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$1102(Landroid/net/wifi/WifiInfo;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$1202(Landroid/net/wifi/WifiInfo;I)I
    .locals 0

    iput p1, p0, Landroid/net/wifi/WifiInfo;->mWifiGeneration:I

    return p1
.end method

.method static synthetic access$1302(Landroid/net/wifi/WifiInfo;Z)Z
    .locals 0
...
.method static synthetic access$1402(Landroid/net/wifi/WifiInfo;Z)Z
    ...
    iput-boolean p1, p0, Landroid/net/wifi/WifiInfo;->mTwtSupport:Z
...
.method static synthetic access$702(Landroid/net/wifi/WifiInfo;Landroid/net/wifi/SupplicantState;)Landroid/net/wifi/SupplicantState;
    .locals 0
...
.method static synthetic access$902(Landroid/net/wifi/WifiInfo;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Landroid/net/wifi/WifiInfo;->mNetworkSuggestionOrSpecifierPackageName:Ljava/lang/String;
...
.method public getNetworkSuggestionOrSpecifierPackageName()Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Landroid/net/wifi/WifiInfo;->mNetworkSuggestionOrSpecifierPackageName:Ljava/lang/String;
...
.method public getPasspointProviderFriendlyName()Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/net/wifi/WifiInfo;->mProviderFriendlyName:Ljava/lang/String;
...
.method public getWifiGeneration()I
    ...
    iget v0, p0, Landroid/net/wifi/WifiInfo;->mWifiGeneration:I
...
.method public isOsuAp()Z
    ...
    iget-boolean v0, p0, Landroid/net/wifi/WifiInfo;->mOsuAp:Z
...
.method public isTwtSupported()Z
    ...
    iget-boolean v0, p0, Landroid/net/wifi/WifiInfo;->mTwtSupport:Z
...
.method public isVhtMax8SpatialStreamsSupported()Z
    ...
    iget-boolean v0, p0, Landroid/net/wifi/WifiInfo;->mVhtMax8SpatialStreamsSupport:Z
...
.method public reset()V
    ...
    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->setNetworkId(I)V

    const/16 v2, -0x7f

    invoke-virtual {p0, v2}, Landroid/net/wifi/WifiInfo;->setRssi(I)V

    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->setLinkSpeed(I)V

    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->setTxLinkSpeedMbps(I)V

    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->setRxLinkSpeedMbps(I)V

    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->setFrequency(I)V
    ...
    invoke-virtual {p0, v2}, Landroid/net/wifi/WifiInfo;->setOsuAp(Z)V

    invoke-virtual {p0, v0}, Landroid/net/wifi/WifiInfo;->setNetworkSuggestionOrSpecifierPackageName(Ljava/lang/String;)V

    invoke-virtual {p0, v0}, Landroid/net/wifi/WifiInfo;->setFQDN(Ljava/lang/String;)V

    invoke-virtual {p0, v0}, Landroid/net/wifi/WifiInfo;->setProviderFriendlyName(Ljava/lang/String;)V

    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->setWifiGeneration(I)V

    invoke-virtual {p0, v2}, Landroid/net/wifi/WifiInfo;->setTwtSupport(Z)V

    invoke-virtual {p0, v2}, Landroid/net/wifi/WifiInfo;->setVhtMax8SpatialStreamsSupport(Z)V
    ...
    iput-wide v3, p0, Landroid/net/wifi/WifiInfo;->txBadRate:D

    iput-wide v3, p0, Landroid/net/wifi/WifiInfo;->txSuccessRate:D

    iput-wide v3, p0, Landroid/net/wifi/WifiInfo;->rxSuccessRate:D

    iput-wide v3, p0, Landroid/net/wifi/WifiInfo;->txRetriesRate:D
...
.method public setNetworkSuggestionOrSpecifierPackageName(Ljava/lang/String;)V
    .locals 0
...
.method public setProviderFriendlyName(Ljava/lang/String;)V
    .locals 0
...
.method public setTwtSupport(Z)V
    .locals 0
...
.method public setVhtMax8SpatialStreamsSupport(Z)V
    .locals 0
...
.method public setWifiGeneration(I)V
    .locals 0
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, ", Wifi Generation: "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget v2, p0, Landroid/net/wifi/WifiInfo;->mWifiGeneration:I

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(I)Ljava/lang/StringBuffer;

    const-string v2, ", TWT support: "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget-boolean v2, p0, Landroid/net/wifi/WifiInfo;->mTwtSupport:Z

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(Z)Ljava/lang/StringBuffer;

    const-string v2, ", Eight Max VHT Spatial streams support: "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget-boolean v2, p0, Landroid/net/wifi/WifiInfo;->mVhtMax8SpatialStreamsSupport:Z
    ...
    const-string v3, ", Tx Link speed: "

    invoke-virtual {v0, v3}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget v3, p0, Landroid/net/wifi/WifiInfo;->mTxLinkSpeed:I

    invoke-virtual {v0, v3}, Ljava/lang/StringBuffer;->append(I)Ljava/lang/StringBuffer;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    const-string v3, ", Rx Link speed: "

    invoke-virtual {v0, v3}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget v3, p0, Landroid/net/wifi/WifiInfo;->mRxLinkSpeed:I
