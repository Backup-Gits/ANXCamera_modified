...
.field public static final DISABLED_AUTHENTICATION_NO_SUBSCRIPTION:I = 0xe
...
.field public static final NETWORK_SELECTION_DISABLED_MAX:I = 0xf
...
.field private mSlaveSeenInLastQualifiedNetworkSelection:Z
...
.method static constructor <clinit>()V
    ...
    const-string v15, "NETWORK_SELECTION_DISABLED_AUTHENTICATION_NO_SUBSCRIPTION"
...
.method public getSeenInLastQualifiedNetworkSelection(Z)Z
    .locals 1

    if-eqz p1, :cond_0

    iget-boolean v0, p0, Landroid/net/wifi/WifiConfiguration$NetworkSelectionStatus;->mSlaveSeenInLastQualifiedNetworkSelection:Z
...
.method public readFromParcel(Landroid/os/Parcel;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/net/wifi/WifiConfiguration$NetworkSelectionStatus;->setDisableTime(J)V

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroid/net/wifi/WifiConfiguration$NetworkSelectionStatus;->setNetworkSelectionBSSID(Ljava/lang/String;)V
...
.method public setSeenInLastQualifiedNetworkSelection(ZZ)V
    .locals 0

    if-eqz p2, :cond_0

    iput-boolean p1, p0, Landroid/net/wifi/WifiConfiguration$NetworkSelectionStatus;->mSlaveSeenInLastQualifiedNetworkSelection:Z

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1}, Landroid/net/wifi/WifiConfiguration$NetworkSelectionStatus;->setSeenInLastQualifiedNetworkSelection(Z)V
