...
.method public static getDefaultImpl()Landroid/net/wifi/ISoftApCallback;
    .locals 1

    sget-object v0, Landroid/net/wifi/ISoftApCallback$Stub$Proxy;->sDefaultImpl:Landroid/net/wifi/ISoftApCallback;
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo v0, "onStaDisconnected"

    return-object v0

    :cond_1
    const-string/jumbo v0, "onStaConnected"

    return-object v0

    :cond_2
    const-string/jumbo v0, "onNumClientsChanged"
...
.method public static setDefaultImpl(Landroid/net/wifi/ISoftApCallback;)Z
    .locals 1
    ...
    sput-object p0, Landroid/net/wifi/ISoftApCallback$Stub$Proxy;->sDefaultImpl:Landroid/net/wifi/ISoftApCallback;
...
.method public getTransactionName(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Landroid/net/wifi/ISoftApCallback$Stub;->getDefaultTransactionName(I)Ljava/lang/String;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, v2, v3}, Landroid/net/wifi/ISoftApCallback$Stub;->onStaDisconnected(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v2, v3}, Landroid/net/wifi/ISoftApCallback$Stub;->onStaConnected(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v2}, Landroid/net/wifi/ISoftApCallback$Stub;->onNumClientsChanged(I)V
    ...
    invoke-virtual {p0, v2, v3}, Landroid/net/wifi/ISoftApCallback$Stub;->onStateChanged(II)V
