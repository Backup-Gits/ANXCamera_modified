...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo v0, "getTotalStats"

    return-object v0

    :pswitch_1
    const-string/jumbo v0, "getIfaceStats"

    return-object v0

    :pswitch_2
    const-string/jumbo v0, "getUidStats"
    ...
    :pswitch_7
    const-string/jumbo v0, "incrementOperationCount"

    return-object v0

    :pswitch_8
    const-string/jumbo v0, "getMobileIfaces"

    return-object v0

    :pswitch_9
    const-string/jumbo v0, "getDetailedUidStats"

    return-object v0

    :pswitch_a
    const-string/jumbo v0, "getDataLayerSnapshotForUid"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, v1, v4, v5, v6}, Landroid/net/INetworkStatsService$Stub;->registerUsageCallback(Ljava/lang/String;Landroid/net/DataUsageRequest;Landroid/os/Messenger;Landroid/os/IBinder;)Landroid/net/DataUsageRequest;
    ...
    sget-object v4, Landroid/net/NetworkState;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {p0, v1, v3, v4, v5}, Landroid/net/INetworkStatsService$Stub;->forceUpdateIfaces([Landroid/net/Network;[Lcom/android/internal/net/VpnInfo;[Landroid/net/NetworkState;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Landroid/net/INetworkStatsService$Stub;->getDetailedUidStats([Ljava/lang/String;)Landroid/net/NetworkStats;
    ...
    invoke-virtual {p0, v3, v4}, Landroid/net/INetworkStatsService$Stub;->openSessionForUsageStats(ILjava/lang/String;)Landroid/net/INetworkStatsSession;
