...
.field public final mFactorySerialNumber:I
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Ljava/lang/String;Landroid/net/NetworkInfo;Landroid/net/NetworkCapabilities;Landroid/net/LinkProperties;ILandroid/net/NetworkMisc;I)V
    .locals 16
    ...
    iput v14, v0, Landroid/net/NetworkAgent;->mFactorySerialNumber:I
    ...
    invoke-direct {v8, v1}, Landroid/net/NetworkInfo;-><init>(Landroid/net/NetworkInfo;)V

    new-instance v9, Landroid/net/LinkProperties;

    invoke-direct {v9, v3}, Landroid/net/LinkProperties;-><init>(Landroid/net/LinkProperties;)V

    new-instance v10, Landroid/net/NetworkCapabilities;

    invoke-direct {v10, v2}, Landroid/net/NetworkCapabilities;-><init>(Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual/range {v6 .. v13}, Landroid/net/ConnectivityManager;->registerNetworkAgent(Landroid/os/Messenger;Landroid/net/NetworkInfo;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;ILandroid/net/NetworkMisc;I)I

    move-result v6

    iput v6, v0, Landroid/net/NetworkAgent;->netId:I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :sswitch_0
    invoke-virtual {p0, p1}, Landroid/net/NetworkAgent;->removeKeepalivePacketFilter(Landroid/os/Message;)V

    goto/16 :goto_3

    :sswitch_1
    invoke-virtual {p0, p1}, Landroid/net/NetworkAgent;->addKeepalivePacketFilter(Landroid/os/Message;)V
    ...
    :sswitch_4
    invoke-virtual {p0, p1}, Landroid/net/NetworkAgent;->stopSocketKeepalive(Landroid/os/Message;)V

    goto/16 :goto_3

    :sswitch_5
    invoke-virtual {p0, p1}, Landroid/net/NetworkAgent;->startSocketKeepalive(Landroid/os/Message;)V
