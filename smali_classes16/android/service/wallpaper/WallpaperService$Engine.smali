...
.method updateSurface(ZZZ)V
    ...
    :try_start_1
    sget-boolean v0, Landroid/service/wallpaper/WallpaperService;->USE_SEAMLESS_ROTATION:Z
    ...
    invoke-virtual {v15, v0}, Landroid/view/Display;->getDisplayInfo(Landroid/view/DisplayInfo;)Z
    ...
    iput v10, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mWindowFlags:I
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    iget v6, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mBlurRadio:F

    iput v6, v0, Landroid/view/WindowManager$LayoutParams;->blurRatio:F
    :try_end_3
    ...
    :try_start_7
    iget-object v13, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mContentInsets:Landroid/graphics/Rect;
    :try_end_7
    ...
    :try_start_b
    iget-object v8, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mInputChannel:Landroid/view/InputChannel;
    :try_end_b
    ...
    invoke-direct {v0, v1, v2, v6}, Landroid/service/wallpaper/WallpaperService$Engine$WallpaperInputEventReceiver;-><init>(Landroid/service/wallpaper/WallpaperService$Engine;Landroid/view/InputChannel;Landroid/os/Looper;)V
    ...
    iget-object v15, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mOutsets:Landroid/graphics/Rect;
    :try_end_f
    ...
    :try_start_10
    iget-object v4, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mBackdropFrame:Landroid/graphics/Rect;
    :try_end_10
    ...
    :try_start_11
    iget-object v3, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mDisplayCutout:Landroid/view/DisplayCutout$ParcelableWrapper;
    :try_end_11
    ...
    invoke-virtual {v1, v0, v7, v8, v9}, Landroid/service/wallpaper/WallpaperService$Engine;->onSurfaceChanged(Landroid/view/SurfaceHolder;III)V
    ...
    iget v14, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mCurWidth:I

    iget v15, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mCurHeight:I

    invoke-interface {v9, v10, v13, v14, v15}, Landroid/view/SurfaceHolder$Callback;->surfaceChanged(Landroid/view/SurfaceHolder;III)V
    ...
    iget-object v8, v1, Landroid/service/wallpaper/WallpaperService$Engine;->mOutsets:Landroid/graphics/Rect;
    ...
    invoke-direct/range {v19 .. v24}, Landroid/view/WindowInsets;-><init>(Landroid/graphics/Rect;Landroid/graphics/Rect;ZZLandroid/view/DisplayCutout;)V
