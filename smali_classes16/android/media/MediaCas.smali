...
# instance fields
.field private final mBinder:Landroid/hardware/cas/V1_1/ICasListener$Stub;
...
.method public constructor <init>(I)V
    ...
    new-instance v2, Landroid/media/MediaCas$2;

    invoke-direct {v2, p0}, Landroid/media/MediaCas$2;-><init>(Landroid/media/MediaCas;)V

    iput-object v2, p0, Landroid/media/MediaCas;->mBinder:Landroid/hardware/cas/V1_1/ICasListener$Stub;
    ...
    iget-object v4, p0, Landroid/media/MediaCas;->mBinder:Landroid/hardware/cas/V1_1/ICasListener$Stub;

    invoke-interface {v2, p1, v4}, Landroid/hardware/cas/V1_0/IMediaCasService;->createPlugin(ILandroid/hardware/cas/V1_0/ICasListener;)Landroid/hardware/cas/V1_0/ICas;
    ...
    :cond_0
    const-string v4, "Used cas@1.1 interface to create plugin"

    invoke-static {v1, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v4, p0, Landroid/media/MediaCas;->mBinder:Landroid/hardware/cas/V1_1/ICasListener$Stub;

    invoke-interface {v3, p1, v4}, Landroid/hardware/cas/V1_1/IMediaCasService;->createPluginExt(ILandroid/hardware/cas/V1_1/ICasListener;)Landroid/hardware/cas/V1_1/ICas;
...
.method static synthetic access$300(Landroid/media/MediaCas;)Landroid/media/MediaCas$EventHandler;
    .locals 1
...
.method static synthetic access$400(Landroid/media/MediaCas;)V
    .locals 0
...
.method static synthetic access$500(Landroid/media/MediaCas;[BII)Ljava/util/ArrayList;
    .locals 1
...
.method static synthetic access$600(Landroid/media/MediaCas;)Landroid/hardware/cas/V1_0/ICas;
    .locals 1
...
.method static synthetic access$700(Landroid/media/MediaCas;)V
    .locals 0
...
.method static synthetic access$800(Landroid/media/MediaCas;)Landroid/hardware/cas/V1_1/ICas;
    .locals 1
...
.method public openSession()Landroid/media/MediaCas$Session;
    ...
    iget-object v0, v1, Landroid/media/MediaCas$OpenSessionCallback;->mSession:Landroid/media/MediaCas$Session;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
