...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_3
    const-string/jumbo v0, "getDvbDeviceList"

    return-object v0

    :pswitch_4
    const-string/jumbo v0, "isSingleSessionActive"
    ...
    :pswitch_6
    const-string/jumbo v0, "getAvailableTvStreamConfigList"
    ...
    :pswitch_9
    const-string/jumbo v0, "getHardwareList"
    ...
    :pswitch_22
    const-string/jumbo v0, "getBlockedRatings"

    return-object v0

    :pswitch_23
    const-string/jumbo v0, "isRatingBlocked"
    ...
    :pswitch_25
    const-string/jumbo v0, "isParentalControlsEnabled"
    ...
    :pswitch_28
    const-string/jumbo v0, "getTvContentRatingSystemList"

    return-object v0

    :pswitch_29
    const-string/jumbo v0, "getTvInputState"
    ...
    :pswitch_2b
    const-string/jumbo v0, "getTvInputInfo"

    return-object v0

    :pswitch_2c
    const-string/jumbo v0, "getTvInputList"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {v6, v0, v1, v2, v3}, Landroid/media/tv/ITvInputManager$Stub;->captureFrame(Ljava/lang/String;Landroid/view/Surface;Landroid/media/tv/TvStreamConfig;I)Z
    ...
    invoke-static {v1}, Landroid/media/tv/ITvInputHardwareCallback$Stub;->asInterface(Landroid/os/IBinder;)Landroid/media/tv/ITvInputHardwareCallback;
    ...
    invoke-virtual {v6, v0, v1, v2, v3}, Landroid/media/tv/ITvInputManager$Stub;->acquireTvInputHardware(ILandroid/media/tv/ITvInputHardwareCallback;Landroid/media/tv/TvInputInfo;I)Landroid/media/tv/ITvInputHardware;
    ...
    invoke-interface {v4}, Landroid/media/tv/ITvInputHardware;->asBinder()Landroid/os/IBinder;
    ...
    invoke-virtual {v6, v0, v1, v2, v3}, Landroid/media/tv/ITvInputManager$Stub;->createOverlayView(Landroid/os/IBinder;Landroid/os/IBinder;Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {v6, v0, v1, v2, v3}, Landroid/media/tv/ITvInputManager$Stub;->sendAppPrivateCommand(Landroid/os/IBinder;Ljava/lang/String;Landroid/os/Bundle;I)V
    ...
    invoke-virtual {v6, v0, v1, v2, v3}, Landroid/media/tv/ITvInputManager$Stub;->tune(Landroid/os/IBinder;Landroid/net/Uri;Landroid/os/Bundle;I)V
