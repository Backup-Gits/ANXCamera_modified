...
.method private declared-synchronized getChildren(Landroid/mtp/MtpStorageManager$MtpObject;)Ljava/util/Collection;
    ...
    :try_start_6
    invoke-static {v3, v2}, Landroid/mtp/MtpStorageManager;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method private declared-synchronized handleAddedObject(Landroid/mtp/MtpStorageManager$MtpObject;Ljava/lang/String;Z)V
    ...
    :try_start_9
    invoke-static {v4, v3}, Landroid/mtp/MtpStorageManager;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public declared-synchronized checkConsistency()Z
    ...
    :cond_b
    sget-object v9, Landroid/mtp/MtpStorageManager;->TAG:Ljava/lang/String;

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "File exists in fs but not in children "
    ...
    check-cast v8, Landroid/mtp/MtpStorageManager$MtpObject;

    invoke-virtual {v8}, Landroid/mtp/MtpStorageManager$MtpObject;->getPath()Ljava/nio/file/Path;
    ...
    const-string v11, "File in children doesn\'t exist in fs "
    ...
    :cond_e
    iget-object v9, p0, Landroid/mtp/MtpStorageManager;->mObjects:Ljava/util/HashMap;

    invoke-virtual {v8}, Landroid/mtp/MtpStorageManager$MtpObject;->getId()I
    ...
    const-string v11, "Child is not in object map "
    ...
    :cond_10
    :try_start_3
    invoke-static {v5, v4}, Landroid/mtp/MtpStorageManager;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_3
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_0
    .catch Ljava/nio/file/DirectoryIteratorException; {:try_start_3 .. :try_end_3} :catch_0
    .catchall {:try_start_3 .. :try_end_3} :catchall_2
