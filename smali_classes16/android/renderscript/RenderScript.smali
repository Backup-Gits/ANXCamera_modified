...
.method declared-synchronized nAllocationCopyFromBitmap(JLandroid/graphics/Bitmap;)V
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/renderscript/RenderScript;->rsnAllocationCopyFromBitmap(JJJ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized nAllocationCopyToBitmap(JLandroid/graphics/Bitmap;)V
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/renderscript/RenderScript;->rsnAllocationCopyToBitmap(JJJ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized nAllocationCreateBitmapBackedAllocation(JILandroid/graphics/Bitmap;I)J
    ...
    invoke-virtual {p4}, Landroid/graphics/Bitmap;->getNativeInstance()J
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/renderscript/RenderScript;->rsnAllocationCreateBitmapBackedAllocation(JJIJI)J
...
.method declared-synchronized nAllocationCreateBitmapRef(JLandroid/graphics/Bitmap;)J
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/renderscript/RenderScript;->rsnAllocationCreateBitmapRef(JJJ)J
...
.method declared-synchronized nAllocationCreateFromBitmap(JILandroid/graphics/Bitmap;I)J
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/renderscript/RenderScript;->rsnAllocationCreateFromBitmap(JJIJI)J
...
.method declared-synchronized nAllocationCubeCreateFromBitmap(JILandroid/graphics/Bitmap;I)J
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/renderscript/RenderScript;->rsnAllocationCubeCreateFromBitmap(JJIJI)J
...
.method native rsnAllocationCopyFromBitmap(JJJ)V
.end method

.method native rsnAllocationCopyToBitmap(JJJ)V
.end method

.method native rsnAllocationCreateBitmapBackedAllocation(JJIJI)J
.end method

.method native rsnAllocationCreateBitmapRef(JJJ)J
.end method

.method native rsnAllocationCreateFromAssetStream(JIII)J
.end method

.method native rsnAllocationCreateFromBitmap(JJIJI)J
.end method

.method native rsnAllocationCreateTyped(JJIIJ)J
.end method

.method native rsnAllocationCubeCreateFromBitmap(JJIJI)J
.end method
