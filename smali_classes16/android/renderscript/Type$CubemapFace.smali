...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1, v1}, Landroid/renderscript/Type$CubemapFace;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v3, v2, v2}, Landroid/renderscript/Type$CubemapFace;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v4, v3, v3}, Landroid/renderscript/Type$CubemapFace;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v5, v4, v4}, Landroid/renderscript/Type$CubemapFace;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v6, v5, v5}, Landroid/renderscript/Type$CubemapFace;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v7, v6, v6}, Landroid/renderscript/Type$CubemapFace;-><init>(Ljava/lang/String;II)V
    ...
    const-string v8, "POSITVE_X"

    invoke-direct {v0, v8, v7, v1}, Landroid/renderscript/Type$CubemapFace;-><init>(Ljava/lang/String;II)V
    ...
    const-string v9, "POSITVE_Y"

    invoke-direct {v0, v9, v8, v3}, Landroid/renderscript/Type$CubemapFace;-><init>(Ljava/lang/String;II)V
    ...
    const-string v10, "POSITVE_Z"

    invoke-direct {v0, v10, v9, v5}, Landroid/renderscript/Type$CubemapFace;-><init>(Ljava/lang/String;II)V
