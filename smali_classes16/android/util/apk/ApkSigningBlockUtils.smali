...
.method private static computeContentDigestsPer1MbChunk([I[Landroid/util/apk/DataSource;)[[B
    ...
    invoke-static {v1, v8, v0}, Landroid/util/apk/ApkSigningBlockUtils;->setUnsignedInt32LittleEndian(I[BI)V
    ...
    :cond_3
    :try_start_1
    invoke-interface {v9, v13, v2, v3, v1}, Landroid/util/apk/DataSource;->feedIntoDataDigester(Landroid/util/apk/DataDigester;JI)V
    :try_end_1
    ...
    invoke-static {v7}, Landroid/util/apk/ApkSigningBlockUtils;->getContentDigestAlgorithmOutputSizeBytes(I)I
    ...
    add-int/lit8 v12, v25, 0x5

    invoke-virtual {v7, v8, v12, v9}, Ljava/security/MessageDigest;->digest([BII)I
    ...
    invoke-direct {v5, v7, v0}, Ljava/security/DigestException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
