...
.field private static final APPLY_RAMPING_RINGER_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
...
.field private static final AUTOMATIC_POWER_SAVE_MODE_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
...
.field private static final AWARE_ALLOWED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

.field public static final BACKUP_AGENT_TIMEOUT_PARAMETERS:Ljava/lang/String; = "backup_agent_timeout_parameters"

.field public static final BACKUP_MULTI_USER_ENABLED:Ljava/lang/String; = "backup_multi_user_enabled"
...
.field public static final DEFAULT_USER_ID_TO_BOOT_INTO:Ljava/lang/String; = "default_boot_into_user_id"
...
.field private static final DYNAMIC_POWER_SAVINGS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
...
.field private static final ENABLE_AUTOMATIC_SYSTEM_SERVER_HEAP_DUMPS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
...
.field public static final LAST_ACTIVE_USER_ID:Ljava/lang/String; = "last_active_persistent_user_id"
...
.field public static final LOCATION_DISABLE_STATUS_CALLBACKS:Ljava/lang/String; = "location_disable_status_callbacks"
...
.field public static final LOCATION_LAST_LOCATION_MAX_AGE_MILLIS:Ljava/lang/String; = "location_last_location_max_age_millis"
...
.field private static final LOW_POWER_MODE_STICKY_AUTO_DISABLE_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

.field public static final LOW_POWER_MODE_STICKY_AUTO_DISABLE_LEVEL:Ljava/lang/String; = "low_power_sticky_auto_disable_level"

.field private static final LOW_POWER_MODE_STICKY_AUTO_DISABLE_LEVEL_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
...
.field private static final POWER_BUTTON_LONG_PRESS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
...
.field private static final POWER_BUTTON_VERY_LONG_PRESS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
...
.field public static final WIFI_DATA_STALL_MIN_TX_BAD:Ljava/lang/String; = "wifi_data_stall_min_tx_bad"

.field public static final WIFI_DATA_STALL_MIN_TX_SUCCESS_WITHOUT_RX:Ljava/lang/String; = "wifi_data_stall_min_tx_success_without_rx"
...
.field public static final WIFI_IS_UNUSABLE_EVENT_METRICS_ENABLED:Ljava/lang/String; = "wifi_is_unusable_event_metrics_enabled"

.field public static final WIFI_LINK_PROBING_ENABLED:Ljava/lang/String; = "wifi_link_probing_enabled"

.field private static final WIFI_LINK_PROBING_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

.field public static final WIFI_LINK_SPEED_METRICS_ENABLED:Ljava/lang/String; = "wifi_link_speed_metrics_enabled"
...
.field public static final WIFI_PNO_FREQUENCY_CULLING_ENABLED:Ljava/lang/String; = "wifi_pno_frequency_culling_enabled"

.field private static final WIFI_PNO_FREQUENCY_CULLING_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

.field public static final WIFI_PNO_RECENCY_SORTING_ENABLED:Ljava/lang/String; = "wifi_pno_recency_sorting_enabled"

.field private static final WIFI_PNO_RECENCY_SORTING_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
...
.field private static final WIFI_SCAN_THROTTLE_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/provider/Settings$Global;->APPLY_RAMPING_RINGER_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sput-object v0, Landroid/provider/Settings$Global;->WIFI_SCAN_THROTTLE_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sput-object v0, Landroid/provider/Settings$Global;->WIFI_PNO_FREQUENCY_CULLING_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    sget-object v0, Landroid/provider/SettingsValidators;->BOOLEAN_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    sput-object v0, Landroid/provider/Settings$Global;->WIFI_PNO_RECENCY_SORTING_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    sget-object v0, Landroid/provider/SettingsValidators;->BOOLEAN_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    sput-object v0, Landroid/provider/Settings$Global;->WIFI_LINK_PROBING_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    invoke-direct {v0, v4}, Landroid/provider/SettingsValidators$DiscreteValueValidator;-><init>([Ljava/lang/String;)V
    ...
    sput-object v0, Landroid/provider/Settings$Global;->ENABLE_AUTOMATIC_SYSTEM_SERVER_HEAP_DUMPS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    invoke-direct {v0, v5, v4}, Landroid/provider/SettingsValidators$InclusiveIntegerRangeValidator;-><init>(II)V

    sput-object v0, Landroid/provider/Settings$Global;->LOW_POWER_MODE_STICKY_AUTO_DISABLE_LEVEL_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sput-object v0, Landroid/provider/Settings$Global;->LOW_POWER_MODE_STICKY_AUTO_DISABLE_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sput-object v0, Landroid/provider/Settings$Global;->AUTOMATIC_POWER_SAVE_MODE_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    new-instance v0, Landroid/provider/SettingsValidators$InclusiveIntegerRangeValidator;

    invoke-direct {v0, v5, v4}, Landroid/provider/SettingsValidators$InclusiveIntegerRangeValidator;-><init>(II)V

    sput-object v0, Landroid/provider/Settings$Global;->DYNAMIC_POWER_SAVINGS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sput-object v0, Landroid/provider/Settings$Global;->AWARE_ALLOWED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    new-instance v0, Landroid/provider/SettingsValidators$InclusiveIntegerRangeValidator;

    const/4 v1, 0x5

    invoke-direct {v0, v5, v1}, Landroid/provider/SettingsValidators$InclusiveIntegerRangeValidator;-><init>(II)V

    sput-object v0, Landroid/provider/Settings$Global;->POWER_BUTTON_LONG_PRESS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sput-object v0, Landroid/provider/Settings$Global;->POWER_BUTTON_VERY_LONG_PRESS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string v6, "apply_ramping_ringer"
    ...
    const-string/jumbo v12, "power_sounds_enabled"

    const-string v13, "dock_sounds_enabled"

    const-string v14, "charging_sounds_enabled"

    const-string/jumbo v15, "usb_mass_storage_enabled"

    const-string/jumbo v16, "network_recommendations_enabled"

    const-string/jumbo v17, "wifi_wakeup_enabled"

    const-string/jumbo v18, "wifi_networks_available_notification_on"

    const-string/jumbo v19, "wifi_carrier_networks_available_notification_on"

    const-string/jumbo v20, "use_open_wifi_package"
    ...
    const-string v24, "dock_audio_media_enabled"

    const-string v25, "enable_automatic_system_server_heap_dumps"

    const-string v26, "encoded_surround_output"

    const-string v27, "encoded_surround_output_enabled_formats"

    const-string/jumbo v28, "low_power_trigger_level"

    const-string/jumbo v29, "low_power_sticky_auto_disable_enabled"

    const-string/jumbo v30, "low_power_sticky_auto_disable_level"

    const-string v31, "bluetooth_on"

    const-string/jumbo v32, "private_dns_mode"

    const-string/jumbo v33, "private_dns_specifier"

    const-string/jumbo v34, "soft_ap_timeout_enabled"

    const-string/jumbo v35, "zen_duration"

    const-string v36, "charging_vibration_enabled"

    const-string v37, "aware_allowed"
    ...
    sget-object v1, Landroid/provider/Settings$Global;->APPLY_RAMPING_RINGER_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->BUGREPORT_IN_POWER_MENU_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->STAY_ON_WHILE_PLUGGED_IN_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->AUTO_TIME_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->AUTO_TIME_ZONE_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->POWER_SOUNDS_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->DOCK_SOUNDS_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->CHARGING_SOUNDS_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->USB_MASS_STORAGE_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->NETWORK_RECOMMENDATIONS_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->WIFI_WAKEUP_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->WIFI_NETWORKS_AVAILABLE_NOTIFICATION_ON_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->USE_OPEN_WIFI_PACKAGE_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->WIFI_WATCHDOG_POOR_NETWORK_TEST_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->EMERGENCY_TONE_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->CALL_AUTO_RETRY_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->DOCK_AUDIO_MEDIA_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->ENABLE_AUTOMATIC_SYSTEM_SERVER_HEAP_DUMPS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string v3, "enable_automatic_system_server_heap_dumps"

    invoke-interface {v0, v3, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->ENCODED_SURROUND_OUTPUT_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->ENCODED_SURROUND_OUTPUT_ENABLED_FORMATS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->LOW_POWER_MODE_STICKY_AUTO_DISABLE_LEVEL_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->LOW_POWER_MODE_STICKY_AUTO_DISABLE_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->LOW_POWER_MODE_TRIGGER_LEVEL_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    const-string/jumbo v3, "low_power_trigger_level_max"

    invoke-interface {v0, v3, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->AUTOMATIC_POWER_SAVE_MODE_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->DYNAMIC_POWER_SAVINGS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->BLUETOOTH_ON_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->PRIVATE_DNS_MODE_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->PRIVATE_DNS_SPECIFIER_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->SOFT_AP_TIMEOUT_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string/jumbo v3, "soft_ap_timeout_enabled"

    invoke-interface {v0, v3, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->WIFI_CARRIER_NETWORKS_AVAILABLE_NOTIFICATION_ON_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string/jumbo v3, "wifi_carrier_networks_available_notification_on"

    invoke-interface {v0, v3, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->WIFI_SCAN_THROTTLE_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string/jumbo v3, "wifi_scan_throttle_enabled"

    invoke-interface {v0, v3, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->APP_AUTO_RESTRICTION_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->ZEN_DURATION_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->CHARGING_VIBRATION_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string v4, "charging_vibration_enabled"
    ...
    const-string v6, "device_provisioning_mobile_data"
    ...
    const-string/jumbo v6, "require_password_to_decrypt"
    ...
    const-string v6, "device_demo_mode"

    invoke-interface {v0, v6, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->WIFI_PNO_FREQUENCY_CULLING_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string/jumbo v6, "wifi_pno_frequency_culling_enabled"

    invoke-interface {v0, v6, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->WIFI_PNO_RECENCY_SORTING_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string/jumbo v6, "wifi_pno_recency_sorting_enabled"

    invoke-interface {v0, v6, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->WIFI_LINK_PROBING_ENABLED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string/jumbo v6, "wifi_link_probing_enabled"

    invoke-interface {v0, v6, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->AWARE_ALLOWED_VALIDATOR:Landroid/provider/SettingsValidators$Validator;

    const-string v6, "aware_allowed"

    invoke-interface {v0, v6, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroid/provider/Settings$Global;->VALIDATORS:Ljava/util/Map;

    sget-object v1, Landroid/provider/Settings$Global;->POWER_BUTTON_LONG_PRESS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->POWER_BUTTON_VERY_LONG_PRESS_VALIDATOR:Landroid/provider/SettingsValidators$Validator;
    ...
    sget-object v5, Landroid/provider/Settings$Global;->sProviderHolder:Landroid/provider/Settings$ContentProviderHolder;

    const-string v6, "GET_global"

    const-string v7, "PUT_global"

    invoke-direct {v0, v1, v6, v7, v5}, Landroid/provider/Settings$NameValueCache;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Landroid/provider/Settings$ContentProviderHolder;)V
