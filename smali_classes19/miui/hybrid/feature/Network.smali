...
.field private static final WP:Ljava/lang/String; = "getType"

.field private static final XP:Ljava/lang/String; = "enableNotification"

.field private static final YP:Ljava/lang/String; = "disableNotification"

.field private static final ZP:Ljava/lang/String; = "metered"

.field private static final _P:Ljava/lang/String; = "connected"


# instance fields
.field private VP:Lmiui/hybrid/LifecycleListener;

.field private mCallback:Lmiui/hybrid/Callback;

.field private mFilter:Landroid/content/IntentFilter;

.field private mReceiver:Lmiui/hybrid/feature/Network$a;
...
.method private a(Lmiui/hybrid/NativeInterface;)V
    ...
    iget-object v0, p0, Lmiui/hybrid/feature/Network;->mReceiver:Lmiui/hybrid/feature/Network$a;
    ...
    iget-object v1, p0, Lmiui/hybrid/feature/Network;->VP:Lmiui/hybrid/LifecycleListener;

    invoke-virtual {p1, v1}, Lmiui/hybrid/NativeInterface;->removeLifecycleListener(Lmiui/hybrid/LifecycleListener;)V

    iget-object p1, p0, Lmiui/hybrid/feature/Network;->mReceiver:Lmiui/hybrid/feature/Network$a;

    invoke-virtual {v0, p1}, Landroid/app/Activity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    const/4 p1, 0x0

    iput-object p1, p0, Lmiui/hybrid/feature/Network;->mReceiver:Lmiui/hybrid/feature/Network$a;
...
.method private b(Lmiui/hybrid/Request;)Lmiui/hybrid/Response;
    ...
    new-instance p1, Lmiui/hybrid/feature/Network$a;

    const/4 v2, 0x0

    invoke-direct {p1, p0, v2}, Lmiui/hybrid/feature/Network$a;-><init>(Lmiui/hybrid/feature/Network;Lmiui/hybrid/feature/d;)V
    ...
    new-instance p1, Lmiui/hybrid/feature/d;

    invoke-direct {p1, p0, v0}, Lmiui/hybrid/feature/d;-><init>(Lmiui/hybrid/feature/Network;Lmiui/hybrid/NativeInterface;)V

    iput-object p1, p0, Lmiui/hybrid/feature/Network;->VP:Lmiui/hybrid/LifecycleListener;

    iget-object p0, p0, Lmiui/hybrid/feature/Network;->VP:Lmiui/hybrid/LifecycleListener;
