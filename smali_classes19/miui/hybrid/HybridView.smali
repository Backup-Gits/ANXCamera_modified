...
# static fields
.field private static final ki:I = 0x0

.field private static final li:I = 0x1

.field private static final mi:I = 0x2


# instance fields
.field private Qf:Z

.field private _h:Lmiui/widget/ProgressBar;

.field private ai:Lcom/miui/internal/hybrid/HybridProgressView;

.field private bi:Landroid/view/ViewGroup;

.field private di:Landroid/widget/Button;

.field private ei:Landroid/widget/TextView;

.field private fi:Lcom/miui/internal/hybrid/WebContainerView;

.field private gi:Lmiui/hybrid/HybridSettings;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, Lmiui/hybrid/HybridView;->hi:I
    ...
    iput-boolean v0, p0, Lmiui/hybrid/HybridView;->ii:Z
    ...
    iput-boolean v0, p0, Lmiui/hybrid/HybridView;->Qf:Z
    ...
    iput-object p1, p0, Lmiui/hybrid/HybridView;->fi:Lcom/miui/internal/hybrid/WebContainerView;

    iget-object p1, p0, Lmiui/hybrid/HybridView;->fi:Lcom/miui/internal/hybrid/WebContainerView;
    ...
    iget p1, p0, Lmiui/hybrid/HybridView;->hi:I
    ...
    iput-object p1, p0, Lmiui/hybrid/HybridView;->_h:Lmiui/widget/ProgressBar;
    ...
    iput-object p1, p0, Lmiui/hybrid/HybridView;->ai:Lcom/miui/internal/hybrid/HybridProgressView;
    ...
    iput-object p1, p0, Lmiui/hybrid/HybridView;->ei:Landroid/widget/TextView;

    iget-boolean p1, p0, Lmiui/hybrid/HybridView;->Qf:Z

    if-eqz p1, :cond_2

    iget-object p0, p0, Lmiui/hybrid/HybridView;->ei:Landroid/widget/TextView;
...
.method static synthetic a(Lmiui/hybrid/HybridView;I)V
    ...
    invoke-direct {p0, p1}, Lmiui/hybrid/HybridView;->w(I)V
...
.method private w(I)V
    ...
    iget-object v0, p0, Lmiui/hybrid/HybridView;->bi:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, Lmiui/hybrid/HybridView;->bi:Landroid/view/ViewGroup;
...
.method b(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, Lmiui/hybrid/HybridView;->ei:Landroid/widget/TextView;
...
.method b(Z)V
    ...
    iput-boolean p1, p0, Lmiui/hybrid/HybridView;->ji:Z
...
.method public getSettings()Lmiui/hybrid/HybridSettings;
    ...
    iget-object v0, p0, Lmiui/hybrid/HybridView;->gi:Lmiui/hybrid/HybridSettings;
    ...
    iput-object v0, p0, Lmiui/hybrid/HybridView;->gi:Lmiui/hybrid/HybridSettings;

    :cond_0
    iget-object p0, p0, Lmiui/hybrid/HybridView;->gi:Lmiui/hybrid/HybridSettings;
...
.method k()Lcom/miui/internal/hybrid/HybridManager;
    .locals 0
...
.method l()V
    ...
    iget-boolean v0, p0, Lmiui/hybrid/HybridView;->ii:Z
...
.method m()V
    ...
    iput-object v0, p0, Lmiui/hybrid/HybridView;->bi:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lmiui/hybrid/HybridView;->di:Landroid/widget/Button;

    iget-object v0, p0, Lmiui/hybrid/HybridView;->di:Landroid/widget/Button;

    new-instance v1, Lmiui/hybrid/h;

    invoke-direct {v1, p0}, Lmiui/hybrid/h;-><init>(Lmiui/hybrid/HybridView;)V
    ...
    invoke-direct {p0, v1}, Lmiui/hybrid/HybridView;->w(I)V
...
.method setProgress(I)V
    ...
    iget-boolean v0, p0, Lmiui/hybrid/HybridView;->ji:Z

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lmiui/hybrid/HybridView;->l()V
    ...
    iget-object v0, p0, Lmiui/hybrid/HybridView;->fi:Lcom/miui/internal/hybrid/WebContainerView;
    ...
    :cond_1
    iget-object v0, p0, Lmiui/hybrid/HybridView;->_h:Lmiui/widget/ProgressBar;

    if-nez v0, :cond_2

    iget-object v0, p0, Lmiui/hybrid/HybridView;->ai:Lcom/miui/internal/hybrid/HybridProgressView;
    ...
    :cond_2
    iget v0, p0, Lmiui/hybrid/HybridView;->hi:I
    ...
    iget-object p0, p0, Lmiui/hybrid/HybridView;->_h:Lmiui/widget/ProgressBar;
    ...
    iget-object p0, p0, Lmiui/hybrid/HybridView;->ai:Lcom/miui/internal/hybrid/HybridProgressView;
