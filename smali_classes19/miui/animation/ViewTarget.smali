...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lmiui/animation/ViewTarget$ViewAttachStateListener;
    }
.end annotation
...
# static fields
.field private static final KJ:Ljava/lang/String; = "CalledFromWrongThreadException"

.field private static LJ:Lmiui/animation/ViewTarget$ViewAttachStateListener;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lmiui/animation/ViewTarget$ViewAttachStateListener;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lmiui/animation/ViewTarget$ViewAttachStateListener;-><init>(Lmiui/animation/ViewTarget$1;)V

    sput-object v0, Lmiui/animation/ViewTarget;->LJ:Lmiui/animation/ViewTarget$ViewAttachStateListener;
...
.method private constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lmiui/animation/ViewTarget;->Zc:Ljava/lang/ref/WeakReference;
...
.method static synthetic a(Lmiui/animation/ViewTarget;Landroid/view/View;Ljava/lang/Runnable;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lmiui/animation/ViewTarget;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method private b(Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    const-string v2, "CalledFromWrongThreadException"
    ...
    iput-boolean v0, p0, Lmiui/animation/ViewTarget;->JJ:Z
...
.method static synthetic p()Lmiui/animation/ViewTarget$ViewAttachStateListener;
    .locals 1

    sget-object v0, Lmiui/animation/ViewTarget;->LJ:Lmiui/animation/ViewTarget$ViewAttachStateListener;
...
.method public executeOnInitialized(Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, Lmiui/animation/ViewTarget;->Zc:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    new-instance v1, Lmiui/animation/b;

    invoke-direct {v1, p0, v0, p1}, Lmiui/animation/b;-><init>(Lmiui/animation/ViewTarget;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public getLocationOnScreen([I)V
    ...
    iget-object p0, p0, Lmiui/animation/ViewTarget;->Zc:Ljava/lang/ref/WeakReference;
...
.method public post(Ljava/lang/Runnable;)V
    ...
    :cond_0
    iget-boolean v1, p0, Lmiui/animation/ViewTarget;->JJ:Z
    ...
    :cond_1
    invoke-direct {p0, v0, p1}, Lmiui/animation/ViewTarget;->b(Landroid/view/View;Ljava/lang/Runnable;)V
