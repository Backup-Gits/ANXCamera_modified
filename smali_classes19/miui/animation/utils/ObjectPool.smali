...
# static fields
.field private static final DN:I = 0x5

.field private static final EN:Ljava/lang/Runnable;

.field private static final FN:Ljava/util/concurrent/ConcurrentHashMap;
...
.field private static final Fs:J = 0x5dcL
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/animation/utils/ObjectPool;->LL:Landroid/os/Handler;

    new-instance v0, Lmiui/animation/utils/ObjectPool$1;

    invoke-direct {v0}, Lmiui/animation/utils/ObjectPool$1;-><init>()V

    sput-object v0, Lmiui/animation/utils/ObjectPool;->EN:Ljava/lang/Runnable;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Lmiui/animation/utils/ObjectPool;->FN:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private static varargs a(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-static {v6, p1}, Lmiui/animation/utils/ObjectPool;->a(Ljava/lang/reflect/Constructor;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static a(Ljava/lang/Class;)Lmiui/animation/utils/ObjectPool$ObjectCache;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v0, Lmiui/animation/utils/ObjectPool;->FN:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v1, Lmiui/animation/utils/ObjectPool;->FN:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static varargs acquire(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lmiui/animation/utils/ObjectPool;->a(Ljava/lang/Class;)Lmiui/animation/utils/ObjectPool$ObjectCache;
    ...
    iget-object v3, v0, Lmiui/animation/utils/ObjectPool$ObjectCache;->zN:Ljava/util/List;
    ...
    :try_start_1
    invoke-static {p0, p1}, Lmiui/animation/utils/ObjectPool;->a(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p0, v0, Lmiui/animation/utils/ObjectPool$ObjectCache;->zN:Ljava/util/List;
...
.method public static release(Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lmiui/animation/utils/ObjectPool;->a(Ljava/lang/Class;)Lmiui/animation/utils/ObjectPool$ObjectCache;

    move-result-object v0

    const/4 v1, 0x0

    iget-object v2, v0, Lmiui/animation/utils/ObjectPool$ObjectCache;->zN:Ljava/util/List;
    ...
    sget-object p0, Lmiui/animation/utils/ObjectPool;->LL:Landroid/os/Handler;

    sget-object v0, Lmiui/animation/utils/ObjectPool;->EN:Ljava/lang/Runnable;
