...
.field private uJ:Lmiui/animation/ITouchStyle;
...
.method private varargs constructor <init>([Lmiui/animation/IAnimTarget;)V
    ...
    iput-object p1, p0, Lmiui/animation/Folme$a;->mTargets:[Lmiui/animation/IAnimTarget;

    return-void
.end method

.method synthetic constructor <init>([Lmiui/animation/IAnimTarget;Lmiui/animation/a;)V
    .locals 0

    invoke-direct {p0, p1}, Lmiui/animation/Folme$a;-><init>([Lmiui/animation/IAnimTarget;)V
...
.method clean()V
    ...
    iget-object v0, p0, Lmiui/animation/Folme$a;->uJ:Lmiui/animation/ITouchStyle;
    ...
    :cond_0
    iget-object v0, p0, Lmiui/animation/Folme$a;->mVisible:Lmiui/animation/IVisibleStyle;
    ...
    :cond_1
    iget-object p0, p0, Lmiui/animation/Folme$a;->mState:Lmiui/animation/IStateStyle;
...
.method public state()Lmiui/animation/IStateStyle;
    ...
    iget-object v0, p0, Lmiui/animation/Folme$a;->mState:Lmiui/animation/IStateStyle;

    if-nez v0, :cond_0

    iget-object v0, p0, Lmiui/animation/Folme$a;->mTargets:[Lmiui/animation/IAnimTarget;
    ...
    iput-object v0, p0, Lmiui/animation/Folme$a;->mState:Lmiui/animation/IStateStyle;
...
.method public touch()Lmiui/animation/ITouchStyle;
    ...
    iget-object v1, p0, Lmiui/animation/Folme$a;->mTargets:[Lmiui/animation/IAnimTarget;
    ...
    iput-object v0, p0, Lmiui/animation/Folme$a;->uJ:Lmiui/animation/ITouchStyle;

    :cond_0
    iget-object p0, p0, Lmiui/animation/Folme$a;->uJ:Lmiui/animation/ITouchStyle;
...
.method public visible()Lmiui/animation/IVisibleStyle;
    ...
    iput-object v0, p0, Lmiui/animation/Folme$a;->mVisible:Lmiui/animation/IVisibleStyle;

    :cond_0
    iget-object p0, p0, Lmiui/animation/Folme$a;->mVisible:Lmiui/animation/IVisibleStyle;
