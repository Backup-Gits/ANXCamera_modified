...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lmiui/animation/controller/FolmeTouch$a;,
...
# static fields
.field private static final kK:F = 0.9f

.field private static final lK:I = 0xa

.field private static mK:Ljava/util/WeakHashMap;
...
.field private aK:Lmiui/animation/controller/FolmeFont;
...
.field private fK:Ljava/lang/ref/WeakReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private gK:Lmiui/animation/base/AnimConfig;

.field private hK:Lmiui/animation/base/AnimConfig;

.field private iK:Lmiui/animation/base/AnimConfig;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/animation/controller/FolmeTouch;->mK:Ljava/util/WeakHashMap;
...
.method public varargs constructor <init>([Lmiui/animation/IAnimTarget;)V
    ...
    iput-object v1, p0, Lmiui/animation/controller/FolmeTouch;->eK:Ljava/util/Map;

    new-instance v1, Lmiui/animation/base/AnimConfig;

    invoke-direct {v1}, Lmiui/animation/base/AnimConfig;-><init>()V

    iput-object v1, p0, Lmiui/animation/controller/FolmeTouch;->gK:Lmiui/animation/base/AnimConfig;

    new-instance v1, Lmiui/animation/base/AnimConfig;

    invoke-direct {v1}, Lmiui/animation/base/AnimConfig;-><init>()V

    iput-object v1, p0, Lmiui/animation/controller/FolmeTouch;->hK:Lmiui/animation/base/AnimConfig;
    ...
    :goto_0
    invoke-direct {p0, p1}, Lmiui/animation/controller/FolmeTouch;->b(Lmiui/animation/IAnimTarget;)V
    ...
    invoke-direct {p0}, Lmiui/animation/controller/FolmeTouch;->ge()V

    iget-object p1, p0, Lmiui/animation/controller/FolmeTouch;->gK:Lmiui/animation/base/AnimConfig;
    ...
    new-instance v5, Lmiui/animation/controller/b;

    invoke-direct {v5, p0}, Lmiui/animation/controller/b;-><init>(Lmiui/animation/controller/FolmeTouch;)V
    ...
    iget-object p1, p0, Lmiui/animation/controller/FolmeTouch;->hK:Lmiui/animation/base/AnimConfig;
    ...
    iput-object p1, p0, Lmiui/animation/controller/FolmeTouch;->iK:Lmiui/animation/base/AnimConfig;
...
.method static synthetic a(Lmiui/animation/controller/FolmeTouch;)F
    .locals 0

    iget p0, p0, Lmiui/animation/controller/FolmeTouch;->_J:F
...
.method private varargs a([Lmiui/animation/ITouchStyle$TouchType;)Lmiui/animation/ITouchStyle$TouchType;
    .locals 0
...
.method private varargs a(Landroid/view/MotionEvent;Landroid/view/View;[Lmiui/animation/base/AnimConfig;)V
    .locals 1

    iget-boolean v0, p0, Lmiui/animation/controller/FolmeTouch;->dK:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lmiui/animation/controller/FolmeTouch;->mLocation:[I

    invoke-static {p2, v0, p1}, Lmiui/animation/controller/FolmeTouch;->a(Landroid/view/View;[ILandroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0}, Lmiui/animation/controller/FolmeTouch;->fe()V

    :cond_0
    return-void
.end method

.method private varargs a(Landroid/view/View;Landroid/view/MotionEvent;[Lmiui/animation/base/AnimConfig;)V
    .locals 2
    ...
    invoke-direct {p0, p3}, Lmiui/animation/controller/FolmeTouch;->d([Lmiui/animation/base/AnimConfig;)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p2, p1, p3}, Lmiui/animation/controller/FolmeTouch;->a(Landroid/view/MotionEvent;Landroid/view/View;[Lmiui/animation/base/AnimConfig;)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, p3}, Lmiui/animation/controller/FolmeTouch;->c([Lmiui/animation/base/AnimConfig;)V

    :goto_0
    return-void
.end method

.method private varargs a(Landroid/view/View;[Lmiui/animation/base/AnimConfig;)V
    .locals 2

    sget-object v0, Lmiui/animation/controller/FolmeTouch;->mK:Ljava/util/WeakHashMap;
    ...
    invoke-direct {v0, v1}, Lmiui/animation/controller/FolmeTouch$InnerViewTouchListener;-><init>(Lmiui/animation/controller/b;)V

    sget-object v1, Lmiui/animation/controller/FolmeTouch;->mK:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p0, p2}, Lmiui/animation/controller/FolmeTouch$InnerViewTouchListener;->b(Lmiui/animation/controller/FolmeTouch;[Lmiui/animation/base/AnimConfig;)V

    return-void
.end method

.method private varargs a(Landroid/widget/AbsListView;Landroid/view/View;Z[Lmiui/animation/base/AnimConfig;)V
    .locals 2
    ...
    :cond_1
    new-instance p1, Lmiui/animation/controller/FolmeTouch$a;

    invoke-direct {p1, p0, p4}, Lmiui/animation/controller/FolmeTouch$a;-><init>(Lmiui/animation/controller/FolmeTouch;[Lmiui/animation/base/AnimConfig;)V
...
.method static synthetic a(Lmiui/animation/controller/FolmeTouch;Landroid/view/View;Landroid/view/MotionEvent;[Lmiui/animation/base/AnimConfig;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lmiui/animation/controller/FolmeTouch;->a(Landroid/view/View;Landroid/view/MotionEvent;[Lmiui/animation/base/AnimConfig;)V

    return-void
.end method

.method static synthetic a(Lmiui/animation/controller/FolmeTouch;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lmiui/animation/controller/FolmeTouch;->b(Landroid/view/View;Z)V

    return-void
.end method

.method static synthetic a(Lmiui/animation/controller/FolmeTouch;[Lmiui/animation/base/AnimConfig;)V
    .locals 0

    invoke-direct {p0, p1}, Lmiui/animation/controller/FolmeTouch;->d([Lmiui/animation/base/AnimConfig;)V

    return-void
.end method

.method private varargs a(Landroid/view/View;Z[Lmiui/animation/base/AnimConfig;)Z
    .locals 3
    ...
    invoke-direct {p0, p1}, Lmiui/animation/controller/FolmeTouch;->s(Landroid/view/View;)Lmiui/animation/controller/FolmeTouch$ListViewInfo;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v1, v0, Lmiui/animation/controller/FolmeTouch$ListViewInfo;->cL:Landroid/widget/AbsListView;
    ...
    const-string v2, "handleListViewTouch for "
    ...
    iget-object v0, v0, Lmiui/animation/controller/FolmeTouch$ListViewInfo;->cL:Landroid/widget/AbsListView;

    invoke-direct {p0, v0, p1, p2, p3}, Lmiui/animation/controller/FolmeTouch;->a(Landroid/widget/AbsListView;Landroid/view/View;Z[Lmiui/animation/base/AnimConfig;)V
...
.method private a(Lmiui/animation/ITouchStyle$TouchType;)Z
    .locals 1

    sget-object v0, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    iget-object p0, p0, Lmiui/animation/controller/FolmeTouch;->eK:Ljava/util/Map;
...
.method static synthetic a(Lmiui/animation/controller/FolmeTouch;Landroid/view/View;Z[Lmiui/animation/base/AnimConfig;)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lmiui/animation/controller/FolmeTouch;->a(Landroid/view/View;Z[Lmiui/animation/base/AnimConfig;)Z
...
.method static synthetic a(Lmiui/animation/controller/FolmeTouch;Lmiui/animation/ITouchStyle$TouchType;)Z
    .locals 0

    invoke-direct {p0, p1}, Lmiui/animation/controller/FolmeTouch;->a(Lmiui/animation/ITouchStyle$TouchType;)Z
...
.method private varargs a([Lmiui/animation/base/AnimConfig;)[Lmiui/animation/base/AnimConfig;
    .locals 2
    ...
    iget-object p0, p0, Lmiui/animation/controller/FolmeTouch;->gK:Lmiui/animation/base/AnimConfig;
...
.method private b(Lmiui/animation/IAnimTarget;)V
    .locals 2
    ...
    iput p1, p0, Lmiui/animation/controller/FolmeTouch;->_J:F

    :cond_1
    return-void
.end method

.method private varargs b([Lmiui/animation/base/AnimConfig;)[Lmiui/animation/base/AnimConfig;
    .locals 3
    ...
    iget-object v1, p0, Lmiui/animation/controller/FolmeTouch;->hK:Lmiui/animation/base/AnimConfig;

    const/4 v2, 0x0

    aput-object v1, v0, v2

    iget-object p0, p0, Lmiui/animation/controller/FolmeTouch;->iK:Lmiui/animation/base/AnimConfig;
...
.method private varargs c([Lmiui/animation/base/AnimConfig;)V
    .locals 2
    ...
    iput-boolean v0, p0, Lmiui/animation/controller/FolmeTouch;->dK:Z
...
.method private varargs d([Lmiui/animation/base/AnimConfig;)V
    .locals 2
...
.method private ge()V
    ...
    iget-boolean v0, p0, Lmiui/animation/controller/FolmeTouch;->jK:Z
...
.method private s(Landroid/view/View;)Lmiui/animation/controller/FolmeTouch$ListViewInfo;
    .locals 4
    ...
    invoke-direct {v0, v1}, Lmiui/animation/controller/FolmeTouch$ListViewInfo;-><init>(Lmiui/animation/controller/b;)V
    ...
    iget-object v3, v0, Lmiui/animation/controller/FolmeTouch$ListViewInfo;->cL:Landroid/widget/AbsListView;

    invoke-direct {v2, v3}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v2, p0, Lmiui/animation/controller/FolmeTouch;->mListView:Ljava/lang/ref/WeakReference;

    iput-object v1, v0, Lmiui/animation/controller/FolmeTouch$ListViewInfo;->cL:Landroid/widget/AbsListView;
...
.method private t(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Lmiui/animation/controller/FolmeTouch;->fK:Ljava/lang/ref/WeakReference;
    ...
    iput-object v0, p0, Lmiui/animation/controller/FolmeTouch;->fK:Ljava/lang/ref/WeakReference;
...
.method public varargs bindViewOfListItem(Landroid/view/View;[Lmiui/animation/base/AnimConfig;)V
    ...
    invoke-direct {p0, p1}, Lmiui/animation/controller/FolmeTouch;->t(Landroid/view/View;)Z
    ...
    :cond_0
    new-instance v0, Lmiui/animation/controller/c;

    invoke-direct {v0, p0, p1, p2}, Lmiui/animation/controller/c;-><init>(Lmiui/animation/controller/FolmeTouch;Landroid/view/View;[Lmiui/animation/base/AnimConfig;)V
...
.method public cancel()V
    ...
    iget-object p0, p0, Lmiui/animation/controller/FolmeTouch;->aK:Lmiui/animation/controller/FolmeFont;
...
.method public clean()V
    ...
    iget-object v0, p0, Lmiui/animation/controller/FolmeTouch;->aK:Lmiui/animation/controller/FolmeFont;
    ...
    :cond_0
    iget-object v0, p0, Lmiui/animation/controller/FolmeTouch;->eK:Ljava/util/Map;
    ...
    invoke-direct {p0, v0}, Lmiui/animation/controller/FolmeTouch;->a(Ljava/lang/ref/WeakReference;)Landroid/view/View;

    iput-object v1, p0, Lmiui/animation/controller/FolmeTouch;->fK:Ljava/lang/ref/WeakReference;
...
.method public varargs handleTouchOf(Landroid/view/View;Z[Lmiui/animation/base/AnimConfig;)V
    ...
    invoke-direct {p0, p1, p3}, Lmiui/animation/controller/FolmeTouch;->a(Landroid/view/View;[Lmiui/animation/base/AnimConfig;)V
    ...
    new-instance v0, Lmiui/animation/controller/d;
    ...
    invoke-direct/range {v2 .. v7}, Lmiui/animation/controller/d;-><init>(Lmiui/animation/controller/FolmeTouch;ZLandroid/view/View;[Lmiui/animation/base/AnimConfig;Z)V
...
.method public ignoreTouchOf(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p0}, Lmiui/animation/controller/FolmeTouch$InnerViewTouchListener;->b(Lmiui/animation/controller/FolmeTouch;)Z

    move-result p0

    if-eqz p0, :cond_0

    sget-object p0, Lmiui/animation/controller/FolmeTouch;->mK:Ljava/util/WeakHashMap;
...
.method public onMotionEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-direct {p0, v1, p1, v0}, Lmiui/animation/controller/FolmeTouch;->a(Landroid/view/View;Landroid/view/MotionEvent;[Lmiui/animation/base/AnimConfig;)V
...
.method public varargs setAlpha(F[Lmiui/animation/ITouchStyle$TouchType;)Lmiui/animation/ITouchStyle;
    ...
    invoke-direct {p0, p2}, Lmiui/animation/controller/FolmeTouch;->a([Lmiui/animation/ITouchStyle$TouchType;)Lmiui/animation/ITouchStyle$TouchType;
...
.method public setFontStyle(Lmiui/animation/controller/FolmeFont;)V
    ...
    iput-object p1, p0, Lmiui/animation/controller/FolmeTouch;->aK:Lmiui/animation/controller/FolmeFont;
...
.method public setTint(I)Lmiui/animation/ITouchStyle;
    ...
    iput-boolean v0, p0, Lmiui/animation/controller/FolmeTouch;->jK:Z
...
.method public setTintMode(I)Lmiui/animation/ITouchStyle;
    ...
    iget-object v0, p0, Lmiui/animation/controller/FolmeTouch;->gK:Lmiui/animation/base/AnimConfig;

    invoke-virtual {v0, p1}, Lmiui/animation/base/AnimConfig;->setTintMode(I)Lmiui/animation/base/AnimConfig;

    iget-object v0, p0, Lmiui/animation/controller/FolmeTouch;->hK:Lmiui/animation/base/AnimConfig;
...
.method public varargs touchDown([Lmiui/animation/base/AnimConfig;)V
    ...
    invoke-virtual {p0, v0, v1}, Lmiui/animation/controller/FolmeBase;->a(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-direct {p0, p1}, Lmiui/animation/controller/FolmeTouch;->a([Lmiui/animation/base/AnimConfig;)[Lmiui/animation/base/AnimConfig;
    ...
    iget v1, p0, Lmiui/animation/controller/FolmeTouch;->cK:I
...
.method public varargs touchUp([Lmiui/animation/base/AnimConfig;)V
    ...
    invoke-direct {p0, p1}, Lmiui/animation/controller/FolmeTouch;->b([Lmiui/animation/base/AnimConfig;)[Lmiui/animation/base/AnimConfig;
    ...
    iget v1, p0, Lmiui/animation/controller/FolmeTouch;->bK:I
...
.method public useVarFont(Landroid/widget/TextView;III)Lmiui/animation/ITouchStyle;
    ...
    iput p3, p0, Lmiui/animation/controller/FolmeTouch;->bK:I

    iput p4, p0, Lmiui/animation/controller/FolmeTouch;->cK:I
