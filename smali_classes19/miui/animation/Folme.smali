...
.field private static final vJ:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/animation/Folme;->vJ:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private static a([Landroid/view/View;[Lmiui/animation/IAnimTarget;)Lmiui/animation/Folme$a;
    .locals 6
    ...
    sget-object v4, Lmiui/animation/Folme;->vJ:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    check-cast v4, Lmiui/animation/Folme$a;
...
.method private static c(Ljava/lang/Object;)V
    ...
    sget-object v0, Lmiui/animation/Folme;->vJ:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v0, p0}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lmiui/animation/Folme$a;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lmiui/animation/Folme$a;->clean()V
...
.method public static varargs clean([Landroid/view/View;)V
    ...
    invoke-static {v2}, Lmiui/animation/Folme;->c(Ljava/lang/Object;)V
...
.method public static varargs end([Ljava/lang/Object;)V
    ...
    :cond_0
    sget-object v3, Lmiui/animation/Folme;->vJ:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v3, v2}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lmiui/animation/Folme$a;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Lmiui/animation/Folme$a;->end()V
...
.method public static getTargets(Ljava/util/Collection;)V
    ...
    :cond_0
    sget-object v2, Lmiui/animation/Folme;->vJ:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static getValueTarget(Ljava/lang/Object;)Lmiui/animation/IAnimTarget;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static useAt(Lmiui/animation/IAnimTarget;)Lmiui/animation/IFolme;
    ...
    check-cast v0, Lmiui/animation/Folme$a;

    if-nez v0, :cond_0

    new-instance v0, Lmiui/animation/Folme$a;
    ...
    invoke-direct {v0, v1, v2}, Lmiui/animation/Folme$a;-><init>([Lmiui/animation/IAnimTarget;Lmiui/animation/a;)V

    sget-object v1, Lmiui/animation/Folme;->vJ:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static varargs useAt([Landroid/view/View;)Lmiui/animation/IFolme;
    ...
    invoke-static {p0, v0}, Lmiui/animation/Folme;->a([Landroid/view/View;[Lmiui/animation/IAnimTarget;)Lmiui/animation/Folme$a;

    move-result-object p0

    if-nez p0, :cond_1

    new-instance p0, Lmiui/animation/Folme$a;

    const/4 v2, 0x0

    invoke-direct {p0, v0, v2}, Lmiui/animation/Folme$a;-><init>([Lmiui/animation/IAnimTarget;Lmiui/animation/a;)V
