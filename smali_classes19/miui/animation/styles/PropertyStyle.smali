...
# static fields
.field private static final qN:I = 0x3
...
.field kN:Lmiui/animation/physics/EquilibriumChecker;

.field lN:Ljava/lang/Object;
...
.field private oN:Lmiui/animation/physics/PhysicsOperator;
...
.method public constructor <init>(Ljava/lang/Object;Lmiui/animation/property/FloatProperty;)V
    ...
    iput-object v0, p0, Lmiui/animation/styles/PropertyStyle;->iN:[I
    ...
    iput-object v0, p0, Lmiui/animation/styles/PropertyStyle;->jN:[D

    iput-object p1, p0, Lmiui/animation/styles/PropertyStyle;->lN:Ljava/lang/Object;
...
.method private Ae()V
    ...
    iget-object v0, p0, Lmiui/animation/styles/PropertyStyle;->kN:Lmiui/animation/physics/EquilibriumChecker;

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lmiui/animation/styles/PropertyStyle;->ze()D
...
.method private Be()V
    ...
    iget-object v0, p0, Lmiui/animation/styles/PropertyStyle;->oN:Lmiui/animation/physics/PhysicsOperator;

    invoke-static {v0}, Lmiui/animation/physics/PhysicsUtil;->willStop(Lmiui/animation/physics/PhysicsOperator;)Z
    ...
    invoke-direct {p0, v0, v1}, Lmiui/animation/styles/PropertyStyle;->g(D)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lmiui/animation/styles/PropertyStyle;->jN:[D
...
.method private Ce()V
    ...
    :goto_0
    iput-boolean v0, p0, Lmiui/animation/styles/PropertyStyle;->BL:Z

    iget-boolean v0, p0, Lmiui/animation/styles/PropertyStyle;->BL:Z
    ...
    iget-object v4, p0, Lmiui/animation/styles/PropertyStyle;->iN:[I
...
.method private De()V
    ...
    iget-boolean v0, p0, Lmiui/animation/styles/PropertyStyle;->nN:Z
    ...
    :goto_0
    iget-boolean v2, p0, Lmiui/animation/styles/PropertyStyle;->nN:Z
    ...
    iget-object v2, p0, Lmiui/animation/styles/PropertyStyle;->jN:[D
...
.method private a(Lmiui/animation/utils/EaseManager$EaseStyle;)Lmiui/animation/physics/PhysicsOperator;
    .locals 2

    invoke-direct {p0, p1}, Lmiui/animation/styles/PropertyStyle;->b(Lmiui/animation/utils/EaseManager$EaseStyle;)[F
...
.method private a([DFD)V
    ...
    iget-object v3, p0, Lmiui/animation/styles/PropertyStyle;->oN:Lmiui/animation/physics/PhysicsOperator;
...
.method private b(Lmiui/animation/utils/EaseManager$EaseStyle;)[F
    .locals 2
...
.method private j(J)V
    ...
    iget v0, p0, Lmiui/animation/styles/PropertyStyle;->pN:I

    const/4 v1, 0x1

    add-int/2addr v0, v1

    iput v0, p0, Lmiui/animation/styles/PropertyStyle;->pN:I

    invoke-direct {p0}, Lmiui/animation/styles/PropertyStyle;->De()V
    ...
    iget-object p2, p0, Lmiui/animation/styles/PropertyStyle;->jN:[D

    invoke-direct {p0, p2, p1, v2, v3}, Lmiui/animation/styles/PropertyStyle;->a([DFD)V
    ...
    iput-boolean p2, p0, Lmiui/animation/styles/PropertyStyle;->BL:Z

    iget-boolean p2, p0, Lmiui/animation/styles/PropertyStyle;->BL:Z
    ...
    iget-object v5, p0, Lmiui/animation/styles/PropertyStyle;->jN:[D
    ...
    invoke-direct {p0, p1, v2, v3}, Lmiui/animation/styles/PropertyStyle;->q(FD)V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, Lmiui/animation/styles/PropertyStyle;->ye()V

    :goto_0
    return-void
.end method

.method private q(FD)V
    .locals 14

    move-object v0, p0

    iget-object v1, v0, Lmiui/animation/styles/PropertyStyle;->jN:[D
    ...
    invoke-direct {p0, v1, p1, v4, v5}, Lmiui/animation/styles/PropertyStyle;->a([DFD)V
    ...
    :cond_0
    iget-object v0, v0, Lmiui/animation/styles/PropertyStyle;->jN:[D
...
.method private setEase(Lmiui/animation/utils/EaseManager$EaseStyle;)V
    ...
    invoke-direct {p0, p1}, Lmiui/animation/styles/PropertyStyle;->a(Lmiui/animation/utils/EaseManager$EaseStyle;)Lmiui/animation/physics/PhysicsOperator;

    move-result-object p1

    iput-object p1, p0, Lmiui/animation/styles/PropertyStyle;->oN:Lmiui/animation/physics/PhysicsOperator;

    iget-object p1, p0, Lmiui/animation/styles/PropertyStyle;->kN:Lmiui/animation/physics/EquilibriumChecker;
    ...
    iput-object p1, p0, Lmiui/animation/styles/PropertyStyle;->kN:Lmiui/animation/physics/EquilibriumChecker;
...
.method private ye()V
    ...
    invoke-direct {p0}, Lmiui/animation/styles/PropertyStyle;->Be()V
    ...
    invoke-direct {p0, v0, v1, v4, v5}, Lmiui/animation/styles/PropertyStyle;->j(DD)D
    ...
    const-string v9, "doFinishProcess, "
    ...
    :cond_1
    const-string v0, "doFinishProcess, start spring back"
...
.method public clear()V
    ...
    iput-object v0, p0, Lmiui/animation/styles/PropertyStyle;->oN:Lmiui/animation/physics/PhysicsOperator;

    iput-object v0, p0, Lmiui/animation/styles/PropertyStyle;->kN:Lmiui/animation/physics/EquilibriumChecker;
...
.method public getTargetIntValue()I
    ...
    iget-object p0, p0, Lmiui/animation/styles/PropertyStyle;->iN:[I
...
.method protected isAnimRunning(DD)Z
    ...
    iget-object p0, p0, Lmiui/animation/styles/PropertyStyle;->kN:Lmiui/animation/physics/EquilibriumChecker;
...
.method public isRunning()Z
    ...
    iget-boolean p0, p0, Lmiui/animation/styles/PropertyStyle;->BL:Z
...
.method public varargs setIntValues([I)V
    ...
    :cond_0
    iput-object p1, p0, Lmiui/animation/styles/PropertyStyle;->iN:[I

    :goto_0
    invoke-direct {p0}, Lmiui/animation/styles/PropertyStyle;->Ae()V
...
.method public setTarget(Lmiui/animation/IAnimTarget;)V
    ...
    iput-boolean p1, p0, Lmiui/animation/styles/PropertyStyle;->nN:Z
...
.method public update(J)V
    ...
    invoke-direct {p0, p1, p2}, Lmiui/animation/styles/PropertyStyle;->j(J)V
    ...
    invoke-direct {p0}, Lmiui/animation/styles/PropertyStyle;->Ce()V

    :cond_2
    :goto_0
    invoke-virtual {p0}, Lmiui/animation/styles/PropertyStyle;->onUpdate()V

    iget-boolean p1, p0, Lmiui/animation/styles/PropertyStyle;->BL:Z
