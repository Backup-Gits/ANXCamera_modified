...
.field private static final oR:Ljava/util/WeakHashMap;
...
.field private static final pR:Ljava/lang/String; = "modules"

.field private static final qR:Ljava/lang/String; = "modules-temp"
...
.field private nR:Lcom/miui/internal/component/module/ModuleLoader;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/module/ModuleManager;->oR:Ljava/util/WeakHashMap;
...
.method private constructor <init>(Landroid/app/Application;)V
    ...
    invoke-direct {p0, p1}, Lmiui/module/ModuleManager;->q(Landroid/content/Context;)Ljava/io/File;

    move-result-object p1

    iput-object p1, p0, Lmiui/module/ModuleManager;->kR:Ljava/io/File;

    iget-object p1, p0, Lmiui/module/ModuleManager;->kR:Ljava/io/File;

    invoke-virtual {p1}, Ljava/io/File;->mkdirs()Z

    iget-object p1, p0, Lmiui/module/ModuleManager;->mApplication:Landroid/app/Application;

    invoke-direct {p0, p1}, Lmiui/module/ModuleManager;->r(Landroid/content/Context;)Ljava/io/File;

    move-result-object p1

    iput-object p1, p0, Lmiui/module/ModuleManager;->lR:Ljava/io/File;

    iget-object p1, p0, Lmiui/module/ModuleManager;->lR:Ljava/io/File;
    ...
    iget-object v3, p0, Lmiui/module/ModuleManager;->kR:Ljava/io/File;
    ...
    iput-object p1, p0, Lmiui/module/ModuleManager;->nR:Lcom/miui/internal/component/module/ModuleLoader;
...
.method private F(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object p0, p0, Lmiui/module/ModuleManager;->kR:Ljava/io/File;
...
.method private a(Ljava/io/File;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p2}, Lmiui/module/ModuleManager;->F(Ljava/lang/String;)Ljava/io/File;
...
.method public static createInstance(Landroid/app/Application;)Lmiui/module/ModuleManager;
    ...
    :cond_0
    sget-object v0, Lmiui/module/ModuleManager;->oR:Ljava/util/WeakHashMap;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lmiui/module/ModuleManager;->oR:Ljava/util/WeakHashMap;
    ...
    sget-object v2, Lmiui/module/ModuleManager;->oR:Ljava/util/WeakHashMap;
...
.method private q(Landroid/content/Context;)Ljava/io/File;
    .locals 1
...
.method private r(Landroid/content/Context;)Ljava/io/File;
    .locals 1
...
.method public varargs loadModules(Lmiui/module/Repository;[Ljava/lang/String;)V
    ...
    invoke-direct {p0, v7}, Lmiui/module/ModuleManager;->F(Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_4
    iget-object v1, p0, Lmiui/module/ModuleManager;->lR:Ljava/io/File;
    ...
    iget-object v8, p0, Lmiui/module/ModuleManager;->lR:Ljava/io/File;

    iget-object v11, p0, Lmiui/module/ModuleManager;->kR:Ljava/io/File;
    ...
    invoke-direct {p0, v8, v11, v12, v7}, Lmiui/module/ModuleManager;->a(Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v11, p0, Lmiui/module/ModuleManager;->lR:Ljava/io/File;
    ...
    invoke-direct {p0, v7, v3}, Lmiui/module/ModuleManager;->b(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v11, v7}, Lmiui/module/ModuleManager;->a(Ljava/io/File;Ljava/lang/String;)Z
    ...
    iget-object v12, p0, Lmiui/module/ModuleManager;->kR:Ljava/io/File;
    ...
    :try_start_1
    iget-object v11, p0, Lmiui/module/ModuleManager;->nR:Lcom/miui/internal/component/module/ModuleLoader;
    ...
    invoke-direct {p0, v7, v8}, Lmiui/module/ModuleManager;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v7, v2}, Lmiui/module/ModuleManager;->b(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v7, v5}, Lmiui/module/ModuleManager;->b(Ljava/lang/String;I)V
    ...
    :cond_8
    invoke-direct {p0}, Lmiui/module/ModuleManager;->Oe()V
