...
.method private constructor <init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lmiui/smooth/SmoothGradientDrawable$SmoothConstantState;)V
    ...
    iput-object v1, p0, Lmiui/smooth/SmoothGradientDrawable;->Kc:Lcom/miui/internal/smooth/SmoothPathProvider;
    ...
    iput-object v0, p0, Lmiui/smooth/SmoothGradientDrawable;->Lc:Landroid/graphics/drawable/GradientDrawable;
...
.method synthetic constructor <init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lmiui/smooth/SmoothGradientDrawable$SmoothConstantState;Lmiui/smooth/b;)V
    .locals 0
...
.method private constructor <init>(Lmiui/smooth/SmoothGradientDrawable$SmoothConstantState;)V
    ...
    iput-object v0, p0, Lmiui/smooth/SmoothGradientDrawable;->Kc:Lcom/miui/internal/smooth/SmoothPathProvider;
...
.method private a(Landroid/graphics/Rect;F)Landroid/graphics/Path;
    ...
    invoke-direct {p0}, Lmiui/smooth/SmoothGradientDrawable;->ja()[F

    move-result-object v3

    if-nez v3, :cond_0

    invoke-direct {p0}, Lmiui/smooth/SmoothGradientDrawable;->ka()F

    move-result v7

    iget-object v4, p0, Lmiui/smooth/SmoothGradientDrawable;->Kc:Lcom/miui/internal/smooth/SmoothPathProvider;
    ...
    :cond_0
    iget-object v0, p0, Lmiui/smooth/SmoothGradientDrawable;->Kc:Lcom/miui/internal/smooth/SmoothPathProvider;
    ...
    :goto_0
    iget-object p0, p0, Lmiui/smooth/SmoothGradientDrawable;->Kc:Lcom/miui/internal/smooth/SmoothPathProvider;
...
.method private ha()Landroid/graphics/Bitmap;
    .locals 5
    ...
    iget-object v2, p0, Lmiui/smooth/SmoothGradientDrawable;->Lc:Landroid/graphics/drawable/GradientDrawable;
...
.method private ia()Landroid/graphics/BitmapShader;
    ...
    invoke-direct {p0}, Lmiui/smooth/SmoothGradientDrawable;->ha()Landroid/graphics/Bitmap;
...
.method private ja()[F
    ...
    :try_start_0
    iget-object v0, p0, Lmiui/smooth/SmoothGradientDrawable;->Lc:Landroid/graphics/drawable/GradientDrawable;

    if-eqz v0, :cond_0

    iget-object p0, p0, Lmiui/smooth/SmoothGradientDrawable;->Lc:Landroid/graphics/drawable/GradientDrawable;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lmiui/smooth/SmoothGradientDrawable;->Jc:Landroid/graphics/BitmapShader;

    if-nez v0, :cond_0

    invoke-direct {p0}, Lmiui/smooth/SmoothGradientDrawable;->ia()Landroid/graphics/BitmapShader;

    move-result-object v0

    iput-object v0, p0, Lmiui/smooth/SmoothGradientDrawable;->Jc:Landroid/graphics/BitmapShader;

    iget-object v0, p0, Lmiui/smooth/SmoothGradientDrawable;->mPaint:Landroid/graphics/Paint;

    iget-object v1, p0, Lmiui/smooth/SmoothGradientDrawable;->Jc:Landroid/graphics/BitmapShader;
    ...
    invoke-direct {p0, v0, v1}, Lmiui/smooth/SmoothGradientDrawable;->a(Landroid/graphics/Rect;F)Landroid/graphics/Path;
...
.method public getSmooth()F
    ...
    iget p0, p0, Lmiui/smooth/SmoothGradientDrawable$SmoothConstantState;->mc:F
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iput v2, v1, Lmiui/smooth/SmoothGradientDrawable$SmoothConstantState;->mc:F
...
.method public setSmooth(F)V
    ...
    iget v1, v0, Lmiui/smooth/SmoothGradientDrawable$SmoothConstantState;->mc:F

    cmpl-float v1, v1, p1

    if-eqz v1, :cond_0

    iput p1, v0, Lmiui/smooth/SmoothGradientDrawable$SmoothConstantState;->mc:F
