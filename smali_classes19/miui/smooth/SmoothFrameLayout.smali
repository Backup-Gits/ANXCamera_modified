...
.field private ni:Landroid/graphics/Path;

.field private oi:Landroid/graphics/RectF;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p3, p0, Lmiui/smooth/SmoothFrameLayout;->ni:Landroid/graphics/Path;

    new-instance p3, Landroid/graphics/RectF;

    invoke-direct {p3}, Landroid/graphics/RectF;-><init>()V

    iput-object p3, p0, Lmiui/smooth/SmoothFrameLayout;->oi:Landroid/graphics/RectF;
    ...
    iput-object p3, p0, Lmiui/smooth/SmoothFrameLayout;->Kc:Lcom/miui/internal/smooth/SmoothPathProvider;
    ...
    iput p2, p0, Lmiui/smooth/SmoothFrameLayout;->mc:F
...
.method private b(IIF)Landroid/graphics/Path;
    .locals 10
    ...
    iget-object v4, p0, Lmiui/smooth/SmoothFrameLayout;->Kc:Lcom/miui/internal/smooth/SmoothPathProvider;
    ...
    :cond_0
    iget-object v0, p0, Lmiui/smooth/SmoothFrameLayout;->Kc:Lcom/miui/internal/smooth/SmoothPathProvider;
    ...
    :goto_0
    iget-object p0, p0, Lmiui/smooth/SmoothFrameLayout;->Kc:Lcom/miui/internal/smooth/SmoothPathProvider;
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lmiui/smooth/SmoothFrameLayout;->oi:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lmiui/smooth/SmoothFrameLayout;->ni:Landroid/graphics/Path;
...
.method public getCornerRadii()[F
    ...
    iget-object p0, p0, Lmiui/smooth/SmoothFrameLayout;->lc:[F
...
.method public getSmooth()F
    ...
    iget p0, p0, Lmiui/smooth/SmoothFrameLayout;->mc:F
...
.method protected onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lmiui/smooth/SmoothFrameLayout;->oi:Landroid/graphics/RectF;
    ...
    iget p3, p0, Lmiui/smooth/SmoothFrameLayout;->mc:F

    invoke-direct {p0, p1, p2, p3}, Lmiui/smooth/SmoothFrameLayout;->b(IIF)Landroid/graphics/Path;

    move-result-object p1

    iget-object p2, p0, Lmiui/smooth/SmoothFrameLayout;->ni:Landroid/graphics/Path;

    invoke-virtual {p2}, Landroid/graphics/Path;->reset()V

    iget-object v0, p0, Lmiui/smooth/SmoothFrameLayout;->ni:Landroid/graphics/Path;
    ...
    iget-object p0, p0, Lmiui/smooth/SmoothFrameLayout;->ni:Landroid/graphics/Path;
...
.method public setCornerRadii([F)V
    ...
    iput-object p1, p0, Lmiui/smooth/SmoothFrameLayout;->lc:[F
...
.method public setSmooth(F)V
    ...
    iget v0, p0, Lmiui/smooth/SmoothFrameLayout;->mc:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, Lmiui/smooth/SmoothFrameLayout;->mc:F
