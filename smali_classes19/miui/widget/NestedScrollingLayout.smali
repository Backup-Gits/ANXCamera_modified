...
.field private static final yj:I = 0x12c
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p2, p0, Lmiui/widget/NestedScrollingLayout;->rj:I
...
.method private eb()V
    ...
    iget v0, p0, Lmiui/widget/NestedScrollingLayout;->sj:I
...
.method private fb()V
    ...
    iget v0, p0, Lmiui/widget/NestedScrollingLayout;->xj:I

    iget v3, p0, Lmiui/widget/NestedScrollingLayout;->sj:I
...
.method private z(I)V
    ...
    :goto_0
    iput-boolean v0, p0, Lmiui/widget/NestedScrollingLayout;->wj:Z

    iput p1, p0, Lmiui/widget/NestedScrollingLayout;->xj:I
...
.method public computeScroll()V
    ...
    iput v0, p0, Lmiui/widget/NestedScrollingLayout;->sj:I

    invoke-direct {p0}, Lmiui/widget/NestedScrollingLayout;->eb()V
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-boolean v0, p0, Lmiui/widget/NestedScrollingLayout;->wj:Z

    if-eqz v0, :cond_2

    invoke-direct {p0}, Lmiui/widget/NestedScrollingLayout;->fb()V
...
.method protected onFinishInflate()V
    ...
    iget v0, p0, Lmiui/widget/NestedScrollingLayout;->rj:I
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    iget p1, p0, Lmiui/widget/NestedScrollingLayout;->sj:I

    iget p2, p0, Lmiui/widget/NestedScrollingLayout;->uj:I

    if-ge p1, p2, :cond_0

    iget p2, p0, Lmiui/widget/NestedScrollingLayout;->tj:I
    ...
    :goto_1
    invoke-direct {p0, p2}, Lmiui/widget/NestedScrollingLayout;->z(I)V

    :cond_2
    iput-boolean p1, p0, Lmiui/widget/NestedScrollingLayout;->vj:Z
...
.method public onNestedPreScroll(Landroid/view/View;II[I)V
    ...
    iget v0, p0, Lmiui/widget/NestedScrollingLayout;->uj:I

    iget v1, p0, Lmiui/widget/NestedScrollingLayout;->sj:I
    ...
    iget p3, p0, Lmiui/widget/NestedScrollingLayout;->sj:I
    ...
    iput p2, p0, Lmiui/widget/NestedScrollingLayout;->sj:I
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    iget-boolean p1, p0, Lmiui/widget/NestedScrollingLayout;->vj:Z

    if-nez p1, :cond_1

    iget p1, p0, Lmiui/widget/NestedScrollingLayout;->sj:I

    iget v0, p0, Lmiui/widget/NestedScrollingLayout;->tj:I

    iget v1, p0, Lmiui/widget/NestedScrollingLayout;->uj:I
    ...
    :cond_0
    invoke-direct {p0, v0}, Lmiui/widget/NestedScrollingLayout;->z(I)V
...
.method public setScrollingRange(II)V
    ...
    :cond_0
    iput p1, p0, Lmiui/widget/NestedScrollingLayout;->tj:I

    iput p2, p0, Lmiui/widget/NestedScrollingLayout;->uj:I
