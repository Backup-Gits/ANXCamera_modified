...
# static fields
.field private static final Ts:I = 0xd000000

.field private static final Us:F = 0.0f

.field private static final Vs:F = 5.45f

.field private static final Ws:F = 5.45f

.field private static final Xs:I = 0x19
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v1, p0, Lmiui/widget/FloatingActionButton;->Ns:I
    ...
    iput v0, p0, Lmiui/widget/FloatingActionButton;->Os:I
    ...
    iput-boolean p2, p0, Lmiui/widget/FloatingActionButton;->Ps:Z
    ...
    iput-boolean p2, p0, Lmiui/widget/FloatingActionButton;->Ss:Z
    ...
    iput p2, p0, Lmiui/widget/FloatingActionButton;->Rs:I

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    invoke-direct {p0}, Lmiui/widget/FloatingActionButton;->Uc()V

    invoke-direct {p0}, Lmiui/widget/FloatingActionButton;->Vc()V
...
.method private Sc()Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v1, p0, Lmiui/widget/FloatingActionButton;->Ps:Z
    ...
    iget v1, p0, Lmiui/widget/FloatingActionButton;->Rs:I

    invoke-direct {p0, v1}, Lmiui/widget/FloatingActionButton;->W(I)I
    ...
    iget v6, p0, Lmiui/widget/FloatingActionButton;->Ns:I

    int-to-float v6, v6

    iget v7, p0, Lmiui/widget/FloatingActionButton;->Os:I
    ...
    iget v4, p0, Lmiui/widget/FloatingActionButton;->Rs:I
...
.method private Tc()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lmiui/widget/FloatingActionButton;->Qs:Landroid/graphics/drawable/Drawable;
    ...
    iput v0, p0, Lmiui/widget/FloatingActionButton;->Rs:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lmiui/widget/FloatingActionButton;->Ss:Z

    invoke-direct {p0}, Lmiui/widget/FloatingActionButton;->Sc()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Lmiui/widget/FloatingActionButton;->Qs:Landroid/graphics/drawable/Drawable;

    :cond_0
    iget-object p0, p0, Lmiui/widget/FloatingActionButton;->Qs:Landroid/graphics/drawable/Drawable;
...
.method private Uc()V
    ...
    iput-boolean v1, p0, Lmiui/widget/FloatingActionButton;->Ss:Z
    ...
    :cond_0
    iget-boolean v0, p0, Lmiui/widget/FloatingActionButton;->Ss:Z
    ...
    :cond_1
    invoke-direct {p0}, Lmiui/widget/FloatingActionButton;->Tc()Landroid/graphics/drawable/Drawable;
...
.method private Vc()V
    ...
    iget-boolean v0, p0, Lmiui/widget/FloatingActionButton;->Ps:Z
    ...
    iget v2, p0, Lmiui/widget/FloatingActionButton;->Ns:I
    ...
    iget v3, p0, Lmiui/widget/FloatingActionButton;->Os:I
    ...
    iget v4, p0, Lmiui/widget/FloatingActionButton;->Ns:I
    ...
    iget v5, p0, Lmiui/widget/FloatingActionButton;->Os:I
...
.method public setBackgroundColor(I)V
    ...
    iget v0, p0, Lmiui/widget/FloatingActionButton;->Rs:I

    if-eq v0, p1, :cond_1

    :cond_0
    iput p1, p0, Lmiui/widget/FloatingActionButton;->Rs:I
    ...
    iput-boolean p1, p0, Lmiui/widget/FloatingActionButton;->Ss:Z
