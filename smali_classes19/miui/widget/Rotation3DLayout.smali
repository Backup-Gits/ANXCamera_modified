...
.field private static final Rj:I = 0x800033

.field private static final Sj:I = 0xa

.field private static final Tj:F

.field private static final Uj:I = 0x2d

.field private static final Vj:I = 0x12c

.field private static final Wj:[F
...
.field private Oj:Landroid/hardware/Sensor;

.field private Pj:Landroid/hardware/SensorManager;

.field private Qj:Landroid/hardware/SensorEventListener;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lmiui/widget/Rotation3DLayout;->b(F)F

    move-result v0

    sput v0, Lmiui/widget/Rotation3DLayout;->Tj:F
    ...
    sput-object v0, Lmiui/widget/Rotation3DLayout;->Wj:[F
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, Lmiui/widget/Rotation3DLayout;->Bj:F

    sget v0, Lmiui/widget/Rotation3DLayout;->Tj:F

    iput v0, p0, Lmiui/widget/Rotation3DLayout;->Cj:F

    const/16 v0, 0x12c

    iput v0, p0, Lmiui/widget/Rotation3DLayout;->Dj:I

    sget-object v0, Lmiui/widget/Rotation3DLayout;->Wj:[F

    iput-object v0, p0, Lmiui/widget/Rotation3DLayout;->Ej:[F

    array-length v1, v0

    new-array v1, v1, [F

    iput-object v1, p0, Lmiui/widget/Rotation3DLayout;->Fj:[F

    array-length v0, v0

    new-array v0, v0, [F

    iput-object v0, p0, Lmiui/widget/Rotation3DLayout;->Gj:[F

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lmiui/widget/Rotation3DLayout;->Hj:J

    const/4 v0, 0x1

    iput-boolean v0, p0, Lmiui/widget/Rotation3DLayout;->Ij:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, Lmiui/widget/Rotation3DLayout;->Jj:Z

    iput-boolean v0, p0, Lmiui/widget/Rotation3DLayout;->Kj:Z

    iput-boolean v0, p0, Lmiui/widget/Rotation3DLayout;->Lj:Z

    new-instance v1, Lmiui/widget/fa;

    invoke-direct {v1, p0}, Lmiui/widget/fa;-><init>(Lmiui/widget/Rotation3DLayout;)V

    iput-object v1, p0, Lmiui/widget/Rotation3DLayout;->Qj:Landroid/hardware/SensorEventListener;
    ...
    iget p3, p0, Lmiui/widget/Rotation3DLayout;->Bj:F
    ...
    iget-boolean p3, p0, Lmiui/widget/Rotation3DLayout;->Lj:Z

    invoke-virtual {p1, p2, p3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p2

    iput-boolean p2, p0, Lmiui/widget/Rotation3DLayout;->Lj:Z
...
.method static synthetic a(Lmiui/widget/Rotation3DLayout;)F
    ...
    iget p0, p0, Lmiui/widget/Rotation3DLayout;->Mj:F
...
.method static synthetic a(Lmiui/widget/Rotation3DLayout;F)F
    ...
    iput p1, p0, Lmiui/widget/Rotation3DLayout;->Mj:F
...
.method private a(FZ)V
    ...
    iget v1, p0, Lmiui/widget/Rotation3DLayout;->Bj:F
    ...
    iget-boolean p2, p0, Lmiui/widget/Rotation3DLayout;->Jj:Z

    if-nez p2, :cond_4

    iget-boolean p2, p0, Lmiui/widget/Rotation3DLayout;->Kj:Z
...
.method static synthetic a(Lmiui/widget/Rotation3DLayout;Z)Z
    ...
    iput-boolean p1, p0, Lmiui/widget/Rotation3DLayout;->Kj:Z
...
.method static synthetic b(Lmiui/widget/Rotation3DLayout;)F
    ...
    iget p0, p0, Lmiui/widget/Rotation3DLayout;->Bj:F
...
.method static synthetic b(Lmiui/widget/Rotation3DLayout;F)F
    ...
    iput p1, p0, Lmiui/widget/Rotation3DLayout;->Nj:F
...
.method static synthetic c(Lmiui/widget/Rotation3DLayout;)F
    ...
    iget p0, p0, Lmiui/widget/Rotation3DLayout;->Nj:F
...
.method public enableAutoRotationByGravity(Z)V
    ...
    iput-boolean p1, p0, Lmiui/widget/Rotation3DLayout;->Lj:Z

    iget-boolean p1, p0, Lmiui/widget/Rotation3DLayout;->Lj:Z
...
.method public enableTouchRotation(Z)V
    ...
    iput-boolean p1, p0, Lmiui/widget/Rotation3DLayout;->Ij:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lmiui/widget/Rotation3DLayout;->Ij:Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-direct {v0, v14, v15}, Lmiui/widget/Rotation3DLayout;->b(IF)I
    ...
    invoke-direct {v0, v9, v14}, Lmiui/widget/Rotation3DLayout;->b(IF)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-wide v5, p0, Lmiui/widget/Rotation3DLayout;->Hj:J
    ...
    iput-wide v3, p0, Lmiui/widget/Rotation3DLayout;->Hj:J
    ...
    iget v3, p0, Lmiui/widget/Rotation3DLayout;->Cj:F

    mul-float/2addr v1, v3

    invoke-direct {p0, v1, v2}, Lmiui/widget/Rotation3DLayout;->a(FZ)V

    int-to-float v1, v4

    sub-float/2addr v0, v1

    iget v1, p0, Lmiui/widget/Rotation3DLayout;->Cj:F

    mul-float/2addr v0, v1

    invoke-direct {p0, v0, v2}, Lmiui/widget/Rotation3DLayout;->b(FZ)V

    iput-boolean v2, p0, Lmiui/widget/Rotation3DLayout;->Jj:Z
...
.method protected resetRotation()V
    ...
    new-instance v3, Lmiui/widget/ca;

    invoke-direct {v3, p0}, Lmiui/widget/ca;-><init>(Lmiui/widget/Rotation3DLayout;)V
    ...
    new-instance v3, Lmiui/widget/da;

    invoke-direct {v3, p0}, Lmiui/widget/da;-><init>(Lmiui/widget/Rotation3DLayout;)V

    invoke-virtual {v0, v3}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget v3, p0, Lmiui/widget/Rotation3DLayout;->Dj:I
    ...
    new-instance v4, Lmiui/widget/ea;

    invoke-direct {v4, p0}, Lmiui/widget/ea;-><init>(Lmiui/widget/Rotation3DLayout;)V

    invoke-virtual {v3, v4}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget v4, p0, Lmiui/widget/Rotation3DLayout;->Dj:I
    ...
    :goto_0
    iget-object v5, p0, Lmiui/widget/Rotation3DLayout;->Ej:[F

    array-length v6, v5

    if-ge v4, v6, :cond_1

    iget-object v6, p0, Lmiui/widget/Rotation3DLayout;->Fj:[F

    iget v7, p0, Lmiui/widget/Rotation3DLayout;->Mj:F
    ...
    iget-object v6, p0, Lmiui/widget/Rotation3DLayout;->Gj:[F

    iget v7, p0, Lmiui/widget/Rotation3DLayout;->Nj:F
    ...
    iget-object v2, p0, Lmiui/widget/Rotation3DLayout;->Fj:[F
    ...
    iget-object v1, p0, Lmiui/widget/Rotation3DLayout;->Gj:[F
...
.method public setMaxRotationDegree(F)V
    ...
    iput p1, p0, Lmiui/widget/Rotation3DLayout;->Bj:F

    invoke-static {p1}, Lmiui/widget/Rotation3DLayout;->b(F)F

    move-result p1

    iput p1, p0, Lmiui/widget/Rotation3DLayout;->Cj:F
...
.method public setResetAnimDuration(I)V
    ...
    iput p1, p0, Lmiui/widget/Rotation3DLayout;->Dj:I
...
.method public setResetBouncePatterns([F)V
    ...
    iput-object p1, p0, Lmiui/widget/Rotation3DLayout;->Ej:[F

    array-length v0, p1

    new-array v0, v0, [F

    iput-object v0, p0, Lmiui/widget/Rotation3DLayout;->Fj:[F

    array-length p1, p1

    new-array p1, p1, [F

    iput-object p1, p0, Lmiui/widget/Rotation3DLayout;->Gj:[F
...
.method public startGravityDetection()V
    ...
    iget-object v0, p0, Lmiui/widget/Rotation3DLayout;->Pj:Landroid/hardware/SensorManager;
    ...
    iput-object v0, p0, Lmiui/widget/Rotation3DLayout;->Pj:Landroid/hardware/SensorManager;

    :cond_0
    iget-object v0, p0, Lmiui/widget/Rotation3DLayout;->Oj:Landroid/hardware/Sensor;
    ...
    iput-object v0, p0, Lmiui/widget/Rotation3DLayout;->Oj:Landroid/hardware/Sensor;

    iget-object v0, p0, Lmiui/widget/Rotation3DLayout;->Pj:Landroid/hardware/SensorManager;

    iget-object v1, p0, Lmiui/widget/Rotation3DLayout;->Qj:Landroid/hardware/SensorEventListener;

    iget-object p0, p0, Lmiui/widget/Rotation3DLayout;->Oj:Landroid/hardware/Sensor;
...
.method public stopGravityDetection()V
    ...
    iget-object v1, p0, Lmiui/widget/Rotation3DLayout;->Oj:Landroid/hardware/Sensor;

    if-eqz v1, :cond_0

    iget-object v2, p0, Lmiui/widget/Rotation3DLayout;->Qj:Landroid/hardware/SensorEventListener;
