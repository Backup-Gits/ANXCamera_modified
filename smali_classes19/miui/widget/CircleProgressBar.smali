...
.field private static final ot:I = 0x12c

.field private static final pt:I = 0x12c


# instance fields
.field private _s:Landroid/graphics/RectF;

.field private at:Landroid/graphics/Path;

.field private bt:Landroid/animation/Animator;

.field private ct:[I

.field private dt:[Landroid/graphics/drawable/Drawable;

.field private et:[Landroid/graphics/drawable/Drawable;

.field private ft:[Landroid/graphics/drawable/Drawable;

.field private gt:Lmiui/widget/CircleProgressBar$OnProgressChangedListener;

.field private ht:I

.field private it:Landroid/graphics/Bitmap;

.field private jt:Landroid/graphics/Canvas;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Lmiui/widget/CircleProgressBar;->at:Landroid/graphics/Path;

    const/16 p2, 0x12c

    iput p2, p0, Lmiui/widget/CircleProgressBar;->mt:I
...
.method private Z(I)I
    ...
    iget p0, p0, Lmiui/widget/CircleProgressBar;->mt:I
...
.method private a(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;FI)V
    ...
    iget-object p2, p0, Lmiui/widget/CircleProgressBar;->at:Landroid/graphics/Path;

    invoke-virtual {p2}, Landroid/graphics/Path;->reset()V

    iget-object p2, p0, Lmiui/widget/CircleProgressBar;->at:Landroid/graphics/Path;

    iget-object v1, p0, Lmiui/widget/CircleProgressBar;->_s:Landroid/graphics/RectF;
    ...
    :cond_1
    iget-object p2, p0, Lmiui/widget/CircleProgressBar;->it:Landroid/graphics/Bitmap;
    ...
    iput-object p2, p0, Lmiui/widget/CircleProgressBar;->it:Landroid/graphics/Bitmap;

    new-instance p2, Landroid/graphics/Canvas;

    iget-object v1, p0, Lmiui/widget/CircleProgressBar;->it:Landroid/graphics/Bitmap;

    invoke-direct {p2, v1}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V

    iput-object p2, p0, Lmiui/widget/CircleProgressBar;->jt:Landroid/graphics/Canvas;
    ...
    iget-object p2, p0, Lmiui/widget/CircleProgressBar;->jt:Landroid/graphics/Canvas;
    ...
    iget-object v3, p0, Lmiui/widget/CircleProgressBar;->jt:Landroid/graphics/Canvas;

    iget-object v4, p0, Lmiui/widget/CircleProgressBar;->_s:Landroid/graphics/RectF;
...
.method private aa(I)Landroid/graphics/drawable/Drawable;
    .locals 0

    iget-object p0, p0, Lmiui/widget/CircleProgressBar;->dt:[Landroid/graphics/drawable/Drawable;
...
.method private ba(I)Landroid/graphics/drawable/Drawable;
    .locals 0

    iget-object p0, p0, Lmiui/widget/CircleProgressBar;->ft:[Landroid/graphics/drawable/Drawable;
...
.method private ca(I)Landroid/graphics/drawable/Drawable;
    .locals 0

    iget-object p0, p0, Lmiui/widget/CircleProgressBar;->et:[Landroid/graphics/drawable/Drawable;
...
.method private getIntrinsicHeight()I
    ...
    invoke-direct {p0, v0}, Lmiui/widget/CircleProgressBar;->ca(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lmiui/widget/CircleProgressBar;->ft:[Landroid/graphics/drawable/Drawable;
...
.method protected drawableStateChanged()V
    ...
    iget-object v2, p0, Lmiui/widget/CircleProgressBar;->dt:[Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v2, p0, Lmiui/widget/CircleProgressBar;->et:[Landroid/graphics/drawable/Drawable;
...
.method public getPrevAlpha()I
    ...
    iget p0, p0, Lmiui/widget/CircleProgressBar;->lt:I
...
.method public getProgressLevelCount()I
    ...
    iget-object p0, p0, Lmiui/widget/CircleProgressBar;->ct:[I
...
.method protected declared-synchronized onDraw(Landroid/graphics/Canvas;)V
    ...
    :try_start_0
    iget v0, p0, Lmiui/widget/CircleProgressBar;->ht:I

    invoke-direct {p0, v0}, Lmiui/widget/CircleProgressBar;->aa(I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iget v0, p0, Lmiui/widget/CircleProgressBar;->ht:I

    invoke-direct {p0, v0}, Lmiui/widget/CircleProgressBar;->ba(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0}, Lmiui/widget/CircleProgressBar;->Xc()F

    move-result v6

    iget v0, p0, Lmiui/widget/CircleProgressBar;->lt:I
    ...
    iget v0, p0, Lmiui/widget/CircleProgressBar;->kt:I
    ...
    iget v7, p0, Lmiui/widget/CircleProgressBar;->lt:I
...
.method public setDrawablesForLevels([I[I[I)V
    ...
    invoke-direct {p0, p1}, Lmiui/widget/CircleProgressBar;->c([I)[Landroid/graphics/drawable/Drawable;

    move-result-object p1

    invoke-direct {p0, p2}, Lmiui/widget/CircleProgressBar;->c([I)[Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-direct {p0, p3}, Lmiui/widget/CircleProgressBar;->c([I)[Landroid/graphics/drawable/Drawable;
...
.method public setDrawablesForLevels([Landroid/graphics/drawable/Drawable;[Landroid/graphics/drawable/Drawable;[Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Lmiui/widget/CircleProgressBar;->dt:[Landroid/graphics/drawable/Drawable;

    iput-object p2, p0, Lmiui/widget/CircleProgressBar;->et:[Landroid/graphics/drawable/Drawable;

    iput-object p3, p0, Lmiui/widget/CircleProgressBar;->ft:[Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Lmiui/widget/CircleProgressBar;->_s:Landroid/graphics/RectF;
...
.method public setOnProgressChangedListener(Lmiui/widget/CircleProgressBar$OnProgressChangedListener;)V
    ...
    iput-object p1, p0, Lmiui/widget/CircleProgressBar;->gt:Lmiui/widget/CircleProgressBar$OnProgressChangedListener;
...
.method public setPrevAlpha(I)V
    ...
    iput p1, p0, Lmiui/widget/CircleProgressBar;->lt:I
...
.method public declared-synchronized setProgress(I)V
    ...
    iget-object v0, p0, Lmiui/widget/CircleProgressBar;->ct:[I
    ...
    iget-object v4, p0, Lmiui/widget/CircleProgressBar;->ct:[I
    ...
    :goto_2
    iget p1, p0, Lmiui/widget/CircleProgressBar;->ht:I

    if-eq v0, p1, :cond_4

    iget p1, p0, Lmiui/widget/CircleProgressBar;->ht:I

    iput p1, p0, Lmiui/widget/CircleProgressBar;->kt:I

    iput v0, p0, Lmiui/widget/CircleProgressBar;->ht:I
    ...
    :cond_4
    iget-object p1, p0, Lmiui/widget/CircleProgressBar;->gt:Lmiui/widget/CircleProgressBar$OnProgressChangedListener;
...
.method public setProgressByAnimator(ILandroid/animation/Animator$AnimatorListener;)V
    ...
    iput-object p1, p0, Lmiui/widget/CircleProgressBar;->bt:Landroid/animation/Animator;

    iget-object p1, p0, Lmiui/widget/CircleProgressBar;->bt:Landroid/animation/Animator;

    invoke-direct {p0, v0}, Lmiui/widget/CircleProgressBar;->Z(I)I
    ...
    :cond_0
    iget-object p0, p0, Lmiui/widget/CircleProgressBar;->bt:Landroid/animation/Animator;
...
.method public setProgressLevels([I)V
    ...
    iput-object p1, p0, Lmiui/widget/CircleProgressBar;->ct:[I
...
.method public setRotateVelocity(I)V
    ...
    iput p1, p0, Lmiui/widget/CircleProgressBar;->mt:I
...
.method public stopProgressAnimator()V
    ...
    iget-object v0, p0, Lmiui/widget/CircleProgressBar;->bt:Landroid/animation/Animator;
