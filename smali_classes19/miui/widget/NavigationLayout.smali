...
.field private static final Ar:F = 0.5f
...
.field private static final xr:I = 0x190

.field private static final yr:I = -0x330a0809

.field private static final zr:I = 0x96


# instance fields
.field private Ri:F

.field private final br:Lcom/miui/internal/widget/ViewDragHelper;
...
.field private hr:Lmiui/widget/NavigationLayout$WidthDescription;

.field private ir:Lmiui/widget/NavigationLayout$WidthDescription;
...
.field private qr:Ljava/lang/Runnable;
...
.field private ur:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, Lmiui/widget/NavigationLayout;->lr:I

    new-instance v1, Landroid/graphics/Paint;

    invoke-direct {v1}, Landroid/graphics/Paint;-><init>()V

    iput-object v1, p0, Lmiui/widget/NavigationLayout;->mr:Landroid/graphics/Paint;

    const/4 v1, 0x1

    iput-boolean v1, p0, Lmiui/widget/NavigationLayout;->or:Z

    const/4 v2, 0x0

    iput v2, p0, Lmiui/widget/NavigationLayout;->pr:I

    new-instance v3, Lmiui/widget/V;

    invoke-direct {v3, p0}, Lmiui/widget/V;-><init>(Lmiui/widget/NavigationLayout;)V

    iput-object v3, p0, Lmiui/widget/NavigationLayout;->qr:Ljava/lang/Runnable;
    ...
    iput p2, p0, Lmiui/widget/NavigationLayout;->lr:I
    ...
    iput p2, p0, Lmiui/widget/NavigationLayout;->cr:I
    ...
    iput-object p2, p0, Lmiui/widget/NavigationLayout;->hr:Lmiui/widget/NavigationLayout$WidthDescription;
    ...
    iput-object p2, p0, Lmiui/widget/NavigationLayout;->ir:Lmiui/widget/NavigationLayout$WidthDescription;
    ...
    iput p2, p0, Lmiui/widget/NavigationLayout;->er:I

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    const/high16 p1, 0x3f000000    # 0.5f

    new-instance p2, Lmiui/widget/NavigationLayout$a;

    const/4 p3, 0x0

    invoke-direct {p2, p0, p3}, Lmiui/widget/NavigationLayout$a;-><init>(Lmiui/widget/NavigationLayout;Lmiui/widget/V;)V
    ...
    iput-object p1, p0, Lmiui/widget/NavigationLayout;->br:Lcom/miui/internal/widget/ViewDragHelper;
    ...
    iget-object p2, p0, Lmiui/widget/NavigationLayout;->br:Lcom/miui/internal/widget/ViewDragHelper;
...
.method private Ec()V
    ...
    iget-boolean v0, p0, Lmiui/widget/NavigationLayout;->kr:Z
    ...
    iput-boolean v0, p0, Lmiui/widget/NavigationLayout;->kr:Z
...
.method private Fc()V
    ...
    iget-object v0, p0, Lmiui/widget/NavigationLayout;->fr:Landroid/view/View;
    ...
    iget-boolean v1, v0, Lmiui/widget/NavigationLayout$LayoutParams;->fu:Z

    if-eqz v1, :cond_0

    const/4 v1, 0x0

    iput-boolean v1, v0, Lmiui/widget/NavigationLayout$LayoutParams;->fu:Z
...
.method private Gc()F
    ...
    iget-object p0, p0, Lmiui/widget/NavigationLayout;->fr:Landroid/view/View;
...
.method private Hc()Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    .locals 1

    iget-object v0, p0, Lmiui/widget/NavigationLayout;->ur:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    if-nez v0, :cond_0

    new-instance v0, Lmiui/widget/W;

    invoke-direct {v0, p0}, Lmiui/widget/W;-><init>(Lmiui/widget/NavigationLayout;)V

    iput-object v0, p0, Lmiui/widget/NavigationLayout;->ur:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    :cond_0
    iget-object p0, p0, Lmiui/widget/NavigationLayout;->ur:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method private Ic()Z
    ...
    iget-boolean p0, p0, Lmiui/widget/NavigationLayout$LayoutParams;->fu:Z
...
.method static synthetic a(Lmiui/widget/NavigationLayout;F)F
    ...
    iput p1, p0, Lmiui/widget/NavigationLayout;->sr:F
...
.method private a(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v1, p0, Lmiui/widget/NavigationLayout;->wr:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Lmiui/widget/NavigationLayout;->fr:Landroid/view/View;
    ...
    iget-object v3, p0, Lmiui/widget/NavigationLayout;->fr:Landroid/view/View;
    ...
    iget-object v4, p0, Lmiui/widget/NavigationLayout;->fr:Landroid/view/View;
...
.method private a(Landroid/view/View;Z)V
    ...
    :cond_0
    iget-object v0, p0, Lmiui/widget/NavigationLayout;->vr:Landroid/view/View;
    ...
    iget-object v0, p0, Lmiui/widget/NavigationLayout;->tr:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, Lmiui/widget/NavigationLayout;->tr:Landroid/animation/ValueAnimator;

    :goto_4
    iput-object p1, p0, Lmiui/widget/NavigationLayout;->vr:Landroid/view/View;

    iget-object p1, p0, Lmiui/widget/NavigationLayout;->tr:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Lmiui/widget/NavigationLayout;->Hc()Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    :goto_6
    iput v4, p0, Lmiui/widget/NavigationLayout;->sr:F

    iget-object p0, p0, Lmiui/widget/NavigationLayout;->tr:Landroid/animation/ValueAnimator;
...
.method static synthetic b(Lmiui/widget/NavigationLayout;)Lcom/miui/internal/widget/ViewDragHelper;
    ...
    iget-object p0, p0, Lmiui/widget/NavigationLayout;->br:Lcom/miui/internal/widget/ViewDragHelper;
...
.method static synthetic b(Lmiui/widget/NavigationLayout;F)V
    ...
    invoke-direct {p0, p1}, Lmiui/widget/NavigationLayout;->g(F)V

    return-void
.end method

.method static synthetic c(Lmiui/widget/NavigationLayout;)Ljava/lang/Runnable;
    .locals 0

    iget-object p0, p0, Lmiui/widget/NavigationLayout;->qr:Ljava/lang/Runnable;
...
.method private c(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v2, p0, Lmiui/widget/NavigationLayout;->wr:Z
    ...
    iget v1, p0, Lmiui/widget/NavigationLayout;->jr:I
    ...
    iget v3, p0, Lmiui/widget/NavigationLayout;->jr:I
...
.method static synthetic d(Lmiui/widget/NavigationLayout;)Lmiui/widget/NavigationLayout$NavigationListener;
    .locals 0
...
.method private d(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, Lmiui/widget/NavigationLayout;->sr:F
    ...
    iget-object v1, p0, Lmiui/widget/NavigationLayout;->vr:Landroid/view/View;

    if-eqz v1, :cond_0

    iget v1, p0, Lmiui/widget/NavigationLayout;->lr:I
    ...
    iget-object v1, p0, Lmiui/widget/NavigationLayout;->mr:Landroid/graphics/Paint;
    ...
    iget-object v6, p0, Lmiui/widget/NavigationLayout;->mr:Landroid/graphics/Paint;
...
.method private e(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, Lmiui/widget/NavigationLayout;->rr:F
    ...
    iget-boolean v0, p0, Lmiui/widget/NavigationLayout;->wr:Z
    ...
    iget-object v7, p0, Lmiui/widget/NavigationLayout;->mr:Landroid/graphics/Paint;
...
.method static synthetic e(Lmiui/widget/NavigationLayout;)Z
    .locals 0

    iget-boolean p0, p0, Lmiui/widget/NavigationLayout;->wr:Z

    return p0
.end method

.method static synthetic f(Lmiui/widget/NavigationLayout;)V
    .locals 0

    invoke-direct {p0}, Lmiui/widget/NavigationLayout;->Ec()V

    return-void
.end method

.method static synthetic g(Lmiui/widget/NavigationLayout;)Landroid/view/View;
    .locals 0

    iget-object p0, p0, Lmiui/widget/NavigationLayout;->vr:Landroid/view/View;
...
.method private g(F)V
    ...
    :cond_1
    iget p1, p0, Lmiui/widget/NavigationLayout;->er:I

    if-nez p1, :cond_2

    iget-object p0, p0, Lmiui/widget/NavigationLayout;->gr:Landroid/view/View;
    ...
    iget-object p1, p0, Lmiui/widget/NavigationLayout;->fr:Landroid/view/View;

    invoke-virtual {p1}, Landroid/view/View;->getWidth()I

    move-result p1

    iget-object v1, p0, Lmiui/widget/NavigationLayout;->gr:Landroid/view/View;
...
.method static synthetic h(Lmiui/widget/NavigationLayout;)F
    .locals 0

    invoke-direct {p0}, Lmiui/widget/NavigationLayout;->Gc()F
...
.method private pullChildren()V
    ...
    iget-object v0, p0, Lmiui/widget/NavigationLayout;->gr:Landroid/view/View;
    ...
    iput-object v0, p0, Lmiui/widget/NavigationLayout;->gr:Landroid/view/View;
    ...
    iput-object v0, p0, Lmiui/widget/NavigationLayout;->fr:Landroid/view/View;
...
.method public closeNavigationDrawer(Z)V
    ...
    iget-boolean v0, p0, Lmiui/widget/NavigationLayout;->or:Z
    ...
    iget-boolean p1, p0, Lmiui/widget/NavigationLayout;->dr:Z
    ...
    :cond_1
    iget-boolean p1, p0, Lmiui/widget/NavigationLayout;->wr:Z
    ...
    :goto_0
    iget-object v0, p0, Lmiui/widget/NavigationLayout;->br:Lcom/miui/internal/widget/ViewDragHelper;
    ...
    iget-object p1, p0, Lmiui/widget/NavigationLayout;->qr:Ljava/lang/Runnable;
...
.method public computeScroll()V
    ...
    iget v0, p0, Lmiui/widget/NavigationLayout;->er:I
    ...
    iput v0, p0, Lmiui/widget/NavigationLayout;->rr:F
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, Lmiui/widget/NavigationLayout;->dr:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, Lmiui/widget/NavigationLayout;->e(Landroid/graphics/Canvas;)V

    invoke-direct {p0, p1}, Lmiui/widget/NavigationLayout;->a(Landroid/graphics/Canvas;)V
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Lmiui/widget/NavigationLayout;->vr:Landroid/view/View;

    invoke-virtual {v2}, Landroid/view/View;->getLeft()I

    move-result v2

    iget-object v3, p0, Lmiui/widget/NavigationLayout;->vr:Landroid/view/View;

    invoke-virtual {v3}, Landroid/view/View;->getRight()I

    move-result v3

    iget-object v4, p0, Lmiui/widget/NavigationLayout;->vr:Landroid/view/View;

    invoke-virtual {v4}, Landroid/view/View;->getTop()I

    move-result v4

    iget-object v5, p0, Lmiui/widget/NavigationLayout;->vr:Landroid/view/View;
...
.method public getDividerWidth()I
    ...
    iget p0, p0, Lmiui/widget/NavigationLayout;->jr:I
...
.method public getDrawerEnabledOrientation()I
    ...
    iget p0, p0, Lmiui/widget/NavigationLayout;->cr:I
...
.method public getDrawerLockMode()I
    ...
    iget p0, p0, Lmiui/widget/NavigationLayout;->pr:I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v1, p0, Lmiui/widget/NavigationLayout;->dr:Z

    if-eqz v1, :cond_8

    iget v1, p0, Lmiui/widget/NavigationLayout;->pr:I
    ...
    :cond_1
    iget-object p1, p0, Lmiui/widget/NavigationLayout;->br:Lcom/miui/internal/widget/ViewDragHelper;
    ...
    invoke-direct {p0}, Lmiui/widget/NavigationLayout;->Fc()V

    iput-boolean v3, p0, Lmiui/widget/NavigationLayout;->kr:Z
    ...
    iput v1, p0, Lmiui/widget/NavigationLayout;->pq:F

    iput p1, p0, Lmiui/widget/NavigationLayout;->Ri:F
    ...
    iget-object v4, p0, Lmiui/widget/NavigationLayout;->br:Lcom/miui/internal/widget/ViewDragHelper;
    ...
    invoke-direct {p0}, Lmiui/widget/NavigationLayout;->Ic()Z

    move-result p1

    if-nez p1, :cond_7

    iget-boolean p0, p0, Lmiui/widget/NavigationLayout;->kr:Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v0, v6, Lmiui/widget/NavigationLayout;->dr:Z

    const/4 v8, 0x0

    if-eqz v0, :cond_4

    iget-object v0, v6, Lmiui/widget/NavigationLayout;->fr:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getMeasuredWidth()I

    move-result v0

    iget-object v1, v6, Lmiui/widget/NavigationLayout;->fr:Landroid/view/View;
    ...
    iget-object v0, v6, Lmiui/widget/NavigationLayout;->gr:Landroid/view/View;
    ...
    iget v1, v6, Lmiui/widget/NavigationLayout;->er:I
    ...
    iget-object v2, v6, Lmiui/widget/NavigationLayout;->gr:Landroid/view/View;

    iget-boolean v3, v6, Lmiui/widget/NavigationLayout;->wr:Z
    ...
    iget-object v1, v6, Lmiui/widget/NavigationLayout;->gr:Landroid/view/View;
    ...
    iget v1, v6, Lmiui/widget/NavigationLayout;->jr:I
...
.method protected onMeasure(II)V
    ...
    iput-boolean v6, p0, Lmiui/widget/NavigationLayout;->or:Z
    ...
    iget-object v4, p0, Lmiui/widget/NavigationLayout;->ir:Lmiui/widget/NavigationLayout$WidthDescription;

    goto :goto_1

    :cond_1
    iget-object v4, p0, Lmiui/widget/NavigationLayout;->hr:Lmiui/widget/NavigationLayout$WidthDescription;
    ...
    iget-object v4, p0, Lmiui/widget/NavigationLayout;->gr:Landroid/view/View;
    ...
    :goto_4
    iget v0, p0, Lmiui/widget/NavigationLayout;->cr:I
    ...
    iget v2, p0, Lmiui/widget/NavigationLayout;->jr:I
    ...
    iput-boolean v6, p0, Lmiui/widget/NavigationLayout;->dr:Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {p0, v0}, Lmiui/widget/NavigationLayout;->g(F)V
...
.method public onRtlPropertiesChanged(I)V
    ...
    :goto_0
    iput-boolean p1, p0, Lmiui/widget/NavigationLayout;->wr:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0, v2}, Lmiui/widget/NavigationLayout$SavedState;-><init>(Landroid/os/Parcelable;Lmiui/widget/V;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v0, p0, Lmiui/widget/NavigationLayout;->pr:I
    ...
    iput-boolean v2, p0, Lmiui/widget/NavigationLayout;->kr:Z

    goto :goto_1

    :cond_2
    iget v0, p0, Lmiui/widget/NavigationLayout;->pq:F

    sub-float v0, v1, v0

    iget v4, p0, Lmiui/widget/NavigationLayout;->Ri:F

    sub-float v4, p1, v4

    iget-object v5, p0, Lmiui/widget/NavigationLayout;->br:Lcom/miui/internal/widget/ViewDragHelper;

    invoke-virtual {v5}, Lcom/miui/internal/widget/ViewDragHelper;->getTouchSlop()I

    move-result v5

    iget-object v6, p0, Lmiui/widget/NavigationLayout;->br:Lcom/miui/internal/widget/ViewDragHelper;
    ...
    :cond_4
    iget p1, p0, Lmiui/widget/NavigationLayout;->pr:I
...
.method public setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    iput v0, p0, Lmiui/widget/NavigationLayout;->jr:I
...
.method public setDividerWidth(I)V
    ...
    iput p1, p0, Lmiui/widget/NavigationLayout;->jr:I
...
.method public setDrawerEnabledOrientation(I)V
    ...
    iput p1, p0, Lmiui/widget/NavigationLayout;->cr:I
...
.method public setDrawerLockMode(I)V
    ...
    :cond_0
    iput p1, p0, Lmiui/widget/NavigationLayout;->pr:I
...
.method public setDrawerMode(I)V
    ...
    iput p1, p0, Lmiui/widget/NavigationLayout;->er:I
...
.method public setScrimColor(I)V
    ...
    iput p1, p0, Lmiui/widget/NavigationLayout;->lr:I
