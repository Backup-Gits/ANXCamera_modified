...
.field private Mn:Lmiui/widget/FilterSortView$TabView;

.field private Nn:Landroid/widget/LinearLayout;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Lmiui/widget/FilterSortView;->Kn:Ljava/util/List;

    const/4 p2, -0x1

    iput p2, p0, Lmiui/widget/FilterSortView;->Ln:I

    new-instance p3, Lmiui/widget/K;

    invoke-direct {p3, p0}, Lmiui/widget/K;-><init>(Lmiui/widget/FilterSortView;)V

    iput-object p3, p0, Lmiui/widget/FilterSortView;->dm:Lmiui/widget/FilterSortView$TabView$a;
    ...
    iput-object p3, p0, Lmiui/widget/FilterSortView;->Nn:Landroid/widget/LinearLayout;

    iget-object p3, p0, Lmiui/widget/FilterSortView;->Nn:Landroid/widget/LinearLayout;
    ...
    iget-object v2, p0, Lmiui/widget/FilterSortView;->Nn:Landroid/widget/LinearLayout;
    ...
    iput-object p2, p0, Lmiui/widget/FilterSortView;->Mn:Lmiui/widget/FilterSortView$TabView;

    iget-object p1, p0, Lmiui/widget/FilterSortView;->Mn:Lmiui/widget/FilterSortView$TabView;

    invoke-static {p1}, Lmiui/widget/FilterSortView$TabView;->a(Lmiui/widget/FilterSortView$TabView;)Landroid/widget/ImageView;
    ...
    invoke-static {p1}, Lmiui/widget/FilterSortView$TabView;->b(Lmiui/widget/FilterSortView$TabView;)Landroid/widget/TextView;
    ...
    invoke-direct {p0}, Lmiui/widget/FilterSortView;->dc()Landroid/graphics/drawable/Drawable;
...
.method static synthetic a(Lmiui/widget/FilterSortView;)Lmiui/widget/FilterSortView$TabView;
    .locals 0

    iget-object p0, p0, Lmiui/widget/FilterSortView;->Mn:Lmiui/widget/FilterSortView$TabView;

    return-object p0
.end method

.method private dc()Landroid/graphics/drawable/Drawable;
    .locals 2
...
.method private e(Lmiui/widget/FilterSortView$TabView;)V
    .locals 3

    iget-object v0, p0, Lmiui/widget/FilterSortView;->Mn:Lmiui/widget/FilterSortView$TabView;
    ...
    iget-object v1, p0, Lmiui/widget/FilterSortView;->Mn:Lmiui/widget/FilterSortView$TabView;
...
.method public addTab(Ljava/lang/CharSequence;Z)Lmiui/widget/FilterSortView$TabView;
    ...
    iget-object v1, p0, Lmiui/widget/FilterSortView;->dm:Lmiui/widget/FilterSortView$TabView$a;

    invoke-static {v0, v1}, Lmiui/widget/FilterSortView$TabView;->a(Lmiui/widget/FilterSortView$TabView;Lmiui/widget/FilterSortView$TabView$a;)V
    ...
    iget-object p0, p0, Lmiui/widget/FilterSortView;->Kn:Ljava/util/List;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object p2, p0, Lmiui/widget/FilterSortView;->dm:Lmiui/widget/FilterSortView$TabView$a;

    invoke-static {p1, p2}, Lmiui/widget/FilterSortView$TabView;->a(Lmiui/widget/FilterSortView$TabView;Lmiui/widget/FilterSortView$TabView$a;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget p2, p0, Lmiui/widget/FilterSortView;->Ln:I
    ...
    invoke-direct {p0, p1}, Lmiui/widget/FilterSortView;->e(Lmiui/widget/FilterSortView$TabView;)V
...
.method public setFilteredTab(Lmiui/widget/FilterSortView$TabView;)V
    ...
    iput v0, p0, Lmiui/widget/FilterSortView;->Ln:I

    const/4 p0, 0x1

    invoke-static {p1, p0}, Lmiui/widget/FilterSortView$TabView;->b(Lmiui/widget/FilterSortView$TabView;Z)V
...
.method public setTabIncatorVisibility(I)V
    ...
    :goto_0
    iget-object v1, p0, Lmiui/widget/FilterSortView;->Nn:Landroid/widget/LinearLayout;
