...
# static fields
.field private static final aU:Landroid/util/TypedValue;

.field private static final bU:Ljava/lang/ThreadLocal;
...
.field private static cU:Lmiui/util/AttributeResolver$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/util/AttributeResolver;->aU:Landroid/util/TypedValue;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Lmiui/util/AttributeResolver;->bU:Ljava/lang/ThreadLocal;
...
.method public static isUsingMiuiTheme(Landroid/content/Context;)Z
    ...
    sget-object v0, Lmiui/util/AttributeResolver;->cU:Lmiui/util/AttributeResolver$a;

    if-eqz v0, :cond_0

    iget-object v1, v0, Lmiui/util/AttributeResolver$a;->mContext:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean p0, v0, Lmiui/util/AttributeResolver$a;->mResult:Z
    ...
    sput-object v0, Lmiui/util/AttributeResolver;->cU:Lmiui/util/AttributeResolver$a;
...
.method public static resolve(Landroid/content/Context;I)I
    ...
    invoke-static {p0}, Lmiui/util/AttributeResolver;->s(Landroid/content/Context;)Landroid/util/TypedValue;
...
.method private static s(Landroid/content/Context;)Landroid/util/TypedValue;
    .locals 1
    ...
    sget-object p0, Lmiui/util/AttributeResolver;->aU:Landroid/util/TypedValue;

    return-object p0

    :cond_0
    sget-object p0, Lmiui/util/AttributeResolver;->bU:Ljava/lang/ThreadLocal;
    ...
    sget-object v0, Lmiui/util/AttributeResolver;->bU:Ljava/lang/ThreadLocal;
