...
.field public static final enum cJ:Lmiui/util/async/Task$Delivery;

.field public static final enum dJ:Lmiui/util/async/Task$Delivery;

.field public static final enum eJ:Lmiui/util/async/Task$Delivery;

.field public static final enum fJ:Lmiui/util/async/Task$Delivery;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/util/async/Task$Delivery;->cJ:Lmiui/util/async/Task$Delivery;
    ...
    sput-object v0, Lmiui/util/async/Task$Delivery;->dJ:Lmiui/util/async/Task$Delivery;
    ...
    sput-object v0, Lmiui/util/async/Task$Delivery;->eJ:Lmiui/util/async/Task$Delivery;
    ...
    sput-object v0, Lmiui/util/async/Task$Delivery;->fJ:Lmiui/util/async/Task$Delivery;

    const/4 v0, 0x4

    new-array v0, v0, [Lmiui/util/async/Task$Delivery;

    sget-object v5, Lmiui/util/async/Task$Delivery;->cJ:Lmiui/util/async/Task$Delivery;
    ...
    sget-object v1, Lmiui/util/async/Task$Delivery;->eJ:Lmiui/util/async/Task$Delivery;

    aput-object v1, v0, v3

    sget-object v1, Lmiui/util/async/Task$Delivery;->fJ:Lmiui/util/async/Task$Delivery;
