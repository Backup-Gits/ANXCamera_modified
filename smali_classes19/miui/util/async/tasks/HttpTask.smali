...
.method protected final request()Lmiui/net/http/HttpResponse;
    ...
    iget-object v0, p0, Lmiui/util/async/tasks/HttpTask;->lI:Lmiui/net/http/HttpSession$ProgressListener;

    if-nez v0, :cond_0

    new-instance v0, Lmiui/util/async/tasks/a;

    invoke-direct {v0, p0}, Lmiui/util/async/tasks/a;-><init>(Lmiui/util/async/tasks/HttpTask;)V

    iput-object v0, p0, Lmiui/util/async/tasks/HttpTask;->lI:Lmiui/net/http/HttpSession$ProgressListener;

    :cond_0
    sget-object v0, Lmiui/util/async/tasks/b;->mW:[I
    ...
    iget-object p0, p0, Lmiui/util/async/tasks/HttpTask;->lI:Lmiui/net/http/HttpSession$ProgressListener;
