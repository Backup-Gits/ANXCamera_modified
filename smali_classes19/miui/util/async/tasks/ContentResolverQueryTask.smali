...
.field private VV:Lmiui/util/async/tasks/ContentResolverQueryTask$a;
...
.method public disableAutoRequery()V
    ...
    iget-object v0, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->VV:Lmiui/util/async/tasks/ContentResolverQueryTask$a;
    ...
    iget-object v1, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->VV:Lmiui/util/async/tasks/ContentResolverQueryTask$a;

    invoke-virtual {v0, v1}, Landroid/content/ContentResolver;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->VV:Lmiui/util/async/tasks/ContentResolverQueryTask$a;
...
.method public enableAutoRequery()Lmiui/util/async/tasks/ContentResolverQueryTask$Cookie;
    ...
    new-instance v1, Lmiui/util/async/tasks/ContentResolverQueryTask$a;

    invoke-direct {v1, p0}, Lmiui/util/async/tasks/ContentResolverQueryTask$a;-><init>(Lmiui/util/async/tasks/ContentResolverQueryTask;)V

    iput-object v1, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->VV:Lmiui/util/async/tasks/ContentResolverQueryTask$a;
    ...
    iget-object v3, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->VV:Lmiui/util/async/tasks/ContentResolverQueryTask$a;
...
.method public onPrepare(Lmiui/util/async/TaskManager;)V
    ...
    iput-object v0, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->kJ:Ljava/lang/ref/WeakReference;
...
.method pause()V
    ...
    iput-boolean v0, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->RV:Z
...
.method requery()V
    ...
    iget-boolean v0, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->RV:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->UV:Z

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->kJ:Ljava/lang/ref/WeakReference;
...
.method resume()V
    ...
    iget-boolean v1, p0, Lmiui/util/async/tasks/ContentResolverQueryTask;->UV:Z
