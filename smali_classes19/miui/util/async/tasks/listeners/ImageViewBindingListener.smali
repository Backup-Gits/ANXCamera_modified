...
# static fields
.field private static final qW:Ljava/util/LinkedHashSet;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->qW:Ljava/util/LinkedHashSet;
...
.method public constructor <init>(Landroid/widget/ImageView;)V
    ...
    iput-object v0, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->nW:Ljava/lang/ref/WeakReference;
...
.method private a(Lmiui/util/async/tasks/listeners/ImageViewBindingListener;)Z
    ...
    iget-object p0, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->nW:Ljava/lang/ref/WeakReference;

    invoke-virtual {p0}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object p0

    iget-object p1, p1, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->nW:Ljava/lang/ref/WeakReference;
...
.method public onException(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;Ljava/lang/Exception;)V
    ...
    iget-object p1, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->nW:Ljava/lang/ref/WeakReference;
...
.method public onFinalize(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    sget-object p1, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->qW:Ljava/util/LinkedHashSet;
...
.method public onPrepare(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    iget-object p1, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->oW:Ljava/lang/ref/WeakReference;
    ...
    iput-object p1, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->oW:Ljava/lang/ref/WeakReference;

    const/4 p1, 0x0

    sget-object p2, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->qW:Ljava/util/LinkedHashSet;
    ...
    iget-object p1, v0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->oW:Ljava/lang/ref/WeakReference;
    ...
    iget-object p1, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->pW:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->pW:Landroid/graphics/drawable/Drawable;
...
.method public setPlaceHolderDrawable(Landroid/graphics/drawable/Drawable;)Lmiui/util/async/tasks/listeners/ImageViewBindingListener;
    ...
    iput-object p1, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->pW:Landroid/graphics/drawable/Drawable;
