...
.method public onCancel(Landroid/content/DialogInterface;)V
    ...
    iget-object v0, v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->oW:Ljava/lang/ref/WeakReference;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    iget v1, v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->bd:I
    ...
    iget v1, v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->cd:I
    ...
    iget v0, v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Ra:I

    invoke-virtual {p1, v0}, Lmiui/app/ProgressDialog;->setProgressStyle(I)V

    iget-object v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;->mListener:Lmiui/util/async/tasks/listeners/ProgressDialogListener;

    iget-boolean v0, v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ab:Z

    invoke-virtual {p1, v0}, Lmiui/app/ProgressDialog;->setIndeterminate(Z)V

    iget-object v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;->mListener:Lmiui/util/async/tasks/listeners/ProgressDialogListener;

    iget-boolean v1, v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ab:Z

    if-eqz v1, :cond_3

    iget v0, v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->dd:I

    invoke-virtual {p1, v0}, Lmiui/app/ProgressDialog;->setMax(I)V

    iget-object v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;->mListener:Lmiui/util/async/tasks/listeners/ProgressDialogListener;

    iget v0, v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ed:I
...
.method public onResume()V
    ...
    sget-object v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->qW:Ljava/util/LinkedHashMap;
    ...
    :cond_0
    iput-object p0, v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->gd:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iput-object v0, p1, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->gd:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
