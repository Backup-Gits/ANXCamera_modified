...
# static fields
.field static final qW:Ljava/util/LinkedHashMap;
...
.field gd:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->qW:Ljava/util/LinkedHashMap;
...
.method public constructor <init>(Landroid/app/FragmentManager;)V
    ...
    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->bd:I

    const/4 v1, 0x0

    iput-object v1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->mTitle:Ljava/lang/CharSequence;

    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->cd:I
    ...
    iput-boolean v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ab:Z

    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->dd:I

    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Ra:I

    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ed:I
...
.method public onFinalize(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    iget-object p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->gd:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
    ...
    :cond_0
    sget-object p1, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->qW:Ljava/util/LinkedHashMap;
...
.method public onPrepare(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    iput-object v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->oW:Ljava/lang/ref/WeakReference;
    ...
    sget-object v1, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->qW:Ljava/util/LinkedHashMap;
    ...
    iput-object v1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->gd:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
    ...
    iget-object v2, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->gd:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;

    invoke-virtual {v2, v1}, Landroid/app/DialogFragment;->setArguments(Landroid/os/Bundle;)V

    iget-object v1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->gd:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
    ...
    iput-object p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->gd:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
...
.method public onProgress(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;II)V
    ...
    iget-boolean p2, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ab:Z
    ...
    iget-boolean p0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ab:Z
    ...
    :cond_1
    iget p2, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->dd:I
    ...
    :cond_2
    iget p2, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ed:I

    if-eq p2, p4, :cond_3

    iput p4, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ed:I

    if-eqz p1, :cond_3

    iget p0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ed:I
...
.method public setIndeterminate(Z)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    iput-boolean p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ab:Z
...
.method public setMaxProgress(I)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    iput p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->dd:I
...
.method public setMessage(I)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    iput p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->cd:I
...
.method public setProgressStyle(I)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    iput p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Ra:I
...
.method public setTitle(I)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    iput p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->bd:I
