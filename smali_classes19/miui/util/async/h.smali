...
# direct methods
.method public constructor <init>(Lmiui/util/async/TaskManager;Lmiui/util/async/f;I)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    iput-object p1, p0, Lmiui/util/async/h;->kJ:Lmiui/util/async/TaskManager;

    iput-object p2, p0, Lmiui/util/async/h;->mQueue:Lmiui/util/async/f;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lmiui/util/async/h;->lJ:Z
...
.method static synthetic a(Lmiui/util/async/TaskManager;Ljava/lang/Thread;Lmiui/util/async/Task;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lmiui/util/async/h;->b(Lmiui/util/async/TaskManager;Ljava/lang/Thread;Lmiui/util/async/Task;)V
...
.method public static a(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    new-instance v0, Lmiui/util/async/g;

    invoke-direct {v0, p0, p1}, Lmiui/util/async/g;-><init>(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
...
.method private static b(Lmiui/util/async/TaskManager;Ljava/lang/Thread;Lmiui/util/async/Task;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_2
    invoke-virtual {p0}, Lmiui/util/async/TaskManager;->M()Lmiui/util/cache/Cache;
...
.method public run()V
    ...
    iget-object v0, p0, Lmiui/util/async/h;->mQueue:Lmiui/util/async/f;

    :cond_0
    :goto_0
    iget-boolean v1, p0, Lmiui/util/async/h;->lJ:Z
    ...
    iget-object v2, p0, Lmiui/util/async/h;->kJ:Lmiui/util/async/TaskManager;

    invoke-static {v2, p0, v1}, Lmiui/util/async/h;->b(Lmiui/util/async/TaskManager;Ljava/lang/Thread;Lmiui/util/async/Task;)V
...
.method public shutdown()V
    ...
    iput-boolean v0, p0, Lmiui/util/async/h;->lJ:Z
