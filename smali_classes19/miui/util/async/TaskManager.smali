...
.field static final eW:Z = true

.field private static final fW:I = 0xa

.field private static final gW:I = -0x1


# instance fields
.field private cW:Lmiui/util/async/TaskInfoDeliverer;
...
.field private volatile lJ:Z

.field private final mQueue:Lmiui/util/async/f;

.field private oS:Lmiui/util/cache/Cache;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(III)V
    ...
    new-instance v0, Lmiui/util/async/d;

    invoke-direct {v0, p0}, Lmiui/util/async/d;-><init>(Lmiui/util/async/TaskManager;)V

    iput-object v0, p0, Lmiui/util/async/TaskManager;->pI:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lmiui/util/async/TaskManager;->lJ:Z

    new-instance v1, Lmiui/util/async/f;

    invoke-direct {v1, p0, p1}, Lmiui/util/async/f;-><init>(Lmiui/util/async/TaskManager;I)V

    iput-object v1, p0, Lmiui/util/async/TaskManager;->mQueue:Lmiui/util/async/f;
    ...
    iput-object p1, p0, Lmiui/util/async/TaskManager;->dW:Ljava/util/ArrayList;

    :goto_0
    if-ge v0, p2, :cond_1

    iget-object p1, p0, Lmiui/util/async/TaskManager;->dW:Ljava/util/ArrayList;

    new-instance v1, Lmiui/util/async/h;

    iget-object v2, p0, Lmiui/util/async/TaskManager;->mQueue:Lmiui/util/async/f;

    invoke-direct {v1, p0, v2, v0}, Lmiui/util/async/h;-><init>(Lmiui/util/async/TaskManager;Lmiui/util/async/f;I)V
    ...
    check-cast p1, Lmiui/util/async/h;
    ...
    iput-object p1, p0, Lmiui/util/async/TaskManager;->cW:Lmiui/util/async/TaskInfoDeliverer;

    new-instance p1, Lmiui/util/cache/LruCache;

    invoke-direct {p1, p3}, Lmiui/util/cache/LruCache;-><init>(I)V

    iput-object p1, p0, Lmiui/util/async/TaskManager;->oS:Lmiui/util/cache/Cache;
...
.method private clearQueue()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lmiui/util/async/TaskManager;->mQueue:Lmiui/util/async/f;

    invoke-virtual {v0}, Lmiui/util/async/f;->isEmpty()Z
    ...
    invoke-virtual {v0}, Lmiui/util/async/f;->get()Lmiui/util/async/Task;
...
# virtual methods
.method M()Lmiui/util/cache/Cache;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object p0, p0, Lmiui/util/async/TaskManager;->oS:Lmiui/util/cache/Cache;
...
.method a(Lmiui/util/async/Task;)Z
    ...
    iget-object p0, p0, Lmiui/util/async/TaskManager;->mQueue:Lmiui/util/async/f;

    invoke-virtual {p0, p1}, Lmiui/util/async/f;->a(Lmiui/util/async/Task;)Z
...
.method public add(Lmiui/util/async/Task;)V
    ...
    iget-boolean v0, p0, Lmiui/util/async/TaskManager;->lJ:Z
    ...
    iget-object v0, p0, Lmiui/util/async/TaskManager;->oS:Lmiui/util/cache/Cache;
    ...
    invoke-virtual {p1, p0, v1}, Lmiui/util/async/Task;->a(Lmiui/util/async/Task$Status;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p0, v0}, Lmiui/util/async/Task;->a(Lmiui/util/async/Task$Status;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, Lmiui/util/async/h;->a(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    invoke-virtual {p0, p1}, Lmiui/util/async/f;->b(Lmiui/util/async/Task;)Z
...
.method b(Lmiui/util/async/Task;Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lmiui/util/async/TaskManager;->cW:Lmiui/util/async/TaskInfoDeliverer;

    invoke-virtual {p0, p1, p2, p3}, Lmiui/util/async/TaskInfoDeliverer;->a(Lmiui/util/async/Task;Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V
...
.method isShutdown()Z
    ...
    iget-boolean p0, p0, Lmiui/util/async/TaskManager;->lJ:Z
...
.method public pause()V
    ...
    invoke-virtual {p0}, Lmiui/util/async/f;->pause()V
...
.method public resume()V
    ...
    invoke-virtual {p0}, Lmiui/util/async/f;->resume()V
...
.method public setThreadCount(I)V
    ...
    :cond_1
    iget-object v0, p0, Lmiui/util/async/TaskManager;->dW:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lmiui/util/async/TaskManager;->dW:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lmiui/util/async/TaskManager;->dW:Ljava/util/ArrayList;

    invoke-virtual {v1, v0}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lmiui/util/async/h;

    invoke-virtual {v1}, Lmiui/util/async/h;->shutdown()V
