...
# instance fields
.field private IV:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet<",
...
.field private final KV:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public constructor <init>(Lmiui/util/async/Task$Priority;)V
    ...
    iput-object v0, p0, Lmiui/util/async/Task;->KV:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private a(Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lmiui/util/async/Task;->kJ:Ljava/lang/ref/WeakReference;
...
.method private b(Lmiui/util/async/TaskManager;)V
    ...
    iget-object v0, p0, Lmiui/util/async/Task;->KV:Ljava/util/concurrent/atomic/AtomicBoolean;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lmiui/util/async/Task;->IV:Ljava/util/HashSet;
    ...
    :cond_0
    iget-object p0, p0, Lmiui/util/async/Task;->KV:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private d(Lmiui/util/async/TaskManager;)V
    ...
    iget-object p0, p0, Lmiui/util/async/Task;->kJ:Ljava/lang/ref/WeakReference;
...
.method private kf()Z
    ...
    iget-object v1, p0, Lmiui/util/async/Task;->KV:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p0, p0, Lmiui/util/async/Task;->IV:Ljava/util/HashSet;
    ...
    invoke-direct {v1}, Lmiui/util/async/Task;->kf()Z
...
.method final a(Ljava/lang/Thread;)V
    ...
    sget-object v0, Lmiui/util/async/a;->GV:[I
...
.method final a(Lmiui/util/async/Task$Status;Ljava/lang/Object;)V
    ...
    sget-object v0, Lmiui/util/async/a;->FV:[I
    ...
    :cond_0
    sget-object p2, Lmiui/util/async/a;->FV:[I
    ...
    :cond_1
    sget-object p2, Lmiui/util/async/Task$Delivery;->dJ:Lmiui/util/async/Task$Delivery;

    invoke-direct {p0, p2, v7}, Lmiui/util/async/Task;->a(Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V

    sget-object p2, Lmiui/util/async/Task$Delivery;->fJ:Lmiui/util/async/Task$Delivery;
    ...
    :cond_2
    sget-object p2, Lmiui/util/async/Task$Delivery;->cJ:Lmiui/util/async/Task$Delivery;
    ...
    :cond_4
    sget-object v0, Lmiui/util/async/Task$Delivery;->dJ:Lmiui/util/async/Task$Delivery;
...
.method final a(Lmiui/util/async/TaskManager;Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V
    ...
    sget-object v0, Lmiui/util/async/a;->HV:[I
...
.method final a(Lmiui/util/async/TaskManager;)Z
    ...
    iput-object v0, p0, Lmiui/util/async/Task;->kJ:Ljava/lang/ref/WeakReference;
...
.method public final depends(Lmiui/util/async/Task;)V
    ...
    iget-object v1, p1, Lmiui/util/async/Task;->IV:Ljava/util/HashSet;
    ...
    iput-object v1, p1, Lmiui/util/async/Task;->IV:Ljava/util/HashSet;

    :cond_0
    iget-object p1, p1, Lmiui/util/async/Task;->IV:Ljava/util/HashSet;
    ...
    :cond_1
    iget-object v1, p0, Lmiui/util/async/Task;->kJ:Ljava/lang/ref/WeakReference;
...
.method public final publishProgress(II)V
    ...
    sget-object v0, Lmiui/util/async/Task$Delivery;->eJ:Lmiui/util/async/Task$Delivery;
...
.method public final restart()Z
    ...
    invoke-direct {p0}, Lmiui/util/async/Task;->kf()Z
