...
.method private Ie()J
    ...
    :cond_4
    :goto_2
    invoke-direct {v0, v6, v7, v11, v12}, Lmiui/date/Calendar;->b(JJ)V

    invoke-direct {v0, v1}, Lmiui/date/Calendar;->sa(I)I
    ...
    :cond_8
    :goto_4
    invoke-direct {v0, v4, v5, v7, v8}, Lmiui/date/Calendar;->b(JJ)V
...
.method private Je()V
    ...
    invoke-static {v2, v0}, Lmiui/date/Calendar;->c(II)I
...
.method private Ke()V
    ...
    invoke-static {v4, v3}, Lmiui/date/Calendar;->b(II)I
    ...
    invoke-static {v2, v3}, Lmiui/date/Calendar;->b(II)I
    ...
    invoke-static {v3}, Lmiui/date/Calendar;->ta(I)I
    ...
    invoke-static {v2}, Lmiui/date/Calendar;->g(I)I
    ...
    invoke-direct {p0}, Lmiui/date/Calendar;->Le()V
...
.method private Le()V
    ...
    invoke-direct {p0, v2, v3}, Lmiui/date/Calendar;->m(J)J
    ...
    invoke-static {v0, v5}, Lmiui/date/Calendar;->b(ZI)I
    ...
    invoke-static {v7, v8, v4}, Lmiui/date/Calendar;->a(JI)I
    ...
    invoke-direct {p0, v0}, Lmiui/date/Calendar;->sa(I)I
...
.method private a(Ljava/lang/StringBuilder;Lmiui/date/CalendarFormatSymbols;CII)V
    ...
    invoke-static {p1, p4, p0}, Lmiui/date/Calendar;->b(Ljava/lang/StringBuilder;II)V
    ...
    invoke-direct {p0, p1, v9, v9}, Lmiui/date/Calendar;->a(Ljava/lang/StringBuilder;ZZ)V
    ...
    invoke-direct {p0, p1, v7, v9}, Lmiui/date/Calendar;->a(Ljava/lang/StringBuilder;ZZ)V

    goto/16 :goto_1

    :cond_e
    invoke-direct {p0, p1, v7, v7}, Lmiui/date/Calendar;->a(Ljava/lang/StringBuilder;ZZ)V
...
.method private a(Ljava/lang/StringBuilder;ZZ)V
    ...
    invoke-static {p1, v1, p2}, Lmiui/date/Calendar;->b(Ljava/lang/StringBuilder;II)V
    ...
    invoke-static {p1, v1, v0}, Lmiui/date/Calendar;->b(Ljava/lang/StringBuilder;II)V
...
.method private b(JJ)V
    ...
    invoke-static {p1, p2, p4}, Lmiui/date/Calendar;->a(JI)I
...
.method private c(JJ)I
    ...
    invoke-direct {p0, v0, v1}, Lmiui/date/Calendar;->m(J)J
    ...
    invoke-direct {p0, p4}, Lmiui/date/Calendar;->ra(I)I
...
.method private compute()V
    ...
    invoke-direct {p0}, Lmiui/date/Calendar;->Ie()J
    ...
    invoke-direct {p0, v0, v1}, Lmiui/date/Calendar;->k(J)V

    invoke-direct {p0}, Lmiui/date/Calendar;->Je()V

    invoke-direct {p0, v0, v1}, Lmiui/date/Calendar;->l(J)V
...
.method static g(I)I
    ...
    invoke-static {p0}, Lmiui/date/Calendar;->ta(I)I
...
.method private k(J)V
    ...
    invoke-static {v2}, Lmiui/date/Calendar;->f(I)I
    ...
    invoke-static {v2}, Lmiui/date/Calendar;->ta(I)I
    ...
    :cond_3
    invoke-static {v2, p1}, Lmiui/date/Calendar;->b(II)I
...
.method private l(J)V
    ...
    invoke-static {v6, v7, v8}, Lmiui/date/Calendar;->a(JI)I
    ...
    invoke-static {v6, v7, v2}, Lmiui/date/Calendar;->a(JI)I
    ...
    invoke-static {v4, v0}, Lmiui/date/Calendar;->c(II)I
    ...
    invoke-static {v3, v4, v2}, Lmiui/date/Calendar;->a(JI)I
    ...
    invoke-static {v0, v1, v2}, Lmiui/date/Calendar;->a(JI)I
...
.method public add(II)Lmiui/date/Calendar;
    ...
    invoke-static {p1}, Lmiui/date/Calendar;->ta(I)I
    ...
    invoke-static {p2, p1}, Lmiui/date/Calendar;->b(II)I
    ...
    :cond_1c
    invoke-direct {p0}, Lmiui/date/Calendar;->Ke()V
...
.method public getActualMaximum(I)I
    ...
    invoke-static {p0}, Lmiui/date/Calendar;->f(I)I
    ...
    invoke-direct {p0, p1}, Lmiui/date/Calendar;->ra(I)I
    ...
    invoke-static {p1, p0}, Lmiui/date/Calendar;->b(II)I
    ...
    invoke-static {p1, p0}, Lmiui/date/Calendar;->a(ZI)I
...
.method public set(IIIIIII)Lmiui/date/Calendar;
    ...
    invoke-static {v1, p2}, Lmiui/date/Calendar;->a(ZI)I
...
.method public setChineseTime(IIIZIIII)Lmiui/date/Calendar;
    ...
    invoke-static {p1, p2}, Lmiui/date/Calendar;->b(II)I
