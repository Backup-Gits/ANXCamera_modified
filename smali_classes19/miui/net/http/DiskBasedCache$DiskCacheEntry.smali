...
.method static a(Ljava/io/InputStream;)Ljava/util/Map;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static a(Ljava/io/File;Ljava/lang/String;Lmiui/net/http/Cache$Entry;)Lmiui/net/http/DiskBasedCache$DiskCacheEntry;
    ...
    :try_start_1
    invoke-static {v4, v5}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->a(Ljava/io/OutputStream;I)V

    invoke-static {v4, p1}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->a(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-static {v4, v5}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->a(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    :goto_2
    invoke-static {v4, v6}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->a(Ljava/io/OutputStream;Ljava/lang/String;)V

    iget-wide v5, p2, Lmiui/net/http/Cache$Entry;->serverDate:J

    invoke-static {v4, v5, v6}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->a(Ljava/io/OutputStream;J)V
    ...
    invoke-static {v5, v4}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->a(Ljava/util/Map;Ljava/io/OutputStream;)V
    ...
    iput-object p0, v5, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->wx:Ljava/io/File;
    ...
    :try_start_3
    new-instance p1, Lmiui/net/http/DiskBasedCache$a;

    invoke-direct {p1, v5}, Lmiui/net/http/DiskBasedCache$a;-><init>(Lmiui/net/http/DiskBasedCache$DiskCacheEntry;)V
...
.method static a(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, v1}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->a(Ljava/io/OutputStream;J)V
...
.method public static fromFile(Ljava/io/File;)Lmiui/net/http/DiskBasedCache$DiskCacheEntry;
    ...
    :try_start_1
    invoke-static {v2}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->b(Ljava/io/InputStream;)I
    ...
    invoke-static {v2}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->d(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {v2}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->c(Ljava/io/InputStream;)J
    ...
    invoke-static {v2}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->a(Ljava/io/InputStream;)Ljava/util/Map;
    ...
    iput-object p0, v3, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->wx:Ljava/io/File;
...
.method public declared-synchronized J()Z
    ...
    :try_start_0
    iget v0, p0, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->bS:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public K()Lmiui/net/http/Cache$Entry;
    .locals 6
    ...
    iget-object v3, p0, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->wx:Ljava/io/File;
...
.method public declared-synchronized acquire()V
    ...
    iput v0, p0, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->bS:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized delete()V
    ...
    iput-boolean v0, p0, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->aS:Z

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->wx:Ljava/io/File;
    ...
    iget-object v2, p0, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->wx:Ljava/io/File;
...
.method public declared-synchronized release()V
    ...
    iget-boolean v0, p0, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->aS:Z
