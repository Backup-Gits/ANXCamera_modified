...
.field private static final qS:I = 0x2710

.field private static final rS:I = 0x2000

.field private static final sS:Ljava/lang/String; = "Accept-Encoding"

.field private static final tS:Ljava/lang/String; = "gzip"
...
.field private oS:Lmiui/net/http/Cache;

.field private pS:Lmiui/net/http/RetryStrategy;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lmiui/net/http/HttpSession;->mS:Ljava/util/Map;

    invoke-static {}, Lmiui/net/http/DiskBasedCache;->getDefault()Lmiui/net/http/DiskBasedCache;

    move-result-object v0

    iput-object v0, p0, Lmiui/net/http/HttpSession;->oS:Lmiui/net/http/Cache;

    new-instance v0, Lmiui/net/http/BaseRetryStrategy;

    invoke-direct {v0}, Lmiui/net/http/BaseRetryStrategy;-><init>()V

    iput-object v0, p0, Lmiui/net/http/HttpSession;->pS:Lmiui/net/http/RetryStrategy;

    return-void
.end method

.method private H(Ljava/lang/String;)Lmiui/net/http/Cache$Entry;
    .locals 0

    iget-object p0, p0, Lmiui/net/http/HttpSession;->oS:Lmiui/net/http/Cache;
...
.method private a(Ljava/lang/String;Lmiui/net/http/Cache$Entry;Lmiui/net/http/HttpSession$ProgressListener;)Lmiui/net/http/a;
    ...
    iget-object v3, v0, Lmiui/net/http/HttpSession;->mS:Ljava/util/Map;
    ...
    iget-object v5, v0, Lmiui/net/http/HttpSession;->mS:Ljava/util/Map;
    ...
    new-instance v6, Lmiui/net/http/HttpSession$a;
    ...
    invoke-direct/range {v8 .. v13}, Lmiui/net/http/HttpSession$a;-><init>(Ljava/io/InputStream;JLjava/lang/String;Lmiui/net/http/HttpSession$ProgressListener;)V
...
.method private a(Ljava/lang/String;Lmiui/net/http/HttpRequestParams;Lmiui/net/http/HttpSession$ProgressListener;)Lmiui/net/http/a;
    ...
    invoke-direct {p0, p2}, Lmiui/net/http/HttpSession;->H(Ljava/lang/String;)Lmiui/net/http/Cache$Entry;
    ...
    new-instance p0, Lmiui/net/http/a;
    ...
    :cond_3
    iget-object v0, p0, Lmiui/net/http/HttpSession;->mS:Ljava/util/Map;
    ...
    :cond_4
    iget-object v0, p0, Lmiui/net/http/HttpSession;->pS:Lmiui/net/http/RetryStrategy;
...
.method private a(Ljava/lang/String;Lmiui/net/http/a;)V
    ...
    invoke-virtual {p2, p0, v0, v1}, Lmiui/net/http/a;->a(Ljava/io/InputStream;J)V
...
.method private a(Lmiui/net/http/Cache$Entry;)V
    ...
    invoke-static {p1}, Lmiui/net/http/DateUtils;->a(Ljava/util/Date;)Ljava/lang/String;
...
.method private b(Ljava/util/Map;)V
    ...
    iget-object v1, p0, Lmiui/net/http/HttpSession;->mS:Ljava/util/Map;
...
.method public addHeader(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lmiui/net/http/HttpSession;->mS:Ljava/util/Map;
...
.method public download(Ljava/io/File;Ljava/lang/String;Ljava/util/Map;Lmiui/net/http/HttpRequestParams;Lmiui/net/http/HttpSession$ProgressListener;)V
    ...
    iput-object p3, p0, Lmiui/net/http/HttpSession;->nS:Ljava/lang/String;
...
.method public get(Ljava/lang/String;Ljava/util/Map;Lmiui/net/http/HttpRequestParams;Lmiui/net/http/HttpSession$ProgressListener;)Lmiui/net/http/HttpResponse;
    ...
    iput-object p2, p0, Lmiui/net/http/HttpSession;->nS:Ljava/lang/String;
...
.method public setCache(Lmiui/net/http/Cache;)V
    ...
    iget-object v0, p0, Lmiui/net/http/HttpSession;->oS:Lmiui/net/http/Cache;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Lmiui/net/http/HttpSession;->oS:Lmiui/net/http/Cache;
...
.method public setRetryStrategy(Lmiui/net/http/RetryStrategy;)V
    ...
    iput-object p1, p0, Lmiui/net/http/HttpSession;->pS:Lmiui/net/http/RetryStrategy;
