...
.field private static final fS:I = 0xa00000

.field private static final gS:F = 0.9f

.field private static final hS:I = 0x20140228


# instance fields
.field private cS:J

.field private final dS:Ljava/io/File;
...
.method public constructor <init>(Ljava/io/File;I)V
    ...
    iput-wide v0, p0, Lmiui/net/http/DiskBasedCache;->cS:J
    ...
    :cond_0
    iput-object p1, p0, Lmiui/net/http/DiskBasedCache;->dS:Ljava/io/File;

    iput p2, p0, Lmiui/net/http/DiskBasedCache;->eS:I
...
.method private G(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object p0, p0, Lmiui/net/http/DiskBasedCache;->dS:Ljava/io/File;
...
.method private b(Lmiui/net/http/DiskBasedCache$DiskCacheEntry;)V
    ...
    iget-wide v1, p0, Lmiui/net/http/DiskBasedCache;->cS:J

    iget-wide v3, p1, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->size:J

    add-long/2addr v1, v3

    iput-wide v1, p0, Lmiui/net/http/DiskBasedCache;->cS:J

    goto :goto_0

    :cond_0
    iget-wide v2, p0, Lmiui/net/http/DiskBasedCache;->cS:J
    ...
    iput-wide v2, p0, Lmiui/net/http/DiskBasedCache;->cS:J
...
.method private c(Lmiui/net/http/DiskBasedCache$DiskCacheEntry;)V
    .locals 5
...
.method private n(J)V
    ...
    iget-wide v0, p0, Lmiui/net/http/DiskBasedCache;->cS:J

    add-long/2addr v0, p1

    iget v2, p0, Lmiui/net/http/DiskBasedCache;->eS:I
    ...
    :try_start_0
    iget-wide v3, p0, Lmiui/net/http/DiskBasedCache;->cS:J

    add-long/2addr v3, p1

    iget v5, p0, Lmiui/net/http/DiskBasedCache;->eS:I
    ...
    iget-wide v5, p0, Lmiui/net/http/DiskBasedCache;->cS:J

    iget-wide v7, v4, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->size:J

    sub-long/2addr v5, v7

    iput-wide v5, p0, Lmiui/net/http/DiskBasedCache;->cS:J
    ...
    iget-wide v6, p0, Lmiui/net/http/DiskBasedCache;->cS:J

    iget-wide v8, v4, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->size:J

    sub-long/2addr v6, v8

    iput-wide v6, p0, Lmiui/net/http/DiskBasedCache;->cS:J
    ...
    iget v6, p0, Lmiui/net/http/DiskBasedCache;->eS:I
    ...
    iget v3, p0, Lmiui/net/http/DiskBasedCache;->eS:I
    ...
    invoke-virtual {v1}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->J()Z
...
.method public get(Ljava/lang/String;)Lmiui/net/http/Cache$Entry;
    ...
    :cond_0
    invoke-virtual {p0}, Lmiui/net/http/DiskBasedCache$DiskCacheEntry;->K()Lmiui/net/http/Cache$Entry;
...
.method public initialize()V
    ...
    iget-object v0, p0, Lmiui/net/http/DiskBasedCache;->dS:Ljava/io/File;
    ...
    invoke-direct {p0, v5}, Lmiui/net/http/DiskBasedCache;->b(Lmiui/net/http/DiskBasedCache$DiskCacheEntry;)V
...
.method public put(Ljava/lang/String;Lmiui/net/http/Cache$Entry;)Z
    ...
    invoke-direct {p0, p1}, Lmiui/net/http/DiskBasedCache;->G(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p0, v0, v1}, Lmiui/net/http/DiskBasedCache;->n(J)V
...
.method public remove(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lmiui/net/http/DiskBasedCache;->c(Lmiui/net/http/DiskBasedCache$DiskCacheEntry;)V
