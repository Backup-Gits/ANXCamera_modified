...
.field private static final YN:Ljava/lang/String; = "miui:fragment.launchRadius"

.field private static final ZN:Ljava/lang/String; = "miui:fragment.launchColor"

.field private static final _N:Ljava/lang/String; = "miui:fragment.launchThumb"


# instance fields
.field private XN:Lmiui/app/transition/FragmentOptions$RetainedFragment;

.field private ke:Landroid/graphics/Rect;
...
.method private constructor <init>(Landroid/app/Activity;Landroid/graphics/Rect;Landroid/graphics/Bitmap;II)V
    ...
    iput-object p2, p0, Lmiui/app/transition/FragmentOptions;->ke:Landroid/graphics/Rect;

    iput p4, p0, Lmiui/app/transition/FragmentOptions;->mColor:I

    iput p5, p0, Lmiui/app/transition/FragmentOptions;->mRadius:I

    iget-object p2, p0, Lmiui/app/transition/FragmentOptions;->XN:Lmiui/app/transition/FragmentOptions$RetainedFragment;
    ...
    iput-object p4, p0, Lmiui/app/transition/FragmentOptions;->XN:Lmiui/app/transition/FragmentOptions$RetainedFragment;

    iget-object p4, p0, Lmiui/app/transition/FragmentOptions;->XN:Lmiui/app/transition/FragmentOptions$RetainedFragment;
    ...
    :cond_0
    iget-object p0, p0, Lmiui/app/transition/FragmentOptions;->XN:Lmiui/app/transition/FragmentOptions$RetainedFragment;

    invoke-virtual {p0, p3}, Lmiui/app/transition/FragmentOptions$RetainedFragment;->a(Landroid/graphics/Bitmap;)V
...
.method private constructor <init>(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lmiui/app/transition/FragmentOptions;->ke:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Lmiui/app/transition/FragmentOptions;->XN:Lmiui/app/transition/FragmentOptions$RetainedFragment;

    :cond_0
    iget-object p1, p0, Lmiui/app/transition/FragmentOptions;->XN:Lmiui/app/transition/FragmentOptions$RetainedFragment;
...
.method private static a(Landroid/app/Activity;Landroid/os/Bundle;Z)Landroid/transition/Transition;
    .locals 1

    invoke-static {p0, p1}, Lmiui/app/transition/FragmentOptions;->a(Landroid/app/Activity;Landroid/os/Bundle;)Lmiui/app/transition/FragmentOptions;

    move-result-object p1

    if-eqz p1, :cond_0

    new-instance v0, Lmiui/app/transition/i;

    invoke-direct {v0, p0, p1, p2}, Lmiui/app/transition/i;-><init>(Landroid/app/Activity;Lmiui/app/transition/FragmentOptions;Z)V
...
.method private static a(Landroid/app/Activity;Landroid/os/Bundle;)Lmiui/app/transition/FragmentOptions;
    .locals 1
...
.method public static newFragmentTransition(Landroid/app/Activity;Landroid/os/Bundle;Lmiui/app/transition/FragmentOptions$Type;)Landroid/transition/Transition;
    ...
    sget-object v0, Lmiui/app/transition/b;->WN:[I
    ...
    invoke-static {p0, p1, p2}, Lmiui/app/transition/FragmentOptions;->a(Landroid/app/Activity;Landroid/os/Bundle;Z)Landroid/transition/Transition;
    ...
    :cond_1
    invoke-static {p0, p1, v1}, Lmiui/app/transition/FragmentOptions;->a(Landroid/app/Activity;Landroid/os/Bundle;Z)Landroid/transition/Transition;
...
.method public static newFragmentTransition(Lmiui/app/transition/FragmentOptions$Type;)Landroid/transition/Transition;
    ...
    new-instance p0, Lmiui/app/transition/a;

    invoke-direct {p0}, Lmiui/app/transition/a;-><init>()V
    ...
    :cond_1
    new-instance p0, Lmiui/app/transition/d;

    invoke-direct {p0}, Lmiui/app/transition/d;-><init>()V
...
.method private toBundle()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lmiui/app/transition/FragmentOptions;->ke:Landroid/graphics/Rect;
...
.method E()Landroid/graphics/Rect;
    ...
    iget-object p0, p0, Lmiui/app/transition/FragmentOptions;->ke:Landroid/graphics/Rect;
