...
# instance fields
.field private final Ea:Lmiui/widget/DatePicker;

.field private final Fa:Lmiui/app/DatePickerDialog$OnDateSetListener;

.field private Ga:Landroid/view/View;

.field private Ha:Lmiui/widget/SlidingButton;
...
.method public constructor <init>(Landroid/content/Context;ILmiui/app/DatePickerDialog$OnDateSetListener;III)V
    ...
    iput-boolean p1, p0, Lmiui/app/DatePickerDialog;->Ia:Z

    new-instance p1, Lmiui/app/c;

    invoke-direct {p1, p0}, Lmiui/app/c;-><init>(Lmiui/app/DatePickerDialog;)V

    iput-object p1, p0, Lmiui/app/DatePickerDialog;->mOnDateChangedListener:Lmiui/widget/DatePicker$OnDateChangedListener;

    iput-object p3, p0, Lmiui/app/DatePickerDialog;->Fa:Lmiui/app/DatePickerDialog$OnDateSetListener;
    ...
    new-instance p3, Lmiui/app/d;

    invoke-direct {p3, p0}, Lmiui/app/d;-><init>(Lmiui/app/DatePickerDialog;)V
    ...
    iput-object p2, p0, Lmiui/app/DatePickerDialog;->Ea:Lmiui/widget/DatePicker;

    iget-object p2, p0, Lmiui/app/DatePickerDialog;->Ea:Lmiui/widget/DatePicker;
    ...
    iput-object p2, p0, Lmiui/app/DatePickerDialog;->Ga:Landroid/view/View;
    ...
    iput-object p1, p0, Lmiui/app/DatePickerDialog;->Ha:Lmiui/widget/SlidingButton;

    iget-object p1, p0, Lmiui/app/DatePickerDialog;->Ha:Lmiui/widget/SlidingButton;
...
.method private V()V
    ...
    iget-object v0, p0, Lmiui/app/DatePickerDialog;->Fa:Lmiui/app/DatePickerDialog$OnDateSetListener;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lmiui/app/DatePickerDialog;->Ea:Lmiui/widget/DatePicker;

    invoke-virtual {v0}, Landroid/widget/FrameLayout;->clearFocus()V

    iget-object v0, p0, Lmiui/app/DatePickerDialog;->Fa:Lmiui/app/DatePickerDialog$OnDateSetListener;

    iget-object v1, p0, Lmiui/app/DatePickerDialog;->Ea:Lmiui/widget/DatePicker;

    invoke-virtual {v1}, Lmiui/widget/DatePicker;->getYear()I

    move-result v2

    iget-object v3, p0, Lmiui/app/DatePickerDialog;->Ea:Lmiui/widget/DatePicker;

    invoke-virtual {v3}, Lmiui/widget/DatePicker;->getMonth()I

    move-result v3

    iget-object p0, p0, Lmiui/app/DatePickerDialog;->Ea:Lmiui/widget/DatePicker;
...
.method static synthetic a(Lmiui/app/DatePickerDialog;)Z
    ...
    iget-boolean p0, p0, Lmiui/app/DatePickerDialog;->Ia:Z
...
.method public onRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lmiui/app/DatePickerDialog;->Ea:Lmiui/widget/DatePicker;
...
.method public setLunarMode(Z)V
    ...
    iget-object p0, p0, Lmiui/app/DatePickerDialog;->Ga:Landroid/view/View;
...
.method public switchLunarState(Z)V
    ...
    iget-object p0, p0, Lmiui/app/DatePickerDialog;->Ha:Lmiui/widget/SlidingButton;
