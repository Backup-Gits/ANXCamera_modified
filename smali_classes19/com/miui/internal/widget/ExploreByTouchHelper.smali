...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/miui/internal/widget/ExploreByTouchHelper$a;
    }
.end annotation
...
.field private static final Se:Ljava/lang/String;

.field private static final Te:Landroid/graphics/Rect;


# instance fields
.field private Le:Landroid/graphics/Rect;

.field private Me:Landroid/graphics/Rect;

.field private Ne:[I

.field private Oe:Landroid/graphics/Rect;

.field private Pe:Lcom/miui/internal/widget/ExploreByTouchHelper$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Se:Ljava/lang/String;
    ...
    sput-object v0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Te:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput v0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Qe:I

    iput v0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Re:I
...
.method static synthetic a(Lcom/miui/internal/widget/ExploreByTouchHelper;I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-direct {p0, p1}, Lcom/miui/internal/widget/ExploreByTouchHelper;->r(I)Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method private a(IILandroid/os/Bundle;)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/miui/internal/widget/ExploreByTouchHelper;->i(II)Z
...
.method private a(Landroid/graphics/Rect;)Z
    ...
    :cond_5
    iget-object v1, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Oe:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Oe:Landroid/graphics/Rect;
...
.method private g(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-direct {p0, p1, p2}, Lcom/miui/internal/widget/ExploreByTouchHelper;->h(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    :cond_0
    invoke-direct {p0, p2}, Lcom/miui/internal/widget/ExploreByTouchHelper;->q(I)Landroid/view/accessibility/AccessibilityEvent;
...
.method private h(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    sget-object v0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Se:Ljava/lang/String;
...
.method private i(II)Z
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/miui/internal/widget/ExploreByTouchHelper;->p(I)Z
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/miui/internal/widget/ExploreByTouchHelper;->u(I)Z
...
.method private p(I)Z
    ...
    invoke-direct {p0, p1}, Lcom/miui/internal/widget/ExploreByTouchHelper;->t(I)Z
...
.method private q(I)Landroid/view/accessibility/AccessibilityEvent;
    .locals 1
...
.method private r(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    .locals 1
    ...
    invoke-direct {p0, p1}, Lcom/miui/internal/widget/ExploreByTouchHelper;->s(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/miui/internal/widget/ExploreByTouchHelper;->sa()Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method private s(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    .locals 8

    invoke-direct {p0}, Lcom/miui/internal/widget/ExploreByTouchHelper;->ta()V

    iget-object v0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Me:Landroid/graphics/Rect;

    iget-object v1, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Ne:[I

    iget-object v2, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Le:Landroid/graphics/Rect;
    ...
    sget-object v5, Lcom/miui/internal/widget/ExploreByTouchHelper;->Se:Ljava/lang/String;

    invoke-virtual {v3, v5}, Landroid/view/accessibility/AccessibilityNodeInfo;->setClassName(Ljava/lang/CharSequence;)V

    sget-object v5, Lcom/miui/internal/widget/ExploreByTouchHelper;->Te:Landroid/graphics/Rect;
    ...
    iget v5, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Qe:I
...
.method private sa()Landroid/view/accessibility/AccessibilityNodeInfo;
    .locals 6
...
.method private t(I)Z
    ...
    iget p0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Qe:I
...
.method private ta()V
    ...
    iput-object v0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Ne:[I

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Me:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Le:Landroid/graphics/Rect;
...
.method private u(I)Z
    ...
    iget v0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Qe:I
    ...
    :cond_1
    iput p1, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Qe:I
...
.method private v(I)V
    ...
    iget v0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Re:I
    ...
    :cond_0
    iput p1, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Re:I
...
.method public dispatchHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget p1, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Qe:I

    if-eq p1, v4, :cond_2

    invoke-direct {p0, v4}, Lcom/miui/internal/widget/ExploreByTouchHelper;->v(I)V
    ...
    invoke-direct {p0, p1}, Lcom/miui/internal/widget/ExploreByTouchHelper;->v(I)V
...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    iget-object p1, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Pe:Lcom/miui/internal/widget/ExploreByTouchHelper$a;

    if-nez p1, :cond_0

    new-instance p1, Lcom/miui/internal/widget/ExploreByTouchHelper$a;

    const/4 v0, 0x0

    invoke-direct {p1, p0, v0}, Lcom/miui/internal/widget/ExploreByTouchHelper$a;-><init>(Lcom/miui/internal/widget/ExploreByTouchHelper;Lcom/miui/internal/widget/C;)V

    iput-object p1, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Pe:Lcom/miui/internal/widget/ExploreByTouchHelper$a;

    :cond_0
    iget-object p0, p0, Lcom/miui/internal/widget/ExploreByTouchHelper;->Pe:Lcom/miui/internal/widget/ExploreByTouchHelper$a;
...
.method public invalidateVirtualView(II)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/miui/internal/widget/ExploreByTouchHelper;->g(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method public sendEventForVirtualView(II)Z
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Lcom/miui/internal/widget/ExploreByTouchHelper;->g(II)Landroid/view/accessibility/AccessibilityEvent;
