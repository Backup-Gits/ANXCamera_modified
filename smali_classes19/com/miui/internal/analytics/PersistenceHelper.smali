...
.field private mStore:Lcom/miui/internal/analytics/f;

.field private mv:Lcom/miui/internal/analytics/ObjectBuilder;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/miui/internal/analytics/ObjectBuilder<",
            "Lcom/miui/internal/analytics/f;",
            ">;"
        }
    .end annotation
.end field

.field private nv:Lcom/miui/internal/analytics/ObjectBuilder;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/miui/internal/analytics/ObjectBuilder<",
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->lv:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->mv:Lcom/miui/internal/analytics/ObjectBuilder;

    new-instance v0, Lcom/miui/internal/analytics/ObjectBuilder;

    invoke-direct {v0}, Lcom/miui/internal/analytics/ObjectBuilder;-><init>()V

    iput-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->nv:Lcom/miui/internal/analytics/ObjectBuilder;

    iget-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->nv:Lcom/miui/internal/analytics/ObjectBuilder;
    ...
    iget-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->mv:Lcom/miui/internal/analytics/ObjectBuilder;

    const-class v1, Lcom/miui/internal/analytics/e;
    ...
    invoke-direct {p0}, Lcom/miui/internal/analytics/PersistenceHelper;->od()V

    iget-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->lv:Ljava/util/concurrent/atomic/AtomicBoolean;

    monitor-enter v0

    :try_start_0
    new-instance v1, Lcom/miui/internal/analytics/PersistenceHelper$a;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/miui/internal/analytics/PersistenceHelper$a;-><init>(Lcom/miui/internal/analytics/PersistenceHelper;Lcom/miui/internal/analytics/PersistenceHelper$1;)V
    ...
    :goto_0
    :try_start_1
    iget-object v1, p0, Lcom/miui/internal/analytics/PersistenceHelper;->lv:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic a(Lcom/miui/internal/analytics/PersistenceHelper;Landroid/os/Handler;)Landroid/os/Handler;
    ...
    iput-object p1, p0, Lcom/miui/internal/analytics/PersistenceHelper;->ov:Landroid/os/Handler;
...
.method static synthetic a(Lcom/miui/internal/analytics/PersistenceHelper;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->lv:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private a(Lcom/miui/internal/analytics/Event;)V
    ...
    iget-object p0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->mStore:Lcom/miui/internal/analytics/f;

    if-eqz p0, :cond_0

    invoke-virtual {p1, p0}, Lcom/miui/internal/analytics/Event;->writeEvent(Lcom/miui/internal/analytics/f;)V
...
.method private od()V
    ...
    check-cast v0, Lcom/miui/internal/analytics/f;

    iput-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->mStore:Lcom/miui/internal/analytics/f;

    iget-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->mStore:Lcom/miui/internal/analytics/f;

    iget-object p0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->mContext:Landroid/content/Context;

    invoke-interface {v0, p0}, Lcom/miui/internal/analytics/f;->create(Landroid/content/Context;)V
...
.method public close()V
    ...
    iget-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->ov:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->ov:Landroid/os/Handler;

    iget-object v1, p0, Lcom/miui/internal/analytics/PersistenceHelper;->mStore:Lcom/miui/internal/analytics/f;

    if-eqz v1, :cond_0

    invoke-interface {v1}, Lcom/miui/internal/analytics/f;->close()V
...
.method public readEvents(Ljava/lang/String;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-interface {v0, p1}, Lcom/miui/internal/analytics/f;->a(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object v2, p0, Lcom/miui/internal/analytics/PersistenceHelper;->nv:Lcom/miui/internal/analytics/ObjectBuilder;
...
.method public selectStore(Ljava/lang/String;)Z
    ...
    check-cast p1, Lcom/miui/internal/analytics/f;
    ...
    invoke-interface {v0}, Lcom/miui/internal/analytics/f;->close()V

    :cond_0
    iput-object p1, p0, Lcom/miui/internal/analytics/PersistenceHelper;->mStore:Lcom/miui/internal/analytics/f;
...
.method public writeEvent(Lcom/miui/internal/analytics/Event;)V
    ...
    iget-object p0, p0, Lcom/miui/internal/analytics/PersistenceHelper;->ov:Landroid/os/Handler;
