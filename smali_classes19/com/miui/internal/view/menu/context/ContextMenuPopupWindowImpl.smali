...
# static fields
.field private static final Mu:F = 0.1f

.field private static final Nu:F = 0.1f


# instance fields
.field private Gu:Landroid/view/View;

.field private Iu:Landroid/widget/LinearLayout;

.field private Ju:Landroid/view/View;

.field private Ku:Landroid/view/MenuItem;
...
.method public constructor <init>(Landroid/content/Context;Lcom/miui/internal/view/menu/MenuBuilder;Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    invoke-virtual {p2}, Lcom/miui/internal/view/menu/context/ContextMenuAdapter;->v()Landroid/view/MenuItem;

    move-result-object p2

    iput-object p2, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ku:Landroid/view/MenuItem;

    invoke-direct {p0, p1}, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->f(Landroid/content/Context;)V

    iget-object p2, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->mAdapter:Lcom/miui/internal/view/menu/context/ContextMenuAdapter;

    invoke-virtual {p0, p2}, Lmiui/widget/ImmersionListPopupWindow;->setAdapter(Landroid/widget/ListAdapter;)V

    new-instance p2, Lcom/miui/internal/view/menu/context/b;

    invoke-direct {p2, p0}, Lcom/miui/internal/view/menu/context/b;-><init>(Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;)V
    ...
    iput p1, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Lu:I

    return-void
.end method

.method static synthetic a(Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;)Lcom/miui/internal/view/menu/context/ContextMenuAdapter;
    .locals 0
...
.method static synthetic a(Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;Landroid/view/View;FF)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->c(Landroid/view/View;FF)V

    return-void
.end method

.method static synthetic b(Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;)Lcom/miui/internal/view/menu/MenuBuilder;
    .locals 0
...
.method static synthetic c(Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;)Landroid/view/View;
    .locals 0

    iget-object p0, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Gu:Landroid/view/View;
...
.method private c(Landroid/view/View;FF)V
    ...
    iget-object v0, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ju:Landroid/view/View;

    const/16 v1, 0x8

    invoke-virtual {v0, v1}, Landroid/view/View;->setVisibility(I)V

    invoke-direct {p0, p1, p2, p3}, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->d(Landroid/view/View;FF)V
...
.method static synthetic d(Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;)F
    .locals 0
...
.method private d(Landroid/view/View;FF)V
    ...
    :goto_0
    invoke-direct {p0}, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->ld()I
    ...
    :cond_1
    invoke-direct {p0}, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->md()I
    ...
    iget p2, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Lu:I
    ...
    iget p3, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Lu:I
...
.method static synthetic e(Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;)F
    .locals 0
...
.method static synthetic f(Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;)Landroid/view/MenuItem;
    .locals 0

    iget-object p0, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ku:Landroid/view/MenuItem;
...
.method private f(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ku:Landroid/view/MenuItem;

    if-nez v0, :cond_0

    iget-object p0, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ju:Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ku:Landroid/view/MenuItem;
    ...
    :cond_1
    iget-object p1, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ju:Landroid/view/View;

    new-instance v0, Lcom/miui/internal/view/menu/context/c;

    invoke-direct {v0, p0}, Lcom/miui/internal/view/menu/context/c;-><init>(Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;)V
...
.method private md()I
    ...
    :goto_0
    iget-object v2, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ju:Landroid/view/View;
...
.method protected prepareContentView(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Iu:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Iu:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ju:Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ju:Landroid/view/View;
    ...
    iget-object p1, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Iu:Landroid/widget/LinearLayout;
...
.method public show(Landroid/view/View;Landroid/view/ViewGroup;FF)V
    ...
    iput-object p1, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Gu:Landroid/view/View;
    ...
    iget-object p2, p0, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->Ju:Landroid/view/View;
    ...
    invoke-direct {p0, p1, p3, p4}, Lcom/miui/internal/view/menu/context/ContextMenuPopupWindowImpl;->d(Landroid/view/View;FF)V
