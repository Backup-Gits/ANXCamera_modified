...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/miui/internal/server/CoreJobService$a;,
        Lcom/miui/internal/server/CoreJobService$c;,
        Lcom/miui/internal/server/CoreJobService$b;
    }
.end annotation
...
.field private static final Ub:I = 0x1

.field private static final Vb:I = 0x2
...
.method private a(Lcom/miui/internal/server/CoreJobService$a;)V
    .locals 0
...
.method private static c(Landroid/content/Context;)Landroid/app/job/JobInfo;
    .locals 1
...
.method private static d(Landroid/content/Context;)Landroid/app/job/JobInfo;
    .locals 1
...
.method public static scheduleJobs(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/miui/internal/server/CoreJobService;->c(Landroid/content/Context;)Landroid/app/job/JobInfo;
...
.method public onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    :cond_1
    new-instance v0, Lcom/miui/internal/server/CoreJobService$c;

    invoke-direct {v0, p0, p1}, Lcom/miui/internal/server/CoreJobService$c;-><init>(Landroid/app/job/JobService;Landroid/app/job/JobParameters;)V

    invoke-direct {p0, v0}, Lcom/miui/internal/server/CoreJobService;->a(Lcom/miui/internal/server/CoreJobService$a;)V

    return v2

    :cond_2
    new-instance v0, Lcom/miui/internal/server/CoreJobService$b;

    invoke-direct {v0, p0, p1}, Lcom/miui/internal/server/CoreJobService$b;-><init>(Landroid/app/job/JobService;Landroid/app/job/JobParameters;)V
