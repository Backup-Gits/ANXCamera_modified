...
.field private static final Kb:Ljava/lang/String; = "telocation.idf"

.field private static final Lb:Ljava/lang/String; = "telocation-patch"

.field private static final Mb:Ljava/lang/String; = "telocation-old"

.field private static final Nb:Ljava/lang/String; = "telocation-new"

.field private static final Ob:I = 0x3

.field private static final Pb:Ljava/lang/String; = "ver"

.field private static final Qb:Ljava/lang/String; = "t"

.field private static final Rb:Ljava/lang/String; = "m"

.field private static final SECRET:Ljava/lang/String; = "77eb2e8a5755abd016c0d69ba74b219c"

.field private static final Sb:Ljava/lang/String; = "d101b17c77ff93cs"

.field private static final TAG:Ljava/lang/String; = "TelocationUpdateService"

.field private static final Tb:I = 0x1b4
...
.field private Ib:Landroid/app/DownloadManager;

.field private Jb:Landroid/content/SharedPreferences;
...
.method static synthetic a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcom/miui/internal/server/TelocationUpdateService;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private a(Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;)V
    ...
    iget-wide v1, p1, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Qz:J
    ...
    iget-wide v4, p1, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Qz:J
    ...
    iget-object v3, p0, Lcom/miui/internal/server/TelocationUpdateService;->Ib:Landroid/app/DownloadManager;
    ...
    iget-object v5, p0, Lcom/miui/internal/server/TelocationUpdateService;->Ib:Landroid/app/DownloadManager;

    iget-wide v7, p1, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Qz:J
    ...
    :catch_1
    iget-object v3, p1, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Sz:Ljava/lang/String;
    ...
    iget v5, p1, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Tz:I
    ...
    iget v4, p1, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Tz:I

    if-nez v4, :cond_2

    iget-object v4, p1, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Rz:Ljava/lang/String;

    invoke-virtual {v0}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v4, v3, v0}, Lcom/miui/internal/server/TelocationUpdateService;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v3, p1, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Rz:Ljava/lang/String;

    invoke-virtual {v0}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v3, v0}, Lcom/miui/internal/server/TelocationUpdateService;->h(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/miui/internal/server/TelocationUpdateService;->Ib:Landroid/app/DownloadManager;

    new-array v1, v2, [J

    iget-wide v2, p1, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Qz:J

    aput-wide v2, v1, v6

    invoke-virtual {v0, v1}, Landroid/app/DownloadManager;->remove([J)I

    iget-object p0, p0, Lcom/miui/internal/server/TelocationUpdateService;->Jb:Landroid/content/SharedPreferences;

    invoke-static {p0}, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->a(Landroid/content/SharedPreferences;)V
...
.method private a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/miui/internal/server/TelocationUpdateService;->da()Ljava/io/InputStream;
    ...
    invoke-direct {p0, v2, p2}, Lcom/miui/internal/server/TelocationUpdateService;->g(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-wide v5, p0, Lcom/miui/internal/server/TelocationUpdateService;->Hb:J
    ...
    :try_start_2
    invoke-direct {p0, p1}, Lcom/miui/internal/server/TelocationUpdateService;->k(Z)V
    :try_end_2
...
.method private da()Ljava/io/InputStream;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private h(Ljava/lang/String;)J
    ...
    iget-object p0, p0, Lcom/miui/internal/server/TelocationUpdateService;->Ib:Landroid/app/DownloadManager;
...
.method private h(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-wide v0, p0, Lcom/miui/internal/server/TelocationUpdateService;->Hb:J
...
.method private k(Z)V
    ...
    iget-wide v3, p0, Lcom/miui/internal/server/TelocationUpdateService;->Hb:J
    ...
    invoke-static {v2}, Lcom/miui/internal/server/TelocationUpdateService;->e(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/miui/internal/server/TelocationUpdateService$TelocationUpdateResponse;->x()Z
    ...
    iget-object v0, p1, Lcom/miui/internal/server/TelocationUpdateService$TelocationUpdateActionResponse;->cA:Ljava/lang/String;

    iget-object v2, p1, Lcom/miui/internal/server/TelocationUpdateService$TelocationUpdateActionResponse;->bA:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/miui/internal/server/TelocationUpdateService;->Jb:Landroid/content/SharedPreferences;

    invoke-static {v2}, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->b(Landroid/content/SharedPreferences;)Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;
    ...
    iget-wide v4, v2, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Qz:J
    ...
    iget-wide v6, v2, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Qz:J
    ...
    :cond_1
    invoke-direct {p0, v0}, Lcom/miui/internal/server/TelocationUpdateService;->h(Ljava/lang/String;)J
    ...
    iget-object v11, p1, Lcom/miui/internal/server/TelocationUpdateService$TelocationUpdateActionResponse;->bA:Ljava/lang/String;

    iget-object v12, p1, Lcom/miui/internal/server/TelocationUpdateService$TelocationUpdateActionResponse;->aA:Ljava/lang/String;

    iget v13, p1, Lcom/miui/internal/server/TelocationUpdateService$TelocationUpdateActionResponse;->Tz:I
    ...
    invoke-virtual {v0, p0}, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->c(Landroid/content/SharedPreferences;)V
...
.method public onCreate()V
    ...
    iput-object v0, p0, Lcom/miui/internal/server/TelocationUpdateService;->Ib:Landroid/app/DownloadManager;

    invoke-static {p0}, Landroid/preference/PreferenceManager;->getDefaultSharedPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;

    move-result-object v0

    iput-object v0, p0, Lcom/miui/internal/server/TelocationUpdateService;->Jb:Landroid/content/SharedPreferences;
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    iput-wide v1, p0, Lcom/miui/internal/server/TelocationUpdateService;->Hb:J
    ...
    iget-wide v2, p0, Lcom/miui/internal/server/TelocationUpdateService;->Hb:J
    ...
    :try_start_0
    invoke-direct {p0, v3}, Lcom/miui/internal/server/TelocationUpdateService;->k(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v0, p0, Lcom/miui/internal/server/TelocationUpdateService;->Jb:Landroid/content/SharedPreferences;
    ...
    iget-wide v6, v0, Lcom/miui/internal/server/TelocationUpdateService$DownloadInfo;->Qz:J
