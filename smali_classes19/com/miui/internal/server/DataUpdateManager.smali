...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/miui/internal/server/DataUpdateManager$a;,
...
.field private static final Hz:Ljava/lang/String; = "https://api.comm.miui.com"

.field private static final Iz:Ljava/lang/String; = "http://trial.api.comm.miui.com"

.field private static final Jz:Ljava/lang/String;

.field private static final Kz:I = 0x7530

.field public static final LAST_UPDATE_TIME:Ljava/lang/String; = "last_update_time"

.field private static final Lz:J = 0x240c8400L
...
.method static constructor <clinit>()V
    ...
    :cond_0
    const-string v0, "https://api.comm.miui.com"

    :goto_0
    sput-object v0, Lcom/miui/internal/server/DataUpdateManager;->Jz:Ljava/lang/String;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    sget-object v1, Lcom/miui/internal/server/DataUpdateManager;->Jz:Ljava/lang/String;
...
.method synthetic constructor <init>(Landroid/content/Context;Lcom/miui/internal/server/a;)V
    .locals 0
...
.method private Kd()Z
    ...
    invoke-direct {p0}, Lcom/miui/internal/server/DataUpdateManager;->Jd()Z
...
.method private declared-synchronized Md()V
    .locals 10

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/miui/internal/server/DataUpdateManager;->Fz:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/miui/internal/server/DataUpdateManager;->Fz:Ljava/util/Map;
    ...
    iget-object v7, p0, Lcom/miui/internal/server/DataUpdateManager;->Fz:Ljava/util/Map;
    ...
    iget-object v4, p0, Lcom/miui/internal/server/DataUpdateManager;->Fz:Ljava/util/Map;
...
.method private Nd()V
    ...
    invoke-direct {p0}, Lcom/miui/internal/server/DataUpdateManager;->Md()V

    iget-object v2, p0, Lcom/miui/internal/server/DataUpdateManager;->Fz:Ljava/util/Map;
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/miui/internal/server/DataUpdateManager;->Id()Ljava/lang/String;
    ...
    :try_start_1
    new-instance v3, Lcom/miui/internal/server/DataUpdateManager$a;

    invoke-direct {v3, p0, v2}, Lcom/miui/internal/server/DataUpdateManager$a;-><init>(Lcom/miui/internal/server/DataUpdateManager;Ljava/lang/String;)V

    invoke-virtual {v3}, Lcom/miui/internal/server/DataUpdateManager$a;->toString()Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget v2, v3, Lcom/miui/internal/server/DataUpdateManager$a;->mCode:I
    ...
    iget-object v5, v3, Lcom/miui/internal/server/DataUpdateManager$a;->mData:Lorg/json/JSONObject;
...
.method public static getBaseUrl()Ljava/lang/String;
    ...
    sget-object v0, Lcom/miui/internal/server/DataUpdateManager;->Jz:Ljava/lang/String;
...
.method private getContent()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/miui/internal/server/DataUpdateManager;->Fz:Ljava/util/Map;
...
.method private getUserAgent()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/miui/internal/server/DataUpdateManager;->Gz:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/miui/internal/server/DataUpdateManager;->Gz:Ljava/lang/String;

    :cond_1
    iget-object p0, p0, Lcom/miui/internal/server/DataUpdateManager;->Gz:Ljava/lang/String;
...
.method public update()V
    ...
    invoke-direct {p0}, Lcom/miui/internal/server/DataUpdateManager;->Ld()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/miui/internal/server/DataUpdateManager;->Kd()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/miui/internal/server/DataUpdateManager;->Nd()V
