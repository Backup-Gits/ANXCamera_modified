...
# static fields
.field private static final Fx:Ljava/lang/String; = "plugins-opt"

.field private static final Gx:Ljava/lang/String; = ".apk"

.field private static final Hx:Ljava/lang/String; = ".xml"

.field private static final Ix:Ljava/lang/String; = "PluginManifest.xml"

.field private static final Jx:Ljava/lang/String; = "assets/PluginManifest.xml"

.field private static Kx:Ljava/util/Map;
...
.field private static Lx:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field private static Mx:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/miui/internal/component/plugin/PluginLoader;->Kx:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/miui/internal/component/plugin/PluginLoader;->Lx:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/miui/internal/component/plugin/PluginLoader;->Mx:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/miui/internal/component/plugin/PluginLoader;->Nx:Ljava/util/Map;
...
.method public constructor <init>(Ljava/io/File;)V
    ...
    iput-object p1, p0, Lcom/miui/internal/component/plugin/PluginLoader;->Ex:Ljava/io/File;

    new-instance p1, Ljava/io/File;

    iget-object v0, p0, Lcom/miui/internal/component/plugin/PluginLoader;->Ex:Ljava/io/File;
    ...
    iput-object p1, p0, Lcom/miui/internal/component/plugin/PluginLoader;->lx:Ljava/io/File;

    iget-object p1, p0, Lcom/miui/internal/component/plugin/PluginLoader;->Ex:Ljava/io/File;

    invoke-virtual {p1}, Ljava/io/File;->mkdirs()Z

    iget-object p1, p0, Lcom/miui/internal/component/plugin/PluginLoader;->lx:Ljava/io/File;

    invoke-virtual {p1}, Ljava/io/File;->mkdirs()Z

    invoke-direct {p0}, Lcom/miui/internal/component/plugin/PluginLoader;->xd()V

    invoke-direct {p0}, Lcom/miui/internal/component/plugin/PluginLoader;->zd()V
...
.method private Ad()V
    ...
    :cond_1
    sget-object p0, Lcom/miui/internal/component/plugin/PluginLoader;->Kx:Ljava/util/Map;
    ...
    sget-object p0, Lcom/miui/internal/component/plugin/PluginLoader;->Mx:Ljava/util/Map;
    ...
    sget-object p0, Lcom/miui/internal/component/plugin/PluginLoader;->Nx:Ljava/util/Map;
...
.method private a(Lcom/miui/internal/component/plugin/Plugin;)Ljava/lang/ClassLoader;
    ...
    iget-object p0, p0, Lcom/miui/internal/component/plugin/PluginLoader;->lx:Ljava/io/File;
...
.method private b(Lcom/miui/internal/component/plugin/Plugin;)Landroid/content/res/Resources;
    ...
    sget-object v3, Lcom/miui/internal/component/plugin/PluginLoader;->Kx:Ljava/util/Map;
...
.method private xd()V
    ...
    invoke-direct {p0}, Lcom/miui/internal/component/plugin/PluginLoader;->Ad()V
    ...
    iget-object v5, p0, Lcom/miui/internal/component/plugin/PluginLoader;->Ex:Ljava/io/File;
    ...
    :goto_1
    :try_start_2
    invoke-direct {p0, v4, v3}, Lcom/miui/internal/component/plugin/PluginLoader;->a(Ljava/io/File;Ljava/io/File;)Lcom/miui/internal/component/plugin/Plugin;

    move-result-object v3

    sget-object v4, Lcom/miui/internal/component/plugin/PluginLoader;->Kx:Ljava/util/Map;
...
.method private zd()V
    ...
    sget-object v1, Lcom/miui/internal/component/plugin/PluginLoader;->Kx:Ljava/util/Map;
    ...
    sget-object v3, Lcom/miui/internal/component/plugin/PluginLoader;->Lx:Ljava/util/Map;
    ...
    sget-object v4, Lcom/miui/internal/component/plugin/PluginLoader;->Lx:Ljava/util/Map;
...
.method public getClassLoader(Lcom/miui/internal/component/plugin/Plugin;)Ljava/lang/ClassLoader;
    ...
    sget-object v0, Lcom/miui/internal/component/plugin/PluginLoader;->Mx:Ljava/util/Map;
    ...
    :try_start_0
    sget-object v1, Lcom/miui/internal/component/plugin/PluginLoader;->Mx:Ljava/util/Map;
...
.method public getPlugins(Ljava/lang/String;)Ljava/util/List;
    ...
    sget-object p0, Lcom/miui/internal/component/plugin/PluginLoader;->Lx:Ljava/util/Map;
...
.method public getResources(Lcom/miui/internal/component/plugin/Plugin;)Landroid/content/res/Resources;
    ...
    sget-object v0, Lcom/miui/internal/component/plugin/PluginLoader;->Nx:Ljava/util/Map;
    ...
    :try_start_0
    sget-object v1, Lcom/miui/internal/component/plugin/PluginLoader;->Nx:Ljava/util/Map;
