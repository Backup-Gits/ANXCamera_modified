...
# static fields
.field private static final Je:Lmiui/reflect/Field;

.field private static final Ke:Ljava/lang/reflect/Field;


# instance fields
.field private Ie:Landroid/view/Window;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->Je:Lmiui/reflect/Field;

    invoke-static {}, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class;->y()Ljava/lang/Class;
    ...
    sput-object v0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->Ke:Ljava/lang/reflect/Field;
...
.method private constructor <init>(Landroid/view/LayoutInflater;Landroid/view/Window;)V
    ...
    sget-object v0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->Je:Lmiui/reflect/Field;
    ...
    iput-object p1, p0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->mLayoutInflater:Landroid/view/LayoutInflater;

    iput-object p2, p0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->Ie:Landroid/view/Window;

    return-void
.end method

.method synthetic constructor <init>(Landroid/view/LayoutInflater;Landroid/view/Window;Lcom/miui/internal/variable/v16/j;)V
    .locals 0
...
.method static synthetic a(Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;)Landroid/view/LayoutInflater;
    ...
    iget-object p0, p0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->mLayoutInflater:Landroid/view/LayoutInflater;
...
.method private b(Landroid/content/Context;Landroid/view/View;)V
    ...
    :cond_4
    :try_start_0
    sget-object p1, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->Ke:Ljava/lang/reflect/Field;

    iget-object p0, p0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->Ie:Landroid/view/Window;
...
.method private c(Landroid/content/Context;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->getStatusBarHeight(Landroid/content/Context;)I
...
.method public cloneInContext(Landroid/content/Context;)Landroid/view/LayoutInflater;
    ...
    iget-object v0, p0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->mLayoutInflater:Landroid/view/LayoutInflater;

    invoke-virtual {v0, p1}, Landroid/view/LayoutInflater;->cloneInContext(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p1

    new-instance v0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;

    iget-object p0, p0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->Ie:Landroid/view/Window;

    invoke-direct {v0, p1, p0}, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;-><init>(Landroid/view/LayoutInflater;Landroid/view/Window;)V
...
.method public inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    iget-object p1, p0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->Ie:Landroid/view/Window;
    ...
    :cond_0
    iget-object p3, p0, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->Ie:Landroid/view/Window;

    invoke-virtual {p3}, Landroid/view/Window;->getContext()Landroid/content/Context;

    move-result-object p3

    invoke-direct {p0, p3, p2}, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->c(Landroid/content/Context;Landroid/view/View;)V

    sget v0, Lcom/miui/internal/R$layout;->starting_window_simple:I

    if-ne p1, v0, :cond_1

    invoke-direct {p0, p3, p2}, Lcom/miui/internal/variable/v16/Internal_Policy_Impl_PhoneWindow_class$a;->b(Landroid/content/Context;Landroid/view/View;)V
