...
# instance fields
.field private final mExcludes:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Ljava/lang/String;",
...
.method public varargs constructor <init>(Ljava/lang/String;Lcom/xiaomi/camera/device/callable/CameraListener;Landroid/os/Handler;[Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/xiaomi/camera/device/callable/CloseCameraCallable;->mExcludes:Ljava/util/Set;

    if-eqz p4, :cond_1

    iget-object p2, p0, Lcom/xiaomi/camera/device/callable/CloseCameraCallable;->mExcludes:Ljava/util/Set;
    ...
    iget-object p0, p0, Lcom/xiaomi/camera/device/callable/CloseCameraCallable;->mExcludes:Ljava/util/Set;
...
.method public call()Lcom/xiaomi/camera/device/callable/CallableReturn;
    ...
    iget-object v4, p0, Lcom/xiaomi/camera/device/callable/CloseCameraCallable;->mExcludes:Ljava/util/Set;
    ...
    :cond_1
    iget-object v5, p0, Lcom/xiaomi/camera/device/callable/CloseCameraCallable;->mExcludes:Ljava/util/Set;
