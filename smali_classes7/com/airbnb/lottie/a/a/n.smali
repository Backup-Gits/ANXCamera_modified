...
.field private final xc:Landroid/graphics/Path;

.field private final yc:Landroid/graphics/Path;

.field private final zc:Lcom/airbnb/lottie/model/content/MergePaths;
...
.method public constructor <init>(Lcom/airbnb/lottie/model/content/MergePaths;)V
    ...
    iput-object v0, p0, Lcom/airbnb/lottie/a/a/n;->xc:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lcom/airbnb/lottie/a/a/n;->yc:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Lcom/airbnb/lottie/a/a/n;->nc:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/airbnb/lottie/a/a/n;->zc:Lcom/airbnb/lottie/model/content/MergePaths;
...
.method private a(Landroid/graphics/Path$Op;)V
    ...
    iget-object v0, p0, Lcom/airbnb/lottie/a/a/n;->yc:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v0, p0, Lcom/airbnb/lottie/a/a/n;->xc:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v0, p0, Lcom/airbnb/lottie/a/a/n;->nc:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/airbnb/lottie/a/a/n;->nc:Ljava/util/List;
    ...
    invoke-virtual {v2}, Lcom/airbnb/lottie/a/a/e;->lb()Ljava/util/List;
    ...
    invoke-virtual {v2}, Lcom/airbnb/lottie/a/a/e;->mb()Landroid/graphics/Matrix;

    move-result-object v6

    invoke-virtual {v5, v6}, Landroid/graphics/Path;->transform(Landroid/graphics/Matrix;)V

    iget-object v6, p0, Lcom/airbnb/lottie/a/a/n;->yc:Landroid/graphics/Path;
    ...
    :cond_0
    iget-object v3, p0, Lcom/airbnb/lottie/a/a/n;->yc:Landroid/graphics/Path;
    ...
    invoke-virtual {v0}, Lcom/airbnb/lottie/a/a/e;->lb()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/airbnb/lottie/a/a/e;->mb()Landroid/graphics/Matrix;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/graphics/Path;->transform(Landroid/graphics/Matrix;)V

    iget-object v4, p0, Lcom/airbnb/lottie/a/a/n;->xc:Landroid/graphics/Path;
    ...
    :cond_3
    iget-object v1, p0, Lcom/airbnb/lottie/a/a/n;->xc:Landroid/graphics/Path;
    ...
    iget-object p0, p0, Lcom/airbnb/lottie/a/a/n;->yc:Landroid/graphics/Path;
...
.method private nn()V
    ...
    :goto_0
    iget-object v1, p0, Lcom/airbnb/lottie/a/a/n;->nc:Ljava/util/List;
...
.method public getPath()Landroid/graphics/Path;
    ...
    iget-object v0, p0, Lcom/airbnb/lottie/a/a/n;->zc:Lcom/airbnb/lottie/model/content/MergePaths;
    ...
    :cond_0
    sget-object v0, Lcom/airbnb/lottie/a/a/m;->wc:[I

    iget-object v1, p0, Lcom/airbnb/lottie/a/a/n;->zc:Lcom/airbnb/lottie/model/content/MergePaths;
    ...
    :cond_5
    invoke-direct {p0}, Lcom/airbnb/lottie/a/a/n;->nn()V
