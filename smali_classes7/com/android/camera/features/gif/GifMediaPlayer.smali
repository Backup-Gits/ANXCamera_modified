...
.method private onError()V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/features/gif/i;-><init>(Lcom/android/camera/features/gif/GifMediaPlayer;)V
...
.method private onSuccess(Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/android/camera/features/gif/m;

    invoke-direct {v1, p0, p1}, Lcom/android/camera/features/gif/m;-><init>(Lcom/android/camera/features/gif/GifMediaPlayer;Ljava/lang/String;)V
...
.method public synthetic C(Z)V
    ...
    new-instance v2, Lcom/android/camera/features/gif/k;

    invoke-direct {v2, v0}, Lcom/android/camera/features/gif/k;-><init>(Lcom/android/camera/features/gif/GifMediaPlayer;)V
...
.method public synthetic Q(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/camera/features/gif/GifMediaPlayer;->mSurface:Landroid/view/Surface;
    ...
    :cond_0
    invoke-virtual {p1, v1}, Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;->SetViewSurface(Landroid/view/Surface;)V
...
.method public enableReverseFilter(Z)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/camera/features/gif/j;-><init>(Lcom/android/camera/features/gif/GifMediaPlayer;Z)V
...
.method public enableVideoSegmentFilter(Z)V
    ...
    new-instance v1, Lcom/android/camera/features/gif/g;

    invoke-direct {v1, p0, p1}, Lcom/android/camera/features/gif/g;-><init>(Lcom/android/camera/features/gif/GifMediaPlayer;Z)V
...
.method public isComposing()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/features/gif/GifMediaPlayer;->isPlaying()Z

    move-result v0

    if-eqz v0, :cond_0

    iget v0, p0, Lcom/android/camera/features/gif/GifMediaPlayer;->mCheckErrorState:I
    ...
    invoke-virtual {p0, v2}, Lcom/android/camera/features/gif/GifMediaPlayer;->releaseMedia(Z)V

    iget-object v0, p0, Lcom/android/camera/features/gif/GifMediaPlayer;->mVideoPath:Ljava/lang/String;

    iget-wide v2, p0, Lcom/android/camera/features/gif/GifMediaPlayer;->mDuration:J

    invoke-virtual {p0, v0, v2, v3}, Lcom/android/camera/features/gif/GifMediaPlayer;->setVideoUrl(Ljava/lang/String;J)V

    iput v1, p0, Lcom/android/camera/features/gif/GifMediaPlayer;->mCheckErrorState:I
...
.method public onSurfaceTextureAvailable(Landroid/graphics/SurfaceTexture;II)V
    ...
    iget-object p2, p0, Lcom/android/camera/features/gif/GifMediaPlayer;->mEffectPlayer:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
...
.method public resumePlay()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/features/gif/GifMediaPlayer;->releaseMedia(Z)V

    iget-object v0, p0, Lcom/android/camera/features/gif/GifMediaPlayer;->mVideoPath:Ljava/lang/String;

    iget-wide v1, p0, Lcom/android/camera/features/gif/GifMediaPlayer;->mDuration:J

    invoke-virtual {p0, v0, v1, v2}, Lcom/android/camera/features/gif/GifMediaPlayer;->setVideoUrl(Ljava/lang/String;J)V
...
.method public setVideoUrl(Ljava/lang/String;J)V
    ...
    new-instance p3, Lcom/android/camera/features/gif/o;

    invoke-direct {p3, p0, p1}, Lcom/android/camera/features/gif/o;-><init>(Lcom/android/camera/features/gif/GifMediaPlayer;Ljava/lang/String;)V
...
.method public startVideo2Gif()V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/features/gif/n;-><init>(Lcom/android/camera/features/gif/GifMediaPlayer;)V
