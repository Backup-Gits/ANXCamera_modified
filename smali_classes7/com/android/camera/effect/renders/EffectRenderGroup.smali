...
.method private updatePreviewSecondRender(Z)Z
    ...
    invoke-virtual {v2, p1}, Lcom/android/camera/effect/renders/PipeRender;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    iget-boolean v3, p0, Lcom/android/camera/effect/renders/EffectRenderGroup;->mIsMakeupEnabled:Z
    ...
    :goto_1
    iget-boolean v5, p0, Lcom/android/camera/effect/renders/EffectRenderGroup;->mIsKaleidoscopeEnabled:Z

    if-eqz v5, :cond_6

    sget v5, Lcom/android/camera/effect/FilterInfo;->FILTER_ID_KALEIDOSCOPE:I
    ...
    sget v4, Lcom/android/camera/effect/FilterInfo;->FILTER_ID_ZEBRA:I
    ...
    invoke-virtual {v8, v3}, Lcom/android/camera/effect/renders/PipeRender;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {v3, v5}, Lcom/android/camera/effect/renders/PipeRender;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {v5, v3}, Lcom/android/camera/effect/renders/Render;->setKaleidoscope(Ljava/lang/String;)V
    ...
    iget-object v5, p0, Lcom/android/camera/effect/renders/EffectRenderGroup;->mPreviewSecondRender:Lcom/android/camera/effect/renders/PipeRender;

    invoke-virtual {v5, v2}, Lcom/android/camera/effect/renders/PipeRender;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/camera/effect/renders/PipeRender;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {p1, v7}, Lcom/android/camera/effect/renders/PipeRender;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/camera/effect/renders/PipeRender;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {p1, v2, v3}, Lcom/android/camera/effect/renders/PipeRender;->setFrameBufferSize(II)V
