...
.method private updateCenterTipImage(IILjava/util/List;)V
    ...
    invoke-virtual {v10}, Lcom/android/camera/data/data/extra/DataItemLive;->getMimojiStatusManager2()Lcom/android/camera/features/mimoji2/widget/helper/MimojiStatusManager2;
    ...
    invoke-virtual {v10}, Lcom/android/camera/features/mimoji2/widget/helper/MimojiStatusManager2;->setCurrentMimojiCloseState()V

    goto :goto_0

    :cond_1
    invoke-virtual {v10}, Lcom/android/camera/features/mimoji2/widget/helper/MimojiStatusManager2;->isInMimojiPreview()Z

    move-result v4

    if-eqz v4, :cond_5

    invoke-virtual {v10}, Lcom/android/camera/features/mimoji2/widget/helper/MimojiStatusManager2;->getMimojiPanelState()I
    ...
    invoke-virtual {v4}, Lcom/android/camera/module/impl/component/MimojiStatusManager;->setCurrentMimojiCloseState()V
...
.method private updateLeftTipImage(IIILjava/util/List;)V
    ...
    invoke-virtual {v4, v1}, Lcom/android/camera/data/data/runing/ComponentRunningShine;->isVideoShineForceOn(I)Z
    ...
    invoke-interface {v4}, Lcom/android/camera/protocol/ModeProtocol$MiBeautyProtocol;->isTargetShow()Z
    ...
    invoke-virtual {v4}, Lcom/mi/config/a;->Kk()Z
    ...
    invoke-virtual {v4}, Lcom/mi/config/a;->Jk()Z
    ...
    :goto_d
    invoke-virtual {v8, v5}, Lcom/android/camera/ui/ColorImageView;->setColor(I)V
...
.method private updateSpeedTipImage(IILjava/util/List;)V
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->Ch()Z
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-virtual {v12, v5}, Lcom/android/camera/protocol/ModeCoordinatorImpl;->getAttachProtocol(I)Lcom/android/camera/protocol/ModeProtocol$BaseProtocol;
    ...
    invoke-interface {v5, p0}, Lcom/android/camera/protocol/ModeProtocol$ModeChangeController;->changeCamera([Landroid/view/View;)V
    ...
    :cond_e
    invoke-virtual {p0, v4}, Lcom/android/camera/fragment/FragmentBottomPopupTips;->showMimojiPanel(I)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/camera/fragment/FragmentBottomPopupTips;->showMimojiPanel(I)V
...
.method public reConfigBottomTipOfUltraWide()V
    ...
    invoke-static {p0, v0}, Lcom/android/camera/HybridZoomingSystem;->getZoomRatioHistory(ILjava/lang/String;)Ljava/lang/String;
