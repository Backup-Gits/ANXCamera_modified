...
.method private getAIWatermarkData()Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {v0, v2, v2, v4, v3}, Lcom/android/camera/data/data/ComponentDataItem;-><init>(IIILjava/lang/String;)V
...
.method public getComponentRunningAIWatermark()Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;
    ...
    new-instance v0, Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;

    invoke-direct {p0}, Lcom/android/camera/data/data/runing/DataItemRunning;->getAIWatermarkData()Ljava/util/ArrayList;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;-><init>(Lcom/android/camera/data/data/runing/DataItemRunning;Ljava/util/ArrayList;)V

    iput-object v0, p0, Lcom/android/camera/data/data/runing/DataItemRunning;->mComponentRunningAIWatermark:Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;
...
.method public reInitComponent(IILcom/android/camera2/CameraCapabilities;Z)V
    ...
    invoke-virtual {v0, p2, p4}, Lcom/android/camera/data/data/runing/ComponentRunningAutoZoom;->reInit(IZ)V
...
.method public reInitSupport(II)V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->isSupportMacroMode()Z
    ...
    :cond_6
    iput-boolean v4, p0, Lcom/android/camera/data/data/runing/DataItemRunning;->mSupportMacroMode:Z
    ...
    sget-boolean p2, Lcom/mi/config/b;->gh:Z
