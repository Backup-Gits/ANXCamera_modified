...
.method public resetAIWatermark(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;->setIWatermarkEnable(Z)V
    ...
    :cond_0
    const-string p0, "ai_trigger"

    sput-object p0, Lcom/android/camera/aiwatermark/util/WatermarkConstant;->SELECT_KEY:Ljava/lang/String;

    invoke-static {v0}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object p0

    sput-object p0, Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;->mCurrentType:Ljava/lang/String;
