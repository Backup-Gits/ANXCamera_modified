...
.field mUpdateList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lmiui/animation/internal/AnimNotifiers$BaseUpdateNotify;->mUpdateList:Ljava/util/List;
...
.method public bridge synthetic doNotify(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lmiui/animation/internal/AnimNotifiers$BaseUpdateNotify;->doNotify(Lmiui/animation/listener/TransitionListener;)V

    return-void
.end method

.method public doNotify(Lmiui/animation/listener/TransitionListener;)V
    .locals 2

    iget-object v0, p0, Lmiui/animation/internal/AnimNotifiers$BaseUpdateNotify;->mTag:Ljava/lang/Object;

    iget-object v1, p0, Lmiui/animation/internal/AnimNotifiers$BaseUpdateNotify;->mUpdateList:Ljava/util/List;

    invoke-virtual {p0, p1, v0, v1}, Lmiui/animation/internal/AnimNotifiers$BaseUpdateNotify;->doNotify(Lmiui/animation/listener/TransitionListener;Ljava/lang/Object;Ljava/util/List;)V

    return-void
.end method

.method abstract doNotify(Lmiui/animation/listener/TransitionListener;Ljava/lang/Object;Ljava/util/List;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lmiui/animation/listener/TransitionListener;",
...
.method public onNotifyEnd()V
    ...
    iget-object v0, p0, Lmiui/animation/internal/AnimNotifiers$BaseUpdateNotify;->mUpdateList:Ljava/util/List;
...
.method setInfo(Ljava/lang/Object;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p0, Lmiui/animation/internal/AnimNotifiers$BaseUpdateNotify;->mUpdateList:Ljava/util/List;
    ...
    iget-object p0, p0, Lmiui/animation/internal/AnimNotifiers$BaseUpdateNotify;->mUpdateList:Ljava/util/List;
...
.method varargs setUpdate(Ljava/lang/Object;[Lmiui/animation/listener/UpdateInfo;)V
    .locals 0
