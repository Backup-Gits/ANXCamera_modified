...
.field private volatile mRunningTime:J
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lmiuix/animation/internal/AnimRunner;->mRatio:F
...
.method static synthetic access$100(Lmiuix/animation/internal/AnimRunner;Lmiuix/animation/internal/AnimTask;JJ[J)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lmiuix/animation/internal/AnimRunner;->runAnim(Lmiuix/animation/internal/AnimTask;JJ[J)V

    return-void
.end method

.method static synthetic access$200(Lmiuix/animation/internal/AnimRunner;Lmiuix/animation/IAnimTarget;)V
    .locals 0
...
.method static synthetic access$300(Lmiuix/animation/internal/AnimRunner;)J
    .locals 2

    iget-wide v0, p0, Lmiuix/animation/internal/AnimRunner;->mRunningTime:J

    return-wide v0
.end method

.method static synthetic access$400(Lmiuix/animation/internal/AnimRunner;)V
    .locals 0
...
.method private endAnimation()Z
    ...
    iput-wide v0, p0, Lmiuix/animation/internal/AnimRunner;->mRunningTime:J

    iput-wide v0, p0, Lmiuix/animation/internal/AnimRunner;->mLastFrameTime:J
...
.method private isRunning()Z
    ...
    invoke-virtual {p0, v1}, Lmiuix/animation/internal/AnimRunner;->isAnimRunning(Lmiuix/animation/IAnimTarget;)Z
...
.method private updateRunningTime(J)J
    ...
    invoke-virtual {p0, v2, v3}, Lmiuix/animation/internal/AnimRunner;->getAverageDelta(J)J
...
.method public doAnimationFrame(J)Z
    ...
    iget-wide v7, p0, Lmiuix/animation/internal/AnimRunner;->mRunningTime:J
    ...
    check-cast v10, Lmiuix/animation/IAnimTarget;

    invoke-virtual {v10}, Lmiuix/animation/IAnimTarget;->allowAnimRun()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {v10}, Lmiuix/animation/IAnimTarget;->getAnimTask()Lmiuix/animation/internal/AnimTask;
    ...
    new-instance v11, Lmiuix/animation/internal/AnimRunner$2;
    ...
    invoke-direct/range {v0 .. v6}, Lmiuix/animation/internal/AnimRunner$2;-><init>(Lmiuix/animation/internal/AnimRunner;Lmiuix/animation/IAnimTarget;JJ)V

    invoke-virtual {v10, v11}, Lmiuix/animation/IAnimTarget;->post(Ljava/lang/Runnable;)V

    :cond_0
    invoke-direct {p0, v10}, Lmiuix/animation/internal/AnimRunner;->cleanOneshotTarget(Lmiuix/animation/IAnimTarget;)V
...
.method public varargs end(Lmiuix/animation/IAnimTarget;[Lmiuix/animation/property/FloatProperty;)V
    ...
    new-instance v0, Lmiuix/animation/internal/AnimRunner$4;

    invoke-direct {v0, p0, p1, p2}, Lmiuix/animation/internal/AnimRunner$4;-><init>(Lmiuix/animation/internal/AnimRunner;Lmiuix/animation/IAnimTarget;[Lmiuix/animation/property/FloatProperty;)V
...
.method isAnimRunning(Lmiuix/animation/IAnimTarget;)Z
    .locals 0
...
.method public run(Lmiuix/animation/IAnimTarget;Lmiuix/animation/controller/AnimState;Lmiuix/animation/controller/AnimState;Lmiuix/animation/base/AnimConfigLink;)V
    ...
    new-instance v6, Lmiuix/animation/internal/AnimRunner$5;
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/animation/internal/AnimRunner$5;-><init>(Lmiuix/animation/internal/AnimRunner;Lmiuix/animation/IAnimTarget;Lmiuix/animation/controller/AnimState;Lmiuix/animation/controller/AnimState;Lmiuix/animation/base/AnimConfigLink;)V
...
.method public setTimeRatio(F)V
    ...
    iput p1, p0, Lmiuix/animation/internal/AnimRunner;->mRatio:F
