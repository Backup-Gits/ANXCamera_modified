...
.method public constructor <init>(Lmiuix/animation/IAnimTarget;)V
    ...
    iput-object v0, p0, Lmiuix/animation/listener/ListenerNotifier;->mPendingList:Ljava/util/List;
...
.method private notifyByType(ILjava/lang/Object;Lmiuix/animation/listener/UpdateInfo;Ljava/util/Collection;)V
    ...
    new-instance p3, Lmiuix/animation/listener/ListenerNotifier$PendingNotify;

    invoke-direct {p3, p2, p1}, Lmiuix/animation/listener/ListenerNotifier$PendingNotify;-><init>(Ljava/lang/Object;I)V

    iput-object p3, p0, Lmiuix/animation/listener/ListenerNotifier;->mCurNotify:Lmiuix/animation/listener/ListenerNotifier$PendingNotify;

    invoke-direct {p0, p2, p1, v0}, Lmiuix/animation/listener/ListenerNotifier;->notifyListener(Ljava/lang/Object;ILmiuix/animation/listener/ListenerNotifier$NotifyData;)V

    iget-object p1, p0, Lmiuix/animation/listener/ListenerNotifier;->mPendingList:Ljava/util/List;
    ...
    check-cast p2, Lmiuix/animation/listener/ListenerNotifier$PendingNotify;

    iget p3, p2, Lmiuix/animation/listener/ListenerNotifier$PendingNotify;->what:I

    iget-object p4, p2, Lmiuix/animation/listener/ListenerNotifier$PendingNotify;->tag:Ljava/lang/Object;

    invoke-direct {p0, p3, p4}, Lmiuix/animation/listener/ListenerNotifier;->getNotifyData(ILjava/lang/Object;)Lmiuix/animation/listener/ListenerNotifier$NotifyData;

    move-result-object p3

    iget-object p4, p2, Lmiuix/animation/listener/ListenerNotifier$PendingNotify;->tag:Ljava/lang/Object;

    iget p2, p2, Lmiuix/animation/listener/ListenerNotifier$PendingNotify;->what:I

    invoke-direct {p0, p4, p2, p3}, Lmiuix/animation/listener/ListenerNotifier;->notifyListener(Ljava/lang/Object;ILmiuix/animation/listener/ListenerNotifier$NotifyData;)V
    ...
    iget-object p0, p0, Lmiuix/animation/listener/ListenerNotifier;->mPendingList:Ljava/util/List;
    ...
    iget-object p3, p0, Lmiuix/animation/listener/ListenerNotifier;->mPendingList:Ljava/util/List;
...
.method private notifyListener(Ljava/lang/Object;ILmiuix/animation/listener/ListenerNotifier$NotifyData;)V
    ...
    iget-object v1, p3, Lmiuix/animation/listener/ListenerNotifier$NotifyData;->updateList:Ljava/util/List;

    invoke-virtual {v0, p0, p1, v1}, Lmiuix/animation/listener/ListenerNotifier$BaseNotifier;->notify(Lmiuix/animation/listener/ListenerNotifier$ListenerNode;Ljava/lang/Object;Ljava/util/List;)V

    goto :goto_0

    :cond_1
    iget-object p0, p3, Lmiuix/animation/listener/ListenerNotifier$NotifyData;->updateList:Ljava/util/List;
...
.method public clear()V
    ...
    iget-object v0, p0, Lmiuix/animation/listener/ListenerNotifier;->mPendingList:Ljava/util/List;
...
.method public setListeners(Ljava/lang/Object;Lmiuix/animation/base/AnimConfigLink;)Z
    ...
    const-string v0, "setListeners for "

    invoke-virtual {p2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v0, p0, Lmiuix/animation/listener/ListenerNotifier;->mTarget:Lmiuix/animation/IAnimTarget;
