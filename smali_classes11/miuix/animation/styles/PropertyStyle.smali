...
.method private applyDelayedAnimConfig(FD)V
    ...
    invoke-direct {p0, v1, p1, v4, v5}, Lmiuix/animation/styles/PropertyStyle;->doPhysicsCalculation([DFD)V
...
.method private doFinishProcess()V
    ...
    invoke-static {v0}, Lmiuix/animation/physics/PhysicsUtil;->willStop(Lmiuix/animation/physics/PhysicsOperator;)Z
    ...
    :cond_0
    invoke-direct {p0}, Lmiuix/animation/styles/PropertyStyle;->getTargetDoubleValue()D
    ...
    invoke-virtual {v2, v6}, Lmiuix/animation/IAnimTarget;->getMinVisibleChange(Ljava/lang/Object;)F
    ...
    iget-object v9, p0, Lmiuix/animation/styles/PropertyStyle;->mProperty:Lmiuix/animation/property/FloatProperty;
...
.method private updatePhysicsAnim(J)V
    ...
    invoke-direct {p0, p2, p1, v2, v3}, Lmiuix/animation/styles/PropertyStyle;->doPhysicsCalculation([DFD)V
    ...
    invoke-virtual {p0, v4, v5, v6, v7}, Lmiuix/animation/styles/PropertyStyle;->isAnimRunning(DD)Z
    ...
    iget-object v4, p0, Lmiuix/animation/styles/PropertyStyle;->mProperty:Lmiuix/animation/property/FloatProperty;

    iget-object v5, p0, Lmiuix/animation/styles/PropertyStyle;->mVV:[D

    aget-wide v5, v5, v1

    invoke-virtual {p2, v4, v5, v6}, Lmiuix/animation/IAnimTarget;->setVelocity(Lmiuix/animation/property/FloatProperty;D)V
    ...
    invoke-direct {p0, p1, v2, v3}, Lmiuix/animation/styles/PropertyStyle;->applyDelayedAnimConfig(FD)V
...
.method protected isAnimRunning(DD)Z
    ...
    iget-object p0, p0, Lmiuix/animation/styles/PropertyStyle;->mEquilibrium:Lmiuix/animation/physics/EquilibriumChecker;

    invoke-virtual {p0, p1, p2, p3, p4}, Lmiuix/animation/physics/EquilibriumChecker;->isAtEquilibrium(DD)Z
...
.method public varargs setIntValues([I)V
    ...
    :goto_0
    invoke-direct {p0}, Lmiuix/animation/styles/PropertyStyle;->setEquilibriumChecker()V
