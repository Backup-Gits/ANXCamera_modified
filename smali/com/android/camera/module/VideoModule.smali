...
.field protected mDualVideoControler:Lcom/android/camera/doublevideo/DualVideoControler;
...
.method static synthetic access$500(Lcom/android/camera/module/VideoModule;)Landroid/media/MediaRecorder;
    .locals 0
...
.method private getRecorderMaxFileSize(I)J
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->Yh()Z
...
.method private initHistogramEmitter()V
    ...
    invoke-direct {v1, v2}, Lcom/android/camera/module/loader/FunctionParseHistogramStats;-><init>(Lcom/android/camera/protocol/ModeProtocol$TopAlert;)V
...
.method private onMediaRecorderReleased()V
    ...
    iget-object v2, p0, Lcom/android/camera/module/BaseModule;->mTelephonyManager:Landroid/telephony/TelephonyManager;
...
.method private onStartRecorderSucceed()V
    ...
    iput-object v3, p0, Lcom/android/camera/module/VideoModule;->mVideoTagFileName:Ljava/lang/String;

    iget-boolean v3, p0, Lcom/android/camera/module/VideoModule;->mIsVideoTagSupported:Z

    if-eqz v3, :cond_2

    iget-object v3, p0, Lcom/android/camera/module/VideoModule;->mVideoTagFileName:Ljava/lang/String;
    ...
    :goto_0
    invoke-interface {v0, v3}, Lcom/android/camera/protocol/ModeProtocol$MainContentProtocol;->processingStart(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->eh()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Mg()F
    ...
    invoke-interface {v0, v1, v2}, Lcom/android/camera/protocol/ModeProtocol$MainContentProtocol;->updateZoomRatio(FF)V
...
.method private postProcessVideo(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lcom/mi/config/a;->mi()Z
    ...
    invoke-virtual {v9}, Lcom/mi/config/a;->mi()Z
...
.method private setupRecorder(Landroid/media/MediaRecorder;)V
    ...
    invoke-virtual {v3}, Lcom/mi/config/a;->kh()Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->kh()Z
    ...
    invoke-virtual {v5}, Lcom/mi/config/a;->Yh()Z
...
.method private startRecorder()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->Ui()Z
...
.method private updateFrontMirror()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Aj()Z
...
.method private updateHFRDeflicker()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->mi()Z
...
.method public varargs consumePreference([I)V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->kh()Z
...
.method protected onCameraOpened()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/module/VideoModule;->startPreviewSession()V
...
.method public onPauseButtonClick()V
    ...
    invoke-virtual {v1}, Lcom/android/camera/ui/VideoTagView;->resume()V
...
.method protected readVideoPreferences()V
    ...
    const v4, 0x7f10118b    # 1.9149992E38f
    ...
    invoke-direct {v4, p0}, Lcom/android/camera/module/Q;-><init>(Lcom/android/camera/module/VideoModule;)V
    ...
    invoke-virtual {v5, v4}, Lcom/android/camera/data/data/ComponentData;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->ci()Z
    ...
    iput v6, p0, Lcom/android/camera/module/VideoBase;->mMaxVideoDurationInMs:I
...
.method public stopVideoRecording(ZZ)V
    ...
    :cond_1
    iput-boolean v3, v0, Lcom/android/camera/module/BaseModule;->mMediaRecorderRecording:Z
    ...
    invoke-interface {v2}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->getVideoTag()Lcom/android/camera/ui/VideoTagView;
    ...
    invoke-virtual {v2}, Lcom/android/camera/ui/VideoTagView;->stop()V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->el()Z
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Mg()F
...
.method public takeVideoSnapShoot()Z
    ...
    invoke-virtual {v1, v3, v0}, Lcom/android/camera/doublevideo/DualVideoControler;->captureVideoSnapshot(Lcom/android/camera/module/VideoModule$JpegPictureCallback;I)V
...
.method public updateManualEvAdjust()V
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/camera/module/T;-><init>(Lcom/android/camera/module/VideoModule;Z)V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/module/S;-><init>(Lcom/android/camera/module/VideoModule;)V
...
.method protected updateRecordingTime()V
    ...
    :goto_3
    iget-object v4, p0, Lcom/android/camera/module/BaseModule;->mTopAlert:Lcom/android/camera/protocol/ModeProtocol$TopAlert;
