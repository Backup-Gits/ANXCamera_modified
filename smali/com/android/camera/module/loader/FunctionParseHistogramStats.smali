...
.method public constructor <init>(Lcom/android/camera/protocol/ModeProtocol$TopAlert;)V
    ...
    iput-object v0, p0, Lcom/android/camera/module/loader/FunctionParseHistogramStats;->mTopAlertProtocolWeakReference:Ljava/lang/ref/WeakReference;
...
.method public apply(Landroid/hardware/camera2/CaptureResult;)[I
    ...
    invoke-static {p1}, Lcom/android/camera2/CaptureResultParser;->isHistogramStatsEnabled(Landroid/hardware/camera2/CaptureResult;)Z

    move-result v1

    if-nez v1, :cond_3

    sget-boolean v1, Lcom/mi/config/b;->lh:Z

    if-nez v1, :cond_2

    sget-boolean v1, Lcom/mi/config/b;->mh:Z
