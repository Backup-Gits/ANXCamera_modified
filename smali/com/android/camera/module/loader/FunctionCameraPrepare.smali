...
.method private reconfigureData()V
    ...
    invoke-virtual {v6, v11}, Lcom/android/camera/data/data/config/ComponentConfigFlash;->getDefaultValue(I)Ljava/lang/String;

    move-result-object v11

    invoke-interface {v7, v2, v11}, Lcom/android/camera/data/provider/DataProvider$ProviderEditor;->putString(Ljava/lang/String;Ljava/lang/String;)Lcom/android/camera/data/provider/DataProvider$ProviderEditor;
    ...
    invoke-virtual {v1, v11, v2}, Lcom/android/camera/data/data/DataItemBase;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v8, v11}, Lcom/android/camera/data/provider/DataProvider$ProviderEditor;->remove(Ljava/lang/String;)Lcom/android/camera/data/provider/DataProvider$ProviderEditor;
    ...
    invoke-virtual {v2, v13}, Lcom/android/camera/data/data/ComponentData;->getPersistValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v2, v11}, Lcom/android/camera/data/data/ComponentData;->getComponentValue(I)Ljava/lang/String;
    ...
    check-cast v13, Lcom/android/camera/data/data/ComponentDataItem;

    iget-object v13, v13, Lcom/android/camera/data/data/ComponentDataItem;->mValue:Ljava/lang/String;
    ...
    invoke-virtual {v4, v11, v2}, Lcom/android/camera/data/data/DataItemBase;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v13}, Lcom/mi/config/a;->Mk()Z
    ...
    invoke-virtual {v13}, Lcom/mi/config/a;->Ek()Z
    ...
    :goto_5
    invoke-static {v2, v13}, Lcom/android/camera/Util;->isStringValueContained(Ljava/lang/Object;I)Z
    ...
    invoke-virtual {v1, v2, v11}, Lcom/android/camera/data/data/DataItemBase;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    invoke-static {v11}, Lcom/android/camera/Util;->isValidValue(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->vj()Z
    ...
    :goto_7
    invoke-virtual {v1, v14}, Lcom/android/camera/data/data/global/DataItemGlobal;->setCameraIdTransient(I)V
    ...
    invoke-direct {v0, v11, v6}, Lcom/android/camera/module/loader/FunctionCameraPrepare;->resetFlash(Lcom/android/camera/data/data/config/ComponentConfigFlash;Lcom/android/camera/data/provider/DataProvider$ProviderEditor;)V
    ...
    invoke-direct {v0, v11, v6}, Lcom/android/camera/module/loader/FunctionCameraPrepare;->resetHdr(Lcom/android/camera/data/data/config/ComponentConfigHdr;Lcom/android/camera/data/provider/DataProvider$ProviderEditor;)V
    ...
    invoke-direct {v0, v11, v6}, Lcom/android/camera/module/loader/FunctionCameraPrepare;->resetFrontBokenh(Lcom/android/camera/data/data/config/ComponentConfigBokeh;Lcom/android/camera/data/provider/DataProvider$ProviderEditor;)V
    ...
    invoke-direct {v0, v11, v6}, Lcom/android/camera/module/loader/FunctionCameraPrepare;->resetBeautyTransientAndVideoPersist(Lcom/android/camera/data/data/config/ComponentConfigBeauty;Lcom/android/camera/data/provider/DataProvider$ProviderEditor;)V
    ...
    invoke-direct {v0, v11, v6}, Lcom/android/camera/module/loader/FunctionCameraPrepare;->resetCinematicAspectRatio(Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;Lcom/android/camera/data/provider/DataProvider$ProviderEditor;)V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Gi()Z
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Pi()Z
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Ai()Z
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Mk()Z
    ...
    invoke-interface {v7, v2, v6}, Lcom/android/camera/data/provider/DataProvider$ProviderEditor;->putString(Ljava/lang/String;Ljava/lang/String;)Lcom/android/camera/data/provider/DataProvider$ProviderEditor;
    ...
    invoke-virtual {v2, v3, v6}, Lcom/android/camera/data/data/runing/ComponentRunningLighting;->checkValueValid(ILjava/lang/String;)Z
    ...
    invoke-virtual {v2, v3, v6}, Lcom/android/camera/data/data/ComponentData;->setComponentValue(ILjava/lang/String;)V
