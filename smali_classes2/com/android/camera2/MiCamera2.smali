...
.method static constructor <clinit>()V
    ...
    :cond_0
    sget-boolean v0, Lcom/mi/config/b;->kh:Z
...
.method public constructor <init>(ILandroid/hardware/camera2/CameraDevice;Lcom/android/camera2/CameraCapabilities;Landroid/os/Handler;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/android/camera2/MiCamera2;->mVideoRecordStateLock:Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->Xh()Z
...
.method private applyFlashMode(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    :cond_1
    sget-boolean v10, Lcom/mi/config/b;->kh:Z
    ...
    sget-boolean v16, Lcom/mi/config/b;->gh:Z
...
.method private captureStillPicture()V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Xg()I
    ...
    invoke-direct {p0}, Lcom/android/camera2/MiCamera2;->useParallelVTCameraSnapshot()Z

    move-result v2

    invoke-direct {v0, p0, v1, v2}, Lcom/android/camera2/MiCamera2ShotParallelStill;-><init>(Lcom/android/camera2/MiCamera2;Landroid/hardware/camera2/CaptureResult;Z)V
...
.method private configMaxParallelRequestNumberLock()V
    ...
    sget-boolean v1, Lcom/mi/config/b;->bh:Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Sg()I
...
.method private getCaptureInterval()J
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Wg()J
...
.method private prepareRemoteImageReader(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v15}, Lcom/android/camera/module/loader/camera2/Camera2DataContainer;->getUltraWideCameraId()I

    move-result v15

    if-ne v14, v15, :cond_5

    iget-object v9, v0, Lcom/android/camera2/MiCamera2;->mConfigs:Lcom/android/camera2/CameraConfigs;

    invoke-virtual {v9}, Lcom/android/camera2/CameraConfigs;->getUltraWidePhotoSize()Lcom/android/camera/CameraSize;
    ...
    sget v19, Lcom/android/camera2/MiCamera2;->MAX_IMAGE_BUFFER_SIZE:I
    ...
    invoke-direct/range {v14 .. v19}, Lcom/xiaomi/protocol/IImageReaderParameterSets;-><init>(IIIII)V
    ...
    iput-boolean v4, v13, Lcom/xiaomi/protocol/IImageReaderParameterSets;->isParallel:Z
    ...
    invoke-virtual {v7}, Lcom/android/camera2/CameraConfigs;->getWidePhotoSize()Lcom/android/camera/CameraSize;
    ...
    invoke-virtual {v7}, Lcom/android/camera2/CameraConfigs;->getTelePhotoSize()Lcom/android/camera/CameraSize;
    ...
    invoke-virtual {v7}, Lcom/android/camera2/CameraConfigs;->getStandalonePhotoSize()Lcom/android/camera/CameraSize;
    ...
    invoke-virtual {v7}, Lcom/android/camera2/CameraConfigs;->getMacroPhotoSize()Lcom/android/camera/CameraSize;
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->ej()Z
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Th()Z
    ...
    invoke-direct/range {v5 .. v10}, Lcom/xiaomi/protocol/IImageReaderParameterSets;-><init>(IIIII)V
    ...
    const-string v5, "prepareRemoteImageReader: tuningSize = "
...
.method private triggerCapture()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->rk()Z
...
.method private triggerDeviceChecking(ZZ)V
    ...
    sget-boolean v0, Lcom/mi/config/b;->zh:Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->pi()Z
...
.method private triggerPrecapture()V
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->Kj()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->Lj()Z
...
.method private useParallelVTCameraSnapshot()Z
    .locals 4
    ...
    invoke-virtual {v2}, Lcom/android/camera2/CameraCapabilities;->isSupportParallelCameraDevice()Z
...
.method public close()Z
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->vi()Z
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->ei()Z
...
.method public getSATSubCameraIds()[I
    ...
    invoke-virtual {p0}, Lcom/mi/config/a;->ej()Z
...
.method public getSatMasterCameraId()I
    ...
    sget-boolean v1, Lcom/mi/config/b;->Vg:Z
...
.method protected onCapturePictureFinished(ZLcom/android/camera2/MiCamera2Shot;)V
    ...
    invoke-virtual {v6}, Lcom/mi/config/a;->Vg()I
...
.method public sendSatFallbackDisableRequest(Z)I
    .locals 3
    ...
    const-string v2, "sendSatFallbackDisableRequest: E,,"
    ...
    invoke-static {v0, v1, p1}, Lcom/android/camera2/CaptureRequestBuilder;->applySatFallbackDisable(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/CameraCapabilities;Z)V
    ...
    const-string v1, "sendSatFallbackDisableRequest: X. requestId = "
...
.method public setDodepurpleEnabled(Z)V
    ...
    invoke-static {p1, v1, v0, p0}, Lcom/android/camera2/CaptureRequestBuilder;->applyDepurpleEnable(Landroid/hardware/camera2/CaptureRequest$Builder;ILcom/android/camera2/CameraCapabilities;Lcom/android/camera2/CameraConfigs;)V
...
.method public setOpticalZoomToTele(Z)V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->tj()Z
...
.method public startHighSpeedRecordSession(Landroid/view/Surface;Landroid/view/Surface;Landroid/util/Range;Lcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    invoke-virtual {p3}, Lcom/mi/config/a;->Cj()Z
    ...
    invoke-virtual {p2}, Lcom/mi/config/a;->Cj()Z
    ...
    invoke-virtual {p2}, Lcom/mi/config/a;->rh()Z
...
.method public startHighSpeedRecording()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->xg()Z
...
.method public startPreviewSession(Landroid/view/Surface;ZZZIZLcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    const-string v10, "startPreviewSession: opMode=0x%x previewCallback=%b configRawStream=%b"
    ...
    iput-object v8, v1, Lcom/android/camera2/MiCamera2;->mParallelCaptureSurfaceList:Ljava/util/List;
    ...
    iget-object v14, v1, Lcom/android/camera2/MiCamera2;->mParallelCaptureSurfaceList:Ljava/util/List;
    ...
    :cond_4
    iget-object v10, v1, Lcom/android/camera2/MiCamera2;->mParallelCaptureSurfaceList:Ljava/util/List;
    ...
    invoke-static {v11, v10}, Lcom/android/camera/lib/compatibility/util/CompatibilityUtils;->setPhysicalCameraId(Landroid/hardware/camera2/params/OutputConfiguration;Ljava/lang/String;)V
    ...
    const-string v13, "Binds sub output stream to camera "
    ...
    invoke-direct {v1, v2, v8, v10}, Lcom/android/camera2/MiCamera2;->preparePreviewImageReader(Lcom/android/camera/CameraSize;II)V
    ...
    const-string v10, "startPreviewSession: needsRawStream = "
    ...
    invoke-direct {v8, v2, v6, v10}, Landroid/hardware/camera2/params/InputConfiguration;-><init>(III)V
    ...
    iget v6, v1, Lcom/android/camera2/MiCamera2;->mSessionId:I

    move-object/from16 v10, p7

    invoke-direct {v2, v1, v6, v10}, Lcom/android/camera2/MiCamera2$CaptureSessionStateCallback;-><init>(Lcom/android/camera2/MiCamera2;ILcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    invoke-direct {v6, v10}, Landroid/graphics/SurfaceTexture;-><init>(Z)V

    iput-object v6, v1, Lcom/android/camera2/MiCamera2;->mFakeOutputTexture:Landroid/graphics/SurfaceTexture;

    iget-boolean v6, v1, Lcom/android/camera2/MiCamera2;->mSetRepeatingEarly:Z

    if-eqz v6, :cond_d

    iget-object v6, v1, Lcom/android/camera2/MiCamera2;->mFakeOutputTexture:Landroid/graphics/SurfaceTexture;

    iget v10, v2, Lcom/android/camera/CameraSize;->width:I

    iget v2, v2, Lcom/android/camera/CameraSize;->height:I

    invoke-virtual {v6, v10, v2}, Landroid/graphics/SurfaceTexture;->setDefaultBufferSize(II)V
    ...
    iget-object v10, v1, Lcom/android/camera2/MiCamera2;->mPreviewRequestBuilder:Landroid/hardware/camera2/CaptureRequest$Builder;

    invoke-virtual {v10, v2}, Landroid/hardware/camera2/CaptureRequest$Builder;->addTarget(Landroid/view/Surface;)V
    ...
    invoke-direct {v6, v10, v2}, Landroid/hardware/camera2/params/OutputConfiguration;-><init>(Landroid/util/Size;Ljava/lang/Class;)V
    ...
    invoke-interface {v2, v10, v6}, Ljava/util/List;->add(ILjava/lang/Object;)V
    ...
    const-string v10, "startPreviewSession: add preview surface to HAL: "

    invoke-virtual {v6, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v10, v1, Lcom/android/camera2/MiCamera2;->mPreviewSurface:Landroid/view/Surface;
    ...
    invoke-virtual {v2, v3, v10}, Lcom/android/camera2/CaptureSessionConfigurations;->set(Lcom/android/camera2/vendortag/VendorTag;Ljava/lang/Object;)V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Ni()Z
    ...
    invoke-static {v2, v6}, Lcom/android/camera2/compat/MiCameraCompat;->applyFeatureMode(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Ck()Z
...
.method public useSingleCaptureForHdrPlusMfnr()Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Rj()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera2/CameraConfigs;->isRearBokehEnabled()Z
