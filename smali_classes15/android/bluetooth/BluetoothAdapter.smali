...
.method static synthetic access$100(Landroid/bluetooth/BluetoothAdapter;)Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    .locals 1
...
.method public disableBLE()Z
    ...
    :cond_1
    const-string v2, "disableBLE(): Already disabled"
    ...
    invoke-interface {v4, v5, v1, v2}, Landroid/bluetooth/IBluetoothManager;->updateBleAppCount(Landroid/os/IBinder;ZLjava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public enableBLE()Z
    ...
    invoke-interface {v3, v1}, Landroid/bluetooth/IBluetoothManager;->enable(Ljava/lang/String;)Z
...
.method public listenUsingInsecureL2capCoc(I)Landroid/bluetooth/BluetoothServerSocket;
    ...
    const-string v1, "listenUsingInsecureL2capCoc: PLEASE USE THE OFFICIAL API, listenUsingInsecureL2capChannel"
...
.method public listenUsingL2capCoc(I)Landroid/bluetooth/BluetoothServerSocket;
    ...
    const-string v1, "listenUsingL2capCoc: PLEASE USE THE OFFICIAL API, listenUsingL2capChannel"

    invoke-static {v0, v1}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p0}, Landroid/bluetooth/BluetoothAdapter;->listenUsingL2capChannel()Landroid/bluetooth/BluetoothServerSocket;
...
.method public startDiscovery()Z
    ...
    invoke-interface {v0, v2}, Landroid/bluetooth/IBluetooth;->startDiscovery(Ljava/lang/String;)Z
...
.method public startLeScan([Ljava/util/UUID;Landroid/bluetooth/BluetoothAdapter$LeScanCallback;)Z
    ...
    invoke-direct {v4, p0, p1, p2}, Landroid/bluetooth/BluetoothAdapter$3;-><init>(Landroid/bluetooth/BluetoothAdapter;[Ljava/util/UUID;Landroid/bluetooth/BluetoothAdapter$LeScanCallback;)V
