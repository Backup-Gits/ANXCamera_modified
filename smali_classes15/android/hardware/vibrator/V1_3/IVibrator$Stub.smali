...
.method public onTransact(ILandroid/os/HwParcel;Landroid/os/HwParcel;I)V
    ...
    invoke-virtual {p0, v0, v2}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub;->debug(Landroid/os/NativeHandle;Ljava/util/ArrayList;)V
    ...
    new-instance v3, Landroid/hardware/vibrator/V1_3/IVibrator$Stub$4;

    invoke-direct {v3, p0, p3}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub$4;-><init>(Landroid/hardware/vibrator/V1_3/IVibrator$Stub;Landroid/os/HwParcel;)V

    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub;->perform_1_3(IBLandroid/hardware/vibrator/V1_3/IVibrator$perform_1_3Callback;)V
    ...
    new-instance v3, Landroid/hardware/vibrator/V1_3/IVibrator$Stub$3;

    invoke-direct {v3, p0, p3}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub$3;-><init>(Landroid/hardware/vibrator/V1_3/IVibrator$Stub;Landroid/os/HwParcel;)V

    invoke-virtual {p0, v1, v2, v3}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub;->perform_1_2(IBLandroid/hardware/vibrator/V1_2/IVibrator$perform_1_2Callback;)V
    ...
    new-instance v3, Landroid/hardware/vibrator/V1_3/IVibrator$Stub$2;

    invoke-direct {v3, p0, p3}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub$2;-><init>(Landroid/hardware/vibrator/V1_3/IVibrator$Stub;Landroid/os/HwParcel;)V

    invoke-virtual {p0, v1, v2, v3}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub;->perform_1_1(IBLandroid/hardware/vibrator/V1_1/IVibrator$perform_1_1Callback;)V
    ...
    new-instance v3, Landroid/hardware/vibrator/V1_3/IVibrator$Stub$1;

    invoke-direct {v3, p0, p3}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub$1;-><init>(Landroid/hardware/vibrator/V1_3/IVibrator$Stub;Landroid/os/HwParcel;)V

    invoke-virtual {p0, v1, v2, v3}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub;->perform(IBLandroid/hardware/vibrator/V1_0/IVibrator$performCallback;)V
    ...
    invoke-virtual {p0, v1}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub;->setAmplitude(B)I
    ...
    invoke-virtual {p0, v1}, Landroid/hardware/vibrator/V1_3/IVibrator$Stub;->on(I)I
