...
.method private getKeyphraseFromTypedArray(Landroid/content/res/TypedArray;Ljava/lang/String;Ljava/util/List;)Landroid/hardware/soundtrigger/KeyphraseMetadata;
    ...
    invoke-direct {v1, v2, v5, v7, v0}, Landroid/hardware/soundtrigger/KeyphraseMetadata;-><init>(ILjava/lang/String;Landroid/util/ArraySet;I)V
...
.method private getKeyphraseMetadataFromApplicationInfo(Landroid/content/pm/PackageManager;Landroid/content/pm/ApplicationInfo;Ljava/util/List;)Landroid/hardware/soundtrigger/KeyphraseMetadata;
    ...
    const-string v4, "Error parsing keyphrase enrollment meta-data for "
    ...
    :try_start_0
    const-string v0, "android.voice_enrollment"
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {v1, v9, v0}, Landroid/content/pm/ApplicationInfo;->loadXmlMetaData(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/res/XmlResourceParser;
    ...
    const-string v11, "No android.voice_enrollment meta-data for "
    ...
    const-string v15, "Meta-data does not start with voice-enrollment-application tag for "
    ...
    :cond_3
    :try_start_3
    sget-object v0, Lcom/android/internal/R$styleable;->VoiceEnrollmentApplication:[I
    ...
    :try_start_4
    invoke-direct {v14, v0, v7, v2}, Landroid/hardware/soundtrigger/KeyphraseEnrollmentInfo;->getKeyphraseFromTypedArray(Landroid/content/res/TypedArray;Ljava/lang/String;Ljava/util/List;)Landroid/hardware/soundtrigger/KeyphraseMetadata;
