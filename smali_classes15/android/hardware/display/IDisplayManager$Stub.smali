...
.field static final TRANSACTION_getPreferredWideGamutColorSpaceId:I = 0x1d
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {v1, v14, v10}, Landroid/hardware/display/Curve;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v1, v14, v10}, Landroid/hardware/display/BrightnessConfiguration;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v11, v1}, Landroid/hardware/display/IDisplayManager$Stub;->getBrightnessConfigurationForUser(I)Landroid/hardware/display/BrightnessConfiguration;
    ...
    invoke-virtual {v1, v14, v10}, Landroid/content/pm/ParceledListSlice;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v11, v1}, Landroid/hardware/display/IDisplayManager$Stub;->getBrightnessEvents(Ljava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-virtual {v1, v14, v10}, Landroid/graphics/Point;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    :cond_7
    invoke-virtual {v11, v1, v0}, Landroid/hardware/display/IDisplayManager$Stub;->setVirtualDisplayState(Landroid/hardware/display/IVirtualDisplayCallback;Z)V
    ...
    :goto_7
    invoke-virtual {v11, v0, v1}, Landroid/hardware/display/IDisplayManager$Stub;->setVirtualDisplaySurface(Landroid/hardware/display/IVirtualDisplayCallback;Landroid/view/Surface;)V
    ...
    invoke-virtual {v1, v14, v12}, Landroid/hardware/display/WifiDisplayStatus;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v11, v0, v1}, Landroid/hardware/display/IDisplayManager$Stub;->isUidPresentOnDisplay(II)Z
    ...
    invoke-virtual {v11, v1}, Landroid/hardware/display/IDisplayManager$Stub;->getDisplayInfo(I)Landroid/view/DisplayInfo;
