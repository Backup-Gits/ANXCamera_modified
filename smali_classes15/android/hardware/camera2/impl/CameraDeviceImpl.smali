...
.method static synthetic access$1000(Landroid/hardware/camera2/impl/CameraDeviceImpl;IJ[I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Landroid/hardware/camera2/impl/CameraDeviceImpl;->checkEarlyTriggerSequenceComplete(IJ[I)V

    return-void
.end method

.method static synthetic access$1100(Landroid/hardware/camera2/impl/CameraDeviceImpl;)Z
    .locals 1
...
.method static synthetic access$1102(Landroid/hardware/camera2/impl/CameraDeviceImpl;Z)Z
    .locals 0
...
.method static synthetic access$1200(Landroid/hardware/camera2/impl/CameraDeviceImpl;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$1300(Landroid/hardware/camera2/impl/CameraDeviceImpl;)Landroid/util/SparseArray;
    .locals 1
...
.method static synthetic access$1400(Landroid/hardware/camera2/impl/CameraDeviceImpl;)Landroid/hardware/camera2/CameraCharacteristics;
    .locals 1
...
.method static synthetic access$1500(Landroid/hardware/camera2/impl/CameraDeviceImpl;)I
    .locals 1
...
.method static synthetic access$1600(Landroid/hardware/camera2/impl/CameraDeviceImpl;)Landroid/hardware/camera2/impl/CameraDeviceImpl$FrameNumberTracker;
    .locals 1
...
.method static synthetic access$1700(Landroid/hardware/camera2/impl/CameraDeviceImpl;)V
    .locals 0
...
.method static synthetic access$1800(Landroid/hardware/camera2/impl/CameraDeviceImpl;)Landroid/util/SparseArray;
    .locals 1
...
.method static synthetic access$1900(Landroid/hardware/camera2/impl/CameraDeviceImpl;)Landroid/hardware/camera2/impl/CameraCaptureSessionCore;
    .locals 1
...
.method static synthetic access$900(Landroid/hardware/camera2/impl/CameraDeviceImpl;)[I
    .locals 1
...
.method static synthetic access$902(Landroid/hardware/camera2/impl/CameraDeviceImpl;[I)[I
    .locals 0
...
.method private checkAndFireSequenceComplete()V
    ...
    invoke-virtual {v0}, Landroid/hardware/camera2/impl/CameraDeviceImpl$FrameNumberTracker;->getCompletedZslStillFrameNumber()J
    ...
    check-cast v10, Landroid/hardware/camera2/impl/CameraDeviceImpl$RequestLastFrameNumbersHolder;

    const/4 v11, 0x0

    invoke-virtual {v10}, Landroid/hardware/camera2/impl/CameraDeviceImpl$RequestLastFrameNumbersHolder;->getRequestId()I
    ...
    const-string v14, "Camera closed while checking sequences"
    ...
    :try_start_3
    iget-object v14, v1, Landroid/hardware/camera2/impl/CameraDeviceImpl;->mCaptureCallbackMap:Landroid/util/SparseArray;
    ...
    :try_start_4
    invoke-virtual {v10}, Landroid/hardware/camera2/impl/CameraDeviceImpl$RequestLastFrameNumbersHolder;->getLastRegularFrameNumber()J

    move-result-wide v15

    nop

    invoke-virtual {v10}, Landroid/hardware/camera2/impl/CameraDeviceImpl$RequestLastFrameNumbersHolder;->getLastReprocessFrameNumber()J

    move-result-wide v17

    nop

    invoke-virtual {v10}, Landroid/hardware/camera2/impl/CameraDeviceImpl$RequestLastFrameNumbersHolder;->getLastZslStillFrameNumber()J
    ...
    invoke-direct {v0, v1, v12, v14, v10}, Landroid/hardware/camera2/impl/CameraDeviceImpl$10;-><init>(Landroid/hardware/camera2/impl/CameraDeviceImpl;ILandroid/hardware/camera2/impl/CameraDeviceImpl$CaptureCallbackHolder;Landroid/hardware/camera2/impl/CameraDeviceImpl$RequestLastFrameNumbersHolder;)V
...
.method private checkEarlyTriggerSequenceComplete(IJ[I)V
    .locals 6
    ...
    invoke-direct {v1, p1, p2, p3, p4}, Landroid/hardware/camera2/impl/CameraDeviceImpl$RequestLastFrameNumbersHolder;-><init>(IJ[I)V
...
.method private checkInputConfiguration(Landroid/hardware/camera2/params/InputConfiguration;)V
    ...
    invoke-static {v3, p1}, Landroid/hardware/camera2/impl/CameraDeviceImplInjector;->isInputConfigurationFormatValid(Landroid/hardware/camera2/CameraCharacteristics;Landroid/hardware/camera2/params/InputConfiguration;)Z
...
.method private submitCaptureRequest(Ljava/util/List;Landroid/hardware/camera2/impl/CameraDeviceImpl$CaptureCallback;Ljava/util/concurrent/Executor;Z)I
    ...
    invoke-direct {v1, v2, v3, v4, v5}, Landroid/hardware/camera2/impl/CameraDeviceImpl;->checkEarlyTriggerSequenceComplete(IJ[I)V
    ...
    invoke-direct {v3, v8, v14}, Landroid/hardware/camera2/impl/CameraDeviceImpl$RequestLastFrameNumbersHolder;-><init>(Ljava/util/List;Landroid/hardware/camera2/utils/SubmitInfo;)V
...
.method public flush()V
    ...
    invoke-direct {p0, v3, v1, v2, v5}, Landroid/hardware/camera2/impl/CameraDeviceImpl;->checkEarlyTriggerSequenceComplete(IJ[I)V
...
.method public stopRepeating()V
    ...
    :try_start_2
    invoke-direct {p0, v1, v3, v4, v2}, Landroid/hardware/camera2/impl/CameraDeviceImpl;->checkEarlyTriggerSequenceComplete(IJ[I)V
