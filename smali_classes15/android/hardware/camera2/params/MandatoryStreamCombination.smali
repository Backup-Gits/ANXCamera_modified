...
.method static constructor <clinit>()V
    ...
    sget-object v13, Landroid/hardware/camera2/params/MandatoryStreamCombination$SizeThreshold;->VGA:Landroid/hardware/camera2/params/MandatoryStreamCombination$SizeThreshold;
    ...
    invoke-direct {v11, v14, v13}, Landroid/hardware/camera2/params/MandatoryStreamCombination$StreamTemplate;-><init>(ILandroid/hardware/camera2/params/MandatoryStreamCombination$SizeThreshold;)V
    ...
    invoke-direct {v11, v14, v12}, Landroid/hardware/camera2/params/MandatoryStreamCombination$StreamTemplate;-><init>(ILandroid/hardware/camera2/params/MandatoryStreamCombination$SizeThreshold;)V
    ...
    const-string v12, "ZSL(Zero-Shutter-Lag) still imaging"
    ...
    const-string v12, "ZSL still and in-app processing imaging"
    ...
    const-string v12, "ZSL in-app processing with still capture"
    ...
    const-string v12, "High-resolution ZSL in-app video processing with regular preview"
    ...
    const-string v12, "Mutually exclusive ZSL in-app processing and DNG capture"
    ...
    const-string v12, "Mutually exclusive ZSL in-app processing and preview with DNG capture"
    ...
    const-string v12, "Mutually exclusive ZSL two-input in-app processing and DNG capture"
    ...
    const-string v12, "Mutually exclusive ZSL still capture and preview with DNG capture"
    ...
    const-string v12, "Mutually exclusive ZSL in-app processing with still capture and DNG capture"
    ...
    sget-object v10, Landroid/hardware/camera2/params/MandatoryStreamCombination$ReprocessType;->YUV:Landroid/hardware/camera2/params/MandatoryStreamCombination$ReprocessType;

    const-string v11, "Mutually exclusive ZSL in-app processing with still capture and DNG capture"

    invoke-direct {v1, v2, v11, v10}, Landroid/hardware/camera2/params/MandatoryStreamCombination$StreamCombinationTemplate;-><init>([Landroid/hardware/camera2/params/MandatoryStreamCombination$StreamTemplate;Ljava/lang/String;Landroid/hardware/camera2/params/MandatoryStreamCombination$ReprocessType;)V
    ...
    invoke-direct {v10, v7, v11}, Landroid/hardware/camera2/params/MandatoryStreamCombination$StreamTemplate;-><init>(ILandroid/hardware/camera2/params/MandatoryStreamCombination$SizeThreshold;)V
    ...
    invoke-direct {v8, v7, v10}, Landroid/hardware/camera2/params/MandatoryStreamCombination$StreamTemplate;-><init>(ILandroid/hardware/camera2/params/MandatoryStreamCombination$SizeThreshold;)V
    ...
    invoke-direct {v6, v14, v7}, Landroid/hardware/camera2/params/MandatoryStreamCombination$StreamTemplate;-><init>(ILandroid/hardware/camera2/params/MandatoryStreamCombination$SizeThreshold;)V
    ...
    invoke-direct {v4, v9, v6}, Landroid/hardware/camera2/params/MandatoryStreamCombination$StreamTemplate;-><init>(ILandroid/hardware/camera2/params/MandatoryStreamCombination$SizeThreshold;)V
    ...
    const-string v5, "In-app viewfinder analysis with ZSL, RAW, and JPEG reprocessing output"
