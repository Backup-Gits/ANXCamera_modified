...
.method protected dispatchSensorEvent(I[FIJ)V
    ...
    :cond_0
    :try_start_0
    sget-object v1, Landroid/hardware/SystemSensorManager;->mActivityManager:Landroid/app/IActivityManager;

    if-eqz v1, :cond_1

    sget-object v1, Landroid/hardware/SystemSensorManager;->mActivityManager:Landroid/app/IActivityManager;

    invoke-interface {v1}, Landroid/app/IActivityManager;->getCastPid()I
    ...
    sget-object v1, Landroid/hardware/SystemSensorManager;->mActivityTaskManager:Landroid/app/IActivityTaskManager;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/hardware/SystemSensorManager$SensorEventQueue;->mManager:Landroid/hardware/SystemSensorManager;

    invoke-static {v1}, Landroid/hardware/SystemSensorManager;->access$300(Landroid/hardware/SystemSensorManager;)Landroid/content/Context;
    ...
    invoke-static {v2}, Landroid/hardware/SystemSensorManager;->access$300(Landroid/hardware/SystemSensorManager;)Landroid/content/Context;
    ...
    invoke-interface {v1, v2}, Landroid/app/IActivityTaskManager;->isTopActivityInFreeform(Ljava/lang/String;)Z
