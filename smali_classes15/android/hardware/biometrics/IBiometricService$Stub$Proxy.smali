...
.method public authenticate(Landroid/os/IBinder;JILandroid/hardware/biometrics/IBiometricServiceReceiver;Ljava/lang/String;Landroid/os/Bundle;Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;)V
    ...
    :try_start_2
    invoke-virtual {v11, v14, v15}, Landroid/os/Parcel;->writeLong(J)V
    ...
    invoke-virtual {v10, v11, v2}, Landroid/os/Bundle;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-interface/range {p8 .. p8}, Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;->asBinder()Landroid/os/IBinder;
    ...
    iget-object v0, v7, Landroid/hardware/biometrics/IBiometricService$Stub$Proxy;->mRemote:Landroid/os/IBinder;

    invoke-interface {v0, v1, v11, v12, v2}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface/range {v1 .. v9}, Landroid/hardware/biometrics/IBiometricService;->authenticate(Landroid/os/IBinder;JILandroid/hardware/biometrics/IBiometricServiceReceiver;Ljava/lang/String;Landroid/os/Bundle;Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;)V
    :try_end_2
...
.method public canAuthenticate(Ljava/lang/String;)I
    ...
    invoke-interface {v3, p1}, Landroid/hardware/biometrics/IBiometricService;->canAuthenticate(Ljava/lang/String;)I
...
.method public cancelAuthentication(Landroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/hardware/biometrics/IBiometricService;->cancelAuthentication(Landroid/os/IBinder;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onConfirmDeviceCredentialError(ILjava/lang/String;)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/hardware/biometrics/IBiometricService;->onConfirmDeviceCredentialError(ILjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onConfirmDeviceCredentialSuccess()V
    ...
    invoke-interface {v3}, Landroid/hardware/biometrics/IBiometricService;->onConfirmDeviceCredentialSuccess()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public registerCancellationCallback(Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;)V
    ...
    invoke-interface {p1}, Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {v3, p1}, Landroid/hardware/biometrics/IBiometricService;->registerCancellationCallback(Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public registerEnabledOnKeyguardCallback(Landroid/hardware/biometrics/IBiometricEnabledOnKeyguardCallback;)V
    ...
    invoke-interface {v3, p1}, Landroid/hardware/biometrics/IBiometricService;->registerEnabledOnKeyguardCallback(Landroid/hardware/biometrics/IBiometricEnabledOnKeyguardCallback;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
