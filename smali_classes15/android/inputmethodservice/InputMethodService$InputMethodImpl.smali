...
.method public final initializeInternal(Landroid/os/IBinder;ILcom/android/internal/inputmethod/IInputMethodPrivilegedOperations;)V
    ...
    invoke-virtual {v0}, Landroid/inputmethodservice/SoftInputWindow;->isWindowDestoryed()Z
    ...
    const-string v1, "The token has already registered or ims is destoryed, ignore this initialization."
...
.method public showSoftInput(ILandroid/os/ResultReceiver;)V
    ...
    invoke-static {v3, p1, v2}, Landroid/inputmethodservice/InputMethodService;->access$600(Landroid/inputmethodservice/InputMethodService;IZ)Z
    ...
    invoke-static {v3, v1}, Landroid/inputmethodservice/InputMethodService;->access$300(Landroid/inputmethodservice/InputMethodService;Z)V

    iget-object v3, p0, Landroid/inputmethodservice/InputMethodService$InputMethodImpl;->this$0:Landroid/inputmethodservice/InputMethodService;

    invoke-static {v3, v1}, Landroid/inputmethodservice/InputMethodService;->access$400(Landroid/inputmethodservice/InputMethodService;Z)V
    ...
    invoke-virtual {v3, v1}, Landroid/inputmethodservice/InputMethodService;->showWindow(Z)V
    :try_end_0
    ...
    iput-boolean v1, v3, Landroid/inputmethodservice/InputMethodService;->mDecorViewWasVisible:Z

    iput-boolean v2, v3, Landroid/inputmethodservice/InputMethodService;->mInShowWindow:Z
    ...
    invoke-static {v4, v3}, Landroid/inputmethodservice/InputMethodServiceInjector;->onBadTokenException(Landroid/inputmethodservice/InputMethodService;Landroid/view/WindowManager$BadTokenException;)V

    iget-object v4, p0, Landroid/inputmethodservice/InputMethodService$InputMethodImpl;->this$0:Landroid/inputmethodservice/InputMethodService;

    iput-boolean v2, v4, Landroid/inputmethodservice/InputMethodService;->mWindowVisible:Z

    iget-object v4, p0, Landroid/inputmethodservice/InputMethodService$InputMethodImpl;->this$0:Landroid/inputmethodservice/InputMethodService;

    iput-boolean v2, v4, Landroid/inputmethodservice/InputMethodService;->mDecorViewVisible:Z
    :try_end_1
    ...
    iput-boolean v1, v4, Landroid/inputmethodservice/InputMethodService;->mDecorViewWasVisible:Z

    iput-boolean v2, v4, Landroid/inputmethodservice/InputMethodService;->mInShowWindow:Z
