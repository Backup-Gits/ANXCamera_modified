...
# virtual methods
.method public abortActiveSession()V
    .locals 5
    ...
    invoke-interface {v3}, Landroid/apex/IApexService;->abortActiveSession()V
    :try_end_0
...
.method public markStagedSessionReady(I)Z
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v3, p1}, Landroid/apex/IApexService;->markStagedSessionReady(I)Z
...
.method public resumeRollbackIfNeeded()V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v3}, Landroid/apex/IApexService;->resumeRollbackIfNeeded()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public rollbackActiveSession()V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v3}, Landroid/apex/IApexService;->rollbackActiveSession()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public stagePackage(Ljava/lang/String;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v3, p1}, Landroid/apex/IApexService;->stagePackage(Ljava/lang/String;)Z
...
.method public stagePackages(Ljava/util/List;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v3, p1}, Landroid/apex/IApexService;->stagePackages(Ljava/util/List;)Z
...
.method public submitStagedSession(I[ILandroid/apex/ApexInfoList;)Z
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/apex/IApexService;->submitStagedSession(I[ILandroid/apex/ApexInfoList;)Z
    ...
    invoke-virtual {p3, v1}, Landroid/apex/ApexInfoList;->readFromParcel(Landroid/os/Parcel;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
