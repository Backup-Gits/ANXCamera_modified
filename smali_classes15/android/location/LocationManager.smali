...
.field private final mGnssNmeaListeners:Landroid/util/ArrayMap;
...
.field private final mGpsStatusListeners:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;)V
    ...
    iput-object v0, p0, Landroid/location/LocationManager;->mGnssStatusListeners:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Landroid/location/LocationManager;->mGnssNmeaListeners:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Landroid/location/LocationManager;->mGpsStatusListeners:Landroid/util/ArrayMap;
...
.method static synthetic access$500(Landroid/location/LocationManager;)I
    .locals 1
...
.method static synthetic access$502(Landroid/location/LocationManager;I)I
    .locals 0
...
.method static synthetic access$600(Landroid/location/LocationManager;)Landroid/location/GnssStatus;
    .locals 1
...
.method static synthetic access$602(Landroid/location/LocationManager;Landroid/location/GnssStatus;)Landroid/location/GnssStatus;
    .locals 0
...
.method public addGpsStatusListener(Landroid/location/GpsStatus$Listener;)Z
    ...
    iget-object v0, p0, Landroid/location/LocationManager;->mGpsStatusListeners:Landroid/util/ArrayMap;
    ...
    invoke-direct {v0, p0, p1, v1}, Landroid/location/LocationManager$GnssStatusListenerTransport;-><init>(Landroid/location/LocationManager;Landroid/location/GpsStatus$Listener;Landroid/os/Handler;)V
    ...
    iget-object v2, p0, Landroid/location/LocationManager;->mGpsStatusListeners:Landroid/util/ArrayMap;
...
.method public addNmeaListener(Landroid/location/OnNmeaMessageListener;Landroid/os/Handler;)Z
    ...
    iget-object v0, p0, Landroid/location/LocationManager;->mGnssNmeaListeners:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, Landroid/location/LocationManager;->mGnssNmeaListeners:Landroid/util/ArrayMap;
...
.method public addTestProvider(Ljava/lang/String;ZZZZZZZII)V
    ...
    invoke-interface {v0, p1, v3, v4}, Landroid/location/ILocationManager;->addTestProvider(Ljava/lang/String;Lcom/android/internal/location/ProviderProperties;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getGnssCapabilities()Landroid/location/GnssCapabilities;
    ...
    invoke-virtual {v0}, Landroid/location/GnssMeasurementCallbackTransport;->getGnssCapabilities()J
...
.method public getTestProviderCurrentRequests(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {v0, p1, v1}, Landroid/location/ILocationManager;->getTestProviderCurrentRequests(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
...
.method public injectGnssMeasurementCorrections(Landroid/location/GnssMeasurementCorrections;)V
    ...
    invoke-virtual {v0, p1}, Landroid/location/GnssMeasurementCallbackTransport;->injectGnssMeasurementCorrections(Landroid/location/GnssMeasurementCorrections;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public registerGnssStatusCallback(Landroid/location/GnssStatus$Callback;Landroid/os/Handler;)Z
    ...
    iget-object v0, p0, Landroid/location/LocationManager;->mGnssStatusListeners:Landroid/util/ArrayMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Landroid/location/LocationManager;->mGnssStatusListeners:Landroid/util/ArrayMap;
    ...
    :cond_0
    :try_start_1
    new-instance v1, Landroid/location/LocationManager$GnssStatusListenerTransport;

    invoke-direct {v1, p0, p1, p2}, Landroid/location/LocationManager$GnssStatusListenerTransport;-><init>(Landroid/location/LocationManager;Landroid/location/GnssStatus$Callback;Landroid/os/Handler;)V
    ...
    invoke-interface {v2, v1, v3}, Landroid/location/ILocationManager;->registerGnssStatusCallback(Landroid/location/IGnssStatusListener;Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_1

    iget-object v3, p0, Landroid/location/LocationManager;->mGnssStatusListeners:Landroid/util/ArrayMap;
