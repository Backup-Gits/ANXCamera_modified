...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1}, Landroid/graphics/drawable/GradientDrawable$Orientation;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v3, v2}, Landroid/graphics/drawable/GradientDrawable$Orientation;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v4, v3}, Landroid/graphics/drawable/GradientDrawable$Orientation;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "BR_TL"

    invoke-direct {v0, v5, v4}, Landroid/graphics/drawable/GradientDrawable$Orientation;-><init>(Ljava/lang/String;I)V
    ...
    const-string v6, "BOTTOM_TOP"

    invoke-direct {v0, v6, v5}, Landroid/graphics/drawable/GradientDrawable$Orientation;-><init>(Ljava/lang/String;I)V
    ...
    const-string v7, "BL_TR"

    invoke-direct {v0, v7, v6}, Landroid/graphics/drawable/GradientDrawable$Orientation;-><init>(Ljava/lang/String;I)V
    ...
    const-string v8, "LEFT_RIGHT"

    invoke-direct {v0, v8, v7}, Landroid/graphics/drawable/GradientDrawable$Orientation;-><init>(Ljava/lang/String;I)V
    ...
    const-string v9, "TL_BR"

    invoke-direct {v0, v9, v8}, Landroid/graphics/drawable/GradientDrawable$Orientation;-><init>(Ljava/lang/String;I)V
