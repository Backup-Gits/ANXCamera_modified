...
.method private updateStateFromTypedArray(Landroid/content/res/TypedArray;)V
    ...
    invoke-static {v5, v4}, Landroid/graphics/drawable/Drawable;->parseBlendMode(ILandroid/graphics/BlendMode;)Landroid/graphics/BlendMode;

    move-result-object v4

    iput-object v4, v0, Landroid/graphics/drawable/ShapeDrawable$ShapeState;->mBlendMode:Landroid/graphics/BlendMode;
...
.method public setTintBlendMode(Landroid/graphics/BlendMode;)V
    ...
    invoke-virtual {p0, v1, v0, p1}, Landroid/graphics/drawable/ShapeDrawable;->updateBlendModeFilter(Landroid/graphics/BlendModeColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/BlendMode;)Landroid/graphics/BlendModeColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, v0, Landroid/graphics/drawable/ShapeDrawable$ShapeState;->mBlendMode:Landroid/graphics/BlendMode;

    invoke-virtual {p0, v1, p1, v0}, Landroid/graphics/drawable/ShapeDrawable;->updateBlendModeFilter(Landroid/graphics/BlendModeColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/BlendMode;)Landroid/graphics/BlendModeColorFilter;
