...
.method static synthetic access$400(Landroid/content/res/AssetFileDescriptor;Landroid/graphics/ImageDecoder$Source;)Landroid/graphics/ImageDecoder;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p0, p1}, Landroid/graphics/ImageDecoder;->createFromAssetFileDescriptor(Landroid/content/res/AssetFileDescriptor;Landroid/graphics/ImageDecoder$Source;)Landroid/graphics/ImageDecoder;
...
.method static synthetic access$500(Landroid/content/res/AssetManager$AssetInputStream;Landroid/graphics/ImageDecoder$Source;)Landroid/graphics/ImageDecoder;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method static synthetic access$600(Ljava/io/File;Landroid/graphics/ImageDecoder$Source;)Landroid/graphics/ImageDecoder;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private static createFromAssetFileDescriptor(Landroid/content/res/AssetFileDescriptor;Landroid/graphics/ImageDecoder$Source;)Landroid/graphics/ImageDecoder;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v0, p1}, Landroid/graphics/ImageDecoder;->nCreate(Ljava/io/FileDescriptor;Landroid/graphics/ImageDecoder$Source;)Landroid/graphics/ImageDecoder;
    ...
    invoke-static {v5, v6, p1}, Landroid/graphics/ImageDecoder;->createFromStream(Ljava/io/InputStream;ZLandroid/graphics/ImageDecoder$Source;)Landroid/graphics/ImageDecoder;
...
.method private static decodeBitmapImpl(Landroid/graphics/ImageDecoder$Source;Landroid/graphics/ImageDecoder$OnHeaderDecodedListener;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v4, v0}, Landroid/graphics/ImageDecoder;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method private static decodeDrawableImpl(Landroid/graphics/ImageDecoder$Source;Landroid/graphics/ImageDecoder$OnHeaderDecodedListener;)Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v4, v2, Landroid/graphics/ImageDecoder;->mAnimated:Z

    const/4 v15, 0x0

    if-eqz v4, :cond_1

    iget-object v4, v2, Landroid/graphics/ImageDecoder;->mPostProcessor:Landroid/graphics/PostProcessor;
    ...
    invoke-direct {v2, v4}, Landroid/graphics/ImageDecoder;->checkState(Z)V

    new-instance v18, Landroid/graphics/drawable/AnimatedImageDrawable;
    ...
    iget-object v4, v2, Landroid/graphics/ImageDecoder;->mInputStream:Ljava/io/InputStream;
    ...
    invoke-static {v12}, Landroid/graphics/NinePatch;->isNinePatchChunk([B)Z
    ...
    invoke-virtual {v1, v13}, Landroid/graphics/Bitmap;->getOpticalInsets(Landroid/graphics/Rect;)V
    ...
    :goto_1
    iget-wide v4, v2, Landroid/graphics/ImageDecoder;->mNativePtr:J

    invoke-static {v4, v5, v14}, Landroid/graphics/ImageDecoder;->nGetPadding(JLandroid/graphics/Rect;)V

    new-instance v15, Landroid/graphics/drawable/NinePatchDrawable;
    ...
    invoke-direct/range {v4 .. v10}, Landroid/graphics/drawable/NinePatchDrawable;-><init>(Landroid/content/res/Resources;Landroid/graphics/Bitmap;[BLandroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v1, v2}, Landroid/graphics/ImageDecoder;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
