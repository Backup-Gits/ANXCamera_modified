...
.method private bindMediaActionButton(Landroid/widget/RemoteViews;ILandroid/app/Notification$Action;Landroid/app/Notification$StandardTemplateParams;)V
    ...
    invoke-static {v6}, Landroid/app/Notification$Builder;->access$4000(Landroid/app/Notification$Builder;)Z
    ...
    invoke-static {v6, p4}, Landroid/app/Notification$Builder;->access$3800(Landroid/app/Notification$Builder;Landroid/app/Notification$StandardTemplateParams;)Z
    ...
    invoke-static {v6}, Landroid/app/Notification$Builder;->access$3400(Landroid/app/Notification$Builder;)Landroid/content/Context;
    ...
    invoke-static {v7}, Landroid/app/Notification$Builder;->access$3400(Landroid/app/Notification$Builder;)Landroid/content/Context;
...
.method private getActionColor(Landroid/app/Notification$StandardTemplateParams;)I
    ...
    invoke-static {v0, p1}, Landroid/app/Notification$Builder;->access$3800(Landroid/app/Notification$Builder;Landroid/app/Notification$StandardTemplateParams;)Z
...
.method private makeMediaBigContentView()Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, Landroid/app/Notification$Builder;->access$2900(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Landroid/app/Notification;->access$1800(Landroid/app/Notification;)Z
    ...
    invoke-static {v4, v6, v3, v5}, Landroid/app/Notification$Builder;->access$4100(Landroid/app/Notification$Builder;ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v8}, Landroid/app/Notification$Builder;->access$2900(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;
    ...
    invoke-static {v8}, Landroid/app/Notification$Builder;->access$3400(Landroid/app/Notification$Builder;)Landroid/content/Context;
...
.method private makeMediaContentView()Landroid/widget/RemoteViews;
    ...
    invoke-static {v2, v3, v0, v4}, Landroid/app/Notification$Builder;->access$4100(Landroid/app/Notification$Builder;ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;

    move-result-object v2

    iget-object v3, p0, Landroid/app/Notification$MediaStyle;->mBuilder:Landroid/app/Notification$Builder;

    invoke-static {v3}, Landroid/app/Notification$Builder;->access$2900(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;
    ...
    invoke-static {v6}, Landroid/app/Notification$Builder;->access$2900(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;
    ...
    invoke-static {v5}, Landroid/app/Notification;->access$1800(Landroid/app/Notification;)Z
