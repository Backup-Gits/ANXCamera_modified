...
.method public activitySlept(Landroid/os/IBinder;)V
    ...
    invoke-interface {v2, p1}, Landroid/app/IActivityTaskManager;->activitySlept(Landroid/os/IBinder;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public dismissPip(ZI)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/app/IActivityTaskManager;->dismissPip(ZI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public dismissSplitScreenMode(Z)V
    ...
    invoke-interface {v3, p1}, Landroid/app/IActivityTaskManager;->dismissSplitScreenMode(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getActivityDisplayId(Landroid/os/IBinder;)I
    ...
    invoke-interface {v3, p1}, Landroid/app/IActivityTaskManager;->getActivityDisplayId(Landroid/os/IBinder;)I
...
.method public getFilteredTasks(III)Ljava/util/List;
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/app/IActivityTaskManager;->getFilteredTasks(III)Ljava/util/List;
...
.method public isInMultiWindowMode(Landroid/os/IBinder;)Z
    ...
    invoke-interface {v3, p1}, Landroid/app/IActivityTaskManager;->isInMultiWindowMode(Landroid/os/IBinder;)Z
...
.method public isInPictureInPictureMode(Landroid/os/IBinder;)Z
    ...
    invoke-interface {v3, p1}, Landroid/app/IActivityTaskManager;->isInPictureInPictureMode(Landroid/os/IBinder;)Z
...
.method public moveTasksToFullscreenStack(IZ)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/app/IActivityTaskManager;->moveTasksToFullscreenStack(IZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public notifyPinnedStackAnimationEnded()V
    ...
    invoke-interface {v3}, Landroid/app/IActivityTaskManager;->notifyPinnedStackAnimationEnded()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public notifyPinnedStackAnimationStarted()V
    ...
    invoke-interface {v3}, Landroid/app/IActivityTaskManager;->notifyPinnedStackAnimationStarted()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public offsetPinnedStackBounds(ILandroid/graphics/Rect;III)V
    ...
    invoke-interface/range {v4 .. v9}, Landroid/app/IActivityTaskManager;->offsetPinnedStackBounds(ILandroid/graphics/Rect;III)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public resizePinnedStack(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/app/IActivityTaskManager;->resizePinnedStack(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public resizeStack(ILandroid/graphics/Rect;ZZZI)V
    ...
    invoke-virtual {v8, v9, v1}, Landroid/graphics/Rect;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    :try_start_3
    iget-object v0, v13, Landroid/app/IActivityTaskManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
    ...
    invoke-interface/range {v1 .. v7}, Landroid/app/IActivityTaskManager;->resizeStack(ILandroid/graphics/Rect;ZZZI)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public resizeTask(ILandroid/graphics/Rect;I)V
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/app/IActivityTaskManager;->resizeTask(ILandroid/graphics/Rect;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setTaskWindowingMode(IIZ)V
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/app/IActivityTaskManager;->setTaskWindowingMode(IIZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setTaskWindowingModeSplitScreenPrimary(IIZZLandroid/graphics/Rect;Z)Z
    ...
    invoke-interface/range {v1 .. v7}, Landroid/app/IActivityTaskManager;->setTaskWindowingModeSplitScreenPrimary(IIZZLandroid/graphics/Rect;Z)Z
...
.method public startActivities(Landroid/app/IApplicationThread;Ljava/lang/String;[Landroid/content/Intent;[Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;I)I
    ...
    :try_start_2
    invoke-virtual {v10, v13, v0}, Landroid/os/Parcel;->writeTypedArray([Landroid/os/Parcelable;I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2
    ...
    iget-object v1, v7, Landroid/app/IActivityTaskManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
    ...
    invoke-interface/range {v1 .. v8}, Landroid/app/IActivityTaskManager;->startActivities(Landroid/app/IApplicationThread;Ljava/lang/String;[Landroid/content/Intent;[Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;I)I
...
.method public startActivity(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;)I
    ...
    iget-object v2, v4, Landroid/app/IActivityTaskManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;

    invoke-interface {v2, v0, v15, v11, v1}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :try_start_9
    invoke-interface/range {v1 .. v11}, Landroid/app/IActivityTaskManager;->startActivity(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;)I
...
.method public startActivityAndWait(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;I)Landroid/app/WaitResult;
    ...
    :try_start_a
    invoke-interface/range {v1 .. v12}, Landroid/app/IActivityTaskManager;->startActivityAndWait(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;I)Landroid/app/WaitResult;
...
.method public startActivityAsUser(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;I)I
    ...
    :try_start_9
    invoke-interface/range {v1 .. v12}, Landroid/app/IActivityTaskManager;->startActivityAsUser(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;I)I
...
.method public startActivityWithConfig(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/content/res/Configuration;Landroid/os/Bundle;I)I
    ...
    invoke-virtual {v14, v12, v1}, Landroid/content/res/Configuration;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0
    ...
    :try_start_9
    invoke-interface/range {v1 .. v12}, Landroid/app/IActivityTaskManager;->startActivityWithConfig(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/content/res/Configuration;Landroid/os/Bundle;I)I
...
.method public startAssistantActivity(Ljava/lang/String;IILandroid/content/Intent;Ljava/lang/String;Landroid/os/Bundle;I)I
    ...
    iget-object v0, v6, Landroid/app/IActivityTaskManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public startInPlaceAnimationOnFrontMostApplication(Landroid/os/Bundle;)V
    ...
    invoke-interface {v3, p1}, Landroid/app/IActivityTaskManager;->startInPlaceAnimationOnFrontMostApplication(Landroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public updateDisplayOverrideConfiguration(Landroid/content/res/Configuration;I)Z
    ...
    invoke-interface {v2, p1, p2}, Landroid/app/IActivityTaskManager;->updateDisplayOverrideConfiguration(Landroid/content/res/Configuration;I)Z
