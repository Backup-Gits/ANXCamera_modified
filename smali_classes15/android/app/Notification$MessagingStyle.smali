...
.method public static findLatestIncomingMessage(Ljava/util/List;)Landroid/app/Notification$MessagingStyle$Message;
    ...
    invoke-static {v1}, Landroid/app/Notification$MessagingStyle$Message;->access$3600(Landroid/app/Notification$MessagingStyle$Message;)Landroid/app/Person;
...
.method private fixTitleAndTextExtras(Landroid/os/Bundle;)V
    ...
    :cond_0
    invoke-static {v0}, Landroid/app/Notification$MessagingStyle$Message;->access$3500(Landroid/app/Notification$MessagingStyle$Message;)Ljava/lang/CharSequence;
    ...
    :cond_1
    invoke-static {v0}, Landroid/app/Notification$MessagingStyle$Message;->access$3600(Landroid/app/Notification$MessagingStyle$Message;)Landroid/app/Person;
...
.method private makeMessagingView(ZZ)Landroid/widget/RemoteViews;
    ...
    invoke-static {p0}, Landroid/app/Notification$Style;->access$3300(Landroid/app/Notification$Style;)Ljava/lang/CharSequence;
    ...
    invoke-static {v7}, Landroid/app/Notification;->access$1300(Landroid/app/Notification;)Landroid/graphics/drawable/Icon;
    ...
    iget-object v9, v9, Landroid/app/Notification$Builder;->mParams:Landroid/app/Notification$StandardTemplateParams;

    invoke-virtual {v9}, Landroid/app/Notification$StandardTemplateParams;->reset()Landroid/app/Notification$StandardTemplateParams;

    move-result-object v9

    invoke-virtual {v9, v4}, Landroid/app/Notification$StandardTemplateParams;->hasProgress(Z)Landroid/app/Notification$StandardTemplateParams;

    move-result-object v9

    invoke-virtual {v9, v0}, Landroid/app/Notification$StandardTemplateParams;->title(Ljava/lang/CharSequence;)Landroid/app/Notification$StandardTemplateParams;

    move-result-object v9

    invoke-virtual {v9, v8}, Landroid/app/Notification$StandardTemplateParams;->text(Ljava/lang/CharSequence;)Landroid/app/Notification$StandardTemplateParams;
    ...
    invoke-static {v8}, Landroid/app/Notification$Builder;->access$3700(Landroid/app/Notification$Builder;)I

    move-result v8

    invoke-static {v4, v8, v3, v7}, Landroid/app/Notification$Builder;->access$2300(Landroid/app/Notification$Builder;ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p0, v8}, Landroid/app/Notification$MessagingStyle;->addExtras(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v4, v8, v9}, Landroid/widget/RemoteViews;->setViewLayoutMarginEnd(II)V

    nop

    iget-object v8, p0, Landroid/app/Notification$MessagingStyle;->mBuilder:Landroid/app/Notification$Builder;

    invoke-static {v8, v3}, Landroid/app/Notification$Builder;->access$3800(Landroid/app/Notification$Builder;Landroid/app/Notification$StandardTemplateParams;)Z
    ...
    invoke-virtual {v8, v3}, Landroid/app/Notification$Builder;->getPrimaryTextColor(Landroid/app/Notification$StandardTemplateParams;)I
    ...
    invoke-virtual {v8, v3}, Landroid/app/Notification$Builder;->resolveContrastColor(Landroid/app/Notification$StandardTemplateParams;)I
    ...
    const-string/jumbo v10, "setSenderTextColor"

    invoke-virtual {v4, v9, v10, v8}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V

    iget-object v8, p0, Landroid/app/Notification$MessagingStyle;->mBuilder:Landroid/app/Notification$Builder;

    invoke-virtual {v8, v3}, Landroid/app/Notification$Builder;->getSecondaryTextColor(Landroid/app/Notification$StandardTemplateParams;)I

    move-result v8

    const-string/jumbo v10, "setMessageTextColor"

    invoke-virtual {v4, v9, v10, v8}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V

    const-string/jumbo v8, "setDisplayImagesAtEnd"

    invoke-virtual {v4, v9, v8, p1}, Landroid/widget/RemoteViews;->setBoolean(ILjava/lang/String;Z)V

    const-string/jumbo v8, "setAvatarReplacement"

    invoke-virtual {v4, v9, v8, v5}, Landroid/widget/RemoteViews;->setIcon(ILjava/lang/String;Landroid/graphics/drawable/Icon;)V

    const-string/jumbo v8, "setNameReplacement"

    invoke-virtual {v4, v9, v8, v2}, Landroid/widget/RemoteViews;->setCharSequence(ILjava/lang/String;Ljava/lang/CharSequence;)V

    const-string/jumbo v8, "setIsOneToOne"

    invoke-virtual {v4, v9, v8, v6}, Landroid/widget/RemoteViews;->setBoolean(ILjava/lang/String;Z)V
    ...
    const-string/jumbo v10, "setData"

    invoke-virtual {v4, v9, v10, v8}, Landroid/widget/RemoteViews;->setBundle(ILjava/lang/String;Landroid/os/Bundle;)V
...
.method public isGroupConversation()Z
    ...
    invoke-static {v0}, Landroid/app/Notification$Builder;->access$3400(Landroid/app/Notification$Builder;)Landroid/content/Context;
...
.method public makeContentView(Z)Landroid/widget/RemoteViews;
    ...
    invoke-static {v1}, Landroid/app/Notification$Builder;->access$2900(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/app/Notification$Builder;->access$2802(Landroid/app/Notification$Builder;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Landroid/app/Notification$Builder;->access$2800(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;
    ...
    invoke-static {v1, v2}, Landroid/app/Notification$Builder;->access$2802(Landroid/app/Notification$Builder;Ljava/util/ArrayList;)Ljava/util/ArrayList;
