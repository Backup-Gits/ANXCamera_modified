...
.method public bindSlice(Landroid/content/Intent;Ljava/util/Set;)Landroid/app/slice/Slice;
    ...
    :try_start_8
    invoke-static {v1, v7}, Landroid/app/slice/SliceManager;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public bindSlice(Landroid/net/Uri;Ljava/util/Set;)Landroid/app/slice/Slice;
    ...
    :try_start_8
    invoke-static {v3, v2}, Landroid/app/slice/SliceManager;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public getSliceDescendants(Landroid/net/Uri;)Ljava/util/Collection;
    ...
    :try_start_2
    invoke-static {v4, v1}, Landroid/app/slice/SliceManager;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_0
...
.method public mapIntentToUri(Landroid/content/Intent;)Landroid/net/Uri;
    ...
    :try_start_8
    invoke-static {v6, v5}, Landroid/app/slice/SliceManager;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
