...
.method public final bindApplication(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Ljava/util/List;Landroid/content/ComponentName;Landroid/app/ProfilerInfo;Landroid/os/Bundle;Landroid/app/IInstrumentationWatcher;Landroid/app/IUiAutomationConnection;IZZZZLandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;Ljava/util/Map;Landroid/os/Bundle;Ljava/lang/String;Landroid/content/AutofillOptions;Landroid/content/ContentCaptureOptions;)V
    ...
    invoke-static {v2}, Landroid/app/ActivityThread;->access$202(Z)Z
    ...
    iput-object v6, v3, Landroid/app/ActivityThread$AppBindData;->instrumentationName:Landroid/content/ComponentName;

    move-object/from16 v7, p6

    iput-object v7, v3, Landroid/app/ActivityThread$AppBindData;->instrumentationArgs:Landroid/os/Bundle;

    move-object/from16 v8, p7

    iput-object v8, v3, Landroid/app/ActivityThread$AppBindData;->instrumentationWatcher:Landroid/app/IInstrumentationWatcher;

    move-object/from16 v9, p8

    iput-object v9, v3, Landroid/app/ActivityThread$AppBindData;->instrumentationUiAutomationConnection:Landroid/app/IUiAutomationConnection;

    move/from16 v10, p9

    iput v10, v3, Landroid/app/ActivityThread$AppBindData;->debugMode:I

    move/from16 v11, p10

    iput-boolean v11, v3, Landroid/app/ActivityThread$AppBindData;->enableBinderTracking:Z

    move/from16 v12, p11

    iput-boolean v12, v3, Landroid/app/ActivityThread$AppBindData;->trackAllocation:Z

    move/from16 v13, p12

    iput-boolean v13, v3, Landroid/app/ActivityThread$AppBindData;->restrictedBackupMode:Z

    move/from16 v14, p13

    iput-boolean v14, v3, Landroid/app/ActivityThread$AppBindData;->persistent:Z

    move-object/from16 v15, p14

    iput-object v15, v3, Landroid/app/ActivityThread$AppBindData;->config:Landroid/content/res/Configuration;
...
.method public notifyPackageForeground()V
    ...
    invoke-static {v0}, Landroid/app/ActivityThread;->access$202(Z)Z
