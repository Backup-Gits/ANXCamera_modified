...
.method public getMenuInflater()Landroid/view/MenuInflater;
    ...
    invoke-direct {v1, v0, p0}, Landroid/view/MenuInflater;-><init>(Landroid/content/Context;Ljava/lang/Object;)V
...
.method public isInMultiWindowMode()Z
    ...
    invoke-interface {v0, v1}, Landroid/app/IActivityTaskManager;->isInMultiWindowMode(Landroid/os/IBinder;)Z
...
.method public isInPictureInPictureMode()Z
    ...
    invoke-interface {v0, v1}, Landroid/app/IActivityTaskManager;->isInPictureInPictureMode(Landroid/os/IBinder;)Z
...
.method public onBackPressed()V
    ...
    new-instance v3, Landroid/app/Activity$1;

    invoke-direct {v3, p0}, Landroid/app/Activity$1;-><init>(Landroid/app/Activity;)V
...
.method protected onStop()V
    ...
    invoke-virtual {v2}, Landroid/view/autofill/AutofillManager;->onInvisibleForAutofill()V
    ...
    invoke-virtual {v4, v3}, Landroid/content/Intent;->getIBinderExtra(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v3

    invoke-virtual {v2, v0, v3}, Landroid/view/autofill/AutofillManager;->onPendingSaveUi(ILandroid/os/IBinder;)V
...
.method final performCreate(Landroid/os/Bundle;Landroid/os/PersistableBundle;)V
    ...
    const-string/jumbo v6, "performCreate"
    ...
    invoke-virtual {v5, p1}, Landroid/app/ActivityTransitionState;->readState(Landroid/os/Bundle;)V

    iget-object v5, p0, Landroid/app/Activity;->mWindow:Landroid/view/Window;

    invoke-virtual {v5}, Landroid/view/Window;->getWindowStyle()Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v0, p0, v5}, Landroid/app/ActivityTransitionState;->setEnterActivityOptions(Landroid/app/Activity;Landroid/app/ActivityOptions;)V
...
.method final performPause()V
    ...
    const-string/jumbo v10, "onPause"
...
.method final performStart(Ljava/lang/String;)V
    ...
    const-string v11, "Detected problems with app native libraries\n(please consult log for detail):\n"
...
.method final performStop(ZLjava/lang/String;)V
    ...
    invoke-static {v9}, Landroid/app/Activity$ManagedCursor;->access$200(Landroid/app/Activity$ManagedCursor;)Z

    move-result v10

    if-nez v10, :cond_2

    invoke-static {v9}, Landroid/app/Activity$ManagedCursor;->access$100(Landroid/app/Activity$ManagedCursor;)Landroid/database/Cursor;

    move-result-object v10

    invoke-interface {v10}, Landroid/database/Cursor;->deactivate()V

    invoke-static {v9, v1}, Landroid/app/Activity$ManagedCursor;->access$202(Landroid/app/Activity$ManagedCursor;Z)Z
...
.method public startActivityIfNeeded(Landroid/content/Intent;ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v13, p0}, Landroid/content/Intent;->prepareToLeaveProcess(Landroid/content/Context;)V
    ...
    invoke-interface/range {v2 .. v12}, Landroid/app/IActivityTaskManager;->startActivity(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;)I
    ...
    :goto_0
    invoke-static {v14, v13}, Landroid/app/Instrumentation;->checkStartActivityResult(ILjava/lang/Object;)V
