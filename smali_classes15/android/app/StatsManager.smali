...
.field public static final EXTRA_STATS_ACTIVE_CONFIG_KEYS:Ljava/lang/String; = "android.app.extra.STATS_ACTIVE_CONFIG_KEYS"
...
.method public getRegisteredExperimentIds()[J
    ...
    :cond_0
    :try_start_2
    invoke-interface {v1}, Landroid/os/IStatsManager;->getRegisteredExperimentIds()[J
...
.method public setActiveConfigsChangedOperation(Landroid/app/PendingIntent;)[J
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/app/StatsManager$StatsUnavailableException;
    ...
    invoke-interface {v0, v1}, Landroid/os/IStatsManager;->removeActiveConfigsChangedOperation(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1, v2}, Landroid/os/IStatsManager;->setActiveConfigsChangedOperation(Landroid/os/IBinder;Ljava/lang/String;)[J
    ...
    const-string v2, "Failed to connect to statsd when registering active configs listener."
...
.method public setPullerCallback(ILandroid/os/IStatsPullerCallback;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/app/StatsManager$StatsUnavailableException;
    ...
    invoke-interface {v0, p1, v1}, Landroid/os/IStatsManager;->unregisterPullerCallback(ILjava/lang/String;)V
    ...
    invoke-interface {v0, p1, p2, v1}, Landroid/os/IStatsManager;->registerPullerCallback(ILandroid/os/IStatsPullerCallback;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/SecurityException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
