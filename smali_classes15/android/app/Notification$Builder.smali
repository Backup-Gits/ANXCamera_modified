...
.method static synthetic access$2300(Landroid/app/Notification$Builder;ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    .locals 1
...
.method static synthetic access$2400(Landroid/app/Notification$Builder;)I
    .locals 1
...
.method static synthetic access$2500(Landroid/app/Notification$Builder;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    .locals 1
...
.method static synthetic access$2700(Landroid/app/Notification$Builder;Landroid/widget/RemoteViews;ILandroid/app/Notification$StandardTemplateParams;)V
    .locals 0
...
.method static synthetic access$2802(Landroid/app/Notification$Builder;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    .locals 0
...
.method static synthetic access$3100(Landroid/app/Notification$Builder;)I
    .locals 1
...
.method static synthetic access$3200(Landroid/app/Notification$Builder;)Landroid/os/Bundle;
    .locals 1
...
.method static synthetic access$3700(Landroid/app/Notification$Builder;)I
    .locals 1
...
.method static synthetic access$3800(Landroid/app/Notification$Builder;Landroid/app/Notification$StandardTemplateParams;)Z
    .locals 1
...
.method static synthetic access$4000(Landroid/app/Notification$Builder;)Z
    .locals 1
...
.method static synthetic access$4100(Landroid/app/Notification$Builder;ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    .locals 1
...
.method static synthetic access$4500(Landroid/app/Notification$Builder;ILandroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    .locals 1
...
.method private applyStandardTemplate(ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v3}, Landroid/app/Notification;->access$1800(Landroid/app/Notification;)Z
...
.method private applyStandardTemplateWithActions(ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v7, v9}, Landroid/os/Bundle;->getCharSequenceArray(Ljava/lang/String;)[Ljava/lang/CharSequence;
...
.method private bindActivePermissions(Landroid/widget/RemoteViews;Landroid/app/Notification$StandardTemplateParams;)V
    ...
    invoke-virtual {p1, v3, v2, v0, v1}, Landroid/widget/RemoteViews;->setDrawableTint(IZILandroid/graphics/PorterDuff$Mode;)V
...
.method private bindHeaderChronometerAndTime(Landroid/widget/RemoteViews;Landroid/app/Notification$StandardTemplateParams;)V
    ...
    invoke-static {v0}, Landroid/app/Notification;->access$2000(Landroid/app/Notification;)J
...
.method private bindLargeIcon(Landroid/widget/RemoteViews;Landroid/app/Notification$StandardTemplateParams;)Z
    ...
    invoke-static {v0}, Landroid/app/Notification;->access$1300(Landroid/app/Notification;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {v0, v1}, Landroid/app/Notification;->access$1302(Landroid/app/Notification;Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {v1}, Landroid/app/Notification;->access$1300(Landroid/app/Notification;)Landroid/graphics/drawable/Icon;
...
.method private bindNotificationHeader(Landroid/widget/RemoteViews;Landroid/app/Notification$StandardTemplateParams;)V
    ...
    invoke-static {v0, v1}, Landroid/app/Notification;->access$1602(Landroid/app/Notification;Z)Z
...
.method private bindReplyIcon(Landroid/widget/RemoteViews;Landroid/app/Notification$StandardTemplateParams;)Z
    ...
    invoke-static {v2}, Landroid/app/Notification$Action;->access$1900(Landroid/app/Notification$Action;)[Landroid/app/RemoteInput;
...
.method private bindSmallIcon(Landroid/widget/RemoteViews;Landroid/app/Notification$StandardTemplateParams;)V
    ...
    invoke-static {v0}, Landroid/app/Notification;->access$2100(Landroid/app/Notification;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {v0, v1}, Landroid/app/Notification;->access$2102(Landroid/app/Notification;Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;
...
.method private generateActionButton(Landroid/app/Notification$Action;ZLandroid/app/Notification$StandardTemplateParams;)Landroid/widget/RemoteViews;
    ...
    invoke-static {p1}, Landroid/app/Notification$Action;->access$1900(Landroid/app/Notification$Action;)[Landroid/app/RemoteInput;
...
.method private handleProgressBar(Landroid/widget/RemoteViews;Landroid/os/Bundle;Landroid/app/Notification$StandardTemplateParams;)Z
    ...
    invoke-virtual {p1, v5, v1, v2, v3}, Landroid/widget/RemoteViews;->setProgressBar(IIIZ)V
    ...
    invoke-virtual {p1, v5, v0}, Landroid/widget/RemoteViews;->setProgressBackgroundTintList(ILandroid/content/res/ColorStateList;)V
...
.method private makePublicView(Z)Landroid/widget/RemoteViews;
    ...
    invoke-static {v3}, Landroid/app/Notification;->access$1300(Landroid/app/Notification;)Landroid/graphics/drawable/Icon;

    move-result-object v3

    iget-object v4, p0, Landroid/app/Notification$Builder;->mN:Landroid/app/Notification;

    invoke-static {v4, v2}, Landroid/app/Notification;->access$1302(Landroid/app/Notification;Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;
    ...
    invoke-virtual {v6, v8, v10, v9}, Landroid/widget/RemoteViews;->setBoolean(ILjava/lang/String;Z)V
    ...
    invoke-static {v8, v3}, Landroid/app/Notification;->access$1302(Landroid/app/Notification;Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;
...
.method private resetNotificationHeader(Landroid/widget/RemoteViews;)V
    ...
    invoke-static {v1, v0}, Landroid/app/Notification;->access$1602(Landroid/app/Notification;Z)Z
...
.method public build()Landroid/app/Notification;
    ...
    invoke-static {v0, v1, v2}, Landroid/app/Notification;->access$2002(Landroid/app/Notification;J)J
...
.method public setAllowSystemGeneratedContextualActions(Z)Landroid/app/Notification$Builder;
    ...
    invoke-static {v0, p1}, Landroid/app/Notification;->access$2202(Landroid/app/Notification;Z)Z
...
.method public setBubbleMetadata(Landroid/app/Notification$BubbleMetadata;)Landroid/app/Notification$Builder;
    ...
    invoke-static {v0, p1}, Landroid/app/Notification;->access$1002(Landroid/app/Notification;Landroid/app/Notification$BubbleMetadata;)Landroid/app/Notification$BubbleMetadata;
...
.method public setGroup(Ljava/lang/String;)Landroid/app/Notification$Builder;
    ...
    invoke-static {v0, p1}, Landroid/app/Notification;->access$1402(Landroid/app/Notification;Ljava/lang/String;)Ljava/lang/String;
...
.method public setLargeIcon(Landroid/graphics/drawable/Icon;)Landroid/app/Notification$Builder;
    ...
    invoke-static {v0, p1}, Landroid/app/Notification;->access$1302(Landroid/app/Notification;Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;
...
.method public setLocusId(Landroid/content/LocusId;)Landroid/app/Notification$Builder;
    ...
    invoke-static {v0, p1}, Landroid/app/Notification;->access$702(Landroid/app/Notification;Landroid/content/LocusId;)Landroid/content/LocusId;
...
.method public setRemoteInputHistory([Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
    ...
    invoke-static {v4}, Landroid/app/Notification;->safeCharSequence(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3, v0, v2}, Landroid/os/Bundle;->putCharSequenceArray(Ljava/lang/String;[Ljava/lang/CharSequence;)V
...
.method public setSettingsText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
    ...
    invoke-static {v0, v1}, Landroid/app/Notification;->access$1202(Landroid/app/Notification;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method public setTimeout(J)Landroid/app/Notification$Builder;
    ...
    invoke-static {v0, p1, p2}, Landroid/app/Notification;->access$1102(Landroid/app/Notification;J)J
...
.method public usesStandardHeader()Z
    ...
    invoke-static {}, Landroid/app/Notification;->access$1700()Landroid/util/ArraySet;
