...
.field public static final ACTION_ENTER_CAST_MODE:Ljava/lang/String; = "android.intent.action.ENTER_CAST_MODE"

.field public static final ACTION_EXIT_CAST_MODE:Ljava/lang/String; = "android.intent.action.EXIT_CAST_MODE"
...
.field public static final ACTION_MICPHONE_PLUG:Ljava/lang/String; = "android.media.extra.AUDIO_MIC_PLUG_STATE"
...
.field public static final EXTRA_SERVICE_STATE:Ljava/lang/String; = "android.intent.extra.SERVICE_STATE"
...
.method private constructor <init>(Landroid/content/Intent;I)V
    ...
    iput-object v1, p0, Landroid/content/Intent;->mSourceBounds:Landroid/graphics/Rect;
...
.method private static getIntentOld(Ljava/lang/String;I)Landroid/content/Intent;
    ...
    invoke-virtual {v1, v0, v8, v7, v6}, Ljava/lang/String;->regionMatches(ILjava/lang/String;II)Z
    ...
    invoke-virtual {v1, v0, v11, v7, v10}, Ljava/lang/String;->regionMatches(ILjava/lang/String;II)Z
    ...
    invoke-virtual {v1, v0, v12, v7, v10}, Ljava/lang/String;->regionMatches(ILjava/lang/String;II)Z
    ...
    iput-object v12, v8, Landroid/content/Intent;->mType:Ljava/lang/String;
    ...
    iput v12, v8, Landroid/content/Intent;->mFlags:I

    and-int/lit8 v12, p1, 0x4

    if-nez v12, :cond_7

    iget v12, v8, Landroid/content/Intent;->mFlags:I
    ...
    iput-object v15, v8, Landroid/content/Intent;->mComponent:Landroid/content/ComponentName;
    ...
    invoke-virtual {v1, v0, v10, v7, v6}, Ljava/lang/String;->regionMatches(ILjava/lang/String;II)Z
    ...
    iget-object v0, v8, Landroid/content/Intent;->mExtras:Landroid/os/Bundle;
    ...
    iput-object v0, v8, Landroid/content/Intent;->mExtras:Landroid/os/Bundle;
    ...
    :goto_5
    iget-object v6, v8, Landroid/content/Intent;->mAction:Ljava/lang/String;

    if-nez v6, :cond_1b

    iput-object v2, v8, Landroid/content/Intent;->mAction:Ljava/lang/String;
...
.method public static parseCommandArgs(Landroid/os/ShellCommand;Landroid/content/Intent$CommandOptionHandler;)Landroid/content/Intent;
    ...
    :sswitch_0
    const-string v11, "--grant-write-uri-permission"
    ...
    :sswitch_1
    const-string v11, "--activity-multiple-task"
    ...
    :sswitch_2
    const-string v11, "--grant-read-uri-permission"
    ...
    :sswitch_3
    const-string v11, "--receiver-foreground"
    ...
    :sswitch_4
    const-string v11, "--receiver-no-abort"
    ...
    :sswitch_5
    const-string v11, "--activity-launched-from-history"
    ...
    :sswitch_6
    const-string v11, "--activity-clear-when-task-reset"
    ...
    :sswitch_c
    const-string v11, "--activity-match-external"
    ...
    :sswitch_d
    const-string v11, "--receiver-replace-pending"
    ...
    :sswitch_e
    const-string v11, "--include-stopped-packages"
    ...
    :sswitch_f
    const-string v11, "--exclude-stopped-packages"
    ...
    :sswitch_10
    const-string v11, "--grant-persistable-uri-permission"
    ...
    :sswitch_11
    const-string v11, "--activity-single-top"
    ...
    :sswitch_12
    const-string v11, "--receiver-registered-only"
    ...
    :sswitch_13
    const-string v11, "--activity-no-user-action"
    ...
    :sswitch_14
    const-string v11, "--activity-clear-top"
    ...
    :sswitch_15
    const-string v11, "--activity-reset-task-if-needed"
    ...
    :sswitch_16
    const-string v11, "--activity-no-animation"
    ...
    :sswitch_17
    const-string v11, "--activity-exclude-from-recents"
    ...
    :sswitch_2d
    const-string v11, "--receiver-include-background"
    ...
    :sswitch_2e
    const-string v11, "--activity-previous-is-top"
    ...
    :sswitch_2f
    const-string v11, "--activity-brought-to-front"
    ...
    :sswitch_30
    const-string v11, "--activity-reorder-to-front"
    ...
    :sswitch_31
    const-string v11, "--debug-log-resolution"
    ...
    :sswitch_32
    const-string v11, "--activity-clear-task"
    ...
    :sswitch_33
    const-string v11, "--activity-no-history"
    ...
    :sswitch_34
    const-string v11, "--activity-task-on-home"
    ...
    :sswitch_35
    const-string v11, "--grant-prefix-uri-permission"
    ...
    invoke-interface {v1, v7, v8}, Landroid/content/Intent$CommandOptionHandler;->handleOption(Ljava/lang/String;Landroid/os/ShellCommand;)Z
    ...
    invoke-virtual {v3, v11}, Landroid/content/Intent;->replaceExtras(Landroid/os/Bundle;)Landroid/content/Intent;

    invoke-virtual {v2}, Landroid/content/Intent;->getExtras()Landroid/os/Bundle;

    move-result-object v12

    invoke-virtual {v2, v11}, Landroid/content/Intent;->replaceExtras(Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    invoke-virtual {v3, v2, v11}, Landroid/content/Intent;->fillIn(Landroid/content/Intent;I)I
    ...
    const-string v11, "No intent supplied"
...
.method private writeToProtoWithoutFieldId(Landroid/util/proto/ProtoOutputStream;ZZZZ)V
    .locals 4
...
.method public migrateExtraStreamToClipData()Z
    ...
    invoke-virtual {p0, v4}, Landroid/content/Intent;->getCharSequenceExtra(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v9, v4, v3, v6, v2}, Landroid/content/ClipData$Item;-><init>(Ljava/lang/CharSequence;Ljava/lang/String;Landroid/content/Intent;Landroid/net/Uri;)V

    invoke-direct {v5, v6, v8, v9}, Landroid/content/ClipData;-><init>(Ljava/lang/CharSequence;[Ljava/lang/String;Landroid/content/ClipData$Item;)V
    ...
    invoke-virtual {p0, v4}, Landroid/content/Intent;->getCharSequenceArrayListExtra(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v4

    invoke-virtual {p0, v3}, Landroid/content/Intent;->getStringArrayListExtra(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v2, v4, v3, v1}, Landroid/content/Intent;->makeClipItem(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;I)Landroid/content/ClipData$Item;

    move-result-object v10

    invoke-direct {v8, v6, v9, v10}, Landroid/content/ClipData;-><init>(Ljava/lang/CharSequence;[Ljava/lang/String;Landroid/content/ClipData$Item;)V
    ...
    invoke-static {v2, v4, v3, v8}, Landroid/content/Intent;->makeClipItem(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;I)Landroid/content/ClipData$Item;
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;)V
    ...
    invoke-direct/range {v0 .. v5}, Landroid/content/Intent;->writeToProtoWithoutFieldId(Landroid/util/proto/ProtoOutputStream;ZZZZ)V
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;JZZZZ)V
    ...
    invoke-direct/range {v2 .. v7}, Landroid/content/Intent;->writeToProtoWithoutFieldId(Landroid/util/proto/ProtoOutputStream;ZZZZ)V
