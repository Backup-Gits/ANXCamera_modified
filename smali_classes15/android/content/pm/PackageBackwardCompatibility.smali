...
.method static constructor <clinit>()V
    ...
    new-instance v1, Landroid/content/pm/OrgApacheHttpLegacyUpdater;

    invoke-direct {v1}, Landroid/content/pm/OrgApacheHttpLegacyUpdater;-><init>()V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Landroid/content/pm/AndroidHidlUpdater;

    invoke-direct {v1}, Landroid/content/pm/AndroidHidlUpdater;-><init>()V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Landroid/content/pm/PackageBackwardCompatibility$AndroidTestRunnerSplitUpdater;

    invoke-direct {v1}, Landroid/content/pm/PackageBackwardCompatibility$AndroidTestRunnerSplitUpdater;-><init>()V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v1, Landroid/content/pm/-$$Lambda$jpya2qgMDDEok2GAoKRDqPM5lIE;->INSTANCE:Landroid/content/pm/-$$Lambda$jpya2qgMDDEok2GAoKRDqPM5lIE;

    const-string v2, "android.content.pm.AndroidTestBaseUpdater"

    invoke-static {v0, v2, v1}, Landroid/content/pm/PackageBackwardCompatibility;->addOptionalUpdater(Ljava/util/List;Ljava/lang/String;Ljava/util/function/Supplier;)Z
    ...
    new-array v2, v2, [Landroid/content/pm/PackageSharedLibraryUpdater;
    ...
    new-instance v3, Landroid/content/pm/PackageBackwardCompatibility;

    invoke-direct {v3, v1, v2}, Landroid/content/pm/PackageBackwardCompatibility;-><init>(Z[Landroid/content/pm/PackageSharedLibraryUpdater;)V

    sput-object v3, Landroid/content/pm/PackageBackwardCompatibility;->INSTANCE:Landroid/content/pm/PackageBackwardCompatibility;

    return-void
.end method

.method private constructor <init>(Z[Landroid/content/pm/PackageSharedLibraryUpdater;)V
    .locals 0

    invoke-direct {p0}, Landroid/content/pm/PackageSharedLibraryUpdater;-><init>()V

    iput-boolean p1, p0, Landroid/content/pm/PackageBackwardCompatibility;->mBootClassPathContainsATB:Z

    iput-object p2, p0, Landroid/content/pm/PackageBackwardCompatibility;->mPackageUpdaters:[Landroid/content/pm/PackageSharedLibraryUpdater;
