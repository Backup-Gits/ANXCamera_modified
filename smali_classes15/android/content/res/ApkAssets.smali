...
.method private constructor <init>(Ljava/io/FileDescriptor;Ljava/lang/String;ZZ)V
    ...
    new-instance v1, Landroid/content/res/StringBlock;

    iget-wide v2, p0, Landroid/content/res/ApkAssets;->mNativePtr:J

    invoke-static {v2, v3}, Landroid/content/res/ApkAssets;->nativeGetStringBlock(J)J

    move-result-wide v2

    invoke-direct {v1, v2, v3, v0}, Landroid/content/res/StringBlock;-><init>(JZ)V

    iput-object v1, p0, Landroid/content/res/ApkAssets;->mStringBlock:Landroid/content/res/StringBlock;
