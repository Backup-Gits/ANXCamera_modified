...
.method private onMeasureExactFormat(II)V
    ...
    iput-boolean v10, v9, Landroid/widget/ActionMenuView$LayoutParams;->expanded:Z

    iput v10, v9, Landroid/widget/ActionMenuView$LayoutParams;->extraPixels:I

    iput v10, v9, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I

    iput-boolean v10, v9, Landroid/widget/ActionMenuView$LayoutParams;->expandable:Z

    iput v10, v9, Landroid/widget/ActionMenuView$LayoutParams;->leftMargin:I

    iput v10, v9, Landroid/widget/ActionMenuView$LayoutParams;->rightMargin:I
    ...
    invoke-virtual {v10}, Lcom/android/internal/view/menu/ActionMenuItemView;->hasText()Z
    ...
    :goto_2
    iput-boolean v10, v9, Landroid/widget/ActionMenuView$LayoutParams;->preventEdgeOffset:Z

    iget-boolean v10, v9, Landroid/widget/ActionMenuView$LayoutParams;->isOverflowButton:Z
    ...
    invoke-static {v4, v8, v10, v6, v5}, Landroid/widget/ActionMenuView;->measureChildForCells(Landroid/view/View;IIII)I
    ...
    iget-boolean v5, v9, Landroid/widget/ActionMenuView$LayoutParams;->expandable:Z
    ...
    :cond_5
    iget-boolean v5, v9, Landroid/widget/ActionMenuView$LayoutParams;->isOverflowButton:Z
    ...
    iget-boolean v10, v7, Landroid/widget/ActionMenuView$LayoutParams;->expandable:Z
    ...
    :cond_a
    iget v10, v7, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I

    if-ge v10, v9, :cond_b

    iget v9, v7, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I
    ...
    iget v2, v12, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I
    ...
    iget-boolean v2, v12, Landroid/widget/ActionMenuView$LayoutParams;->preventEdgeOffset:Z
    ...
    iput v2, v12, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I

    iput-boolean v3, v12, Landroid/widget/ActionMenuView$LayoutParams;->expanded:Z
    ...
    iget-boolean v11, v9, Landroid/widget/ActionMenuView$LayoutParams;->preventEdgeOffset:Z
    ...
    instance-of v12, v9, Lcom/android/internal/view/menu/ActionMenuItemView;

    if-eqz v12, :cond_1d

    iput v4, v11, Landroid/widget/ActionMenuView$LayoutParams;->extraPixels:I

    const/4 v12, 0x1

    iput-boolean v12, v11, Landroid/widget/ActionMenuView$LayoutParams;->expanded:Z

    if-nez v7, :cond_1c

    iget-boolean v12, v11, Landroid/widget/ActionMenuView$LayoutParams;->preventEdgeOffset:Z
    ...
    iput v12, v11, Landroid/widget/ActionMenuView$LayoutParams;->leftMargin:I
    ...
    iput v12, v11, Landroid/widget/ActionMenuView$LayoutParams;->rightMargin:I
    ...
    iget-boolean v11, v9, Landroid/widget/ActionMenuView$LayoutParams;->expanded:Z
    ...
    :cond_23
    iget v11, v9, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I

    mul-int/2addr v11, v8

    iget v12, v9, Landroid/widget/ActionMenuView$LayoutParams;->extraPixels:I
    ...
    invoke-virtual {v0, v4, v3}, Landroid/widget/ActionMenuView;->setMeasuredDimension(II)V
