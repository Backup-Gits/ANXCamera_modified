...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/widget/Editor$3;-><init>()V
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    invoke-direct {v0, p0, v2}, Landroid/widget/Editor$ProcessTextIntentActionsHandler;-><init>(Landroid/widget/Editor;Landroid/widget/Editor$1;)V
...
.method static synthetic access$2500(Landroid/widget/Editor;)I
    .locals 1
...
.method static synthetic access$2800(Landroid/widget/Editor;)Landroid/widget/Editor$PositionListener;
    .locals 1
...
.method static synthetic access$3600(Landroid/widget/Editor;IIZ)V
    .locals 0
...
.method static synthetic access$4500(Landroid/widget/Editor;Landroid/content/Context;Landroid/content/Intent;)V
    .locals 0
...
.method static synthetic access$4700(Landroid/widget/Editor;)Landroid/widget/SelectionActionModeHelper;
    .locals 1
...
.method static synthetic access$4800(Landroid/view/View;)F
    .locals 1
...
.method static synthetic access$4900(Landroid/widget/Editor;II)Z
    .locals 1
...
.method static synthetic access$5000(Landroid/widget/Editor;)Landroid/widget/Editor$MagnifierMotionAnimator;
    .locals 1
...
.method static synthetic access$5402(Landroid/widget/Editor;Z)Z
    .locals 0
...
.method static synthetic access$5500(Landroid/widget/Editor;)V
    .locals 0
...
.method static synthetic access$5800(Landroid/widget/Editor;)V
    .locals 0
...
.method static synthetic access$600(Landroid/widget/Editor;)Landroid/widget/Editor$EmailAddPopupWindow;
    .locals 1
...
.method static synthetic access$6000(Landroid/widget/Editor;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$6002(Landroid/widget/Editor;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    .locals 0
...
.method static synthetic access$6100(Landroid/widget/Editor;)I
    .locals 1
...
.method static synthetic access$6200(Landroid/widget/Editor;)Z
    .locals 1
...
.method static synthetic access$6300(Landroid/widget/Editor;)Landroid/view/ActionMode;
    .locals 1
...
.method static synthetic access$6400(Landroid/widget/Editor;Landroid/text/Layout;IF)I
    .locals 1
...
.method static synthetic access$6900(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    .locals 1
...
.method static synthetic access$6902(Landroid/widget/Editor;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    .locals 0
...
.method static synthetic access$7000(Landroid/widget/Editor;)F
    .locals 1
...
.method static synthetic access$7100(Landroid/widget/Editor;)F
    .locals 1
...
.method static synthetic access$7200(Landroid/widget/Editor;FF)Z
    .locals 1
...
.method static synthetic access$7300(Landroid/widget/Editor;)Z
    .locals 1
...
.method static synthetic access$7400(Landroid/widget/Editor;)V
    .locals 0
...
.method static synthetic access$7600(Landroid/widget/Editor;I)I
    .locals 1
...
.method static synthetic access$7700(Landroid/widget/Editor;I)I
    .locals 1
...
.method static synthetic access$7800(Landroid/widget/Editor;IZ)I
    .locals 1
...
.method static synthetic access$7900(Landroid/widget/Editor;II)J
    .locals 2
...
.method private drawHardwareAccelerated(Landroid/graphics/Canvas;Landroid/text/Layout;Landroid/graphics/Path;Landroid/graphics/Paint;I)V
    ...
    invoke-virtual {v10, v9}, Landroid/text/Layout;->getLineRangeForDraw(Landroid/graphics/Canvas;)J
    ...
    instance-of v0, v10, Landroid/text/DynamicLayout;
    ...
    iput-object v0, v1, Landroid/widget/Editor;->mTextRenderNodes:[Landroid/widget/Editor$TextRenderNode;
    ...
    invoke-virtual {v2}, Landroid/text/DynamicLayout;->getIndexFirstChangedBlock()I
    ...
    invoke-direct {v1, v4, v5, v0}, Landroid/widget/Editor;->getAvailableDisplayListIndex([III)I
    ...
    iput-boolean v0, v12, Landroid/widget/Editor$TextRenderNode;->isDirty:Z
    ...
    new-instance v12, Landroid/widget/Editor$TextRenderNode;
    ...
    invoke-direct {v12, v4}, Landroid/widget/Editor$TextRenderNode;-><init>(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Landroid/widget/Editor$TextRenderNode;->renderNode:Landroid/graphics/RenderNode;
    ...
    invoke-virtual {v11, v0, v14}, Landroid/graphics/RenderNode;->start(II)Landroid/graphics/RecordingCanvas;
    ...
    :try_start_0
    invoke-virtual {v14, v0, v4}, Landroid/graphics/RecordingCanvas;->translate(FF)V

    invoke-virtual {v10, v14, v12, v15}, Landroid/text/Layout;->drawText(Landroid/graphics/Canvas;II)V
    ...
    iput-boolean v4, v0, Landroid/widget/Editor$TextRenderNode;->isDirty:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {v11, v14}, Landroid/graphics/RenderNode;->end(Landroid/graphics/RecordingCanvas;)V

    invoke-virtual {v11, v4}, Landroid/graphics/RenderNode;->setClipToBounds(Z)Z
    ...
    :goto_8
    invoke-virtual {v11, v13, v6, v2, v7}, Landroid/graphics/RenderNode;->setLeftTopRightBottom(IIII)Z
    ...
    invoke-virtual {v0, v11}, Landroid/graphics/RecordingCanvas;->drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    invoke-virtual {v2, v5}, Landroid/text/DynamicLayout;->setIndexFirstChangedBlock(I)V
    ...
    invoke-virtual {v10, v9, v2, v3}, Landroid/text/Layout;->drawText(Landroid/graphics/Canvas;II)V
...
.method private getCharRange(I)J
    ...
    invoke-static {p1, v3}, Landroid/text/TextUtils;->packRangeInLong(II)J
...
.method private getTextThumbnailBuilder(II)Landroid/view/View$DragShadowBuilder;
    ...
    invoke-direct {p0, v2}, Landroid/widget/Editor;->getCharClusterRange(I)J
...
.method private isPositionVisible(II)Z
    ...
    :try_start_0
    sget-object v1, Landroid/widget/Editor;->TEMP_POSITION:[F
...
.method private setSelectionTranslation(II)V
    ...
    invoke-virtual {v2, v0}, Landroid/widget/Editor$SelectionModifierCursorController;->setTranslationCache([F)V
...
.method private showError()V
    ...
    invoke-virtual {v1, v2, v3, v4}, Landroid/widget/Editor$ErrorPopup;->showAsDropDown(Landroid/view/View;II)V
...
.method getEmailPopupWindow()Landroid/widget/Editor$EmailAddPopupWindow;
    ...
    invoke-static {v0}, Landroid/widget/Editor$SelectionModifierCursorController;->access$300(Landroid/widget/Editor$SelectionModifierCursorController;)V
...
.method public isInSwipeSelectionMode()Z
    ...
    invoke-static {v0}, Landroid/widget/Editor$SelectionModifierCursorController;->access$700(Landroid/widget/Editor$SelectionModifierCursorController;)Z
...
.method loadHandleDrawables(Z)V
    ...
    invoke-static {v0}, Landroid/widget/Editor$InsertionPointCursorController;->access$8000(Landroid/widget/Editor$InsertionPointCursorController;)V
    ...
    invoke-static {v0}, Landroid/widget/Editor$SelectionModifierCursorController;->access$8100(Landroid/widget/Editor$SelectionModifierCursorController;)V
...
.method onDraw(Landroid/graphics/Canvas;Landroid/text/Layout;Landroid/graphics/Path;Landroid/graphics/Paint;I)V
    ...
    iget-object v11, v6, Landroid/widget/Editor;->mInputMethodState:Landroid/widget/Editor$InputMethodState;

    if-eqz v11, :cond_2

    iget v1, v11, Landroid/widget/Editor$InputMethodState;->mBatchEditNesting:I

    if-nez v1, :cond_2

    invoke-direct/range {p0 .. p0}, Landroid/widget/Editor;->getInputMethodManager()Landroid/view/inputmethod/InputMethodManager;

    move-result-object v1

    if-eqz v1, :cond_2

    iget-object v2, v6, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;
    ...
    iget-boolean v3, v11, Landroid/widget/Editor$InputMethodState;->mContentChanged:Z

    if-nez v3, :cond_0

    iget-boolean v3, v11, Landroid/widget/Editor$InputMethodState;->mSelectionModeChanged:Z
    ...
    invoke-virtual {v1, v2}, Landroid/view/inputmethod/InputMethodManager;->isWatchingCursor(Landroid/view/View;)Z
    ...
    iget-object v2, v11, Landroid/widget/Editor$InputMethodState;->mTmpRectF:Landroid/graphics/RectF;

    const/4 v3, 0x1

    invoke-virtual {v0, v2, v3}, Landroid/graphics/Path;->computeBounds(Landroid/graphics/RectF;Z)V

    iget-object v2, v11, Landroid/widget/Editor$InputMethodState;->mTmpOffset:[F

    iget-object v4, v11, Landroid/widget/Editor$InputMethodState;->mTmpOffset:[F
    ...
    iget-object v12, v11, Landroid/widget/Editor$InputMethodState;->mTmpOffset:[F
    ...
    invoke-virtual {v2, v5, v3}, Landroid/graphics/RectF;->offset(FF)V

    iget-object v2, v11, Landroid/widget/Editor$InputMethodState;->mCursorRectInWindow:Landroid/graphics/Rect;

    iget-object v3, v11, Landroid/widget/Editor$InputMethodState;->mTmpRectF:Landroid/graphics/RectF;
    ...
    iget-object v4, v11, Landroid/widget/Editor$InputMethodState;->mTmpRectF:Landroid/graphics/RectF;
    ...
    iget-object v5, v11, Landroid/widget/Editor$InputMethodState;->mTmpRectF:Landroid/graphics/RectF;
    ...
    iget-object v14, v11, Landroid/widget/Editor$InputMethodState;->mTmpRectF:Landroid/graphics/RectF;
    ...
    iget-object v13, v6, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;
    ...
    iget-object v3, v11, Landroid/widget/Editor$InputMethodState;->mCursorRectInWindow:Landroid/graphics/Rect;
    ...
    invoke-virtual/range {v12 .. v17}, Landroid/view/inputmethod/InputMethodManager;->updateCursor(Landroid/view/View;IIII)V

    :cond_2
    iget-object v1, v6, Landroid/widget/Editor;->mCorrectionHighlighter:Landroid/widget/Editor$CorrectionHighlighter;

    if-eqz v1, :cond_3

    invoke-virtual {v1, v7, v8}, Landroid/widget/Editor$CorrectionHighlighter;->draw(Landroid/graphics/Canvas;I)V
    ...
    iget-object v1, v6, Landroid/widget/Editor;->mDrawableForCursor:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_4

    invoke-direct {v6, v7, v8}, Landroid/widget/Editor;->drawCursor(Landroid/graphics/Canvas;I)V
    ...
    :goto_0
    iget-object v0, v6, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;
    ...
    invoke-direct/range {v0 .. v5}, Landroid/widget/Editor;->drawHardwareAccelerated(Landroid/graphics/Canvas;Landroid/text/Layout;Landroid/graphics/Path;Landroid/graphics/Paint;I)V
    ...
    invoke-virtual {v0, v7, v12, v1, v8}, Landroid/text/Layout;->draw(Landroid/graphics/Canvas;Landroid/graphics/Path;Landroid/graphics/Paint;I)V
...
.method onTouchUpEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v0}, Landroid/widget/Editor$InsertionPointCursorController;->access$800(Landroid/widget/Editor$InsertionPointCursorController;)Landroid/widget/Editor$InsertionHandleView;

    move-result-object v0

    invoke-virtual {v0}, Landroid/widget/Editor$InsertionHandleView;->isPopshowing()Z
...
.method selectCurrentWord()Z
    ...
    :cond_6
    :goto_0
    invoke-direct {p0, v8, v9}, Landroid/widget/Editor;->setSelectionTranslation(II)V
    ...
    invoke-static {v6, v8, v9}, Landroid/text/Selection;->setSelection(Landroid/text/Spannable;II)V
...
.method updateCursorPosition()V
    ...
    invoke-direct {p0, v1}, Landroid/widget/Editor;->handleEmailPopup(I)V
