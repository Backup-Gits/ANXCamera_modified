...
.method public constructor <init>()V
    ...
    iget v5, p0, Landroid/view/animation/SpringInterpolator;->response:F
    ...
    iget v2, p0, Landroid/view/animation/SpringInterpolator;->k:F

    mul-float/2addr v4, v2

    iget v2, p0, Landroid/view/animation/SpringInterpolator;->c:F
    ...
    iget v3, p0, Landroid/view/animation/SpringInterpolator;->r:F
    ...
    iget v3, p0, Landroid/view/animation/SpringInterpolator;->w:F
...
.method public constructor <init>(FF)V
    ...
    iput v0, p0, Landroid/view/animation/SpringInterpolator;->initial:F

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Landroid/view/animation/SpringInterpolator;->m:F
    ...
    iput v0, p0, Landroid/view/animation/SpringInterpolator;->c:F

    const/high16 v0, 0x40800000    # 4.0f

    mul-float/2addr v2, v0

    iget v0, p0, Landroid/view/animation/SpringInterpolator;->k:F

    mul-float/2addr v2, v0

    iget v0, p0, Landroid/view/animation/SpringInterpolator;->c:F
    ...
    iput v0, p0, Landroid/view/animation/SpringInterpolator;->r:F

    iget v0, p0, Landroid/view/animation/SpringInterpolator;->initial:F

    iput v0, p0, Landroid/view/animation/SpringInterpolator;->c1:F

    iget v1, p0, Landroid/view/animation/SpringInterpolator;->r:F
    ...
    iget v1, p0, Landroid/view/animation/SpringInterpolator;->w:F

    div-float/2addr v0, v1

    iput v0, p0, Landroid/view/animation/SpringInterpolator;->c2:F
...
.method public constructor <init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;)V
    ...
    iget v4, p0, Landroid/view/animation/SpringInterpolator;->response:F
    ...
    iget v1, p0, Landroid/view/animation/SpringInterpolator;->k:F

    mul-float/2addr v3, v1

    iget v1, p0, Landroid/view/animation/SpringInterpolator;->c:F
    ...
    iget v1, p0, Landroid/view/animation/SpringInterpolator;->initial:F

    iput v1, p0, Landroid/view/animation/SpringInterpolator;->c1:F

    iget v2, p0, Landroid/view/animation/SpringInterpolator;->r:F
    ...
    iget v2, p0, Landroid/view/animation/SpringInterpolator;->w:F

    div-float/2addr v1, v2

    iput v1, p0, Landroid/view/animation/SpringInterpolator;->c2:F
...
.method private refreshParams()V
    ...
    iget v0, p0, Landroid/view/animation/SpringInterpolator;->w:F
