...
.method public addToDisplay(Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/view/InputChannel;Landroid/view/InsetsState;)I
    ...
    invoke-virtual {v14, v15, v1}, Landroid/view/WindowManager$LayoutParams;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_3
    ...
    iget-object v2, v9, Landroid/view/IWindowSession$Stub$Proxy;->mRemote:Landroid/os/IBinder;

    invoke-interface {v2, v0, v15, v13, v1}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :try_start_c
    invoke-virtual {v7, v3}, Landroid/view/DisplayCutout$ParcelableWrapper;->readFromParcel(Landroid/os/Parcel;)V
    ...
    :try_start_d
    invoke-virtual {v8, v3}, Landroid/view/InputChannel;->readFromParcel(Landroid/os/Parcel;)V
    ...
    :try_start_e
    invoke-virtual {v9, v3}, Landroid/view/InsetsState;->readFromParcel(Landroid/os/Parcel;)V
    :try_end_e
...
.method public finishDrawing(Landroid/view/IWindow;)V
    ...
    invoke-interface {v3, p1}, Landroid/view/IWindowSession;->finishDrawing(Landroid/view/IWindow;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public insetsModified(Landroid/view/IWindow;Landroid/view/InsetsState;)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/view/IWindowSession;->insetsModified(Landroid/view/IWindow;Landroid/view/InsetsState;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public isFocusWindowAdaptNotch(I)Z
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v3, p1}, Landroid/view/IWindowSession;->isFocusWindowAdaptNotch(I)Z
...
.method public notifyHasSurfaceView(Landroid/os/IBinder;Z)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/view/IWindowSession;->notifyHasSurfaceView(Landroid/os/IBinder;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public relayout(Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IIIIJLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/util/MergedConfiguration;Landroid/view/SurfaceControl;Landroid/view/InsetsState;)I
    ...
    invoke-virtual {v15, v14, v0}, Landroid/view/WindowManager$LayoutParams;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    iget-object v1, v5, Landroid/view/IWindowSession$Stub$Proxy;->mRemote:Landroid/os/IBinder;

    const/4 v2, 0x4

    invoke-interface {v1, v2, v14, v13, v0}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :try_start_7
    invoke-virtual/range {v22 .. v22}, Landroid/os/Parcel;->readException()V
    ...
    :try_start_f
    invoke-virtual {v10, v3}, Landroid/view/DisplayCutout$ParcelableWrapper;->readFromParcel(Landroid/os/Parcel;)V
    ...
    :try_start_10
    invoke-virtual {v11, v3}, Landroid/util/MergedConfiguration;->readFromParcel(Landroid/os/Parcel;)V
    ...
    :try_start_11
    invoke-virtual {v12, v3}, Landroid/view/SurfaceControl;->readFromParcel(Landroid/os/Parcel;)V
    ...
    :try_start_12
    invoke-virtual {v13, v3}, Landroid/view/InsetsState;->readFromParcel(Landroid/os/Parcel;)V
    :try_end_12
...
.method public setWallpaperPosition(Landroid/os/IBinder;FFFF)V
    ...
    invoke-interface/range {v4 .. v9}, Landroid/view/IWindowSession;->setWallpaperPosition(Landroid/os/IBinder;FFFF)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public updateTapExcludeRegion(Landroid/view/IWindow;ILandroid/graphics/Region;)V
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/view/IWindowSession;->updateTapExcludeRegion(Landroid/view/IWindow;ILandroid/graphics/Region;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
