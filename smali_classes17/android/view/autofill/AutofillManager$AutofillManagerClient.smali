...
.method static synthetic lambda$authenticate$2(Landroid/view/autofill/AutofillManager;IILandroid/content/IntentSender;Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, Landroid/view/autofill/AutofillManager;->access$2200(Landroid/view/autofill/AutofillManager;IILandroid/content/IntentSender;Landroid/content/Intent;)V
...
.method static synthetic lambda$dispatchUnhandledKey$6(Landroid/view/autofill/AutofillManager;ILandroid/view/autofill/AutofillId;Landroid/view/KeyEvent;)V
    ...
    invoke-static {p0, p1, p2, p3}, Landroid/view/autofill/AutofillManager;->access$1800(Landroid/view/autofill/AutofillManager;ILandroid/view/autofill/AutofillId;Landroid/view/KeyEvent;)V

    return-void
.end method

.method static synthetic lambda$getAugmentedAutofillClient$11(Landroid/view/autofill/AutofillManager;Lcom/android/internal/os/IResultReceiver;)V
    .locals 0

    invoke-static {p0, p1}, Landroid/view/autofill/AutofillManager;->access$1400(Landroid/view/autofill/AutofillManager;Lcom/android/internal/os/IResultReceiver;)V
...
.method static synthetic lambda$notifyNoFillUi$5(Landroid/view/autofill/AutofillManager;ILandroid/view/autofill/AutofillId;I)V
    ...
    invoke-static {p0, p1, p2, p3}, Landroid/view/autofill/AutofillManager;->access$1900(Landroid/view/autofill/AutofillManager;ILandroid/view/autofill/AutofillId;I)V
...
.method static synthetic lambda$setSaveUiState$9(Landroid/view/autofill/AutofillManager;IZ)V
    ...
    invoke-static {p0, p1, p2}, Landroid/view/autofill/AutofillManager;->access$1600(Landroid/view/autofill/AutofillManager;IZ)V

    return-void
.end method

.method static synthetic lambda$setSessionFinished$10(Landroid/view/autofill/AutofillManager;ILjava/util/List;)V
    .locals 0

    invoke-static {p0, p1, p2}, Landroid/view/autofill/AutofillManager;->access$1500(Landroid/view/autofill/AutofillManager;ILjava/util/List;)V
...
.method static synthetic lambda$setState$0(Landroid/view/autofill/AutofillManager;I)V
    ...
    invoke-static {p0, p1}, Landroid/view/autofill/AutofillManager;->access$2400(Landroid/view/autofill/AutofillManager;I)V
...
.method static synthetic lambda$setTrackedViews$8(Landroid/view/autofill/AutofillManager;I[Landroid/view/autofill/AutofillId;ZZ[Landroid/view/autofill/AutofillId;Landroid/view/autofill/AutofillId;)V
    ...
    invoke-static/range {p0 .. p6}, Landroid/view/autofill/AutofillManager;->access$1700(Landroid/view/autofill/AutofillManager;I[Landroid/view/autofill/AutofillId;ZZ[Landroid/view/autofill/AutofillId;Landroid/view/autofill/AutofillId;)V
...
.method public getAugmentedAutofillClient(Lcom/android/internal/os/IResultReceiver;)V
    ...
    new-instance v1, Landroid/view/autofill/-$$Lambda$AutofillManager$AutofillManagerClient$eeFWMGoPtaXdpslR3NLvhgXvMMs;

    invoke-direct {v1, v0, p1}, Landroid/view/autofill/-$$Lambda$AutofillManager$AutofillManagerClient$eeFWMGoPtaXdpslR3NLvhgXvMMs;-><init>(Landroid/view/autofill/AutofillManager;Lcom/android/internal/os/IResultReceiver;)V
...
.method public setSessionFinished(ILjava/util/List;)V
    ...
    new-instance v1, Landroid/view/autofill/-$$Lambda$AutofillManager$AutofillManagerClient$-IhPS_W7AwZ4M9TKIIFigmQd5SE;

    invoke-direct {v1, v0, p1, p2}, Landroid/view/autofill/-$$Lambda$AutofillManager$AutofillManagerClient$-IhPS_W7AwZ4M9TKIIFigmQd5SE;-><init>(Landroid/view/autofill/AutofillManager;ILjava/util/List;)V
