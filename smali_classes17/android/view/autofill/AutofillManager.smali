...
.method static synthetic access$1400(Landroid/view/autofill/AutofillManager;Lcom/android/internal/os/IResultReceiver;)V
    .locals 0
...
.method static synthetic access$1500(Landroid/view/autofill/AutofillManager;ILjava/util/List;)V
    .locals 0
...
.method static synthetic access$1600(Landroid/view/autofill/AutofillManager;IZ)V
    .locals 0
...
.method static synthetic access$1700(Landroid/view/autofill/AutofillManager;I[Landroid/view/autofill/AutofillId;ZZ[Landroid/view/autofill/AutofillId;Landroid/view/autofill/AutofillId;)V
    .locals 0
...
.method static synthetic access$1800(Landroid/view/autofill/AutofillManager;ILandroid/view/autofill/AutofillId;Landroid/view/KeyEvent;)V
    .locals 0
...
.method static synthetic access$1900(Landroid/view/autofill/AutofillManager;ILandroid/view/autofill/AutofillId;I)V
    .locals 0
...
.method static synthetic access$2000(Landroid/view/autofill/AutofillManager;Landroid/view/autofill/AutofillId;Z)V
    .locals 0
...
.method static synthetic access$2100(Landroid/view/autofill/AutofillManager;ILandroid/view/autofill/AutofillId;IILandroid/graphics/Rect;Landroid/view/autofill/IAutofillWindowPresenter;)V
    .locals 0
...
.method static synthetic access$2200(Landroid/view/autofill/AutofillManager;IILandroid/content/IntentSender;Landroid/content/Intent;)V
    .locals 0
...
.method static synthetic access$2300(Landroid/view/autofill/AutofillManager;ILjava/util/List;Ljava/util/List;)V
    .locals 0
...
.method static synthetic access$2400(Landroid/view/autofill/AutofillManager;I)V
    .locals 0
...
.method private autofill(ILjava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {v0}, Landroid/view/autofill/AutofillId;->isVirtualInt()Z
    ...
    invoke-virtual {v6, v14, v3}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_5
    invoke-virtual {v0}, Landroid/view/autofill/AutofillId;->getVirtualChildIntId()I
    ...
    invoke-virtual {v3, v0, v13}, Landroid/view/autofill/ParcelableMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {v14, v13}, Landroid/view/View;->autofill(Landroid/view/autofill/AutofillValue;)V

    invoke-direct {v1, v14, v13}, Landroid/view/autofill/AutofillManager;->setAutofilledIfValuesIs(Landroid/view/View;Landroid/view/autofill/AutofillValue;)V
    ...
    invoke-virtual {v3, v4, v9}, Landroid/metrics/LogMaker;->addTaggedData(ILjava/lang/Object;)Landroid/metrics/LogMaker;
...
.method private ensureServiceClientAddedIfNeededLocked()V
    ...
    new-instance v1, Landroid/view/autofill/AutofillManager$AutofillManagerClient;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Landroid/view/autofill/AutofillManager$AutofillManagerClient;-><init>(Landroid/view/autofill/AutofillManager;Landroid/view/autofill/AutofillManager$1;)V
    ...
    invoke-interface {v3, v4, v5, v1, v2}, Landroid/view/autofill/IAutoFillManager;->addClient(Landroid/view/autofill/IAutoFillManagerClient;Landroid/content/ComponentName;ILcom/android/internal/os/IResultReceiver;)V
    ...
    :goto_2
    sput-boolean v4, Landroid/view/autofill/Helper;->sVerbose:Z
    ...
    :cond_4
    iput-boolean v5, p0, Landroid/view/autofill/AutofillManager;->mEnabledForAugmentedAutofillOnly:Z
    ...
    invoke-direct {v6, v4, v5, v1}, Landroid/view/autofill/-$$Lambda$AutofillManager$V76JiQu509LCUz3-ckpb-nB3JhA;-><init>(Landroid/view/autofill/IAutoFillManager;Landroid/view/autofill/IAutoFillManagerClient;I)V
...
.method private notifyNoFillUi(ILandroid/view/autofill/AutofillId;I)V
    ...
    const-string/jumbo v1, "notifyNoFillUi(): sessionId="
    ...
    const-string v1, ", sessionFinishedState="
    ...
    invoke-direct {p0, p3, v2}, Landroid/view/autofill/AutofillManager;->setSessionFinished(ILjava/util/List;)V
...
.method private startSessionLocked(Landroid/view/autofill/AutofillId;Landroid/graphics/Rect;Landroid/view/autofill/AutofillValue;I)V
    ...
    const-string/jumbo v2, "startSessionLocked(): id="
    ...
    const-string v2, ", augmentedOnly="

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v2, v1, Landroid/view/autofill/AutofillManager;->mForAugmentedAutofillOnly:Z
    ...
    iget-boolean v2, v1, Landroid/view/autofill/AutofillManager;->mEnabledForAugmentedAutofillOnly:Z
    ...
    iget-object v2, v1, Landroid/view/autofill/AutofillManager;->mEnteredIds:Landroid/util/ArraySet;
    ...
    :cond_5
    iput-boolean v10, v1, Landroid/view/autofill/AutofillManager;->mForAugmentedAutofillOnly:Z
    ...
    const-string/jumbo v2, "not automatically starting session for "
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/util/SyncResultReceiver;->getIntResult()I
...
.method public isFieldClassificationEnabled()Z
    ...
    invoke-interface {v2, v0}, Landroid/view/autofill/IAutoFillManager;->isFieldClassificationEnabled(Lcom/android/internal/os/IResultReceiver;)V
...
.method public notifyValueChanged(Landroid/view/View;)V
    ...
    const-string/jumbo v5, "notifyValueChanged(): not notifying system server on augmented-only mode"
...
.method public notifyValueChanged(Landroid/view/View;ILandroid/view/autofill/AutofillValue;)V
    ...
    const-string/jumbo v2, "notifyValueChanged(): ignoring on augmented only mode"
...
.method public setAugmentedAutofillWhitelist(Ljava/util/Set;Ljava/util/Set;)V
    ...
    invoke-interface {v1, v2, v3, v0}, Landroid/view/autofill/IAutoFillManager;->setAugmentedAutofillWhitelist(Ljava/util/List;Ljava/util/List;Lcom/android/internal/os/IResultReceiver;)V
    ...
    const-string/jumbo v3, "setAugmentedAutofillWhitelist(): received invalid result: "
