...
.method private applyInterpolator()V
    ...
    iget-object v1, p0, Landroid/view/RenderNodeAnimator;->mNativePtr:Lcom/android/internal/util/VirtualRefBasePtr;
...
.method private static callOnFinished(Landroid/view/RenderNodeAnimator;)V
    ...
    iget-object v0, p0, Landroid/view/RenderNodeAnimator;->mHandler:Landroid/os/Handler;

    if-eqz v0, :cond_0

    invoke-static {p0}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v1, Landroid/view/-$$Lambda$1kvF4JuyM42-wmyDVPAIYdPz1jE;

    invoke-direct {v1, p0}, Landroid/view/-$$Lambda$1kvF4JuyM42-wmyDVPAIYdPz1jE;-><init>(Landroid/view/RenderNodeAnimator;)V
...
.method private doStart()V
    ...
    invoke-virtual {v0, v1}, Landroid/view/View;->setAlphaInternal(F)V
...
.method private setTarget(Landroid/graphics/RenderNode;)V
    .locals 2

    invoke-direct {p0}, Landroid/view/RenderNodeAnimator;->checkMutable()V

    iget-object v0, p0, Landroid/view/RenderNodeAnimator;->mTarget:Landroid/graphics/RenderNode;
    ...
    iput-object p1, p0, Landroid/view/RenderNodeAnimator;->mTarget:Landroid/graphics/RenderNode;

    iget-object v0, p0, Landroid/view/RenderNodeAnimator;->mTarget:Landroid/graphics/RenderNode;

    invoke-virtual {v0, p0}, Landroid/graphics/RenderNode;->addAnimator(Landroid/view/RenderNodeAnimator;)V
...
.method public setTarget(Landroid/graphics/RecordingCanvas;)V
    .locals 1

    iget-object v0, p1, Landroid/graphics/RecordingCanvas;->mNode:Landroid/graphics/RenderNode;

    invoke-direct {p0, v0}, Landroid/view/RenderNodeAnimator;->setTarget(Landroid/graphics/RenderNode;)V
...
.method public setTarget(Landroid/view/DisplayListCanvas;)V
    ...
    invoke-virtual {p0, v0}, Landroid/view/RenderNodeAnimator;->setTarget(Landroid/graphics/RecordingCanvas;)V
...
.method public start()V
    ...
    iget-object v1, p0, Landroid/view/RenderNodeAnimator;->mHandler:Landroid/os/Handler;
    ...
    iput-object v1, p0, Landroid/view/RenderNodeAnimator;->mHandler:Landroid/os/Handler;
