...
.method public onMinimizedStateChanged(Z)V
    ...
    invoke-interface {v2, p1}, Landroid/view/IPinnedStackListener;->onMinimizedStateChanged(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onMovementBoundsChanged(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZI)V
    ...
    invoke-virtual {p1, v11, v1}, Landroid/graphics/Rect;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    :try_start_2
    iget-object v1, v13, Landroid/view/IPinnedStackListener$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public onShelfVisibilityChanged(ZI)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/view/IPinnedStackListener;->onShelfVisibilityChanged(ZI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
