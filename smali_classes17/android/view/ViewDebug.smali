...
.method private static capturedViewExportMethods(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-class v8, Landroid/view/ViewDebug$CapturedViewProperty;
    ...
    invoke-static {v6, v7, v9}, Landroid/view/ViewDebug;->capturedViewExportMethods(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/String;
...
.method private static exportFields(Landroid/content/Context;Ljava/lang/Object;Ljava/io/BufferedWriter;Ljava/lang/Class;Ljava/lang/String;)V
    ...
    invoke-static {v9, v5, v6, v2, v1}, Landroid/view/ViewDebug;->writeEntry(Ljava/io/BufferedWriter;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v7, v1, v9, v2}, Landroid/view/ViewDebug;->dumpViewProperties(Landroid/content/Context;Ljava/lang/Object;Ljava/io/BufferedWriter;Ljava/lang/String;)V
    ...
    invoke-static {v9, v1, v4, v5}, Landroid/view/ViewDebug;->exportUnrolledFlags(Ljava/io/BufferedWriter;[Landroid/view/ViewDebug$FlagToString;ILjava/lang/String;)V
    ...
    invoke-static {v9, v4, v5, v2, v1}, Landroid/view/ViewDebug;->writeEntry(Ljava/io/BufferedWriter;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_1
...
.method private static exportMethods(Landroid/content/Context;Ljava/lang/Object;Ljava/io/BufferedWriter;Ljava/lang/Class;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {v13, v14}, Landroid/view/ViewDebug;->callMethodOnAppropriateTheadBlocking(Ljava/lang/reflect/Method;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v8, v1, v4, v2}, Landroid/view/ViewDebug;->exportUnrolledFlags(Ljava/io/BufferedWriter;[Landroid/view/ViewDebug$FlagToString;ILjava/lang/String;)V
    ...
    invoke-static {v8, v5, v6, v1, v2}, Landroid/view/ViewDebug;->writeEntry(Ljava/io/BufferedWriter;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v8, v2, v4, v1, v0}, Landroid/view/ViewDebug;->writeEntry(Ljava/io/BufferedWriter;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_5
...
.method public static invokeViewMethod(Landroid/view/View;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v7, Landroid/view/ViewDebug$5;
    ...
    invoke-direct/range {v0 .. v6}, Landroid/view/ViewDebug$5;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/reflect/Method;Landroid/view/View;[Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/CountDownLatch;)V
...
.method static synthetic lambda$performViewCapture$5(Landroid/view/View;[Landroid/graphics/Bitmap;ZLjava/util/concurrent/CountDownLatch;)V
    .locals 3
...
.method static synthetic lambda$startRenderingCommandsCapture$4(Ljava/util/concurrent/Callable;Landroid/graphics/Picture;)Ljava/lang/Boolean;
    .locals 2
...
.method private static performViewCapture(Landroid/view/View;Z)Landroid/graphics/Bitmap;
    ...
    new-instance v2, Landroid/view/-$$Lambda$ViewDebug$1iDmmthcZt_8LsYI6VndkxasPEs;

    invoke-direct {v2, p0, v1, p1, v0}, Landroid/view/-$$Lambda$ViewDebug$1iDmmthcZt_8LsYI6VndkxasPEs;-><init>(Landroid/view/View;[Landroid/graphics/Bitmap;ZLjava/util/concurrent/CountDownLatch;)V
...
.method public static startRenderingCommandsCapture(Landroid/view/View;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Ljava/lang/AutoCloseable;
    ...
    new-instance v4, Landroid/view/-$$Lambda$ViewDebug$hyDSYptlxuUTTyRIONqWzWWVDB0;

    invoke-direct {v4, p2}, Landroid/view/-$$Lambda$ViewDebug$hyDSYptlxuUTTyRIONqWzWWVDB0;-><init>(Ljava/util/concurrent/Callable;)V

    invoke-direct {v3, v1, v4, p1, v2}, Landroid/view/ViewDebug$PictureCallbackHandler;-><init>(Landroid/graphics/HardwareRenderer;Ljava/util/function/Function;Ljava/util/concurrent/Executor;Landroid/view/ViewDebug$1;)V
