...
.method private static debugLog(Landroid/metrics/LogMaker;)V
    ...
    invoke-virtual {p0, v0}, Landroid/metrics/LogMaker;->getTaggedData(I)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1}, Landroid/metrics/LogMaker;->getTaggedData(I)Ljava/lang/Object;

    move-result-object v1

    const-string v2, "ANY_ENTITY"
    ...
    invoke-virtual {p0, v2}, Landroid/metrics/LogMaker;->getTaggedData(I)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v4}, Landroid/metrics/LogMaker;->getTaggedData(I)Ljava/lang/Object;

    move-result-object v4

    invoke-static {v4, v3}, Ljava/util/Objects;->toString(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v5}, Landroid/metrics/LogMaker;->getTaggedData(I)Ljava/lang/Object;

    move-result-object v5

    invoke-static {v5, v3}, Ljava/util/Objects;->toString(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v6}, Landroid/metrics/LogMaker;->getTaggedData(I)Ljava/lang/Object;

    move-result-object v6

    invoke-static {v6, v3}, Ljava/util/Objects;->toString(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Landroid/metrics/LogMaker;->getPackageName()Ljava/lang/String;

    move-result-object v9

    aput-object v9, v7, v8

    const-string v8, "%s:%s %d links (%d/%d chars) %dms %s"

    invoke-static {v6, v8, v7}, Ljava/lang/String;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v6

    const-string v7, "GenerateLinksLogger"

    invoke-static {v7, v6}, Landroid/view/textclassifier/Log;->v(Ljava/lang/String;Ljava/lang/String;)V
...
.method private shouldLog()Z
    ...
    :cond_0
    iget-object v2, p0, Landroid/view/textclassifier/GenerateLinksLogger;->mRng:Ljava/util/Random;
