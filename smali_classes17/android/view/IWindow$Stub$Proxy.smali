...
.method public resized(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZLandroid/util/MergedConfiguration;Landroid/graphics/Rect;ZZILandroid/view/DisplayCutout$ParcelableWrapper;)V
    ...
    invoke-virtual {v15, v6, v1}, Landroid/graphics/Rect;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_1
    ...
    invoke-virtual {v14, v6, v1}, Landroid/graphics/Rect;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_3
    ...
    invoke-virtual {v13, v6, v1}, Landroid/graphics/Rect;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0
    ...
    invoke-virtual {v12, v6, v1}, Landroid/graphics/Rect;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_7
    ...
    invoke-virtual {v11, v6, v1}, Landroid/graphics/Rect;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_9
    ...
    invoke-virtual {v10, v6, v1}, Landroid/graphics/Rect;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_b
    ...
    invoke-virtual {v9, v6, v1}, Landroid/util/MergedConfiguration;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_d
    ...
    invoke-virtual {v8, v6, v1}, Landroid/graphics/Rect;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_f
    ...
    invoke-virtual {v7, v6, v1}, Landroid/view/DisplayCutout$ParcelableWrapper;->writeToParcel(Landroid/os/Parcel;I)V
    :try_end_11
    ...
    iget-object v1, v4, Landroid/view/IWindow$Stub$Proxy;->mRemote:Landroid/os/IBinder;

    const/4 v2, 0x2

    const/4 v3, 0x0

    invoke-interface {v1, v2, v6, v3, v0}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :try_start_13
    invoke-interface/range {v1 .. v14}, Landroid/view/IWindow;->resized(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZLandroid/util/MergedConfiguration;Landroid/graphics/Rect;ZZILandroid/view/DisplayCutout$ParcelableWrapper;)V
    :try_end_13
