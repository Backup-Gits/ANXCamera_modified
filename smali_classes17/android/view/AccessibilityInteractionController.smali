...
.method private applyAppScaleAndMagnificationSpecIfNeeded(Landroid/view/accessibility/AccessibilityNodeInfo;Landroid/view/MagnificationSpec;)V
    ...
    invoke-virtual {v9, v3}, Landroid/graphics/RectF;->scale(F)V

    if-eqz v2, :cond_4

    iget v10, v2, Landroid/view/MagnificationSpec;->scale:F

    invoke-virtual {v9, v10}, Landroid/graphics/RectF;->scale(F)V

    iget v10, v2, Landroid/view/MagnificationSpec;->offsetX:F
    ...
    iget-object v7, v6, Landroid/view/View$AttachInfo;->mDisplay:Landroid/view/Display;
    ...
    :cond_6
    iget v7, v6, Landroid/view/View$AttachInfo;->mApplicationScale:F

    iget v8, v2, Landroid/view/MagnificationSpec;->scale:F

    mul-float/2addr v7, v8

    iget-object v8, v0, Landroid/view/AccessibilityInteractionController;->mTempRect1:Landroid/graphics/Rect;

    iget v9, v6, Landroid/view/View$AttachInfo;->mWindowLeft:I
    ...
    iget v9, v6, Landroid/view/View$AttachInfo;->mWindowTop:I

    int-to-float v9, v9

    mul-float/2addr v9, v7

    iget v10, v2, Landroid/view/MagnificationSpec;->offsetY:F
    ...
    iget-object v10, v0, Landroid/view/AccessibilityInteractionController;->mViewRootImpl:Landroid/view/ViewRootImpl;
    ...
    iget-object v9, v6, Landroid/view/View$AttachInfo;->mDisplay:Landroid/view/Display;
    ...
    iget-object v9, v0, Landroid/view/AccessibilityInteractionController;->mTempPoint:Landroid/graphics/Point;
    ...
    iget-object v11, v0, Landroid/view/AccessibilityInteractionController;->mTempRect2:Landroid/graphics/Rect;

    const/4 v12, 0x0

    invoke-virtual {v11, v12, v12, v9, v10}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual {v8, v13, v14, v15, v12}, Landroid/graphics/Rect;->intersects(IIII)Z
    ...
    invoke-virtual {v1, v12}, Landroid/view/accessibility/AccessibilityNodeInfo;->setVisibleToUser(Z)V
...
.method private findAccessibilityNodeInfosByTextUiThread(Landroid/os/Message;)V
    ...
    invoke-direct {v7, v2}, Landroid/view/AccessibilityInteractionController;->isShown(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v11, v3}, Landroid/view/accessibility/AccessibilityNodeProvider;->findAccessibilityNodeInfosByText(Ljava/lang/String;I)Ljava/util/List;
