...
.method private static addFileWithFootersToDropBox(Landroid/os/DropBoxManager;Ljava/util/HashMap;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-static {v5}, Landroid/util/StatsLog;->write(I)I
...
.method private static addFsckErrorsToDropBoxAndLogFsStat(Landroid/os/DropBoxManager;Ljava/util/HashMap;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-static {v4, v15, v2, v3}, Lcom/android/server/BootReceiver;->handleFsckFsStat(Ljava/util/regex/Matcher;[Ljava/lang/String;II)V
...
.method public static fixFsckFsStat(Ljava/lang/String;I[Ljava/lang/String;II)I
    ...
    const-string v6, "fs_stat, got quota fix without tree optimization, partition:"
...
.method private logBootEvents(Landroid/content/Context;)V
    ...
    const-string/jumbo v3, "ro.runtime.firstboot"
...
.method private static logFsShutdownTime()V
    ...
    const-string v8, "boot_fs_shutdown_umount_stat"
    ...
    const-string v10, "boot_fs_shutdown_duration"

    invoke-static {v4, v10, v9}, Lcom/android/internal/logging/MetricsLogger;->histogram(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-static {v4, v8, v10}, Lcom/android/internal/logging/MetricsLogger;->histogram(Landroid/content/Context;Ljava/lang/String;I)V

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "boot_fs_shutdown,"
    ...
    invoke-static {v4, v8, v7}, Lcom/android/internal/logging/MetricsLogger;->histogram(Landroid/content/Context;Ljava/lang/String;I)V

    const-string v4, "boot_fs_shutdown, string not found"
...
.method private static logSystemServerShutdownTimeMetrics()V
    ...
    :cond_6
    invoke-static {v5, v6, v7, v10}, Lcom/android/server/BootReceiver;->logStatsdShutdownAtom(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
