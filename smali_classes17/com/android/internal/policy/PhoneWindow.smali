...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/android/internal/policy/PhoneWindow$4;

    invoke-direct {v1}, Lcom/android/internal/policy/PhoneWindow$4;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/internal/policy/PhoneWindow;->mSharedElementReenterTransition:Landroid/transition/Transition;
...
.method private launchDefaultSearch(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v1, v3, v5, v2}, Landroid/app/SearchManager;->launchLegacyAssist(Ljava/lang/String;ILandroid/os/Bundle;)Z
...
.method private registerSwipeCallbacks(Landroid/view/ViewGroup;)V
    ...
    const-string v1, "contentParent is not a SwipeDismissLayout: "
...
.method protected generateLayout(Lcom/android/internal/policy/DecorView;)Landroid/view/ViewGroup;
    ...
    invoke-virtual {v0, v9, v10}, Lcom/android/internal/policy/PhoneWindow;->setFlags(II)V
    ...
    invoke-virtual {v2, v10, v9}, Landroid/content/res/TypedArray;->getValue(ILandroid/util/TypedValue;)Z
    ...
    iput-object v9, v0, Lcom/android/internal/policy/PhoneWindow;->mFixedWidthMajor:Landroid/util/TypedValue;
    ...
    invoke-virtual {v2, v9, v12}, Landroid/content/res/TypedArray;->getValue(ILandroid/util/TypedValue;)Z
    ...
    iput-object v9, v0, Lcom/android/internal/policy/PhoneWindow;->mFixedWidthMinor:Landroid/util/TypedValue;
    ...
    iput-object v9, v0, Lcom/android/internal/policy/PhoneWindow;->mFixedHeightMinor:Landroid/util/TypedValue;
    ...
    invoke-virtual {v11, v6}, Landroid/content/res/Resources;->getBoolean(I)Z
    ...
    invoke-virtual {v0, v8}, Lcom/android/internal/policy/PhoneWindow;->hasFeature(I)Z
    ...
    :cond_1f
    :goto_a
    invoke-virtual {v0, v8}, Lcom/android/internal/policy/PhoneWindow;->setNeedsMenuKey(I)V
    ...
    iput-boolean v7, v0, Lcom/android/internal/policy/PhoneWindow;->mEnsureStatusBarContrastWhenTransparent:Z
    ...
    iput-boolean v7, v0, Lcom/android/internal/policy/PhoneWindow;->mEnsureNavigationBarContrastWhenTransparent:Z
    ...
    iget-boolean v8, v0, Lcom/android/internal/policy/PhoneWindow;->mIsFloating:Z
    ...
    invoke-virtual {v0, v8, v3}, Lcom/android/internal/policy/PhoneWindow;->setFlags(II)V

    :cond_23
    iget-object v3, v0, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    iget-boolean v3, v3, Lcom/android/internal/policy/DecorView;->mForceWindowDrawsBarBackgrounds:Z
    ...
    iget v1, v7, Landroid/view/WindowManager$LayoutParams;->layoutInDisplayCutoutMode:I
    ...
    invoke-static {v1}, Lmiui/os/MiuiInit;->getCutoutMode(Ljava/lang/String;)I
    ...
    :cond_29
    :goto_c
    iget-boolean v1, v0, Lcom/android/internal/policy/PhoneWindow;->mAlwaysReadCloseOnTouchAttr:Z
    ...
    iget v3, v7, Landroid/view/WindowManager$LayoutParams;->softInputMode:I

    invoke-virtual {v2, v1, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, v7, Landroid/view/WindowManager$LayoutParams;->softInputMode:I
    ...
    :goto_d
    iget v1, v7, Landroid/view/WindowManager$LayoutParams;->windowAnimations:I
    ...
    iget-object v1, v0, Lcom/android/internal/policy/PhoneWindow;->mBackgroundDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput v1, v0, Lcom/android/internal/policy/PhoneWindow;->mFrameResource:I
    ...
    iput-object v1, v0, Lcom/android/internal/policy/PhoneWindow;->mBackgroundFallbackDrawable:Landroid/graphics/drawable/Drawable;

    :cond_34
    iget-boolean v1, v0, Lcom/android/internal/policy/PhoneWindow;->mLoadElevation:Z
    ...
    iput v1, v0, Lcom/android/internal/policy/PhoneWindow;->mElevation:F
    ...
    iput-boolean v1, v0, Lcom/android/internal/policy/PhoneWindow;->mClipToOutline:Z
    ...
    iput v1, v0, Lcom/android/internal/policy/PhoneWindow;->mTextColor:I
    ...
    invoke-virtual {v0, v4}, Lcom/android/internal/policy/PhoneWindow;->setCloseOnSwipeEnabled(Z)V
    ...
    invoke-virtual {v4, v8, v3, v5}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
    ...
    invoke-direct {v0, v4}, Lcom/android/internal/policy/PhoneWindow;->registerSwipeCallbacks(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v5, v8}, Lcom/android/internal/policy/DecorView;->setWindowBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v8, v5}, Lcom/android/internal/policy/DecorView;->setWindowFrame(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v8, v1}, Lcom/android/internal/policy/DecorView;->setElevation(F)V

    iget-object v1, v0, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    iget-boolean v8, v0, Lcom/android/internal/policy/PhoneWindow;->mClipToOutline:Z

    invoke-virtual {v1, v8}, Lcom/android/internal/policy/DecorView;->setClipToOutline(Z)V
...
.method public restoreHierarchyState(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/policy/PhoneWindow;->restorePanelState(Landroid/util/SparseArray;)V
...
.method public setCloseOnSwipeEnabled(Z)V
    ...
    instance-of v1, v0, Lcom/android/internal/widget/SwipeDismissLayout;
