...
.field public static final KEY_IS_SYSTEM_PROCESS:Ljava/lang/String; = "is_system_process"

.field public static final KEY_IS_USER_INITIATED:Ljava/lang/String; = "is_user_initiated"
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    const-string v2, "is_user_initiated"
    ...
    const-string v3, "is_system_process"
    ...
    const-string v6, "android.app.action.REPORT_HEAP_LIMIT"
    ...
    const-string v8, "Heap Dump"

    invoke-static {v6, v8, v7}, Landroid/content/ClipData;->newUri(Landroid/content/ContentResolver;Ljava/lang/CharSequence;Landroid/net/Uri;)Landroid/content/ClipData;
    ...
    invoke-virtual {v7, v1}, Landroid/content/ClipDescription;->getMimeType(I)Ljava/lang/String;
    ...
    :try_start_0
    invoke-virtual {p0, v5}, Lcom/android/internal/app/DumpHeapActivity;->startActivity(Landroid/content/Intent;)V
    ...
    const-string v9, "Unable to direct launch to "
    ...
    const-string v9, "DumpHeapActivity"
    ...
    iget-object v8, p0, Lcom/android/internal/app/DumpHeapActivity;->mProcess:Ljava/lang/String;
    ...
    invoke-static {v8, v9, v1}, Landroid/util/DebugUtils;->sizeValueToString(JLjava/lang/StringBuilder;)Ljava/lang/String;

    move-result-object v1

    aput-object v1, v7, v4

    invoke-virtual {p0, v5, v7}, Lcom/android/internal/app/DumpHeapActivity;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    new-instance v4, Lcom/android/internal/app/DumpHeapActivity$1;

    invoke-direct {v4, p0}, Lcom/android/internal/app/DumpHeapActivity$1;-><init>(Lcom/android/internal/app/DumpHeapActivity;)V
    ...
    new-instance v4, Lcom/android/internal/app/DumpHeapActivity$2;

    invoke-direct {v4, p0}, Lcom/android/internal/app/DumpHeapActivity$2;-><init>(Lcom/android/internal/app/DumpHeapActivity;)V
