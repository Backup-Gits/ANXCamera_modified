...
.method public getCallCapablePhoneAccounts(ZLjava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {v3, p1, p2}, Lcom/android/internal/telecom/ITelecomService;->getCallCapablePhoneAccounts(ZLjava/lang/String;)Ljava/util/List;
...
.method public getCurrentTtyMode(Ljava/lang/String;)I
    ...
    invoke-interface {v3, p1}, Lcom/android/internal/telecom/ITelecomService;->getCurrentTtyMode(Ljava/lang/String;)I
...
.method public getDefaultOutgoingPhoneAccount(Ljava/lang/String;Ljava/lang/String;)Landroid/telecom/PhoneAccountHandle;
    ...
    invoke-interface {v3, p1, p2}, Lcom/android/internal/telecom/ITelecomService;->getDefaultOutgoingPhoneAccount(Ljava/lang/String;Ljava/lang/String;)Landroid/telecom/PhoneAccountHandle;
...
.method public getLine1Number(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v3, p1, p2}, Lcom/android/internal/telecom/ITelecomService;->getLine1Number(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;)Ljava/lang/String;
...
.method public getSelfManagedPhoneAccounts(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {v3, p1}, Lcom/android/internal/telecom/ITelecomService;->getSelfManagedPhoneAccounts(Ljava/lang/String;)Ljava/util/List;
...
.method public getVoiceMailNumber(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v3, p1, p2}, Lcom/android/internal/telecom/ITelecomService;->getVoiceMailNumber(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;)Ljava/lang/String;
...
.method public handleCallIntent(Landroid/content/Intent;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v3, p1}, Lcom/android/internal/telecom/ITelecomService;->handleCallIntent(Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public isInCall(Ljava/lang/String;)Z
    ...
    invoke-interface {v3, p1}, Lcom/android/internal/telecom/ITelecomService;->isInCall(Ljava/lang/String;)Z
...
.method public isInManagedCall(Ljava/lang/String;)Z
    ...
    invoke-interface {v3, p1}, Lcom/android/internal/telecom/ITelecomService;->isInManagedCall(Ljava/lang/String;)Z
...
.method public isTtySupported(Ljava/lang/String;)Z
    ...
    invoke-interface {v3, p1}, Lcom/android/internal/telecom/ITelecomService;->isTtySupported(Ljava/lang/String;)Z
...
.method public isVoiceMailNumber(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v2, p1, p2, p3}, Lcom/android/internal/telecom/ITelecomService;->isVoiceMailNumber(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public placeCall(Landroid/net/Uri;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-interface {v3, p1, p2, p3}, Lcom/android/internal/telecom/ITelecomService;->placeCall(Landroid/net/Uri;Landroid/os/Bundle;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setTestAutoModeApp(Ljava/lang/String;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v3, p1}, Lcom/android/internal/telecom/ITelecomService;->setTestAutoModeApp(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public showInCallScreen(ZLjava/lang/String;)V
    ...
    invoke-interface {v3, p1, p2}, Lcom/android/internal/telecom/ITelecomService;->showInCallScreen(ZLjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
