...
.method final bufferUInt32NoTag(I)V
    ...
    invoke-static {}, Lcom/android/framework/protobuf/CodedOutputStream;->access$200()J
    ...
    invoke-static {}, Lcom/android/framework/protobuf/CodedOutputStream;->access$300()Lsun/misc/Unsafe;

    move-result-object v4

    iget-object v7, p0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->buffer:[B
    ...
    iput v3, p0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I
...
.method final bufferUInt64NoTag(J)V
    ...
    iget v1, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I
    ...
    iget-object v2, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->buffer:[B
    ...
    iget v2, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I

    add-int/2addr v2, v1

    iput v2, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I

    iget v2, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->totalBytesWritten:I

    add-int/2addr v2, v1

    iput v2, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->totalBytesWritten:I
    ...
    iget-object v15, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->buffer:[B
    ...
    iget-object v1, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->buffer:[B

    iget v2, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I

    add-int/lit8 v5, v2, 0x1

    iput v5, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I
    ...
    iget v1, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->totalBytesWritten:I

    add-int/lit8 v1, v1, 0x1

    iput v1, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->totalBytesWritten:I
    ...
    iget v7, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I

    add-int/lit8 v8, v7, 0x1

    iput v8, v0, Lcom/android/framework/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I
